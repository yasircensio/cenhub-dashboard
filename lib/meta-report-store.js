...
function accountReportFields(account) {
  ...
  return {
    ...
    metaReportScenarioTrendMethod: normalizeMetaReportScenarioTrendMethod(account.metaReportScenarioTrendMethod),
    metaReportScenarioMonthWindow: normalizeMetaReportScenarioMonthWindow(account.metaReportScenarioMonthWindow),
    metaReportScenarioElasticity: normalizeMetaReportScenarioElasticity(account.metaReportScenarioElasticity),
...
async function updateMetaReportSettings(clientId, input = {}) {
  ...
  if (input.metaReportScenarioTrendMethod != null) {
    patch.metaReportScenarioTrendMethod = normalizeMetaReportScenarioTrendMethod(input.metaReportScenarioTrendMethod);
  }
  ...
  if (input.metaReportScenarioElasticity != null) {
    patch.metaReportScenarioElasticity = normalizeMetaReportScenarioElasticity(input.metaReportScenarioElasticity);
  }
