...
function rowToAccount(row, { includeSecrets = false } = {}) {
  ...
  const account = {
    ...
    metaReportScenarioTrendMethod: require('./meta-report-scenario-settings').normalizeMetaReportScenarioTrendMethod(
      normalized.meta_report_scenario_trend_method,
    ),
    ...
    metaReportScenarioElasticity: require('./meta-report-scenario-settings').normalizeMetaReportScenarioElasticity(
      normalized.meta_report_scenario_elasticity,
    ),
...
async function updateAccount(clientId, input) {
  ...
  const updated = {
    ...
    meta_report_scenario_trend_method: input.metaReportScenarioTrendMethod != null
      ? require('./meta-report-scenario-settings').normalizeMetaReportScenarioTrendMethod(input.metaReportScenarioTrendMethod)
      : require('./meta-report-scenario-settings').normalizeMetaReportScenarioTrendMethod(existing.metaReportScenarioTrendMethod),
    ...
    meta_report_scenario_elasticity: input.metaReportScenarioElasticity != null
      ? require('./meta-report-scenario-settings').normalizeMetaReportScenarioElasticity(input.metaReportScenarioElasticity)
      : require('./meta-report-scenario-settings').normalizeMetaReportScenarioElasticity(existing.metaReportScenarioElasticity),
  ...
  if (usePostgres()) {
    ...
    await query`
      UPDATE accounts SET
        ...
        meta_report_scenario_trend_method = ${updated.meta_report_scenario_trend_method},
        meta_report_scenario_month_window = ${updated.meta_report_scenario_month_window},
        meta_report_scenario_elasticity = ${updated.meta_report_scenario_elasticity},
