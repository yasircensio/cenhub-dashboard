...
async function getGoogleAdsReportsDashboard({ filter = 'all' } = {}) {
  const { getGoogleAdsConfig, getGoogleAdsConfigDebug, describeGoogleAdsDeveloperTokenProblem } = require('./google-ads-config');
