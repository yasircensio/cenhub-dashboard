    ...
    if (pathInfo.kind === 'client-settings') {
      ...
      if (method === 'PATCH' || method === 'PUT') {
        ...
        const account = await updateMetaReportSettings(pathInfo.clientId, {
          ...
          metaReportScenarioTrendMethod: body.metaReportScenarioTrendMethod,
          metaReportScenarioMonthWindow: body.metaReportScenarioMonthWindow,
          metaReportScenarioElasticity: body.metaReportScenarioElasticity,
        ...
        sendJson(response, 200, {
          ...
          settings: {
            ...
            metaReportScenarioTrendMethod: require('./meta-report-scenario-settings').normalizeMetaReportScenarioTrendMethod(
              account.metaReportScenarioTrendMethod,
            ),
            ...
            metaReportScenarioElasticity: require('./meta-report-scenario-settings').normalizeMetaReportScenarioElasticity(
              account.metaReportScenarioElasticity,
            ),
