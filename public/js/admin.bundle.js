(function(){const t=window.location.pathname.replace(/^\/+|\/+$/g,"").split("/").filter(Boolean);if(t[0]==="login"){document.body.dataset.dashboardMode="login",delete document.body.dataset.clientSlug;return}if(t[0]==="team"){document.body.dataset.dashboardMode="team",delete document.body.dataset.clientSlug;return}if(t[0]==="admin"){if(t[1]==="sync-history"&&(t[2]==="ghl"||t[2]==="meta")){document.body.dataset.dashboardMode=`sync-history-${t[2]}`,delete document.body.dataset.clientSlug;return}if(t[1]==="fb-lead-sync"){document.body.dataset.dashboardMode="fb-lead-sync",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]==="custom-values"){document.body.dataset.dashboardMode="meta-reports-custom",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]==="ghl-clients"){document.body.dataset.dashboardMode="meta-reports-ghl-clients",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]){document.body.dataset.dashboardMode="meta-reports-client",document.body.dataset.clientSlug=t[2];return}if(t[1]==="meta-reports"){document.body.dataset.dashboardMode="meta-reports",delete document.body.dataset.clientSlug;return}document.body.dataset.dashboardMode=t.length>=2?"admin":"hub",t.length>=2?document.body.dataset.clientSlug=t[1]:delete document.body.dataset.clientSlug;return}if(t[0]==="report"&&t[1]){document.body.dataset.dashboardMode="report",document.body.dataset.reportToken=t[1],delete document.body.dataset.clientSlug;return}t[0]&&t[0]!=="index.html"&&(document.body.dataset.dashboardMode="client",document.body.dataset.clientSlug=t[0])})();const DASHBOARD_MODE=document.body.dataset.dashboardMode||"client",IS_LOGIN_PAGE=DASHBOARD_MODE==="login",IS_TEAM_PAGE=DASHBOARD_MODE==="team",IS_ADMIN_HUB=DASHBOARD_MODE==="hub",IS_ADMIN_CLIENT=DASHBOARD_MODE==="admin",IS_ADMIN_SYNC_HISTORY_GHL=DASHBOARD_MODE==="sync-history-ghl",IS_ADMIN_SYNC_HISTORY_META=DASHBOARD_MODE==="sync-history-meta",IS_ADMIN_FB_LEAD_SYNC=DASHBOARD_MODE==="fb-lead-sync",IS_ADMIN_META_REPORTS=DASHBOARD_MODE==="meta-reports",IS_ADMIN_META_REPORTS_CLIENT=DASHBOARD_MODE==="meta-reports-client",IS_ADMIN_META_REPORTS_CUSTOM=DASHBOARD_MODE==="meta-reports-custom",IS_ADMIN_META_REPORTS_GHL_CLIENTS=DASHBOARD_MODE==="meta-reports-ghl-clients",IS_REPORT_VIEW=DASHBOARD_MODE==="report",REPORT_TOKEN=document.body.dataset.reportToken||"",IS_ADMIN_SYNC_HISTORY=IS_ADMIN_SYNC_HISTORY_GHL||IS_ADMIN_SYNC_HISTORY_META,IS_CLIENT_VIEW=DASHBOARD_MODE==="client",IS_PREVIEW=IS_CLIENT_VIEW&&!!new URLSearchParams(window.location.search).get("client"),IS_ADMIN=IS_ADMIN_HUB||IS_ADMIN_CLIENT||IS_TEAM_PAGE||IS_ADMIN_SYNC_HISTORY||IS_ADMIN_FB_LEAD_SYNC||IS_ADMIN_META_REPORTS||IS_ADMIN_META_REPORTS_CLIENT||IS_ADMIN_META_REPORTS_CUSTOM||IS_ADMIN_META_REPORTS_GHL_CLIENTS||new URLSearchParams(window.location.search).get("view")==="admin",ADMIN_UI=IS_ADMIN_HUB||IS_ADMIN_CLIENT||IS_TEAM_PAGE||IS_ADMIN_SYNC_HISTORY||IS_ADMIN_FB_LEAD_SYNC||IS_ADMIN_META_REPORTS||IS_ADMIN_META_REPORTS_CLIENT||IS_ADMIN_META_REPORTS_CUSTOM||IS_ADMIN_META_REPORTS_GHL_CLIENTS||IS_ADMIN,LOADING_MSG=ADMIN_UI?"Loading dashboard data...":"Henter dashboard data...",RETRY_MSG=ADMIN_UI?"Try again":"Pr\xF8v igen";(function(){const t=document.getElementById("initial-loading-msg");t&&(t.textContent=LOADING_MSG)})();function resolveClientSlug(){if(document.body.dataset.clientSlug)return document.body.dataset.clientSlug;const e=window.location.pathname.replace(/^\/+|\/+$/g,"").split("/").filter(Boolean);return e[0]==="admin"&&e[1]==="meta-reports"&&e[2]&&e[2]!=="custom-values"&&e[2]!=="ghl-clients"?e[2]:e[0]==="admin"&&e[1]&&e[1]!=="meta-reports"?e[1]:e[0]&&e[0]!=="admin"&&e[0]!=="index.html"&&e[0]!=="report"?e[0]:new URLSearchParams(window.location.search).get("client")||"suntech-nordic"}const CLIENT_SLUG=resolveClientSlug();let tenantParams={},facebookClientId=CLIENT_SLUG,setupAccount=null,setupPipelines=[],metricsModelChangeMode=!1;function esc(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function renderBrandTopbar(e=""){const t=!!(e&&e.includes("staff-admin-chrome")),a=t||e&&e.includes("admin-topbar-link")?"/admin":"",n=a?`<a href="${a}" class="brand-logo-link" aria-label="Cenhub home"><img class="brand-logo" src="/cenhub-logo-white.png" alt="Cenhub" width="167" height="41" /></a>`:'<img class="brand-logo" src="/cenhub-logo-white.png" alt="Cenhub" width="167" height="41" />',o=t?`<button type="button" class="staff-nav-toggle" id="staff-nav-toggle" aria-expanded="false" aria-controls="staff-topbar-panel" aria-label="Open menu">
    ...
    <nav class="staff-nav" aria-label="Admin navigation">
      ...
      <div class="staff-nav-dropdown" data-staff-nav-dropdown="meta-reports">
        ...
        <div class="staff-nav-dropdown-menu" role="menu">
          ...
          <a href="/admin/meta-reports/ghl-clients" class="staff-nav-dropdown-item${e==="meta-reports-ghl-clients"?" is-active":""}" role="menuitem">GHL clients</a>
  ...
  `}function renderSyncHistoryRows(e,t){if(!e.length)return'<div class="sync-history-empty">No sync runs logged yet.</div>';const a=t==="meta"?"Spend / details":"Details",n=e.map(o=>{let s="\u2014";if(t==="meta"){const r=[];if(o.thisMonthSpend!=null&&r.push(`${fmtDkk(o.thisMonthSpend)} DKK this month`),o.spendDateStop){const i=formatSyncHistoryDate(o.spendDateStop);i&&r.push(`through ${i}`)}o.errorMessage&&r.push(o.errorMessage),s=r.join(" \xB7 ")||"\u2014"}else o.opportunityCount!=null?(s=`${o.opportunityCount} opportunities`,o.errorMessage&&(s+=` \xB7 ${o.errorMessage}`)):o.errorMessage&&(s=o.errorMessage);return`
      <tr>
...
${a}`))try{const o=await adminFetch(`/api/sync-history?type=${encodeURIComponent(e)}`,{method:"DELETE"});showToast(`Cleared ${o.deleted||0} log entr${o.deleted===1?"y":"ies"}.`,"success"),await loadSyncHistoryPage(e)}catch(o){showToast(o.message||`Failed to clear ${t} sync log.`,"error")}}function renderSyncHistoryLoginPrompt(e){const t=e==="meta"?"Meta sync log":"GHL sync log";return`
    ${renderBrandTopbar("")}
    ${wrapDashboardShell(`
      <div class="page-hero admin-hub-hero">
        <h1>${esc(t)}</h1>
...
Resume the interrupted ${S}?`)&&(l=w.id,c=Number(w.batchOffset)||0)}}if(a?setFbLeadProgress({processed:c,total:0,label:c>0?"Resuming preview\u2026":"Fetching Meta leads\u2026"}):updateGlobalApplyProgress({waiting:!0,elapsed:0}),a&&c===0){const w=await adminFetchWithRetry("/api/fb-lead-sync/prepare",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l})}),v=w.summary||w;l=v.runId,c=0,setFbLeadProgress({processed:0,total:v.inWindow||0,label:`Matching ${v.inWindow||0} Meta leads to GHL\u2026`})}else!a&&c===0&&updateGlobalApplyProgress({waiting:!1,processed:0,total:$||m?.updated||0});do{d=await adminFetchWithRetry("/api/fb-lead-sync/run",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l,previewRunId:a?null:h,batchOffset:c,batchLimit:r})});const w=d.summary||d;l=w.runId,c=w.nextBatchOffset??w.batchOffset+(w.batchProcessed||0),u=u.concat(w.rows||[]),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.runId=l);const v=w.inWindow||c||$;a?(setFbLeadProgress({processed:c,total:v,complete:!w.hasMore}),s&&(s.innerHTML=renderFbLeadRunResults({...w,rows:u}))):updateGlobalApplyProgress({processed:c,total:v,written:w.updated||0,complete:!w.hasMore})}while((d.summary||d).hasMore);p=!0;const y=d.summary||d,f=y.inWindow||c||$,g=y.nextBatchOffset??c;if(a)setFbLeadProgress({processed:g,total:f,complete:!0}),markFbLeadPreviewReady(e,t,y.updated),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.previewOk=(y.updated||0)>0),showToast((y.updated||0)>0?"Preview complete \u2014 use Apply in Run history below.":"Preview complete \u2014 all contacts already have Fb Lead id. Nothing to apply.","success"),await refreshFbLeadHistoryUi(),document.getElementById("fb-lead-history-mount")?.scrollIntoView({behavior:"smooth",block:"nearest"});else{updateGlobalApplyProgress({processed:g,total:f,written:y.updated||0,complete:!0}),delete fbLeadSyncState.previewOkByClient[e];try{const w=JSON.parse(sessionStorage.getItem("fbLeadSyncPreviewOk")||"{}");delete w[e],sessionStorage.setItem("fbLeadSyncPreviewOk",JSON.stringify(w))}catch{}showToast("FB lead sync complete \u2014 Fb Lead id written to GHL","success"),stopGlobalApplyProgress({success:!0})}await refreshFbLeadHistoryUi();const b=await adminFetch("/api/fb-lead-sync");fbLeadSyncState.clients=b.clients||[],hydrateFbLeadPreviewState(fbLeadSyncState.clients),await refreshFbLeadClientRowsUi()}catch(y){a?hideFbLeadProgress(!0):(updateGlobalApplyProgress({error:`Failed \u2014 ${y.message||"Apply failed"}`}),stopGlobalApplyProgress({success:!1,keepVisibleMs:12e3})),showToast((y.message||(a?"FB lead preview failed.":"FB lead apply failed."))+(a?" Partial progress is saved \u2014 use Resume in Run history or try Preview again.":" Partial progress is saved \u2014 use Resume in Run history."),"error"),await refreshFbLeadHistoryUi()}finally{o&&(o.disabled=!1),fbLeadSyncState.applyingRunId=null,!p&&a&&hideFbLeadProgress(!0),!a&&!p&&(fbLeadSyncState.isApplying=!1,await refreshFbLeadHistoryUi())}}async function expandFbLeadRun(e){const t=document.getElementById(`fb-lead-run-audit-${e}`);if(t){if(!t.hidden){t.hidden=!0;return}try{const a=await adminFetch(`/api/fb-lead-sync/history/${e}`),n=fbLeadSyncState.clients.find(s=>s.clientId===a.run.clientId);t.innerHTML=`<td colspan="7"><div class="fb-lead-audit-scroll" id="fb-lead-audit-scroll-${e}">${renderFbLeadAuditTable(a.run.rows||[],a.run.locationId||n?.locationId)}</div></td>`,t.hidden=!1;const o=document.getElementById(`fb-lead-audit-scroll-${e}`);o&&o.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(a){showToast(a.message||"Failed to load run audit.","error")}}}function viewFbLeadClientHistory(e){const t=getFbLeadHistoryRunsForDisplay(fbLeadSyncState.historyRuns.filter(o=>o.clientId===e)),a=document.getElementById("fb-lead-history-mount");if(!a)return;const n=Object.fromEntries(fbLeadSyncState.clients.map(o=>[o.clientId,o.locationId]));a.innerHTML=t.length?renderFbLeadHistoryRows(t,n):`<div class="sync-history-empty">No runs for ${esc(e)} yet.</div>`,a.scrollIntoView({behavior:"smooth",block:"start"})}async function loadFbLeadSyncPage({silent:e=!1,fullPreflight:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){e||(a.innerHTML=`
  ...
  `:`<div class="meta-hub-switch is-disabled"><span class="meta-hub-switch-label">${esc(e)}</span><span class="meta-report-muted">\u2014</span></div>`}function metaReportFullUrl(e){return e?`${window.location.origin}${e}`:""}function normalizeMetaReportSlugInput(e){return String(e||"").trim().toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"")}function resolveMetaReportShareSlug(e){const t=e.settings||{};if(t.metaReportSlug)return t.metaReportSlug;const n=String(e.reportUrl||"").replace(/^\/report\//,"").match(/^(.+)-(\d{4})$/);return n?n[1]:""}function resolveMetaReportShareCode(e){const a=String(e.reportUrl||"").replace(/^\/report\//,"").match(/-(\d{4})$/);return a?a[1]:""}function closeMetaReportModal(){document.getElementById("meta-report-modal-root")?.remove(),document.body.classList.remove("meta-report-modal-open"),metaReportsState.clientShareExpanded=!1}function openMetaReportModal(e,{wizard:t=!1}={}){closeMetaReportModal();const a=document.createElement("div");a.id="meta-report-modal-root",a.className="meta-report-modal-root",a.innerHTML=`
    <div class="meta-report-modal-backdrop" data-meta-report-modal-close aria-hidden="true"></div>
    <div class="meta-report-modal${t?" is-wizard":""}" role="dialog" aria-modal="true">
      ${e}
    </div>
  `,document.body.appendChild(a),document.body.classList.add("meta-report-modal-open"),a.querySelectorAll("[data-meta-report-modal-close]").forEach(n=>{n.addEventListener("click",closeMetaReportModal)}),a.querySelector(".meta-report-modal-close")?.addEventListener("click",closeMetaReportModal)}function renderMetaReportShareModalContent(e){const a=!!(e.settings||{}).metaReportEnabled,n=e.reportUrl||null;if(!n)return"";const o=metaReportFullUrl(n),s=resolveMetaReportShareSlug(e),r=resolveMetaReportShareCode(e);return`
  ...
  `}function parseComparisonDateKey(e){const t=String(e||"").match(/^([ab])-(start|end)$/);return t?{side:t[1],bound:t[2],stateKey:t[1]==="b"?"comparisonPeriodB":"comparisonPeriodA"}:null}function metaReportComparisonSafePickerBounds(e,t){const a=e||void 0,n=t||void 0;return a&&n&&a>n?{min:n,max:a}:{min:a,max:n}}function syncMetaReportComparisonDateDisplays(){document.querySelectorAll("[data-comparison-date]").forEach(e=>{const t=e.getAttribute("data-comparison-date"),a=document.querySelector(`[data-comparison-date-trigger="${t}"]`);if(!t||!a)return;const n=e.value||"",o=a.querySelector(".meta-report-comparison-date-trigger-value");o&&(o.textContent=n?metaReportComparisonFormatDateLabel(n):"Select date"),a.classList.toggle("has-value",!!n),a.classList.toggle("is-empty",!n)})}function applyMetaReportComparisonDateChange(e,t,a,{editable:n=!1}={}){const o=parseComparisonDateKey(t);if(!o||!a)return;const{side:s,bound:r,stateKey:i}=o;metaReportsState[i]||(metaReportsState[i]={startDate:null,endDate:null});const l=metaReportsState[i];l[`${r}Date`]=a,l.startDate&&l.endDate&&l.startDate>l.endDate&&(r==="end"?l.startDate=l.endDate:l.endDate=l.startDate);const c=document.querySelector(`[data-comparison-date="${s}-start"]`),d=document.querySelector(`[data-comparison-date="${s}-end"]`);c&&(c.value=l.startDate||""),d&&(d.value=l.endDate||""),syncMetaReportComparisonDateDisplays(),metaReportsState.comparisonMode="custom",document.querySelectorAll("[data-comparison-preset]").forEach(u=>{const p=u.getAttribute("data-comparison-preset")==="custom";u.classList.toggle("active",p),u.setAttribute("aria-pressed",p)}),refreshMetaReportComparison(e,{editable:n})}function ensureMetaReportComparisonDatePickerPopover(){if(document.getElementById("meta-report-comparison-date-popover"))return;const e=document.createElement("div");e.id="meta-report-comparison-date-backdrop",e.className="meta-report-comparison-date-backdrop",e.hidden=!0,e.addEventListener("click",closeMetaReportComparisonDatePicker),document.body.appendChild(e);const t=document.createElement("div");t.id="meta-report-comparison-date-popover",t.className="meta-report-comparison-date-popover",t.hidden=!0,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),document.body.appendChild(t)}function isMetaReportComparisonDatePickerDayDisabled(e,t,a,n){const{min:o,max:s}=getMetaReportComparisonDatePickerFieldBounds(t,a,n);return!!(o&&e<o||s&&e>s)}function metaReportComparisonDatePickerCanShiftMonth(e){const{viewYear:t,viewMonth:a,payload:n,side:o,bound:s}=metaReportComparisonDatePickerState;if(!t||!a||!n||!o||!s)return!1;let r=a+e,i=t;r<1&&(r=12,i-=1),r>12&&(r=1,i+=1);const l=`${i}-${String(r).padStart(2,"0")}`,{min:c,max:d}=getMetaReportComparisonDatePickerFieldBounds(n,o,s),u=c?c.slice(0,7):null,p=d?d.slice(0,7):null;return!(u&&l<u||p&&l>p)}function renderMetaReportComparisonDatePickerDayCell(e,t,a,n,o,s,r,i,l,c){const d=["date-picker-day"];if(a&&d.push("is-outside"),e===n&&d.push("is-today"),e===o&&d.push("is-selected"),s&&r){const u=s<=r?s:r,p=s<=r?r:s;e>=u&&e<=p&&d.push("is-in-range"),e===s&&d.push("is-range-start"),e===r&&d.push("is-range-end")}return isMetaReportComparisonDatePickerDayDisabled(e,i,l,c)?(d.push("is-disabled"),`<button type="button" class="${d.join(" ")}" disabled aria-disabled="true">${t}</button>`):`<button type="button" class="${d.join(" ")}" onclick="selectMetaReportComparisonDatePickerDay('${e}')">${t}</button>`}function renderMetaReportComparisonDatePickerPopover(){const e=document.getElementById("meta-report-comparison-date-popover"),{viewYear:t,viewMonth:a,inputKey:n,payload:o,side:s,bound:r}=metaReportComparisonDatePickerState;if(!e||!n||!t||!a||!o||!s||!r)return;const i=new Intl.DateTimeFormat("en-GB",{month:"long",year:"numeric"}).format(new Date(t,a-1,1)),l=["Mo","Tu","We","Th","Fr","Sa","Su"],d=(new Date(t,a-1,1).getDay()+6)%7,u=new Date(t,a,0).getDate(),p=new Date(t,a-1,0).getDate(),h=isoFromParts(new Date().getFullYear(),new Date().getMonth()+1,new Date().getDate()),$=document.querySelector(`[data-comparison-date="${n}"]`)?.value||"",f=metaReportsState[s==="b"?"comparisonPeriodB":"comparisonPeriodA"]||{},g=f.startDate||"",b=f.endDate||"",{min:w,max:v}=getMetaReportComparisonDatePickerFieldBounds(o,s,r);let S="";for(let L=d-1;L>=0;L-=1){const k=p-L,M=a===1?12:a-1,B=a===1?t-1:t,E=isoFromParts(B,M,k);S+=renderMetaReportComparisonDatePickerDayCell(E,k,!0,h,$,g,b,o,s,r)}for(let L=1;L<=u;L+=1){const k=isoFromParts(t,a,L);S+=renderMetaReportComparisonDatePickerDayCell(k,L,!1,h,$,g,b,o,s,r)}const I=(7-(d+u)%7)%7;for(let L=1;L<=I;L+=1){const k=a===12?1:a+1,M=a===12?t+1:t,B=isoFromParts(M,k,L);S+=renderMetaReportComparisonDatePickerDayCell(B,L,!0,h,$,g,b,o,s,r)}const A=r==="start"&&v?`<span class="date-picker-hint">Through ${esc(metaReportComparisonFormatDateLabel(v))}</span>`:r==="end"&&w?`<span class="date-picker-hint">From ${esc(metaReportComparisonFormatDateLabel(w))}</span>`:"";e.innerHTML=`
    <div class="date-picker-panel">
      ...
      <div class="date-picker-weekdays">
        ${l.map(L=>`<div class="date-picker-weekday">${L}</div>`).join("")}
      </div>
  ...
  `:""}function renderMetaReportMonthBody(e,{editable:t=!1,yearPayload:a=null,activeMonthKey:n=null,settings:o=null}={}){const s=n||e?.monthKey||null,r=s?metaReportMonthBounds(s):null,i=o||a?.settings||{},l=isMetaReportGhlListClient(i),c=resolveClientToplineMode(i),d=resolveMetaToplineSource(e),u=l&&c==="cenhub"&&d==="ghl",p=l&&(d==="manual"||c==="cenhub"&&d!=="ghl");let h="";if(t&&e&&!e.meta?.emptyMonth&&r){const A=u?" readonly":"",L=e.manualLeads??e.inputs?.manualLeads??"",k=renderMetaReportMonthManualRow(e,i);h=`
      <div class="meta-report-edit-panel" id="meta-report-edit-panel">
        ...
        <div class="meta-report-edit-grid">
          ...
          ${p?`<label>Manual leads (optional)<input type="number" step="any" id="meta-report-manual-leads" value="${esc(L)}" /></label>`:""}
          <label>Won leads<input type="number" step="any" id="meta-report-won-leads" value="${esc(e.topline?.wonLeads??"")}"${A} /></label>
          <label>Avg lead value<input type="number" step="any" id="meta-report-avg-lead-value" value="${esc(e.topline?.avgLeadValue??"")}"${A} /></label>
          <label>Avg profit per won<input type="number" step="any" id="meta-report-avg-profit" value="${esc(e.inputs?.avgProfitPerWon??"")}"${A} /></label>
        </div>
        ${k}
    ...
    `}const m=n||e?.monthKey||null,$=t?m?`Report preview \xB7 ${metaMonthLabel(m)}`:"Report preview":m?`Report \xB7 ${metaMonthLabel(m)}`:"Report",y=metaReportsState.reportViewMode||"monthly",f=shouldShowMetaReportYearVisuals(e,a,{editable:t}),g=e&&!e.meta?.emptyMonth?`
    <div class="meta-report-preview-card">
      <div class="meta-report-preview-card-label">${$}</div>
      ${renderMetaReportHighlightStrip(e)}
    </div>
  `:"",b=renderMetaReportMonthTables(e,{editable:t}),w=f?renderMetaReportChartsPanel({editable:t}):"",v=t&&f?renderMetaReportScenarioCard():"",S=f?renderMetaReportViewModeTabs():"";let I;return f?I=`
      <div class="meta-report-view-panel${y==="monthly"?" is-active":""}" data-report-view-panel="monthly" role="tabpanel"${y==="monthly"?"":" hidden"}>
        <div class="meta-report-content-layout">
          <div class="meta-report-content-main">${b}</div>
          ${w}
        </div>
      </div>
      <div class="meta-report-view-panel${y==="comparison"?" is-active":""}" data-report-view-panel="comparison" role="tabpanel"${y==="comparison"?"":" hidden"}>
        ${renderMetaReportComparisonView()}
      </div>
      ${v}
    `:I=`<div class="meta-report-content-main">${b}</div>`,`${h}${g}${S}${I}`}function renderMetaReportsHubPage(e){const t=e.clients||[],a=e.meta||{};return`
      ...
      <div class="meta-hub-layout">
        ...
        <div class="hub-toolbar-row">
          ...
          <div class="hub-toolbar-actions">
            ...
            <a class="admin-btn admin-btn--secondary" href="/admin/meta-reports/ghl-clients">GHL clients</a>
  ...
  `}function setMetaReportYearLoadingBanner(e,t,a){const n=document.querySelector(e);if(!n)return;let o=n.querySelector(".meta-report-year-loading-banner");a?(o||(o=document.createElement("span"),o.className="meta-report-year-loading-banner",o.setAttribute("aria-live","polite"),n.appendChild(o)),o.innerHTML=`<span class="meta-report-save-indicator-spinner"></span> Loading ${esc(t)}\u2026`,o.hidden=!1):o&&(o.hidden=!0)}function setMetaReportClientYearLoading(e,t){const a=document.querySelector(".meta-report-client-page"),n=document.getElementById("meta-report-year");if(t){n&&(n.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!0);const o=document.querySelector(".meta-report-tabs");o&&(o.innerHTML=renderMetaReportTabsSkeleton(),o.setAttribute("aria-busy","true"));const s=document.getElementById("meta-report-month-panel");s&&(s.innerHTML=renderMetaReportMonthPanelSkeleton(),s.classList.add("is-loading")),destroyMetaReportCharts()}else{n&&(n.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!1);const o=document.querySelector(".meta-report-tabs");o&&o.removeAttribute("aria-busy");const s=document.getElementById("meta-report-month-panel");s&&s.classList.remove("is-loading")}}function setMetaCvYearLoading(e,t){const a=document.querySelector(".sync-history-page.meta-reports-page"),n=document.getElementById("meta-cv-year"),o=document.getElementById("meta-cv-search");if(t){n&&(n.disabled=!0),o&&(o.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!0);const s=document.querySelector(".meta-cv-summary");s&&(s.classList.add("is-skeleton"),s.innerHTML=renderMetaCvSummarySkeleton());const r=document.querySelector(".meta-cv-legend");r&&r.setAttribute("aria-hidden","true");const i=document.getElementById("meta-cv-client-list");i&&(i.innerHTML=renderMetaCvListSkeleton(),i.setAttribute("aria-busy","true"));const l=document.getElementById("meta-cv-editor");l&&(l.innerHTML=renderMetaCvEditorYearSkeleton(),l.setAttribute("aria-busy","true"))}else{n&&(n.disabled=!1),o&&(o.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!1);const s=document.querySelector(".meta-cv-summary");s&&s.classList.remove("is-skeleton");const r=document.querySelector(".meta-cv-legend");r&&r.removeAttribute("aria-hidden");const i=document.getElementById("meta-cv-client-list");i&&i.removeAttribute("aria-busy");const l=document.getElementById("meta-cv-editor");l&&l.removeAttribute("aria-busy")}}function setMetaReportPublicYearLoading(e,t){const a=document.querySelector(".meta-reports-page--public"),n=document.getElementById("meta-report-year");if(t){n&&(n.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!0);const o=document.querySelector(".meta-reports-page--public .meta-report-tabs");o&&(o.innerHTML=renderMetaReportTabsSkeleton(),o.setAttribute("aria-busy","true"));const s=document.getElementById("meta-report-month-panel");s&&(s.innerHTML=renderMetaReportMonthPanelSkeleton(),s.classList.add("is-loading")),destroyMetaReportCharts()}else{n&&(n.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!1);const o=document.querySelector(".meta-reports-page--public .meta-report-tabs");o&&o.removeAttribute("aria-busy");const s=document.getElementById("meta-report-month-panel");s&&s.classList.remove("is-loading")}}function bindMetaReportsClientChromeEvents(e){const t=e.clientId,a=document.getElementById("meta-report-year");a&&(a.onchange=async()=>{if(a.selectedOptions?.[0]?.disabled){a.value=String(metaReportsState.selectedYear);return}const o=metaReportsState.selectedYear,s=Number(a.value);if(s!==o){metaReportsState.selectedYear=s,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportClientYearLoading(s,!0);try{await loadMetaReportsClientPage({silent:!0})}catch(r){metaReportsState.selectedYear=o,a&&(a.value=String(o)),await loadMetaReportsClientPage({silent:!0}),showToast(r.message||"Load failed","error")}finally{setMetaReportClientYearLoading(s,!1)}}}),bindMetaReportCopyButtons(),bindMetaReportBackfillButton(t),bindMetaReportBottomlineFeeEvents(t,"meta-report"),bindMetaReportShareEvents(e)}function bindMetaReportsClientEvents(e){bindMetaReportsClientChromeEvents(e),bindMetaReportsClientTabEvents(e),bindMetaReportsClientEditEvents(e.clientId,e),isMetaReportGhlListClient(e.settings||{})&&(bindMetaReportToplineSourceControl(e.clientId,e),bindMetaReportMonthManualEvents(e.clientId,e))}function bindMetaReportsClientEditEvents(e,t){const a=document.getElementById("meta-report-refresh-meta");a&&(a.onclick=async()=>{a.disabled=!0;try{const o=metaReportsState.activeMonthKey,s=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(o)}/refresh`,{method:"POST"});refreshMetaReportMonthPanel(s.monthPayload),showToast("Meta data refreshed","success")}catch(o){showToast(o.message||"Meta refresh failed","error")}finally{a.disabled=!1}});const n=document.getElementById("meta-report-save-month");n&&(n.onclick=async()=>{n.disabled=!0;try{const o=metaReportsState.activeMonthKey,s=t?.months?.[o],r=t?.settings||{},i=resolveClientToplineMode(r),l=resolveMetaToplineSource(s),c=isMetaReportGhlListClient(r)&&(l==="manual"||i==="cenhub"&&l!=="ghl"),d={periodStart:document.getElementById("meta-report-period-start")?.value,periodEnd:document.getElementById("meta-report-period-end")?.value,wonLeads:document.getElementById("meta-report-won-leads")?.value===""?null:Number(document.getElementById("meta-report-won-leads")?.value),avgLeadValue:document.getElementById("meta-report-avg-lead-value")?.value===""?null:Number(document.getElementById("meta-report-avg-lead-value")?.value),avgProfitPerWon:document.getElementById("meta-report-avg-profit")?.value===""?null:Number(document.getElementById("meta-report-avg-profit")?.value)};if(c){d.toplineSource="manual",d.manualOverride=!0;const p=document.getElementById("meta-report-manual-leads");p&&(d.manualLeads=p.value===""?null:Number(p.value))}const u=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(o)}`,{method:"PUT",body:JSON.stringify(d)});refreshMetaReportMonthPanel(u.monthPayload),showToast("Month saved","success")}catch(o){showToast(o.message||"Save failed","error")}finally{n.disabled=!1}})}function bindPublicMetaReportTabEvents(e){document.querySelectorAll("[data-meta-month-tab]").forEach(t=>{t.onclick=()=>{switchMetaReportMonthTab(t.getAttribute("data-meta-month-tab"),{editable:!1})}})}function bindPublicMetaReportEvents(e){bindPublicMetaReportTabEvents(e);const t=document.getElementById("meta-report-year");t&&(t.onchange=async()=>{if(t.selectedOptions?.[0]?.disabled){t.value=String(metaReportsState.selectedYear);return}const n=metaReportsState.selectedYear,o=Number(t.value);if(o!==n){metaReportsState.selectedYear=o,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportPublicYearLoading(o,!0);try{await loadPublicMetaReportPage({silent:!0})}catch(s){metaReportsState.selectedYear=n,t&&(t.value=String(n)),await loadPublicMetaReportPage({silent:!0}),showToast(s.message||"Load failed","error")}finally{setMetaReportPublicYearLoading(o,!1)}}})}async function loadMetaReportsHubPage(){const e=document.getElementById("dashboard");if(!e)return;const t=await fetchStaffMe();if(!t){e.innerHTML=`
    ...
    `}).join("")}function isMetaReportGhlListClient(e={}){return!!e.metaReportGhlDataEnabled}function resolveMetaToplineSource(e){return e?.dataSource||e?.toplineSource||"meta"}function classifyMetaReportMonthInputStatus(e,t=!1){if(!e)return"empty";const a=e.topline?.wonLeads!=null||e.inputs?.wonLeads!=null,n=e.topline?.avgLeadValue!=null||e.inputs?.avgLeadValue!=null,o=e.inputs?.avgProfitPerWon!=null;return a&&n&&(!t||o)?"complete":a||n||o?"partial":"empty"}function resolveClientToplineMode(e={}){return e.metaReportToplineMode==="cenhub"?"cenhub":"meta"}function metaToplineSourceNote(e){return e==="cenhub"?"Using Cenhub for all months":"Using Meta Analytics for all months"}function metaToplineConfirmWord(e){return e==="cenhub"?"Cenhub":"Meta"}function renderMetaToplineSourcePillHtml(e,t){return`<span class="meta-topline-source-pill is-${t}"><span class="meta-topline-source-pill-dot" aria-hidden="true"></span><span class="meta-topline-source-pill-text">${esc(e)}</span></span>`}function renderMetaMonthSourcePill(e,t={}){if(!isMetaReportGhlListClient(t))return"";const a=resolveMetaToplineSource(e),n=resolveClientToplineMode(t);return a==="manual"?renderMetaToplineSourcePillHtml("Manual this month","manual"):n==="meta"||a==="meta"?renderMetaToplineSourcePillHtml("Meta Analytics","meta"):a==="ghl"?renderMetaToplineSourcePillHtml("Cenhub","cenhub"):renderMetaToplineSourcePillHtml("No Cenhub data","cenhub-empty")}function renderMetaReportToplineSourceControl(e){const t=e?.settings||{};if(!isMetaReportGhlListClient(t))return"";const a=resolveClientToplineMode(t),n=metaReportsState.clientToplineSaving,o=n?" disabled":"",s=t.hasGhl!==!1;return`
    <div class="meta-report-topline-source-wrap meta-topline-source-panel${n?" is-loading":""}" id="meta-report-topline-source-panel">
      <div class="meta-report-topline-summary">
        <div class="meta-report-topline-summary-content">
          <div class="meta-report-topline-summary-row">
            ...
            <span class="meta-report-topline-summary-value ${a==="cenhub"?"is-cenhub":"is-meta"}">${esc(a==="cenhub"?"Cenhub":"Meta Analytics")}</span>
          </div>
          <div class="meta-report-topline-summary-row">
      ...
      ${a==="cenhub"?`
        <div class="meta-report-topline-extra-actions">
          <button type="button" class="admin-btn admin-btn--ghost admin-btn--small" id="meta-report-sync-ghl-year"${o||!s?" disabled":""}${s?"":' title="GHL not connected"'}>Sync year from Cenhub</button>
          <button type="button" class="admin-btn admin-btn--ghost admin-btn--small" id="meta-report-refresh-snapshot"${o||!s?" disabled":""}>Refresh Cenhub snapshot</button>
        </div>
      `:""}
    </div>
  `}function renderMetaReportToplineChangeModal(e,t){const a=resolveClientToplineMode(e?.settings||{});return`
    <div class="meta-report-modal-head">
    ...
    <div class="metrics-option-cards">
      <label class="metrics-option-card">
        ...
        <span class="metrics-option-card-top">
          ...
          <span class="metrics-option-card-title">Meta Analytics</span>
...
Type "skip" to skip manual months, or "overwrite" to replace all:`,"skip");if(!s)return!1;s.trim().toLowerCase()==="overwrite"&&(n={...n,skipManual:!1,overwriteManual:!0})}}return await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/switch-topline-source`,{method:"POST",body:JSON.stringify(n)}),showToast(a==="cenhub"?"Switched all months to Cenhub":"Switched all months to Meta Analytics","success"),typeof t.reload=="function"?await t.reload():await loadMetaReportsClientPage({silent:!0}),!0}function bindMetaReportToplineChangeModal(e){const t=e.clientId;document.querySelectorAll('input[name="meta-topline-draft-mode"]').forEach(n=>{n.addEventListener("change",updateMetaReportToplineApplyState)}),document.getElementById("meta-report-topline-ack")?.addEventListener("change",updateMetaReportToplineApplyState),document.getElementById("meta-report-topline-confirm")?.addEventListener("input",updateMetaReportToplineApplyState);const a=document.getElementById("meta-report-topline-apply");a&&(a.onclick=async()=>{const n=getMetaReportToplineDraftMode(),o=resolveClientToplineMode(e.settings||{});if(n===o)return;a.disabled=!0,document.getElementById("meta-report-topline-modal-loading")?.removeAttribute("hidden");const s=typeof e.reload=="function";s?setMetaCvSavePending(!0):(metaReportsState.clientToplineSaving=!0,syncMetaReportToplineSourceBar(metaReportsState.clientPayload||e));try{await applyMetaReportToplineSwitch(t,e,n)&&closeMetaReportModal()}catch(r){showToast(r.message||"Could not switch data source","error")}finally{s?setMetaCvSavePending(!1):(metaReportsState.clientToplineSaving=!1,syncMetaReportToplineSourceBar(metaReportsState.clientPayload)),document.getElementById("meta-report-topline-modal-loading")?.setAttribute("hidden","")}})}function renderMetaReportMonthManualRow(e,t={}){if(!isMetaReportGhlListClient(t)||resolveClientToplineMode(t)!=="cenhub")return"";const o=resolveMetaToplineSource(e)==="manual",s=!o;return!o&&!s?"":`
  ...
  `}function renderMetaCvToplineSourceControl(e,t){if(!e?.metaReportGhlDataEnabled)return"";const a=e.metaReportToplineMode==="cenhub"?"cenhub":"meta",n=metaReportsState.customValues.saving,o=n?" disabled":"",s=e.hasGhl!==!1;return`
    <div class="meta-report-topline-source-wrap meta-topline-source-panel${n?" is-loading":""}" id="meta-cv-topline-source-panel">
      ...
      ${a==="cenhub"?`
        <div class="meta-report-topline-extra-actions">
          <button type="button" class="admin-btn admin-btn--ghost admin-btn--small" id="meta-cv-sync-ghl-year"${o||!s?" disabled":""}>Sync year from Cenhub</button>
        </div>
      `:""}
    </div>
  `}function renderMetaCvMonthManualRow(e,t){if(!t?.metaReportGhlDataEnabled||(t.metaReportToplineMode==="cenhub"?"cenhub":"meta")!=="cenhub")return"";const o=(e?.dataSource||e?.toplineSource||"meta")==="manual",s=!o;return!o&&!s?"":`
    <div class="meta-report-month-manual-row">
      ${o?renderMetaToplineSourcePillHtml("Manual values this month","manual"):""}
      ${s?'<button type="button" class="meta-topline-manual-pill-btn" id="meta-cv-use-manual-month">Use manual values for this month</button>':""}
    </div>
  `}function bindMetaToplineCenhubActionEvents({clientId:e,prefix:t,getMonthKey:a,getYear:n,setSaving:o,onReload:s,onMonthUpdated:r}){if(!e||!t)return;const i=document.getElementById(`${t}-sync-ghl-year`);i&&(i.onclick=async()=>{o&&o(!0);try{const c=n?.()||metaReportsState.selectedYear,d=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/sync-ghl-preview?year=${encodeURIComponent(c)}`);let u=!0,p=!1;if((d.skipManual||[]).length){const m=window.prompt(`${d.skipManual.length} month(s) have manual values (${d.skipManual.join(", ")}).
Type "skip" to skip manual months, or "overwrite" to replace all:`,"skip");if(!m)return;m.trim().toLowerCase()==="overwrite"&&(u=!1,p=!0)}const h=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/sync-ghl-year?year=${encodeURIComponent(c)}`,{method:"POST",body:JSON.stringify({skipManual:u,overwriteManual:p})});s?await s():r&&await r(h,null,{yearSync:!0}),showToast(`Synced ${h.synced?.length||0} month(s)${h.skipped?.length?`, skipped ${h.skipped.length}`:""}`,"success")}catch(c){showToast(c.message||"Year sync failed","error")}finally{o&&o(!1)}});const l=document.getElementById(`${t}-refresh-snapshot`);l&&(l.onclick=async()=>{const c=a?.();if(c){o&&o(!0);try{const d=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(c)}/refresh-snapshot`,{method:"POST",body:"{}"});r&&await r(d,c),showToast("Cenhub data refreshed and synced","success")}catch(d){showToast(d.message||"Refresh failed","error")}finally{o&&o(!1)}}})}function monthHasCenhubSnapshot(e){if(resolveMetaToplineSource(e)==="ghl")return!0;const a=e?.ghlTotals||{};return!!(e?.ghlSyncedAt||a.leads!=null||a.wonLeads!=null)}function renderMetaCvClientRows(e){const t=getMetaCvFilteredClients(e),a=e.monthKeys||[];return t.length?t.map(n=>`
  ...
  `}function setMetaReportClientSettingsExpanded(e,t){if(e!=="meta-report")return;metaReportsState.clientReportSettingsExpanded=!!t,t&&(metaReportsState.clientShareExpanded=!1);const a=document.querySelector(".meta-report-bottomline-fee-settings--client"),n=document.getElementById(`${e}-fee-editor`);a?.classList.toggle("is-editing",t),a?.classList.toggle("is-collapsed",!t),n&&n.classList.toggle("is-hidden",!t);const o=document.getElementById("meta-report-share-summary"),s=document.getElementById("meta-report-share-editor");o&&(o.hidden=metaReportsState.clientShareExpanded),s&&(s.hidden=!metaReportsState.clientShareExpanded),syncMetaReportControlPanelUi()}function updateMetaReportBottomlineFeeSummary(e={},t="meta-report"){const a=document.getElementById(`${t}-fee-summary`);if(!a)return;const n=document.createElement("div");n.innerHTML=renderMetaReportBottomlineFeeSummary(e,t);const o=n.firstElementChild;o&&a.replaceWith(o);const s=document.getElementById(`${t}-fee-edit`);s&&(s.onclick=()=>setMetaReportClientSettingsExpanded(t,!0))}function renderMetaReportBottomlineFeeSettings(e={},t="meta-report",{compact:a=!1,variant:n="default",collapsible:o=!1,externalSummary:s=!1}={}){const r=!!e.metaReportShowBottomline,i=!!e.metaReportFeeEnabled,l=e.metaReportFeeMode||"",c=resolveMetaReportFeeMode(e),d=e.metaReportFeePercent??20,u=e.metaReportMarketingFeeAmount??0,p=metaReportUsesInlineFeeValue(t),h=`data-fee-mode="${esc(l)}" data-fee-enabled="${i?"true":"false"}" data-fee-percent="${esc(d)}" data-marketing-fee="${esc(u)}"`;if(n==="cv"){const b=describeMetaReportFeeModeLabel(c,d,u),w=META_REPORT_FEE_MODE_META.map(({value:v,title:S})=>`
        <label class="meta-report-fee-mode-pill">
          <input type="radio" name="${t}-fee-mode" value="${esc(v)}"${c===v?" checked":""} />
          <span>${esc(S)}</span>
        </label>`).join("");return`
      ...
      <div class="meta-cv-bottomline-panel">
        ...
        <div class="meta-report-fee-nested meta-cv-bottomline-body${r?"":" is-hidden"}" id="${t}-fee-nested" ${h}>
          <div class="meta-report-fee-status" id="${t}-fee-status" aria-live="polite">
            <span class="meta-report-fee-status-value is-active">${esc(b)}</span>
          </div>
          <div class="meta-report-fee-mode-pills">${w}</div>
  ...
  `}const m=describeMetaReportFeeModeLabel(c,d,u),$=META_REPORT_FEE_MODE_META.map(({value:b,icon:w,title:v,desc:S})=>`
        <label class="meta-report-fee-mode-card">
          <input type="radio" name="${t}-fee-mode" value="${esc(b)}"${c===b?" checked":""} />
          <span class="meta-report-fee-mode-card-icon" aria-hidden="true">${esc(w)}</span>
          <span class="meta-report-fee-mode-card-text">
            <span class="meta-report-fee-mode-card-title">${esc(v)}</span>
            <small>${esc(S)}</small>
          </span>
          <span class="meta-report-fee-mode-card-radio" aria-hidden="true">${ICON_CHECK}</span>
        </label>`).join(""),y=o?metaReportsState.clientReportSettingsExpanded:!0,f=o?`
        ...
        <div class="meta-report-fee-save-row">
          <button type="button" class="admin-btn admin-btn--primary admin-btn--small" id="${t}-fee-save">Save fee settings</button>
        </div>`,g=o&&!s?renderMetaReportBottomlineFeeSummary(e,t):"";return`
    <div class="meta-report-bottomline-fee-settings${o?" meta-report-bottomline-fee-settings--client":""}${o?y?" is-editing":" is-collapsed":""}">
      ${g}
      <div class="meta-report-bottomline-editor${o&&!y?" is-hidden":""}" id="${t}-fee-editor">
        <div class="meta-report-bottomline-row">
          ...
          ${renderMetaReportSwitch(`${t}-setting-bottomline`,r,"Show bottomline",!1,{hideLabel:!0})}
        </div>
        <div class="meta-report-fee-nested${r?"":" is-hidden"}" id="${t}-fee-nested" ${h}>
          <div class="meta-report-fee-status" id="${t}-fee-status" aria-live="polite">
            <span class="meta-report-fee-status-value is-active">${esc(m)}</span>
          </div>
          <div class="meta-report-fee-mode-grid${a?" meta-report-fee-mode-grid--rows":""}">${$}
          </div>
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,a=(e.clients||[]).find(R=>R.clientId===t.selectedClientId),n=t.selectedMonthKey;if(!a||!n)return`
      <div class="meta-cv-editor-empty">
        Select a client month pill to edit won leads, average lead value, and average profit.
      </div>
    `;const o=a.months?.[n]||{};if(t.loadingEditor)return renderMetaCvEditorSkeleton(a,n,o);const s=t.editorPayload?.months?.[n]||null,r=a.metaReportShowBottomline,i=!!a.metaReportGhlDataEnabled,l=a.metaReportToplineMode==="cenhub"?"cenhub":"meta",c=o.toplineSource||s?.dataSource||"meta",d=i&&l==="cenhub"&&c==="ghl",u=i&&c==="manual",p=o.wonLeads!=null?o.wonLeads:s?.inputs?.wonLeads??s?.topline?.wonLeads??"",h=o.avgLeadValue!=null?o.avgLeadValue:s?.inputs?.avgLeadValue??s?.topline?.avgLeadValue??"",m=o.avgProfitPerWon!=null?o.avgProfitPerWon:s?.inputs?.avgProfitPerWon??"",$=o.ghlLeads??s?.ghlTotals?.leads??"",y=o.ghlTotalRevenue??s?.ghlTotals?.totalRevenue??"",f=o.ghlTotalProfit??s?.ghlTotals?.totalProfit??"",g=metaReportsState.customValues.draftInputs,b=g?.wonLeads??p,w=g?.avgLeadValue??h,v=g?.avgProfitPerWon??m,S=g?.manualLeads??o.manualLeads??"",I=d?" readonly":"",A=d?" disabled":"",L=t.settingsSaving&&t.settingsSavingScope==="report",k=i?renderMetaCvToplineSourceControl(a,e):"",M=renderMetaCvMonthManualRow(s||{dataSource:c},a),B=u?`
      <label>Manual leads (optional)
        <input type="number" step="any" id="meta-cv-manual-leads" value="${esc(S)}" />
      </label>
  `:"",E={metaReportGhlDataEnabled:a.metaReportGhlDataEnabled,metaReportToplineMode:a.metaReportToplineMode},T=i?renderMetaMonthSourcePill(s||{dataSource:c},E):"";return`
    <div class="meta-report-edit-panel-head">
      <div>
    ...
    <div class="meta-cv-editor-grid">
      <label>Client
        <select id="meta-cv-client-select" class="admin-select">
          ${(e.clients||[]).map(R=>`
            <option value="${esc(R.clientId)}"${R.clientId===a.clientId?" selected":""}>${esc(R.accountName)}</option>
          `).join("")}
        </select>
      </label>
      <label>Month
        <select id="meta-cv-month-select" class="admin-select">
          ${(e.monthKeys||[]).map(R=>`
            <option value="${esc(R)}"${R===n?" selected":""}>${esc(metaMonthLabel(R))}</option>
          `).join("")}
        </select>
      </label>
      ${B}
      <label>Won leads
        <input type="number" step="any" id="meta-cv-won-leads" value="${esc(b)}"${I} />
      </label>
      <label>Avg lead value
        <input type="number" step="any" id="meta-cv-avg-lead-value" value="${esc(w)}"${I} />
      </label>
      <label>Avg profit per won${r?"":" (optional)"}
        <input type="number" step="any" id="meta-cv-avg-profit" value="${esc(v)}"${I} />
      </label>
    </div>
    ${M}
    ...
    <div class="meta-cv-editor-actions">
      <div class="meta-cv-editor-actions-left">
        ...
        ${i?'<a class="admin-btn admin-btn--ghost" href="/admin/meta-reports/ghl-clients">GHL clients</a>':""}
        ${renderMetaReportSaveIndicator("meta-cv-save-indicator",t.saving)}
      </div>
      <button type="button" class="admin-btn admin-btn--primary" id="meta-cv-save"${t.saving||t.loadingEditor||t.settingsSaving||d?" disabled":""}${A}>
  ...
  `).join("");return`
    ...
    <div class="sync-history-page meta-reports-page">
      <div class="meta-cv-summary">
        <span class="meta-cv-summary-pill">${t.ghlConnected||0} GHL connected</span>
        <span class="meta-cv-summary-pill is-complete">${t.onGhlList||0} on GHL list</span>
...
This removes the account, GHL token, and all synced snapshot data. This cannot be undone.`))return;if(window.prompt(`Type "${e}" to confirm deletion:`)!==e){showToast("Deletion cancelled \u2014 slug did not match.","error");return}try{await adminFetch(`/api/clients/${encodeURIComponent(e)}`,{method:"DELETE"}),showToast(`Deleted ${e}`,"success"),IS_ADMIN_HUB?await loadAdminHub():window.location.href="/admin"}catch(o){showToast(o.message,"error")}}async function syncClient(e,t){t&&(t.disabled=!0,t.textContent="Syncing...");try{await adminFetch(`/api/clients/${encodeURIComponent(e)}/sync`,{method:"POST",body:"{}"}),showToast("Sync completed","success"),IS_ADMIN_HUB?await loadAdminHub():IS_ADMIN_CLIENT?(await loadSetupAccount(),accountCanPreviewDashboard(setupAccount)&&loadDashboard(!0,{background:!0})):loadDashboard(!0,{background:!0})}catch(a){showToast(a.message,"error")}finally{if(t){t.disabled=!1;const a=t.dataset.syncLabel||"Sync";t.innerHTML=t.dataset.syncLabel?`${ICON_SYNC} ${a}`:a}}}function getMetricsModelLabels(e,t=setupPipelines){const a=new Map((t||[]).map(n=>[n.id,n.name]));return e.dedupeEnabled?{typeLabel:"Funnel + deduplication",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId||"\u2014"}`}:e.winPipelineId?{typeLabel:"Simple (single win pipeline)",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId}`}:{typeLabel:"Simple (no deduplication)",winLabel:"All won opportunities"}}const ICON_LAYER='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z"/><path d="M3 13l9 5 9-5"/></svg>',ICON_MERGE='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="2.4"/><circle cx="6" cy="18" r="2.4"/><circle cx="18" cy="15" r="2.4"/><path d="M6 8.4V15.6"/><path d="M8.2 6.4C14 6.4 14 12.6 15.8 13.4"/></svg>',ICON_TARGET='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>',ICON_LOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 018 0v3.5"/></svg>',ICON_UNLOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 017.8-1.2"/></svg>',ICON_TAG='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.6 12.7L12.7 20.6a2 2 0 01-2.8 0l-7-7a2 2 0 010-2.8L10.8 3H19a2 2 0 012 2v7.7z"/><circle cx="15" cy="8" r="1.2"/></svg>',ICON_HASH='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9h14M5 15h14M10 3L8 21M16 3l-2 18"/></svg>',ICON_EDIT='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 013 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>',ICON_WARNING='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.3 3.9L2.6 18a1.5 1.5 0 001.3 2.2h16.2a1.5 1.5 0 001.3-2.2L13.7 3.9a1.5 1.5 0 00-3.4 0z"/><path d="M12 9v4"/><path d="M12 16.5h.01"/></svg>';function renderMetricsModelPanel(e){const t=getMetricsModelLabels(e),a=!e.metricsModelSetAt||metricsModelChangeMode,n=a?" is-wizard":" is-locked",o=e.dedupeEnabled?"dedupe":e.winPipelineId?"pipeline":"simple",s=e.metricsModelLockedAt?`Locked since ${new Date(e.metricsModelLockedAt).toLocaleDateString("en-GB")}`:"Editable until first successful sync",r=e.metricsModelLockedAt?"metrics-model-badge is-locked":"metrics-model-badge";return a?`
    ...
    <div class="date-picker-panel">
      <div class="date-picker-header">
        ...
        <div class="date-picker-nav">
          ...
          <button type="button" class="date-picker-nav-btn" aria-label="Next month" onclick="shiftDatePickerMonth(1)" ${v?"":"disabled"}>${ICON_CHEVRON_RIGHT}</button>
        </div>
      </div>
      <div class="date-picker-weekdays">
  ...
  `,IS_ADMIN_CLIENT&&loadSetupAccount(),initDatePickers()}let isFetching=!1,pendingRefetch=!1,fetchGeneration=0,activeFetchController=null,fetchStartedAt=0;const FETCH_TIMEOUT_MS=9e4;function restoreDashboardContentAfterFailedFetch(e){!e||!cachedData||(cachedData=applyMarketingData(cachedData,cachedFacebookMetrics),updateDashboardContent(cachedData),updateFilterUi())}function setPresetButtonsDisabled(e){document.querySelectorAll("[data-preset]").forEach(t=>{t.disabled=e})}function resetFetchUiState(){isFetching=!1,setPresetButtonsDisabled(!1);const e=document.getElementById("apply-filters-btn");e&&(e.disabled=!1,e.textContent="Apply data filters")}function cancelActiveFetch(){activeFetchController&&(activeFetchController.abort(),activeFetchController=null)}function canReuseBootstrapDashboard(e){return!!(e?.kpis&&usesClientPipelineDefaults()&&!state.dateFrom&&!state.dateTo&&state.status==="all"&&state.source==="all"&&state.assignedTo==="all")}async function loadDashboard(e=!0,t={}){const{background:a=!1,forceFresh:n=!1}=t,o=!!n,s=document.getElementById("dashboard");if(isFetching&&(e||!cachedData))cancelActiveFetch(),fetchGeneration+=1,pendingRefetch=!1,resetFetchUiState();else if(isFetching){e&&(pendingRefetch=!0);return}const r=!!document.getElementById("dashboard-content"),i=document.getElementById("apply-filters-btn");if(e||!cachedData){const l=++fetchGeneration;activeFetchController=new AbortController;const c=activeFetchController.signal;if(isFetching=!0,fetchStartedAt=Date.now(),!r)s.innerHTML=`
        ...
        `)}`;else if(!a){const d=document.getElementById("dashboard-content");d&&(d.innerHTML=renderKpiSkeleton()),i&&(i.disabled=!0,i.textContent="Loading..."),setPresetButtonsDisabled(!0)}try{let d=null;if(!availablePipelines.length){if(d=await bootstrapDashboardData(c),l!==fetchGeneration)return;availablePipelines=d.filterOptions.pipelines||[],ensurePipelineDefaults(availablePipelines,d.account?.defaultPipelineIds)}if(!ensurePipelineSelectionBeforeFetch())throw new Error("Select at least one pipeline.");const p=canReuseBootstrapDashboard(d)&&!o;let h,m;if(p?[m,h]=await Promise.all([fetchFacebookMetrics(c),Promise.resolve(d)]):[h,m]=await Promise.all([fetchDashboardData(availablePipelines,c,{forceFresh:o}),fetchFacebookMetrics(c)]),l!==fetchGeneration)return;cachedFacebookMetrics=m,cachedData=applyMarketingData(h,m),cachedData.account?.facebookClientId?facebookClientId=cachedData.account.facebookClientId:cachedData.account?.clientId&&(facebookClientId=cachedData.account.clientId),availablePipelines=cachedData.filterOptions.pipelines||availablePipelines,ensurePipelineDefaults(availablePipelines,cachedData?.account?.defaultPipelineIds),lastFetchedAt=cachedData.cachedAt?new Date(cachedData.cachedAt).getTime():Date.now()}catch(d){if(l!==fetchGeneration)return;if(d.name==="AbortError"){r?restoreDashboardContentAfterFailedFetch(r):s.innerHTML=`
            ${renderBrandTopbar(IS_ADMIN?'<a class="admin-topbar-link" href="/admin">Admin hub</a>':"")}
            ${wrapDashboardShell(`
