    ...
    <div class="setup-panel">
      ...
      <div class="setup-section${t}">
        <div class="setup-section-info">
          ...
          <p class="setup-section-desc">Ad metrics sync needs a Meta Ad Account ID plus the shared system user token in Vercel (<code>META_SYSTEM_USER_TOKEN</code>) or a per-client override below. Page and Pixel IDs are stored for future lead/CAPI work. Ad account timezone is used by Meta date presets.</p>
        </div>
