(function(){const t=window.location.pathname.replace(/^\/+|\/+$/g,"").split("/").filter(Boolean);if(t[0]==="login"){document.body.dataset.dashboardMode="login",delete document.body.dataset.clientSlug;return}if(t[0]==="team"){document.body.dataset.dashboardMode="team",delete document.body.dataset.clientSlug;return}if(t[0]==="admin"){if(t[1]==="sync-history"&&(t[2]==="ghl"||t[2]==="meta"||t[2]==="meta-reports")){document.body.dataset.dashboardMode=t[2]==="meta-reports"?"sync-history-meta-reports":`sync-history-${t[2]}`,delete document.body.dataset.clientSlug;return}if(t[1]==="fb-lead-sync"){document.body.dataset.dashboardMode="fb-lead-sync",delete document.body.dataset.clientSlug;return}if(t[1]==="google-ads"&&t[2]==="custom-values"){document.body.dataset.dashboardMode="google-ads-custom",delete document.body.dataset.clientSlug;return}if(t[1]==="google-ads"&&t[2]){document.body.dataset.dashboardMode="google-ads-client",document.body.dataset.clientSlug=t[2];return}if(t[1]==="google-ads"){document.body.dataset.dashboardMode="google-ads",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]==="custom-values"){document.body.dataset.dashboardMode="meta-reports-custom",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]==="ghl-clients"){document.body.dataset.dashboardMode="meta-reports-ghl-clients",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]){document.body.dataset.dashboardMode="meta-reports-client",document.body.dataset.clientSlug=t[2];return}if(t[1]==="meta-reports"){document.body.dataset.dashboardMode="meta-reports",delete document.body.dataset.clientSlug;return}document.body.dataset.dashboardMode=t.length>=2?"admin":"hub",t.length>=2?document.body.dataset.clientSlug=t[1]:delete document.body.dataset.clientSlug;return}if(t[0]==="report"&&t[1]){document.body.dataset.dashboardMode="report",document.body.dataset.reportToken=t[1],delete document.body.dataset.clientSlug;return}t[0]&&t[0]!=="index.html"&&(document.body.dataset.dashboardMode="client",document.body.dataset.clientSlug=t[0])})();const DASHBOARD_MODE=document.body.dataset.dashboardMode||"client",IS_LOGIN_PAGE=DASHBOARD_MODE==="login",IS_TEAM_PAGE=DASHBOARD_MODE==="team",IS_ADMIN_HUB=DASHBOARD_MODE==="hub",IS_ADMIN_CLIENT=DASHBOARD_MODE==="admin",IS_ADMIN_SYNC_HISTORY_GHL=DASHBOARD_MODE==="sync-history-ghl",IS_ADMIN_SYNC_HISTORY_META=DASHBOARD_MODE==="sync-history-meta",IS_ADMIN_SYNC_HISTORY_META_REPORTS=DASHBOARD_MODE==="sync-history-meta-reports",IS_ADMIN_FB_LEAD_SYNC=DASHBOARD_MODE==="fb-lead-sync",IS_ADMIN_META_REPORTS=DASHBOARD_MODE==="meta-reports",IS_ADMIN_META_REPORTS_CLIENT=DASHBOARD_MODE==="meta-reports-client",IS_ADMIN_META_REPORTS_CUSTOM=DASHBOARD_MODE==="meta-reports-custom",IS_ADMIN_META_REPORTS_GHL_CLIENTS=DASHBOARD_MODE==="meta-reports-ghl-clients",IS_ADMIN_GOOGLE_ADS=DASHBOARD_MODE==="google-ads",IS_ADMIN_GOOGLE_ADS_CLIENT=DASHBOARD_MODE==="google-ads-client",IS_ADMIN_GOOGLE_ADS_CUSTOM=DASHBOARD_MODE==="google-ads-custom",IS_REPORT_VIEW=DASHBOARD_MODE==="report",REPORT_TOKEN=document.body.dataset.reportToken||"",IS_ADMIN_SYNC_HISTORY=IS_ADMIN_SYNC_HISTORY_GHL||IS_ADMIN_SYNC_HISTORY_META||IS_ADMIN_SYNC_HISTORY_META_REPORTS,IS_CLIENT_VIEW=DASHBOARD_MODE==="client",IS_PREVIEW=IS_CLIENT_VIEW&&!!new URLSearchParams(window.location.search).get("client"),IS_ADMIN=IS_ADMIN_HUB||IS_ADMIN_CLIENT||IS_TEAM_PAGE||IS_ADMIN_SYNC_HISTORY||IS_ADMIN_FB_LEAD_SYNC||IS_ADMIN_META_REPORTS||IS_ADMIN_META_REPORTS_CLIENT||IS_ADMIN_META_REPORTS_CUSTOM||IS_ADMIN_META_REPORTS_GHL_CLIENTS||IS_ADMIN_GOOGLE_ADS||IS_ADMIN_GOOGLE_ADS_CLIENT||IS_ADMIN_GOOGLE_ADS_CUSTOM||new URLSearchParams(window.location.search).get("view")==="admin",ADMIN_UI=IS_ADMIN_HUB||IS_ADMIN_CLIENT||IS_TEAM_PAGE||IS_ADMIN_SYNC_HISTORY||IS_ADMIN_FB_LEAD_SYNC||IS_ADMIN_META_REPORTS||IS_ADMIN_META_REPORTS_CLIENT||IS_ADMIN_META_REPORTS_CUSTOM||IS_ADMIN_META_REPORTS_GHL_CLIENTS||IS_ADMIN_GOOGLE_ADS||IS_ADMIN_GOOGLE_ADS_CLIENT||IS_ADMIN_GOOGLE_ADS_CUSTOM||IS_ADMIN,LOADING_MSG=ADMIN_UI?"Loading dashboard data...":"Henter dashboard data...",RETRY_MSG=ADMIN_UI?"Try again":"Pr\xF8v igen";(function(){const t=document.getElementById("initial-loading-msg");t&&(t.textContent=LOADING_MSG)})();function resolveClientSlug(){if(document.body.dataset.clientSlug)return document.body.dataset.clientSlug;const e=window.location.pathname.replace(/^\/+|\/+$/g,"").split("/").filter(Boolean),t=new Set(["meta-reports","google-ads","sync-history","fb-lead-sync"]);return e[0]==="admin"&&e[1]==="google-ads"&&e[2]&&e[2]!=="custom-values"||e[0]==="admin"&&e[1]==="meta-reports"&&e[2]&&e[2]!=="custom-values"&&e[2]!=="ghl-clients"?e[2]:e[0]==="admin"&&e[1]&&!t.has(e[1])?e[1]:e[0]&&e[0]!=="admin"&&e[0]!=="index.html"&&e[0]!=="report"?e[0]:new URLSearchParams(window.location.search).get("client")||"suntech-nordic"}const CLIENT_SLUG=resolveClientSlug();let tenantParams={},facebookClientId=CLIENT_SLUG,setupAccount=null,setupPipelines=[],metricsModelChangeMode=!1;function esc(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function renderCensioAnalyticsLogoMarkup(e=""){const t='<img class="meta-report-public-logo" src="/censio-analytics-logo.png?v=4" alt="Censio Analytics" />';return e?`<a href="${e}" class="brand-logo-link" aria-label="Censio Analytics">${t}</a>`:t}function renderBrandTopbar(e="",t={}){const a=t.logo==="analytics"?"analytics":"cenhub",n=!!(e&&e.includes("staff-admin-chrome")),o=n||e&&e.includes("admin-topbar-link")?"/admin":"",r=a==="analytics"?renderCensioAnalyticsLogoMarkup(o):o?`<a href="${o}" class="brand-logo-link" aria-label="Cenhub home"><img class="brand-logo" src="/cenhub-logo-white.png" alt="Cenhub" width="167" height="41" /></a>`:'<img class="brand-logo" src="/cenhub-logo-white.png" alt="Cenhub" width="167" height="41" />',s=n?`<button type="button" class="staff-nav-toggle" id="staff-nav-toggle" aria-expanded="false" aria-controls="staff-topbar-panel" aria-label="Open menu">
    ...
    <header class="brand-topbar${n?" brand-topbar--collapsible":""}${!n?" brand-topbar--centered":""}">
      <div class="brand-topbar-inner">
        <div class="brand-topbar-left">${r}</div>
        ${s}
        ${i}
      </div>
    </header>
  ...
  `).join("")}function renderAdminHubSkeletonPage(e){const t=e==="clients",a=e==="google-ads",n=t?"clients":a?"google-ads":"meta-reports",o=t?"Client administration":a?"Google Ads reports":"Meta client reports",s=t?`<div class="page-hero admin-hub-hero">
        <h1>${o}</h1>
  ...
  `}function renderSyncHistoryRows(e,t){if(!e.length)return'<div class="sync-history-empty">No sync runs logged yet.</div>';const a=t==="meta"?"Spend / details":t==="meta-report-ghl"?"Months / details":"Details",n=e.map(o=>{let r="\u2014";if(t==="meta-report-ghl")r=formatMetaReportGhlSyncDetail(o);else if(t==="meta"){const s=[];if(o.thisMonthSpend!=null&&s.push(`${fmtDkk(o.thisMonthSpend)} DKK this month`),o.spendDateStop){const i=formatSyncHistoryDate(o.spendDateStop);i&&s.push(`through ${i}`)}o.errorMessage&&s.push(o.errorMessage),r=s.join(" \xB7 ")||"\u2014"}else o.opportunityCount!=null?(r=`${o.opportunityCount} opportunities`,o.errorMessage&&(r+=` \xB7 ${o.errorMessage}`)):o.errorMessage&&(r=o.errorMessage);return`
      <tr>
...
${a}`))try{const o=await adminFetch(`/api/sync-history?type=${encodeURIComponent(e)}`,{method:"DELETE"});showToast(`Cleared ${o.deleted||0} log entr${o.deleted===1?"y":"ies"}.`,"success"),await loadSyncHistoryPage(e)}catch(o){showToast(o.message||`Failed to clear ${t} sync log.`,"error")}}function renderSyncHistoryLoginPrompt(e){const t=e==="meta"?"Meta sync log":e==="meta-report-ghl"?"Meta report sync log":"GHL sync log";return`
  ...
  `}async function loadSyncHistoryPage(e,{silent:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){t||(a.innerHTML=renderSyncHistoryLoginPrompt(e));return}currentStaffUser=n,t||(a.innerHTML=`
    ...
    `);try{const o=await adminFetch(`/api/sync-history?type=${encodeURIComponent(e)}&limit=150`);a.innerHTML=renderSyncHistoryPage(e,o);const r=document.getElementById("sync-history-refresh");r&&(r.onclick=()=>loadSyncHistoryPage(e));const s=document.getElementById("sync-history-clear-log");s&&(s.onclick=()=>clearSyncHistoryLog(e)),syncHistoryRefreshTimer&&(clearInterval(syncHistoryRefreshTimer),syncHistoryRefreshTimer=null),syncHistoryRefreshTimer=window.setInterval(()=>{loadSyncHistoryPage(e,{silent:!0}).catch(()=>{})},6e4)}catch(o){a.innerHTML=`
      ${renderBrandTopbar(renderStaffAdminChrome(getSyncHistoryNavTab(e)))}
...
${s} contact(s) will get Fb Lead id written in GHL. This writes live data.`)&&(fbLeadSyncState.activeRun={clientId:e,mode:t,runId:null,previewOk:!0,previewRunId:a},await runFbLeadSyncBatch({clientId:e,mode:t,dryRun:!1}))}async function refreshFbLeadClientRowsUi(){const e=document.getElementById("fb-lead-clients-mount"),t=document.getElementById("fb-lead-field-warnings-mount");e&&(e.innerHTML=renderFbLeadClientRows(fbLeadSyncState.clients)),t&&(t.innerHTML=renderFbLeadFieldWarnings(fbLeadSyncState.clients)),bindFbLeadSyncToggles()}function renderFbLeadClientActions(e){const t=esc(e.clientId),a=e.metaPageId?"":`<a class="admin-btn admin-btn--ghost admin-btn--small" href="/admin/${encodeURIComponent(e.clientId)}">Setup</a>`;return`
  ...
  `}function lastRunIsSuccessfulApply(e){if(!e||e.dryRun)return!1;const t=String(e.status||"").toLowerCase();return t==="success"||t==="ok"}function lastRunIsSuccessfulPreview(e){if(!e||!e.dryRun)return!1;const t=String(e.status||"").toLowerCase();return t==="success"||t==="ok"}function resolveFbLeadClientStats(e,t={}){const a=e?.displayStats||{},n=t.metaLeadCount90d??a.metaLeadCount90d??null,o=t.estimatedMissing??a.outstanding??null,r=t.estimatedMissing!=null?"Estimated contacts still missing Fb Lead id (from a Meta sample)":a.outstandingHint||"Estimated contacts still missing Fb Lead id (from a Meta sample)";return{metaLeads:n!=null?String(n):"\u2014",missing:o!=null?String(o):"\u2014",missingTitle:r}}function formatFbLeadLastRunLabel(e){if(!e)return"\u2014";const t=[e.dryRun?"preview":e.status,`${e.updated||0} ${e.dryRun?"would update":"updated"}`];return(e.skippedNoMatch??0)>0&&t.push(`${e.skippedNoMatch} no match`),t.join(" \xB7 ")}function renderFbLeadClientRows(e){return e.length?`
    <div class="sync-history-table-wrap">
      <table class="sync-history-table fb-lead-clients-table">
        ...
        <tbody>${e.map(a=>{const n=fbLeadSyncState.preflightByClient[a.clientId]||{},o=resolveFbLeadClientStats(a,n),r=formatFbLeadLastRunLabel(a.lastRun);return`
      <tr>
        <td>
  ...
  `:'<div class="sync-history-empty">No clients configured yet.</div>'}function renderFbLeadClientRowsWrapper(e){return`<div id="fb-lead-clients-mount">${renderFbLeadClientRows(e)}</div>`}function renderFbLeadHistoryRows(e,t={}){const a=getFbLeadHistoryRunsForDisplay(e);if(!a.length){const o=fbLeadSyncState.showRoutineCronRuns?0:(e||[]).filter(r=>isRoutineSuccessfulCronRun(r)).length;return o>0?`<div class="sync-history-empty">${o} routine auto-sync run(s) hidden \u2014 enable <strong>Show routine auto-sync runs</strong> above to view them.</div>`:'<div class="sync-history-empty">No FB lead sync runs logged yet.</div>'}return e=a,`
    <div class="sync-history-table-wrap">
      <table class="sync-history-table">
        <thead>
          <tr>
  ...
  `}function renderFbLeadAuditTable(e,t){if(!e.length)return'<div class="sync-history-empty" style="padding:12px">No contact-level rows stored for this run.</div>';const a=e.map(o=>{const r=ghlContactUrl(t,o.contactId),s=r?`<a href="${esc(r)}" target="_blank" rel="noopener noreferrer">Open in GHL</a>`:"\u2014";return`
      <tr>
  ...
  `}function closeFbLeadRunPanel(){const e=document.getElementById("fb-lead-run-panel-mount");e&&(e.innerHTML=""),fbLeadSyncState.activeRun=null}function openFbLeadRunPanel(e,t){const a=fbLeadSyncState.clients.find(r=>r.clientId===e);if(!clientFbLeadFieldReady(a)){showToast(getClientFbLeadFieldHint(a),"error");return}const n=document.getElementById("fb-lead-run-panel-mount");if(!n)return;fbLeadSyncState.activeRun={clientId:e,mode:t,runId:null,previewOk:clientHasReadyPreview(fbLeadSyncState.clients.find(r=>r.clientId===e))},n.innerHTML=renderFbLeadRunPanel(e,t);const o=document.getElementById("fb-lead-preview-btn");o&&(o.onclick=()=>runFbLeadSyncBatch({clientId:e,mode:t,dryRun:!0})),n.scrollIntoView({behavior:"smooth",block:"nearest"})}function renderFbLeadRunResults(e){const t=e.rows||[];if(!t.length)return'<div class="sync-history-empty" style="padding:12px">No rows in this batch.</div>';const a=t.map(r=>`
    <tr>
  ...
  `}function renderGlobalApplyProgress(e,t,a=0){const n=fbLeadSyncState.clients.find(s=>s.clientId===e),o=t==="backfill"?"90-day backfill":"recent sync",r=a>0?`${a} contact(s)`:"contacts";return`
    <div class="fb-lead-apply-progress-card" id="fb-lead-global-progress-card">
      <div class="fb-lead-apply-progress-header">
        <div>
          ...
          <div class="fb-lead-apply-progress-sub">${esc(n?.accountName||e)} \xB7 ${esc(r)}</div>
        </div>
...
Resume the interrupted ${S}?`)&&(l=w.id,c=Number(w.batchOffset)||0)}}if(a?setFbLeadProgress({processed:c,total:0,label:c>0?"Resuming preview\u2026":"Fetching Meta leads\u2026"}):updateGlobalApplyProgress({waiting:!0,elapsed:0}),a&&c===0){const w=await adminFetchWithRetry("/api/fb-lead-sync/prepare",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l})}),$=w.summary||w;l=$.runId,c=0,setFbLeadProgress({processed:0,total:$.inWindow||0,label:`Matching ${$.inWindow||0} Meta leads to GHL\u2026`})}else!a&&c===0&&updateGlobalApplyProgress({waiting:!1,processed:0,total:b||h?.updated||0});do{d=await adminFetchWithRetry("/api/fb-lead-sync/run",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l,previewRunId:a?null:f,batchOffset:c,batchLimit:s})});const w=d.summary||d;l=w.runId,c=w.nextBatchOffset??w.batchOffset+(w.batchProcessed||0),u=u.concat(w.rows||[]),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.runId=l);const $=w.inWindow||c||b;a?(setFbLeadProgress({processed:c,total:$,complete:!w.hasMore}),r&&(r.innerHTML=renderFbLeadRunResults({...w,rows:u}))):updateGlobalApplyProgress({processed:c,total:$,written:w.updated||0,complete:!w.hasMore})}while((d.summary||d).hasMore);p=!0;const y=d.summary||d,m=y.inWindow||c||b,g=y.nextBatchOffset??c;if(a)setFbLeadProgress({processed:g,total:m,complete:!0}),markFbLeadPreviewReady(e,t,y.updated),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.previewOk=(y.updated||0)>0),showToast((y.updated||0)>0?"Preview complete \u2014 use Apply in Run history below.":"Preview complete \u2014 all contacts already have Fb Lead id. Nothing to apply.","success"),await refreshFbLeadHistoryUi(),document.getElementById("fb-lead-history-mount")?.scrollIntoView({behavior:"smooth",block:"nearest"});else{updateGlobalApplyProgress({processed:g,total:m,written:y.updated||0,complete:!0}),delete fbLeadSyncState.previewOkByClient[e];try{const w=JSON.parse(sessionStorage.getItem("fbLeadSyncPreviewOk")||"{}");delete w[e],sessionStorage.setItem("fbLeadSyncPreviewOk",JSON.stringify(w))}catch{}showToast("FB lead sync complete \u2014 Fb Lead id written to GHL","success"),stopGlobalApplyProgress({success:!0})}await refreshFbLeadHistoryUi();const v=await adminFetch("/api/fb-lead-sync");fbLeadSyncState.clients=v.clients||[],hydrateFbLeadPreviewState(fbLeadSyncState.clients),await refreshFbLeadClientRowsUi()}catch(y){a?hideFbLeadProgress(!0):(updateGlobalApplyProgress({error:`Failed \u2014 ${y.message||"Apply failed"}`}),stopGlobalApplyProgress({success:!1,keepVisibleMs:12e3})),showToast((y.message||(a?"FB lead preview failed.":"FB lead apply failed."))+(a?" Partial progress is saved \u2014 use Resume in Run history or try Preview again.":" Partial progress is saved \u2014 use Resume in Run history."),"error"),await refreshFbLeadHistoryUi()}finally{o&&(o.disabled=!1),fbLeadSyncState.applyingRunId=null,!p&&a&&hideFbLeadProgress(!0),!a&&!p&&(fbLeadSyncState.isApplying=!1,await refreshFbLeadHistoryUi())}}async function expandFbLeadRun(e){const t=document.getElementById(`fb-lead-run-audit-${e}`);if(t){if(!t.hidden){t.hidden=!0;return}try{const a=await adminFetch(`/api/fb-lead-sync/history/${e}`),n=fbLeadSyncState.clients.find(r=>r.clientId===a.run.clientId);t.innerHTML=`<td colspan="7"><div class="fb-lead-audit-scroll" id="fb-lead-audit-scroll-${e}">${renderFbLeadAuditTable(a.run.rows||[],a.run.locationId||n?.locationId)}</div></td>`,t.hidden=!1;const o=document.getElementById(`fb-lead-audit-scroll-${e}`);o&&o.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(a){showToast(a.message||"Failed to load run audit.","error")}}}function viewFbLeadClientHistory(e){const t=getFbLeadHistoryRunsForDisplay(fbLeadSyncState.historyRuns.filter(o=>o.clientId===e)),a=document.getElementById("fb-lead-history-mount");if(!a)return;const n=Object.fromEntries(fbLeadSyncState.clients.map(o=>[o.clientId,o.locationId]));a.innerHTML=t.length?renderFbLeadHistoryRows(t,n):`<div class="sync-history-empty">No runs for ${esc(e)} yet.</div>`,a.scrollIntoView({behavior:"smooth",block:"start"})}async function loadFbLeadSyncPage({silent:e=!1,fullPreflight:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){e||(a.innerHTML=`
  ...
  `}function renderLinkedReportLinkControl(){const e=linkedReportsState.pair,t=linkedReportsState.origin||(IS_ADMIN_GOOGLE_ADS_CLIENT?"google-ads":"meta");if(e){const n=t==="meta"?e.googleAccountName:e.metaAccountName;return`<button type="button" class="admin-btn admin-btn--secondary linked-report-link-btn" id="linked-report-link-btn">Linked \xB7 ${esc(n||"partner")}</button>`}return`<button type="button" class="admin-btn admin-btn--secondary linked-report-link-btn" id="linked-report-link-btn">${esc(t==="meta"?"Link Google Ads":"Link Meta report")}</button>`}function linkedAdminOrigin(){return linkedReportsState.origin||(IS_ADMIN_GOOGLE_ADS_CLIENT?"google-ads":"meta")}function renderLinkedAdminPlatformTabsHtml(){const e=[];return linkedReportsState.metaPayload&&e.push("meta"),linkedReportsState.googlePayload&&e.push("google-ads"),renderLinkedReportPlatformTabs({platforms:e,activePlatform:linkedReportsState.activePlatform||linkedAdminOrigin()})}function renderLinkedPublicPlatformTabsHtml(){const e=linkedReportsState.publicDual;return e?.platforms?renderLinkedReportPlatformTabs({platforms:e.platforms,activePlatform:linkedReportsState.activePlatform||e.origin||"meta"}):""}function renderLinkedAdminEditorInner(){if(isGoogleAdsEditorActive()&&linkedReportsState.googlePayload){const s=linkedReportsState.googlePayload,i=googleAdsPayloadToMetaUiShape(s),l=s.monthKeys||[],c=googleAdsReportsState.activeMonthKey||l[l.length-1]||"",d=googleAdsMonthToMetaUiShape(s.months?.[c]||null),u=l.map(p=>`
    ...
    `}const e=linkedReportsState.metaPayload||metaReportsState.clientPayload,t=e?.monthKeys||[],a=metaReportsState.activeMonthKey||t[t.length-1]||"",n=e?.months?.[a]||null,o=e?.settings||{},r=t.map(s=>`
  ...
  `).join("")}function renderLinkedReportPickerItems(e,t=""){const a=String(t||"").trim().toLowerCase(),n=linkedReportsState.pair,r=linkedAdminOrigin()==="meta"?n?.googleClientId:n?.metaClientId,s=e.filter(i=>a?[i.name,i.id,i.sub].filter(Boolean).join(" ").toLowerCase().includes(a):!0);return s.length?(s.sort((i,l)=>{const c=i.id===r?0:1,d=l.id===r?0:1;return c!==d?c-d:String(i.name||"").localeCompare(String(l.name||""))}),s.map(i=>{const l=i.id===r,c=String(i.name||i.id||"?").trim().charAt(0).toUpperCase();return`
  ...
  `);const o=document.getElementById("linked-report-picker-list"),r=document.getElementById("linked-report-picker-search"),s=document.getElementById("linked-report-unlink-btn"),i=linkedReportsState.metaPayload?.clientId||(e==="meta"?CLIENT_SLUG:t?.metaClientId),l=linkedReportsState.googlePayload?.clientId||(e==="google-ads"?CLIENT_SLUG:t?.googleClientId),c=d=>{if(!o)return;o.setAttribute("aria-busy","false");const u=e==="meta"?l:i,p=()=>{o.innerHTML=renderLinkedReportPickerItems(d,r?.value),o.querySelectorAll("[data-linked-pick-id]").forEach(f=>{f.onclick=async()=>{const h=f.getAttribute("data-linked-pick-id");if(!(!h||h===u)){f.disabled=!0;try{e==="meta"?await saveLinkedReportPair(h,i):await saveLinkedReportPair(l,h),closeMetaReportModal(),showToast("Reports linked","success"),await reloadLinkedAdminPairAndRender()}catch(b){showToast(b.message||"Could not link reports","error"),f.disabled=!1}}}})};r&&(r.oninput=p),p()};s&&(s.onclick=async()=>{if(l){s.disabled=!0;try{await saveLinkedReportPair(l,null),closeMetaReportModal(),showToast("Reports unlinked","success"),linkedReportsState.pair=null,e==="meta"?linkedReportsState.googlePayload=null:linkedReportsState.metaPayload=null,linkedReportsState.activePlatform=e,await reloadLinkedAdminPairAndRender()}catch(d){showToast(d.message||"Could not unlink","error"),s.disabled=!1}}});try{if(e==="meta"){const u=((await adminFetch("/api/google-ads-reports?filter=enabled")).clients||[]).filter(p=>p.clientId&&p.googleAdsReportEnabled&&!p.needsSetup).filter(p=>!p.linkedMetaClientId||String(p.linkedMetaClientId)===String(i)).map(p=>({id:p.clientId,name:p.accountName,sub:p.googleCustomerLabel||p.googleCustomerId||p.clientId}));c(u)}else{const u=((await adminFetch("/api/meta-reports?filter=enabled")).clients||[]).filter(p=>p.clientId&&p.metaReportEnabled&&!p.needsSetup).filter(p=>!p.linkedGoogleClientId||String(p.linkedGoogleClientId)===String(l)).map(p=>({id:p.clientId,name:p.accountName,sub:p.clientId}));c(u)}}catch(d){o&&(o.setAttribute("aria-busy","false"),o.innerHTML=`<p class="linked-report-picker-empty">${esc(d.message||"Could not load accounts")}</p>`)}}async function fetchLinkedPartnerPayload(e,t){const a=linkedReportPairFromPayload(e);if(!a)return null;try{if(t==="meta"&&a.googleClientId){const n=linkedReportsState.googlePayload?.year||googleAdsReportsState.selectedYear||e.year;return await adminFetch(`/api/google-ads-reports/clients/${encodeURIComponent(a.googleClientId)}?year=${encodeURIComponent(n)}`)}if(t==="google-ads"&&a.metaClientId){const n=linkedReportsState.metaPayload?.year||metaReportsState.selectedYear||e.year;return await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(a.metaClientId)}?year=${encodeURIComponent(n)}`)}}catch(n){console.warn("Linked partner report failed to load",n)}return null}const META_HUB_FILTER_OPTIONS=[{value:"all",label:"All"},{value:"enabled",label:"Live reports"},{value:"meta-only",label:"Meta only"},{value:"needs-setup",label:"Needs setup"}];function metaHubClientInitial(e){const t=String(e||"?").trim();return esc(t.charAt(0).toUpperCase())}function filterMetaReportsClients(e,t,a=""){let n=e||[];t==="enabled"&&(n=n.filter(r=>r.metaReportEnabled)),t==="meta-only"&&(n=n.filter(r=>!clientUsesCenhubMetaReportTopline(r))),t==="needs-setup"&&(n=n.filter(r=>r.needsSetup));const o=String(a||"").trim().toLowerCase();return o&&(n=n.filter(r=>[r.accountName,r.metaAdAccountId,r.clientId,r.metaName].filter(Boolean).join(" ").toLowerCase().includes(o))),n}function getMetaReportsHubView(e,t,a=metaReportsState.searchQuery){const n=e?.clients||[],o=filterMetaReportsClients(n,t,a),r=e?.summary||{};return{clients:o,allClients:n,summary:{...r,totalListed:n.length},meta:e?.meta||{},filter:t,searchQuery:a}}function renderMetaHubSwitch({label:e,attr:t,value:a,checked:n,disabled:o=!1,inline:r=!1}){const s=r?" meta-hub-switch--inline":"";return a?`
    <label class="meta-hub-switch${o?" is-disabled":""}${s}">
  ...
  `,document.body.appendChild(n),document.body.classList.add("meta-report-modal-open"),n.querySelectorAll("[data-meta-report-modal-close]").forEach(r=>{r.addEventListener("click",closeMetaReportModal)}),n.querySelector(".meta-report-modal-close")?.addEventListener("click",closeMetaReportModal)}function renderMetaReportShareModalContent(e){const a=!!(e.settings||{}).metaReportEnabled,n=e.reportUrl||null;if(!n)return"";const o=metaReportFullUrl(n),r=resolveMetaReportShareSlug(e),s=resolveMetaReportShareCode(e);return`
    <div class="meta-report-modal-head">
  ...
  `}function openMetaReportShareModal(e){metaReportsState.clientShareExpanded=!0,openMetaReportModal(renderMetaReportShareModalContent(e)),bindMetaReportShareEvents(e)}function renderMetaReportShareSummary(e,{hidden:t=!1}={}){const n=!!(e.settings||{}).metaReportEnabled,o=resolveMetaReportShareSlug(e),r=resolveMetaReportShareCode(e),s=o?`${o}-${r||"\xB7\xB7\xB7\xB7"}`:"Not set";return`
  ...
  `}function renderMetaReportMetricTable(e,t,a="meta",{badge:n="",highlightLastN:o=0}={}){const r=t.map(([s,i,l],c)=>`
  ...
  `}function isMetaReportCensioClient(e){const t=String(e?.clientId||"").toLowerCase(),a=String(e?.accountName||"");return t==="censio"||/censio/i.test(a)}function monthHasChartData(e){if(!e||e.meta?.emptyMonth)return!1;if(!metaReportMonthPeriodAligned(e))return(Number(e.topline?.leads)||0)>0;const t=Number(e.meta?.spend)||0,a=Number(e.topline?.leads)||0;return t>0||a>0}function buildMetaReportChartSeries(e){const t=e?.monthKeys||[],a=e?.months||{},n=[];for(const o of t){const r=a[o];if(!r||r.meta?.emptyMonth){n.push({monthKey:o,label:metaMonthLabel(o),periodEnd:r?.periodEnd||null,roasKr:null,roasX:null,poasKr:null,poasX:null,spend:0,leads:0,wonLeads:0,avgLeadValue:0,avgProfitPerWon:0,hasData:!1});continue}const s=!!r.bottomline;n.push({monthKey:o,label:metaMonthLabel(o),periodEnd:r.periodEnd||null,roasKr:Number(r.topline?.roasKr)||0,roasX:Number(r.topline?.roasX)||0,poasKr:s?Number(r.bottomline.poasKr)||0:null,poasX:s?Number(r.bottomline.poasX)||0:null,spend:Number(r.meta?.spend)||0,leads:Number(r.topline?.leads)||0,wonLeads:Number(r.topline?.wonLeads)||0,avgLeadValue:Number(r.topline?.avgLeadValue)||0,avgProfitPerWon:Number(r.inputs?.avgProfitPerWon)||0,hasData:monthHasChartData(r)})}return n}function getMetaReportDemoSeries(e,t,a,n){if(!isMetaReportCensioClient({clientId:e,accountName:t}))return null;const r=new Date,s=r.getFullYear(),i=r.getMonth()+1,l=Number(a)||s;let c=(n||[]).filter(d=>{const u=Number(String(d).slice(0,4)),p=Number(String(d).slice(5,7));return!(u!==l||l===s&&p>i)});if(!c.length){const d=l===s?Math.min(8,i):8;c=Array.from({length:d},(u,p)=>`${l}-${String(p+1).padStart(2,"0")}`)}return c.map((d,u)=>{const p=c.length>1?u/(c.length-1):0,f=Math.round(8e3+p*1e4),h=Math.round(2e3+p*15e3),b=Number((.5+p*2.5).toFixed(2)),y=Math.round(1500+p*12e3),m=Number((.4+p*2.2).toFixed(2)),g=Math.round(20+p*80),v=Math.max(1,Math.round(g*(.08+p*.04)));return{monthKey:d,label:metaMonthLabel(d),roasKr:h,roasX:b,poasKr:y,poasX:m,spend:f,leads:g,wonLeads:v,avgLeadValue:85e3,avgProfitPerWon:42e3,hasData:!0,demo:!0}})}function metaReportScenarioPointHasTopline(e){return metaReportParseAmount(e?.spend)>0&&metaReportParseAmount(e?.leads)>0&&metaReportParseAmount(e?.wonLeads)>0&&metaReportParseAmount(e?.avgLeadValue)>0}function metaReportScenarioPointHasBottomlineInputs(e){return metaReportScenarioPointHasTopline(e)&&metaReportParseAmount(e?.avgProfitPerWon)>0}function filterMetaReportScenarioSeries(e=[],{hasBottomline:t=!1}={}){const a=t?metaReportScenarioPointHasBottomlineInputs:metaReportScenarioPointHasTopline;return e.filter(a)}function resolveMetaReportChartSeries(e,{allowDemo:t=!0}={}){const a=buildMetaReportChartSeries(e);if(a.filter(o=>o.hasData).length>=META_REPORT_CHART_MIN_POINTS)return{series:a,demo:!1};if(t&&isMetaReportCensioClient(e)){const o=getMetaReportDemoSeries(e.clientId,e.accountName,e.year||metaReportsState.selectedYear,e.monthKeys);if(o&&o.length>=META_REPORT_CHART_MIN_POINTS)return{series:o,demo:!0}}return{series:a,demo:!1}}function metaReportParseAmount(e){const t=Number.parseFloat(e);return Number.isFinite(t)?t:0}function metaReportRoundMoney(e){return Math.round(metaReportParseAmount(e)*100)/100}function metaReportRoundRatio(e){return Math.round(metaReportParseAmount(e)*1e8)/1e8}function metaReportAggregateSeriesEfficiency(e=[]){let t=0,a=0,n=0,o=0,r=0;for(const i of e){const l=metaReportParseAmount(i.spend),c=metaReportParseAmount(i.leads),d=metaReportParseAmount(i.wonLeads);l<=0&&c<=0||(t+=l,a+=c,n+=d,o+=d*metaReportParseAmount(i.avgLeadValue),r+=d*metaReportParseAmount(i.avgProfitPerWon))}const s=e.filter(i=>metaReportParseAmount(i.spend)>0).length;return{avgCpl:a>0?metaReportRoundMoney(t/a):0,winRate:a>0?metaReportRoundRatio(n/a):0,avgLeadValue:n>0?metaReportRoundMoney(o/n):0,avgProfitPerWon:n>0?metaReportRoundMoney(r/n):0,avgMonthlySpend:s>0?metaReportRoundMoney(t/s):0}}const META_SCENARIO_MIN_EFFICIENCY_MONTHS=2,META_SCENARIO_MIN_TREND_MONTHS=4,META_SCENARIO_SPEND_RAMP_CAP=2,META_SCENARIO_MAD_MULTIPLIER=2.5,META_SCENARIO_MAX_MONTHLY_TREND=.03;function metaReportScenarioParseDate(e){if(!e)return null;const t=String(e).slice(0,10);if(!/^\d{4}-\d{2}-\d{2}$/.test(t))return null;const a=new Date(`${t}T12:00:00.000Z`);return Number.isNaN(a.getTime())?null:a}function metaReportScenarioIsIncompleteMonth(e,t=new Date,{hasBottomline:a=!1}={}){if(!metaReportScenarioParseDate(e.periodEnd))return!0;const o=t.toISOString().slice(0,10);return String(e.periodEnd).slice(0,10)<o?!1:!(a?metaReportScenarioPointHasBottomlineInputs(e):metaReportScenarioPointHasTopline(e))}function metaReportScenarioIsAdActive(e){return metaReportParseAmount(e.spend)>0&&metaReportParseAmount(e.leads)>0}function metaReportScenarioMedian(e=[]){const t=e.filter(n=>Number.isFinite(n)).slice().sort((n,o)=>n-o);if(!t.length)return 0;const a=Math.floor(t.length/2);return t.length%2===0?(t[a-1]+t[a])/2:t[a]}function metaReportScenarioMad(e=[]){const t=metaReportScenarioMedian(e);return metaReportScenarioMedian(e.map(a=>Math.abs(a-t)))}function metaReportScenarioLinearRegression(e=[]){const t=e.length;if(t<2)return{slope:0,intercept:0,r:0};let a=0,n=0,o=0,r=0,s=0;for(const p of e){const f=metaReportParseAmount(p.x),h=metaReportParseAmount(p.y);a+=f,n+=h,o+=f*h,r+=f*f,s+=h*h}const i=t*r-a*a;if(i===0)return{slope:0,intercept:n/t,r:0};const l=(t*o-a*n)/i,c=(n-l*a)/t,d=Math.sqrt((t*r-a*a)*(t*s-n*n)),u=d>0?(t*o-a*n)/d:0;return{slope:l,intercept:c,r:u}}function metaReportScenarioEnrichMonth(e){const t=metaReportParseAmount(e.spend),a=metaReportParseAmount(e.leads),n=metaReportParseAmount(e.wonLeads),o=metaReportParseAmount(e.avgLeadValue),r=metaReportParseAmount(e.avgProfitPerWon),s=metaReportRoundMoney(n*o),i=metaReportRoundMoney(n*r);return{...e,spend:t,leads:a,wonLeads:n,avgLeadValue:o,avgProfitPerWon:r,cpl:a>0?metaReportRoundMoney(t/a):0,totalLeadValue:s,totalProfit:i,efficiencyIndex:t>0?s/t:0,profitEfficiencyIndex:t>0?i/t:0}}function metaReportPrepareScenarioSeries(e=[],{windowMonths:t="6",asOfDate:a=new Date,smoothOutliers:n=!0,hasBottomline:o=!1}={}){const r=normalizeMetaReportScenarioMonthWindow(t)==="all"?1/0:Number.parseInt(normalizeMetaReportScenarioMonthWindow(t),10)||6,s=e.filter(metaReportScenarioIsAdActive).filter(u=>!metaReportScenarioIsIncompleteMonth(u,a,{hasBottomline:o})).map(metaReportScenarioEnrichMonth),i=s.length,l=r===1/0?s:s.slice(-r);let c=0,d=l;if(n&&l.length>=3){const u=l.map(m=>metaReportParseAmount(m.cpl)),p=l.map(m=>metaReportParseAmount(m.leads)),f=metaReportScenarioMedian(u),h=metaReportScenarioMedian(p),b=metaReportScenarioMad(u),y=metaReportScenarioMad(p);d=l.map(m=>{const g={...m};let v=!1;const w=metaReportParseAmount(m.leads);if(b>0){const $=f-META_SCENARIO_MAD_MULTIPLIER*b,S=f+META_SCENARIO_MAD_MULTIPLIER*b,C=Math.min(S,Math.max($,metaReportParseAmount(m.cpl)));C!==metaReportParseAmount(m.cpl)&&(g.cpl=metaReportRoundMoney(C),g.leads=Math.max(1,Math.round(metaReportParseAmount(m.spend)/C)),v=!0)}if(y>0){const $=h-META_SCENARIO_MAD_MULTIPLIER*y,S=h+META_SCENARIO_MAD_MULTIPLIER*y,C=Math.min(S,Math.max($,metaReportParseAmount(m.leads)));Math.round(C)!==Math.round(w)&&(g.leads=Math.max(1,Math.round(C)),v=!0)}if(v){c+=1;const $=w>0?metaReportParseAmount(m.wonLeads)/w:0,S=metaReportParseAmount(g.leads);g.wonLeads=Math.max(0,Math.round(S*$)),g.totalLeadValue=metaReportRoundMoney(g.wonLeads*metaReportParseAmount(m.avgLeadValue));const C=metaReportParseAmount(g.spend);g.totalProfit=metaReportRoundMoney(g.wonLeads*metaReportParseAmount(m.avgProfitPerWon)),g.efficiencyIndex=C>0?g.totalLeadValue/C:0,g.profitEfficiencyIndex=C>0?g.totalProfit/C:0}return g})}return{months:d,monthsAvailable:i,monthsUsed:d.length,outliersAdjusted:c,confidence:metaReportResolveScenarioConfidence(d.length)}}function metaReportScenarioRecencyEfficiency(e=[]){if(e.length<META_SCENARIO_MIN_EFFICIENCY_MONTHS)return null;let t=0,a=0,n=0,o=0,r=0,s=0;return e.forEach((i,l)=>{const c=l+1;t+=metaReportParseAmount(i.spend)*c,a+=metaReportParseAmount(i.leads)*c,n+=metaReportParseAmount(i.wonLeads)*c,o+=metaReportParseAmount(i.wonLeads)*metaReportParseAmount(i.avgLeadValue)*c,r+=metaReportParseAmount(i.wonLeads)*metaReportParseAmount(i.avgProfitPerWon)*c,s+=metaReportParseAmount(i.spend)}),{avgCpl:a>0?metaReportRoundMoney(t/a):0,winRate:a>0?metaReportRoundRatio(n/a):0,avgLeadValue:n>0?metaReportRoundMoney(o/n):0,avgProfitPerWon:n>0?metaReportRoundMoney(r/n):0,avgMonthlySpend:e.length>0?metaReportRoundMoney(s/e.length):0}}function metaReportScenarioPooledEfficiency(e=[]){return metaReportAggregateSeriesEfficiency(e)}function metaReportScenarioBlendEfficiency(e,t,a=.5){if(!e||!t)return e||t;const n=1-a;return{avgCpl:metaReportRoundMoney(e.avgCpl*a+t.avgCpl*n),winRate:metaReportRoundRatio(e.winRate*a+t.winRate*n),avgLeadValue:metaReportRoundMoney(e.avgLeadValue*a+t.avgLeadValue*n),avgProfitPerWon:metaReportRoundMoney(e.avgProfitPerWon*a+t.avgProfitPerWon*n),avgMonthlySpend:metaReportRoundMoney(e.avgMonthlySpend*a+t.avgMonthlySpend*n)}}function metaReportEfficiencyFromPreparedMonth(e){const t=metaReportParseAmount(e.leads),a=metaReportParseAmount(e.wonLeads);return{avgCpl:metaReportParseAmount(e.cpl),winRate:t>0?metaReportRoundRatio(a/t):0,avgLeadValue:metaReportParseAmount(e.avgLeadValue),avgProfitPerWon:metaReportParseAmount(e.avgProfitPerWon),avgMonthlySpend:metaReportParseAmount(e.spend)}}function metaReportResolveScenarioProjectionEfficiency(e,t,{hasBottomline:a=!1,activeMonthKey:n=null,asOfDate:o=new Date}={}){const r=e?.months||[];if(!r.length||!t)return t;const s=r[r.length-1],i=n||metaReportMonthKeyFromDate(o);return!i||s.monthKey!==i||!(a?metaReportScenarioPointHasBottomlineInputs(s):metaReportScenarioPointHasTopline(s))?t:metaReportScenarioBlendEfficiency(metaReportEfficiencyFromPreparedMonth(s),t,.65)}function metaReportScenarioMonthlyTrend(e=[],t=.75,{dampenHotStreak:a=!1,metricKey:n="efficiencyIndex"}={}){if(e.length<META_SCENARIO_MIN_TREND_MONTHS)return{trendRate:0,trendDirection:"flat",trendRatePct:0,trendR:0};const o=e.map(u=>metaReportParseAmount(u.spend)).filter(u=>u>0),r=metaReportScenarioMedian(o)||1,s=e.map((u,p)=>{const f=metaReportParseAmount(u.spend),h=metaReportParseAmount(u[n]),b=h>0?h:1e-6,y=f>0?f:r;return{x:p,y:Math.log(b)-t*Math.log(y/r)}}),{slope:i,r:l}=metaReportScenarioLinearRegression(s);let c=Math.max(-META_SCENARIO_MAX_MONTHLY_TREND,Math.min(META_SCENARIO_MAX_MONTHLY_TREND,i));if(a){const u=e.map(h=>metaReportParseAmount(h[n])).filter(h=>h>0),p=metaReportScenarioMedian(u),f=e.slice(-3).reduce((h,b)=>h+metaReportParseAmount(b[n]),0)/Math.min(3,e.length);p>0&&f>p*1.15&&c>0&&(c*=.5)}let d="flat";return Math.abs(c)>=.005&&(d=c>0?"up":"down"),{trendRate:c,trendDirection:d,trendRatePct:metaReportRoundRatio(c*100),trendR:metaReportRoundRatio(l)}}function metaReportScenarioCalibrateElasticity(){return META_REPORT_SCENARIO_FIXED_ELASTICITY}function metaReportResolveScenarioConfidence(e=0){const t=Number.parseInt(e,10)||0;return t<4?"low":t<7?"medium":"high"}function metaReportComputeScenarioEfficiency(e=[],{blendHistory:t=!1,includeTrend:a=!1,cautionStrongMonths:n=!1,hasBottomline:o=!1}={}){const r=META_REPORT_SCENARIO_FIXED_ELASTICITY,s=metaReportScenarioCalibrateElasticity(),i=metaReportScenarioRecencyEfficiency(e),l=metaReportScenarioPooledEfficiency(e);if(!i||i.avgCpl<=0)return{efficiency:null,elasticity:s,presetElasticity:r,trendRate:0,trendDirection:"flat",trendRatePct:0,trendR:0};const c=t?metaReportScenarioBlendEfficiency(l,i,.5):i;let d={trendRate:0,trendDirection:"flat",trendRatePct:0,trendR:0};if(a){const p=metaReportScenarioMonthlyTrend(e,s,{dampenHotStreak:n,metricKey:o?"profitEfficiencyIndex":"efficiencyIndex"});Math.abs(p.trendR)>=META_SCENARIO_TREND_R_THRESHOLD&&(d=p)}return{efficiency:c,elasticity:s,presetElasticity:r,...d}}function metaReportProjectBudgetAtSpend({baselineSpend:e,spend:t,efficiency:a,elasticity:n=.75,trendAdj:o=1,hasBottomline:r=!1}={}){const s=metaReportParseAmount(e),i=metaReportParseAmount(t);if(i<=0||s<=0||!a||a.avgCpl<=0)return{spend:0,leads:0,wonLeads:0,totalLeadValue:0,roasKr:0,roasX:0,poasKr:null,poasX:null};const l=s/a.avgCpl,c=i/s,d=metaReportParseAmount(o)>0?metaReportParseAmount(o):1,u=Math.max(0,Math.round(l*c**n*d)),p=Math.round(u*a.winRate),f=metaReportRoundMoney(p*a.avgLeadValue),h=metaReportRoundMoney(f-i),b=i>0?metaReportRoundRatio(h/i):0;let y=null,m=null;if(r&&a.avgProfitPerWon>0){const g=metaReportRoundMoney(p*a.avgProfitPerWon);y=metaReportRoundMoney(g-i),m=i>0?metaReportRoundRatio(y/i):0}return{spend:i,leads:u,wonLeads:p,totalLeadValue:f,roasKr:h,roasX:b,poasKr:y,poasX:m}}function metaReportSpendFromMonthKey(e=[],t=null,a=null){if(!a)return 0;const n=t?.months?.[a];if(n&&!n.meta?.emptyMonth&&metaReportMonthPeriodAligned(n)){const r=metaReportParseAmount(n.meta?.spend??n.google?.spend);if(r>0)return r}const o=e.find(r=>r.monthKey===a);return o?metaReportParseAmount(o.spend):0}function metaReportPrepareBaselineSpendWindow(e=[],{windowMonths:t="6",asOfDate:a=new Date}={}){const n=normalizeMetaReportScenarioMonthWindow(t)==="all"?1/0:Number.parseInt(normalizeMetaReportScenarioMonthWindow(t),10)||6,o=a.toISOString().slice(0,10),r=e.filter(s=>metaReportParseAmount(s.spend)>0).filter(s=>{const i=String(s.periodEnd||"").slice(0,10);return!i||i<o});return n===1/0?r:r.slice(-n)}function resolveMetaReportWindowAverageBaselineSpend(e=[]){if(!e.length)return 0;const t=e.reduce((a,n)=>a+metaReportParseAmount(n.spend),0);return t>0?metaReportRoundMoney(t/e.length):0}function buildMetaReportScenarioProjection(e,t){const a=getMetaReportScenarioPillsFromState(),n=resolveMetaReportScenarioPayload(t)||t,o=payloadHasMetaReportBottomline(n),r=filterMetaReportScenarioSeries(e,{hasBottomline:o});return metaReportProjectBudgetScenario({series:r,multiplier:metaReportsState.budgetMultiplier,hasBottomline:o,blendHistory:a.blendHistory,includeTrend:a.includeTrend,monthWindow:metaReportsState.scenarioMonthWindow,baselineMode:metaReportsState.budgetBaseline,activeMonthKey:resolveMetaReportScenarioActiveMonthKey(n),smoothOutliers:a.smoothUneven,payload:n})}function isMetaReportViewingPastYear(e){const t=Number(e?.year||metaReportsState.selectedYear),a=getMetaReportCalendarYear(e);return Number.isFinite(t)&&t<a}function updateMetaReportScenarioSource(e){if(!e)return;const t=getMetaReportCalendarYear(e);if(Number(e.year)!==t)return;const{series:a,demo:n}=resolveMetaReportChartSeries(e,{allowDemo:!1});if(!a.length||n){metaReportsState.scenarioSourcePayload=null,metaReportsState.scenarioSeries=null;return}metaReportsState.scenarioSourcePayload=e,metaReportsState.scenarioSeries=a}function resolveMetaReportScenarioPayload(e){return isMetaReportViewingPastYear(e)&&metaReportsState.scenarioSourcePayload?metaReportsState.scenarioSourcePayload:e}function resolveMetaReportScenarioSeries(e){return metaReportsState.chartSeries?.length?metaReportsState.chartSeries:isMetaReportViewingPastYear(e)?metaReportsState.scenarioSeries||[]:[]}function resolveMetaReportScenarioActiveMonthKey(e){return isMetaReportViewingPastYear(e)?metaReportMonthKeyFromDate(new Date):metaReportsState.activeMonthKey}async function ensureMetaReportScenarioSource(e,{editable:t=!1}={}){if(!e||!isMetaReportViewingPastYear(e)||metaReportsState.scenarioSeries?.length)return;const a=getMetaReportCalendarYear(e),n=e.clientId,o=e.reportKind==="google-ads";try{if(t&&n){const s=await adminFetch(`${o?"/api/google-ads-reports":"/api/meta-reports"}/clients/${encodeURIComponent(n)}?year=${encodeURIComponent(a)}`);updateMetaReportScenarioSource(o?googleAdsPayloadToMetaUiShape(s):s);return}if(REPORT_TOKEN){const r=await fetch(`/api/meta-reports/public/${encodeURIComponent(REPORT_TOKEN)}?year=${encodeURIComponent(a)}`).then(async s=>{const i=await s.json();if(!s.ok)throw new Error(i.error||"Report not found");return i});updateMetaReportScenarioSource(r.reportKind==="google-ads"?googleAdsPayloadToMetaUiShape(r):r)}}catch{}}function resolveMetaReportLastMonthBaseline(e=[],{activeMonthKey:t=null,asOfDate:a=new Date,payload:n=null}={}){const o=t||metaReportMonthKeyFromDate(a);if(!o)return null;const r=metaReportAddMonthsToMonthKey(o,-1);if(!r)return null;const s=metaReportSpendFromMonthKey(e,n,r);if(s>0)return{monthKey:r,label:metaMonthLabel(r),spend:s};const l=e.filter(c=>metaReportParseAmount(c.spend)>0).sort((c,d)=>String(c.monthKey).localeCompare(String(d.monthKey))).find(c=>c.monthKey===r);return l?{monthKey:r,label:metaMonthLabel(r),spend:metaReportParseAmount(l.spend)}:null}function resolveMetaReportPreparedWindowAverageSpend(e=[]){if(!e.length)return 0;const t=e.reduce((a,n)=>a+metaReportParseAmount(n.spend),0);return t>0?metaReportRoundMoney(t/e.length):0}function resolveMetaReportLatestPreparedSpend(e=[]){for(let t=e.length-1;t>=0;t-=1){const a=metaReportParseAmount(e[t]?.spend);if(a>0)return a}return 0}function resolveMetaReportScenarioBaselineSpend(e,t,{baselineMode:a="year",activeMonthKey:n=null,asOfDate:o=new Date,payload:r=null}={}){const s=t?.months||[];let i=0;if(a==="month"&&n){if(i=metaReportSpendFromMonthKey(e,r,n),i<=0){const l=s.find(c=>c.monthKey===n);l&&metaReportParseAmount(l.spend)>0&&(i=metaReportParseAmount(l.spend))}}else if(a==="last"){const l=resolveMetaReportLastMonthBaseline(e,{activeMonthKey:n,asOfDate:o,payload:r});l?.spend>0&&(i=l.spend)}else if(a==="year"){const l=metaReportPrepareBaselineSpendWindow(e,{windowMonths:metaReportsState.scenarioMonthWindow,asOfDate:o});i=resolveMetaReportWindowAverageBaselineSpend(l),i<=0&&(i=resolveMetaReportPreparedWindowAverageSpend(s))}return i<=0&&(i=resolveMetaReportPreparedWindowAverageSpend(s)),i<=0&&(i=resolveMetaReportLatestPreparedSpend(s)),i}function metaReportProjectBudgetScenario({series:e=[],baselineSpend:t,multiplier:a=1,hasBottomline:n=!1,blendHistory:o=!1,includeTrend:r=!1,cautionStrongMonths:s=!1,monthWindow:i="6",baselineMode:l="year",activeMonthKey:c=null,asOfDate:d=new Date,smoothOutliers:u=!0,payload:p=null}={}){const f=metaReportPrepareScenarioSeries(e,{windowMonths:i,asOfDate:d,smoothOutliers:u,hasBottomline:n}),h=metaReportComputeScenarioEfficiency(f.months,{blendHistory:o,includeTrend:r,cautionStrongMonths:s,hasBottomline:n});let b=metaReportParseAmount(t);b||(b=resolveMetaReportScenarioBaselineSpend(e,f,{baselineMode:l,activeMonthKey:c,asOfDate:d,payload:p}));const y=metaReportParseAmount(a)||1;let{efficiency:m,elasticity:g,trendRate:v}=h;if(m=metaReportResolveScenarioProjectionEfficiency(f,m,{hasBottomline:n,activeMonthKey:c,asOfDate:d}),!m||m.avgCpl<=0||b<=0||f.monthsUsed<META_SCENARIO_MIN_EFFICIENCY_MONTHS)return{...h,efficiency:m,prepared:f,baseline:metaReportProjectBudgetAtSpend({baselineSpend:0,spend:0,efficiency:m}),projected:metaReportProjectBudgetAtSpend({baselineSpend:0,spend:0,efficiency:m}),projectedConservative:null,projectedOptimistic:null,multiplier:y,baselineSpend:b,hasBottomline:n,insufficientData:!0,insufficientReason:f.monthsUsed<META_SCENARIO_MIN_EFFICIENCY_MONTHS?"need_more_months":b<=0?"need_baseline_spend":"need_efficiency"};const $=Math.exp(v*1),S=metaReportProjectBudgetAtSpend({baselineSpend:b,spend:b,efficiency:m,elasticity:g,trendAdj:1,hasBottomline:n}),C=metaReportProjectBudgetAtSpend({baselineSpend:b,spend:metaReportRoundMoney(b*y),efficiency:m,elasticity:g,trendAdj:$,hasBottomline:n}),E=metaReportProjectBudgetAtSpend({baselineSpend:b,spend:metaReportRoundMoney(b*y),efficiency:m,elasticity:g,trendAdj:Math.exp(Math.min(v,0)*1),hasBottomline:n}),I=metaReportProjectBudgetAtSpend({baselineSpend:b,spend:metaReportRoundMoney(b*y),efficiency:m,elasticity:g,trendAdj:Math.exp(Math.max(v,0)*1),hasBottomline:n});return{...h,efficiency:m,prepared:f,baseline:S,projected:C,projectedConservative:E,projectedOptimistic:I,multiplier:y,baselineSpend:b,hasBottomline:n,insufficientData:!1}}function metaReportBuildScenarioProjectionMonthKeys(e=META_REPORT_SCENARIO_PROJECTED_MONTHS,t=new Date){const a=metaReportMonthKeyFromDate(t);if(!a||e<=0)return[];const n=[];for(let o=1;o<=e;o+=1)n.push(metaReportAddMonthsToMonthKey(a,o));return n}function metaReportResolveScenarioStepMultiplier(e,t=1){const a=metaReportParseAmount(t)||1,n=Number.parseInt(e,10)||1;return a<=META_SCENARIO_SPEND_RAMP_CAP?a:n<=1?META_SCENARIO_SPEND_RAMP_CAP:a}function buildMetaReportScenarioProjectionSteps(e,{months:t=META_REPORT_SCENARIO_PROJECTED_MONTHS,hasBottomline:a=!1,asOfDate:n=new Date,targetMultiplier:o=null}={}){if(!e||e.insufficientData)return[];const r=metaReportParseAmount(e.baselineSpend),s=metaReportParseAmount(o??e.multiplier)||1,i=e.efficiency,l=e.elasticity||.75,c=e.trendRate||0,d=metaReportBuildScenarioProjectionMonthKeys(t,n),u=[];for(let p=1;p<=t;p+=1){const f=metaReportResolveScenarioStepMultiplier(p,s),h=metaReportRoundMoney(r*f),b=Math.exp(c*p),y=metaReportProjectBudgetAtSpend({baselineSpend:r,spend:h,efficiency:i,elasticity:l,trendAdj:b,hasBottomline:a}),m=d[p-1]||null;u.push({label:m?metaMonthLabel(m):`+${p} mo`,monthKey:m,spendMultiplier:metaReportRoundRatio(f),spend:y.spend,leads:y.leads,wonLeads:y.wonLeads,totalLeadValue:y.totalLeadValue,roasKr:y.roasKr,roasX:y.roasX,poasKr:y.poasKr,poasX:y.poasX})}return u}function metaReportSpendAxisTick(e){const t=Number(e)||0;return Math.abs(t)>=1e6?`${(t/1e6).toFixed(1)}M`:Math.abs(t)>=1e3?`${Math.round(t/1e3)}K`:t}function metaReportSpendMultiplierValue(e,t){const a=metaReportParseAmount(t),n=metaReportParseAmount(e);return a<=0?0:metaReportRoundRatio(n/a)}function resolveMetaReportSpendChartBaseline(e,t=null){const a=metaReportParseAmount(t?.baselineSpend);return a>0?a:metaReportAggregateSeriesEfficiency(e).avgMonthlySpend}function trimMetaReportScenarioSeries(e,t=META_REPORT_SCENARIO_MAX_HISTORICAL){const a=e.filter(n=>metaReportParseAmount(n.spend)>0);return a.length>t?a.slice(-t):a}function metaReportMonthKeyFromDate(e=new Date){const t=e instanceof Date?e:new Date(e);return Number.isNaN(t.getTime())?null:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}`}function metaReportAddMonthsToMonthKey(e,t=0){const a=String(e||"").trim();if(!/^\d{4}-\d{2}$/.test(a))return null;const[n,o]=a.split("-").map(Number),r=new Date(n,o-1+t,1);return`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`}function metaReportDeltaPct(e,t){const a=metaReportParseAmount(t),n=metaReportParseAmount(e);return a?metaReportRoundRatio((n-a)/Math.abs(a)*100):null}function metaReportResolveBaselineSpend(e,t,a=null){if(a?.baselineSpend>0)return metaReportParseAmount(a.baselineSpend);const n=getMetaReportScenarioPillsFromState(),o=payloadHasMetaReportBottomline(e),r=a?.prepared||metaReportPrepareScenarioSeries(t,{windowMonths:metaReportsState.scenarioMonthWindow,smoothOutliers:n.smoothUneven,hasBottomline:o});return resolveMetaReportScenarioBaselineSpend(t,r,{baselineMode:metaReportsState.budgetBaseline,activeMonthKey:resolveMetaReportScenarioActiveMonthKey(e),payload:e})}function resolveMetaReportScenarioDisplayTimeline(e,t=[]){return metaReportsState.chartSeries?.length?metaReportsState.chartSeries:e?buildMetaReportChartSeries(e):t}function resolveMetaReportScenarioActiveTimeline(e=[]){const t=metaReportMonthKeyFromDate(new Date);return e.filter(a=>!t||!a.monthKey||a.monthKey<=t)}function resolveMetaReportScenarioAdActiveSeries(e,t){const a=resolveMetaReportScenarioActiveTimeline(e);return t==="poas"?a.filter(n=>n.poasKr!=null&&n.poasX!=null&&metaReportParseAmount(n.spend)>0):a.filter(n=>metaReportParseAmount(n.spend)>0)}function resolveMetaReportScenarioLastAdActiveIndex(e=[]){return e.reduce((t,a,n)=>metaReportParseAmount(a.spend)>0?n:t,-1)}function resolveMetaReportScenarioMonthWindowLimit(e=metaReportsState.scenarioMonthWindow){const t=normalizeMetaReportScenarioMonthWindow(e);return t==="all"?1/0:Number.parseInt(t,10)||6}function resolveMetaReportScenarioChartSeries(e){const t=metaReportMonthKeyFromDate(new Date),a=e.filter(r=>!(metaReportParseAmount(r.spend)<=0||t&&r.monthKey&&r.monthKey>t)),n=resolveMetaReportScenarioMonthWindowLimit();return trimMetaReportScenarioSeries(a,n===1/0?META_REPORT_SCENARIO_MAX_HISTORICAL:n)}function resolveMetaReportScenarioBaselineHints(e=[],t=null,a=null){const n=a||metaReportsState.clientPayload||null,o=metaReportsState.chartSeries?.length?metaReportsState.chartSeries:e,r=getMetaReportScenarioPillsFromState(),s=payloadHasMetaReportBottomline(n),i=t?.prepared||metaReportPrepareScenarioSeries(o,{windowMonths:metaReportsState.scenarioMonthWindow,smoothOutliers:r.smoothUneven,hasBottomline:s}),l=resolveMetaReportScenarioActiveMonthKey(n),c=metaReportMonthKeyFromDate(new Date),d=getMetaReportCalendarYear(n)||n?.year||metaReportsState.selectedYear||(l?Number(String(l).slice(0,4)):null),u={activeMonthKey:l,asOfDate:new Date,payload:n},p=metaReportPrepareBaselineSpendWindow(o,{windowMonths:metaReportsState.scenarioMonthWindow,asOfDate:new Date}),f=resolveMetaReportLastMonthBaseline(o,u),h=resolveMetaReportWindowAverageBaselineSpend(p),b=resolveMetaReportScenarioBaselineSpend(o,i,{baselineMode:"last",...u}),y=resolveMetaReportScenarioBaselineSpend(o,i,{baselineMode:"month",...u}),m=!!(c&&d&&String(c).startsWith(`${d}-`));return{windowAverage:h,windowMonthCount:p.length||i.monthsUsed||i.months.length||0,selectedMonthSpend:y,selectedMonthLabel:l?metaMonthLabel(l):"",activeKey:l,currentMonthSpend:m?metaReportSpendFromMonthKey(o,n,c):0,currentMonthLabel:m?metaMonthLabel(c):"",currentKey:m?c:null,lastMonthSpend:b,lastMonthLabel:f?.label||"",lastMonthKey:f?.monthKey||null}}function renderMetaReportBaselineSelectOptions(e=null,t="year"){const a=e?.windowAverage>0?metaReportFmtBaselineAmount(e.windowAverage):"\u2014",n=e?.lastMonthSpend>0?metaReportFmtBaselineAmount(e.lastMonthSpend):"\u2014",o=e?.selectedMonthSpend>0?metaReportFmtBaselineAmount(e.selectedMonthSpend):"\u2014",r=normalizeMetaReportBudgetBaseline(t),s=e?.lastMonthLabel?`Last month \xB7 ${e.lastMonthLabel}`:"Last month";return`
    <option value="year"${r==="year"?" selected":""}>Window average \xB7 ${esc(a)}</option>
    <option value="last"${r==="last"?" selected":""}>${esc(s)} \xB7 ${esc(n)}</option>
    <option value="month"${r==="month"?" selected":""}>Selected month \xB7 ${esc(o)}</option>
  `}function syncMetaReportBaselineUi(e=[],t=null,a=null){const n=resolveMetaReportScenarioBaselineHints(e,t,a),o=document.getElementById("meta-report-budget-baseline");if(o){const r=o.value||metaReportsState.budgetBaseline;o.innerHTML=renderMetaReportBaselineSelectOptions(n,r),o.value=normalizeMetaReportBudgetBaseline(r)}}function renderMetaReportScenarioInsufficientMessage(e){const t=e?.prepared?.monthsAvailable??0,a=e?.prepared?.monthsUsed??0,n=metaReportParseAmount(e?.baselineSpend),o=e?.insufficientReason||"";return o==="need_baseline_spend"||a>=META_SCENARIO_MIN_EFFICIENCY_MONTHS&&n<=0?"Could not resolve baseline spend for the selected baseline mode. Try Window average or choose a month with ad spend.":t>0&&t<META_SCENARIO_MIN_EFFICIENCY_MONTHS?`Only ${t} month${t===1?"":"s"} in the history window has ad spend, leads, won leads, and average lead value (need at least ${META_SCENARIO_MIN_EFFICIENCY_MONTHS}).`:a>=META_SCENARIO_MIN_EFFICIENCY_MONTHS&&o==="need_efficiency"?"Could not estimate efficiency from the selected history window. Check that won leads and average lead value are filled in for those months.":"Add at least two months with ad spend, leads, won leads, and average lead value in the selected history window to model a budget scenario."}function renderMetaReportScenarioContextStrip(e){if(!e||e.insufficientData)return`<p class="meta-report-scenario-context" id="meta-report-scenario-context">${esc(renderMetaReportScenarioInsufficientMessage(e))}</p>`;const t=describeActiveMetaReportScenarioPills(),a=t.length?t.join(" \xB7 "):"Recent months only",n=e.trendDirection==="up"?`trend up ${Math.abs(e.trendRatePct||0).toFixed(1)}%/mo`:e.trendDirection==="down"?`trend down ${Math.abs(e.trendRatePct||0).toFixed(1)}%/mo`:"trend flat",o=e.prepared?.outliersAdjusted?` \xB7 ${e.prepared.outliersAdjusted} uneven month${e.prepared.outliersAdjusted===1?"":"s"} removed`:"",s={low:"Low confidence",medium:"Medium confidence",high:"High confidence"}[e.prepared?.confidence]||"",i=s?` \xB7 ${s} (${e.prepared?.monthsUsed||0} mo data)`:"";return`<p class="meta-report-scenario-context" id="meta-report-scenario-context"><strong>Active:</strong> ${esc(a)} \xB7 last ${e.prepared?.monthsUsed||0} ad months \xB7 ${esc(n)}${esc(o)}${esc(i)}</p>`}function payloadHasMetaReportBottomline(e){return e?.settings?.metaReportShowBottomline===!1?!1:seriesHasBottomline(metaReportsState.chartSeries||buildMetaReportChartSeries(e))}function seriesHasBottomline(e=[]){return e.some(t=>t.poasKr!=null&&t.poasX!=null)}function renderMetaReportChartsPanel({editable:e=!1}={}){const t=metaReportsState.chartTab||"trend";return`
  ...
  `}function applyMetaReportComparisonMonthChange(e,t,a,{editable:n=!1}={}){if(!a||!/^\d{4}-\d{2}$/.test(a))return;const o=t==="b"?"comparisonPeriodB":"comparisonPeriodA";metaReportsState[o]=metaReportComparisonFullMonthDates(a),metaReportsState.comparisonMode="months",document.querySelectorAll("[data-comparison-preset]").forEach(r=>{const s=r.getAttribute("data-comparison-preset")==="months";r.classList.toggle("active",s),r.setAttribute("aria-pressed",s)}),refreshMetaReportComparison(e,{editable:n})}function positionMetaReportComparisonMonthMenu(e,t,a){const n=e.getBoundingClientRect(),r=(a?.getAttribute("data-comparison-month-part")||"month")==="year"?120:176;t.style.left=`${n.left+n.width/2}px`,t.style.top=`${n.bottom+6}px`,t.style.width=`${Math.max(r,n.width+28)}px`,t.style.minWidth=`${r}px`}function openMetaReportComparisonMonthMenu(e,t,a){closeMetaReportComparisonMonthMenus(t),t.parentElement!==document.body&&(t._metaComparisonOwner=a,document.body.appendChild(t)),t.hidden=!1,a.classList.add("is-open"),e.setAttribute("aria-expanded","true"),positionMetaReportComparisonMonthMenu(e,t,a)}function closeMetaReportComparisonMonthMenus(e=null){document.querySelectorAll(".meta-report-comparison-month-menu").forEach(t=>{if(t===e)return;t.hidden=!0;const a=t._metaComparisonOwner||t.closest(".meta-report-comparison-month-dropdown"),n=a?.querySelector(".meta-report-comparison-month-trigger");a?.classList.remove("is-open"),n?.setAttribute("aria-expanded","false"),t._metaComparisonOwner&&t.parentElement===document.body&&t._metaComparisonOwner.appendChild(t)})}function bindMetaReportComparisonMonthInputs(e,{editable:t=!1}={}){document.querySelectorAll("[data-comparison-month-side]").forEach(a=>{const n=a.getAttribute("data-comparison-month-side");if(!n)return;const o=a.querySelector('[data-comparison-month-part="month"]'),r=a.querySelector('[data-comparison-month-part="year"]'),s=()=>{const l=o?.getAttribute("data-selected-value")||"",c=r?.getAttribute("data-selected-value")||"";!l||!c||applyMetaReportComparisonMonthChange(e,n,`${c}-${l}`,{editable:t})};a.querySelectorAll(".meta-report-comparison-month-dropdown").forEach(l=>{const c=l.querySelector(".meta-report-comparison-month-trigger"),d=l.querySelector(".meta-report-comparison-month-menu");!c||!d||(c.onclick=u=>{if(u.preventDefault(),u.stopPropagation(),!d.hidden){closeMetaReportComparisonMonthMenus();return}openMetaReportComparisonMonthMenu(c,d,l)},l.querySelectorAll(".meta-report-comparison-month-option").forEach(u=>{u.onclick=p=>{p.preventDefault(),p.stopPropagation();const f=u.getAttribute("data-value")||"";l.setAttribute("data-selected-value",f);const h=c.querySelector(".meta-report-comparison-month-trigger-value");h&&(h.textContent=u.textContent||f),l.querySelectorAll(".meta-report-comparison-month-option").forEach(b=>{const y=b===u;b.classList.toggle("is-selected",y),b.setAttribute("aria-selected",String(y))}),closeMetaReportComparisonMonthMenus(),s()}}))});const i=a.closest(".meta-report-comparison-duel-side");i&&(i.onclick=l=>{if(l.target.closest(".meta-report-comparison-month-dropdown"))return;const c=a.getBoundingClientRect();(l.clientX<c.left+c.width/2?o:r)?.querySelector(".meta-report-comparison-month-trigger")?.click()})}),metaReportsState.comparisonMonthMenuListenerBound||(document.addEventListener("click",a=>{a.target.closest(".meta-report-comparison-month-menu")||a.target.closest(".meta-report-comparison-month-trigger")||closeMetaReportComparisonMonthMenus()}),window.addEventListener("resize",()=>closeMetaReportComparisonMonthMenus()),window.addEventListener("scroll",a=>{const n=a.target;n instanceof Element&&n.closest(".meta-report-comparison-month-menu")||closeMetaReportComparisonMonthMenus()},!0),metaReportsState.comparisonMonthMenuListenerBound=!0)}function renderMetaReportComparisonMonthPickersPanel(e,t,a){const n=metaReportComparisonMonthInputBounds(a),o=e?.startMonthKey||metaReportsState.activeMonthKey||n.min?.slice(0,7)||"",r=t?.startMonthKey||metaReportComparisonAddMonths(o,-1)||n.min?.slice(0,7)||"";return`
    <div class="meta-report-comparison-duel is-month-pickers" id="meta-report-comparison-range-panel" role="group" aria-label="Compare months">
      ...
      ${renderMetaReportComparisonMonthPickerSide("b",r,a)}
    </div>
  `}function metaReportComparisonMonthKeyFromDate(e){const t=metaReportComparisonParseDate(e);return t?t.slice(0,7):""}const metaReportComparisonDatePickerState={inputKey:null,side:null,bound:null,anchorEl:null,viewYear:null,viewMonth:null,payload:null,editable:!1};function getMetaReportComparisonDatePickerFieldBounds(e,t,a){const n=metaReportComparisonDateInputBounds(e),r=metaReportsState[t==="b"?"comparisonPeriodB":"comparisonPeriodA"]||{};let s=n.min||void 0,i=n.max||void 0;return a==="start"&&r.endDate&&(i=r.endDate),a==="end"&&r.startDate&&(s=r.startDate),metaReportComparisonSafePickerBounds(s,i)}function renderMetaReportComparisonDateInput(e,t,a,n,o=null){const r=`${e}-${t}`,s=t==="start"?"From date":"To date",i=a?metaReportComparisonFormatDateLabel(a):"Select date";return`
    <button type="button" class="meta-report-comparison-date-trigger${a?" has-value":" is-empty"}" data-comparison-date-trigger="${esc(r)}" aria-label="${esc(s)}" aria-haspopup="dialog">
      <span class="meta-report-comparison-date-trigger-value">${esc(i)}</span>
    </button>
    <input type="hidden" data-comparison-date="${esc(r)}" value="${esc(a||"")}" />
  ...
  `}function parseComparisonDateKey(e){const t=String(e||"").match(/^([ab])-(start|end)$/);return t?{side:t[1],bound:t[2],stateKey:t[1]==="b"?"comparisonPeriodB":"comparisonPeriodA"}:null}function metaReportComparisonSafePickerBounds(e,t){const a=e||void 0,n=t||void 0;return a&&n&&a>n?{min:n,max:a}:{min:a,max:n}}function syncMetaReportComparisonDateDisplays(){document.querySelectorAll("[data-comparison-date]").forEach(e=>{const t=e.getAttribute("data-comparison-date"),a=document.querySelector(`[data-comparison-date-trigger="${t}"]`);if(!t||!a)return;const n=e.value||"",o=a.querySelector(".meta-report-comparison-date-trigger-value");o&&(o.textContent=n?metaReportComparisonFormatDateLabel(n):"Select date"),a.classList.toggle("has-value",!!n),a.classList.toggle("is-empty",!n)})}function applyMetaReportComparisonDateChange(e,t,a,{editable:n=!1}={}){const o=parseComparisonDateKey(t);if(!o||!a)return;const{side:r,bound:s,stateKey:i}=o;metaReportsState[i]||(metaReportsState[i]={startDate:null,endDate:null});const l=metaReportsState[i];l[`${s}Date`]=a,l.startDate&&l.endDate&&l.startDate>l.endDate&&(s==="end"?l.startDate=l.endDate:l.endDate=l.startDate);const c=document.querySelector(`[data-comparison-date="${r}-start"]`),d=document.querySelector(`[data-comparison-date="${r}-end"]`);c&&(c.value=l.startDate||""),d&&(d.value=l.endDate||""),syncMetaReportComparisonDateDisplays(),metaReportsState.comparisonMode="custom",document.querySelectorAll("[data-comparison-preset]").forEach(u=>{const p=u.getAttribute("data-comparison-preset")==="custom";u.classList.toggle("active",p),u.setAttribute("aria-pressed",p)}),refreshMetaReportComparison(e,{editable:n})}function ensureMetaReportComparisonDatePickerPopover(){if(document.getElementById("meta-report-comparison-date-popover"))return;const e=document.createElement("div");e.id="meta-report-comparison-date-backdrop",e.className="meta-report-comparison-date-backdrop",e.hidden=!0,e.addEventListener("click",closeMetaReportComparisonDatePicker),document.body.appendChild(e);const t=document.createElement("div");t.id="meta-report-comparison-date-popover",t.className="meta-report-comparison-date-popover",t.hidden=!0,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),document.body.appendChild(t)}function isMetaReportComparisonDatePickerDayDisabled(e,t,a,n){const{min:o,max:r}=getMetaReportComparisonDatePickerFieldBounds(t,a,n);return!!(o&&e<o||r&&e>r)}function metaReportComparisonDatePickerCanShiftMonth(e){const{viewYear:t,viewMonth:a,payload:n,side:o,bound:r}=metaReportComparisonDatePickerState;if(!t||!a||!n||!o||!r)return!1;let s=a+e,i=t;s<1&&(s=12,i-=1),s>12&&(s=1,i+=1);const l=`${i}-${String(s).padStart(2,"0")}`,{min:c,max:d}=getMetaReportComparisonDatePickerFieldBounds(n,o,r),u=c?c.slice(0,7):null,p=d?d.slice(0,7):null;return!(u&&l<u||p&&l>p)}function renderMetaReportComparisonDatePickerDayCell(e,t,a,n,o,r,s,i,l,c){const d=["date-picker-day"];if(a&&d.push("is-outside"),e===n&&d.push("is-today"),e===o&&d.push("is-selected"),r&&s){const u=r<=s?r:s,p=r<=s?s:r;e>=u&&e<=p&&d.push("is-in-range"),e===r&&d.push("is-range-start"),e===s&&d.push("is-range-end")}return isMetaReportComparisonDatePickerDayDisabled(e,i,l,c)?(d.push("is-disabled"),`<button type="button" class="${d.join(" ")}" disabled aria-disabled="true">${t}</button>`):`<button type="button" class="${d.join(" ")}" onclick="selectMetaReportComparisonDatePickerDay('${e}')">${t}</button>`}function renderMetaReportComparisonDatePickerPopover(){const e=document.getElementById("meta-report-comparison-date-popover"),{viewYear:t,viewMonth:a,inputKey:n,payload:o,side:r,bound:s}=metaReportComparisonDatePickerState;if(!e||!n||!t||!a||!o||!r||!s)return;const i=new Intl.DateTimeFormat("en-GB",{month:"long",year:"numeric"}).format(new Date(t,a-1,1)),l=["Mo","Tu","We","Th","Fr","Sa","Su"],d=(new Date(t,a-1,1).getDay()+6)%7,u=new Date(t,a,0).getDate(),p=new Date(t,a-1,0).getDate(),f=isoFromParts(new Date().getFullYear(),new Date().getMonth()+1,new Date().getDate()),b=document.querySelector(`[data-comparison-date="${n}"]`)?.value||"",m=metaReportsState[r==="b"?"comparisonPeriodB":"comparisonPeriodA"]||{},g=m.startDate||"",v=m.endDate||"",{min:w,max:$}=getMetaReportComparisonDatePickerFieldBounds(o,r,s);let S="";for(let I=d-1;I>=0;I-=1){const k=p-I,A=a===1?12:a-1,P=a===1?t-1:t,M=isoFromParts(P,A,k);S+=renderMetaReportComparisonDatePickerDayCell(M,k,!0,f,b,g,v,o,r,s)}for(let I=1;I<=u;I+=1){const k=isoFromParts(t,a,I);S+=renderMetaReportComparisonDatePickerDayCell(k,I,!1,f,b,g,v,o,r,s)}const C=(7-(d+u)%7)%7;for(let I=1;I<=C;I+=1){const k=a===12?1:a+1,A=a===12?t+1:t,P=isoFromParts(A,k,I);S+=renderMetaReportComparisonDatePickerDayCell(P,I,!0,f,b,g,v,o,r,s)}const E=s==="start"&&$?`<span class="date-picker-hint">Through ${esc(metaReportComparisonFormatDateLabel($))}</span>`:s==="end"&&w?`<span class="date-picker-hint">From ${esc(metaReportComparisonFormatDateLabel(w))}</span>`:"";e.innerHTML=`
  ...
  `}function renderMetaReportComparisonView(){const e=metaReportsState.clientPayload||metaReportsState.publicPayload,t=metaReportsState.comparisonResult||computeMetaReportComparison(e),{periodA:a,periodB:n}=metaReportComparisonPeriodsFromState(e),o=metaReportsState.comparisonTab||"table",r=metaReportsState.comparisonLoading;return`
  ...
  `}function metaReportFormatDeltaPct(e){return e==null||!Number.isFinite(e)?"":`${e>0?"+":""}${e.toFixed(0)}%`}function metaReportScenarioDeltaTone(e=""){return String(e).startsWith("+")?"positive":String(e).startsWith("-")?"negative":"neutral"}function renderMetaReportScenarioOutcomeCard({label:e,projectedValue:t,projectedSub:a="",baselineValue:n="",delta:o=""}={}){const r=metaReportScenarioDeltaTone(o);return`
  ...
  `}function destroyMetaReportTrendCharts(){["roas","poas"].forEach(e=>{metaReportsState.chartInstances[e]&&(metaReportsState.chartInstances[e].destroy(),metaReportsState.chartInstances[e]=null),metaReportsState.chartScatterInstances[e]&&(metaReportsState.chartScatterInstances[e].destroy(),metaReportsState.chartScatterInstances[e]=null)})}function destroyMetaReportCharts(){destroyMetaReportTrendCharts(),destroyMetaReportScenarioCharts(),destroyMetaReportComparisonChart()}function destroyMetaReportScenarioCharts(){["roas","poas"].forEach(e=>{metaReportsState.scenarioChartInstances[e]&&(metaReportsState.scenarioChartInstances[e].destroy(),metaReportsState.scenarioChartInstances[e]=null)})}function metaReportChartValue(e,t,a,n){if(e?.hasData===!1)return null;const o=t==="x"?e[n]:e[a];if(o==null)return null;const r=Number(o);return Number.isFinite(r)?r:null}function metaReportChartTooltipLabel(e,t){return t==="x"?metaFmtX(e):metaFmtKr(e)}function metaReportChartAxisTick(e,t){if(t==="x")return`${Number(e).toFixed(1)}x`;const a=Number(e)||0;return Math.abs(a)>=1e6?`${(a/1e6).toFixed(1)}M`:Math.abs(a)>=1e3?`${Math.round(a/1e3)}K`:a}function buildMetaReportLineChart(e,t,a,n,o){const r=t.map(i=>i.label),s=t.map(i=>metaReportChartValue(i,a,n,o));return new Chart(e,{type:"line",data:{labels:r,datasets:[{label:a==="x"?"Multiplier":"Dkr",data:s,borderColor:"#ff6a00",backgroundColor:"rgba(255, 106, 0, 0.12)",borderWidth:2.5,pointBackgroundColor:"#ff6a00",pointBorderColor:"#ffffff",pointBorderWidth:2,pointRadius:4,pointHoverRadius:5,fill:!0,tension:.3,spanGaps:!1}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,callbacks:{label(i){return i.parsed.y==null?"No data":metaReportChartTooltipLabel(i.parsed.y,a)}}}},scales:{x:{grid:{color:"rgba(26, 18, 8, 0.06)"},ticks:{color:"#6b5348",font:{size:11}}},y:{grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:"#6b5348",font:{size:11},callback:i=>metaReportChartAxisTick(i,a)}}}}})}function buildMetaReportDualMetricChart(e,{series:t,mode:a,krKey:n,xKey:o,returnLabel:r,chartType:s="area",projection:i=null,projectionLabel:l="Projected",showProjection:c=!1,baselineSpend:d=null}={}){const u=t.filter(k=>metaReportParseAmount(k.spend)>0),p=u.map(k=>k.label),f=metaReportParseAmount(d??i?.baselineSpend??0)||resolveMetaReportSpendChartBaseline(u,i),h=a==="x"&&f>0,b=u.map(k=>h?metaReportSpendMultiplierValue(k.spend,f):metaReportParseAmount(k.spend)),y=u.map(k=>metaReportChartValue(k,a,n,o)),m=normalizeMetaReportSpendChartType(s),g=a==="x",v=u.length-1;c&&i&&!i.insufficientData&&(p.push(l||`Projected (${Number(i.multiplier).toFixed(1)}\xD7)`),b.push(metaReportParseAmount(h?i.multiplier:i.projected.spend)),y.push(metaReportParseAmount(i.projected[a==="x"?o:n])));const w=p.length-1,$=c&&i&&!i.insufficientData&&w>v;function S(k,A){const P=$&&k===w;return{pointBackgroundColor:A,pointBorderColor:"#ffffff",pointBorderWidth:2,pointRadius:P?7:m==="scatter"?5:4,pointHoverRadius:P?8:m==="scatter"?6:5,pointStyle:P?"rectRot":"circle"}}function C(k,A,P,M,T){const L=A.map((R,N)=>S(N,P)),D={label:k,data:A,borderColor:P,yAxisID:T};return m==="bar"?{...D,type:"bar",backgroundColor:P==="#138b53"?"rgba(19, 139, 83, 0.72)":"rgba(255, 106, 0, 0.72)",borderRadius:4,borderWidth:0}:m==="scatter"?{...D,type:"line",backgroundColor:"transparent",borderWidth:0,showLine:!1,fill:!1,pointBackgroundColor:L.map(R=>R.pointBackgroundColor),pointBorderColor:L.map(R=>R.pointBorderColor),pointBorderWidth:L.map(R=>R.pointBorderWidth),pointRadius:L.map(R=>R.pointRadius),pointHoverRadius:L.map(R=>R.pointHoverRadius),pointStyle:L.map(R=>R.pointStyle)}:{...D,type:"line",backgroundColor:M,borderWidth:2.5,fill:m==="area",tension:.3,pointBackgroundColor:L.map(R=>R.pointBackgroundColor),pointBorderColor:L.map(R=>R.pointBorderColor),pointBorderWidth:L.map(R=>R.pointBorderWidth),pointRadius:L.map(R=>R.pointRadius),pointHoverRadius:L.map(R=>R.pointHoverRadius),pointStyle:L.map(R=>R.pointStyle)}}const E=[C("Ad spend",b,"#138b53","rgba(19, 139, 83, 0.16)","ySpend"),C(r,y,"#ff6a00","rgba(255, 106, 0, 0.12)",g?"yReturn":"ySpend")];if($&&m!=="bar"){const k={type:"line",borderWidth:2,fill:!1,tension:0,pointRadius:0,pointHoverRadius:0,spanGaps:!0};E.push({...k,label:"",data:p.map((A,P)=>P===v||P===w?b[P]:null),borderColor:"rgba(19, 139, 83, 0.55)",borderDash:[5,4],yAxisID:"ySpend"}),E.push({...k,label:"",data:p.map((A,P)=>P===v||P===w?y[P]:null),borderColor:"rgba(255, 106, 0, 0.55)",borderDash:[5,4],yAxisID:g?"yReturn":"ySpend"})}const I={x:{grid:{color:"rgba(26, 18, 8, 0.06)"},ticks:{color:"#6b5348",font:{size:11},maxRotation:45,minRotation:0}},ySpend:{type:"linear",position:"left",title:{display:!0,text:h?"Ad spend (\xD7)":g?"Ad spend (Dkr)":"Dkr",color:g?"#138b53":"#6b5348",font:{size:11,weight:"600"}},grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:g?"#138b53":"#6b5348",font:{size:11},callback:k=>h?metaReportChartAxisTick(k,"x"):metaReportSpendAxisTick(k)}}};return g&&(I.yReturn={type:"linear",position:"right",title:{display:!0,text:"Multiplier",color:"#ff6a00",font:{size:11,weight:"600"}},grid:{drawOnChartArea:!1},ticks:{color:"#ff6a00",font:{size:11},callback:k=>metaReportChartAxisTick(k,"x")}}),new Chart(e,{type:m==="bar"?"bar":"line",data:{labels:p,datasets:E},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!0,position:"top",align:"end",labels:{boxWidth:10,boxHeight:10,font:{size:11,weight:"600"},color:"#6b5348",filter(k){return!!k.text}}},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,filter(k){return!!k.dataset.label},callbacks:{label(k){const A=k.dataset.label||"";return k.dataset.yAxisID==="yReturn"?`${A}: ${metaReportChartTooltipLabel(k.parsed.y,"x")}`:h&&k.dataset.yAxisID==="ySpend"?`${A}: ${metaReportChartTooltipLabel(k.parsed.y,"x")}`:k.datasetIndex===1&&!g?`${A}: ${metaReportChartTooltipLabel(k.parsed.y,a)}`:`${A}: ${metaFmtKr(k.parsed.y)}`}}}},scales:I}})}function buildMetaReportScenarioExtrapolationChart(e,{series:t,mode:a,kind:n,projection:o,chartType:r="area",hasBottomline:s=!1}={}){const i=n==="roas"?"roasKr":"poasKr",l=n==="roas"?"roasX":"poasX",c=n==="roas"?"ROAS":"POAS",d=resolveMetaReportScenarioActiveTimeline(t),u=resolveMetaReportScenarioAdActiveSeries(d,n),p=resolveMetaReportScenarioChartSeries(u),f=resolveMetaReportSpendChartBaseline(p,o),h=a==="x"&&f>0,b=buildMetaReportScenarioProjectionSteps(o,{hasBottomline:s,targetMultiplier:metaReportsState.budgetMultiplier}),y=normalizeMetaReportSpendChartType(r),m=d.map(M=>M.label),g=d.map(M=>metaReportParseAmount(M.spend)<=0?null:h?metaReportSpendMultiplierValue(M.spend,f):metaReportParseAmount(M.spend)),v=d.map(M=>metaReportParseAmount(M.spend)<=0?null:metaReportChartValue(M,a,i,l)),w=resolveMetaReportScenarioLastAdActiveIndex(d),$=m.length;for(const M of b)m.push(M.label),g.push(h?metaReportSpendMultiplierValue(M.spend,f):M.spend),v.push(metaReportParseAmount(M[a==="x"?l:i]));const S=new Set(b.map((M,T)=>$+T)),C=b.length>0;function E(M,T){const L=S.has(M);return{pointBackgroundColor:T,pointBorderColor:"#ffffff",pointBorderWidth:2,pointRadius:L?7:y==="scatter"?5:4,pointHoverRadius:L?8:y==="scatter"?6:5,pointStyle:L?"rectRot":"circle"}}function I(M,T,L,D){const R=T.map((B,O)=>E(O,L)),N={label:M,data:T,borderColor:L,yAxisID:"y"};return y==="bar"?{...N,type:"bar",backgroundColor:L==="#138b53"?"rgba(19, 139, 83, 0.72)":"rgba(255, 106, 0, 0.72)",borderRadius:4,borderWidth:0}:y==="scatter"?{...N,type:"line",backgroundColor:"transparent",borderWidth:0,showLine:!1,fill:!1,pointBackgroundColor:R.map(B=>B.pointBackgroundColor),pointBorderColor:R.map(B=>B.pointBorderColor),pointBorderWidth:R.map(B=>B.pointBorderWidth),pointRadius:R.map(B=>B.pointRadius),pointHoverRadius:R.map(B=>B.pointHoverRadius),pointStyle:R.map(B=>B.pointStyle)}:{...N,type:"line",backgroundColor:D,borderWidth:2.5,fill:y==="area",tension:.3,pointBackgroundColor:R.map(B=>B.pointBackgroundColor),pointBorderColor:R.map(B=>B.pointBorderColor),pointBorderWidth:R.map(B=>B.pointBorderWidth),pointRadius:R.map(B=>B.pointRadius),pointHoverRadius:R.map(B=>B.pointHoverRadius),pointStyle:R.map(B=>B.pointStyle)}}const k=[I("Ad spend",g,"#138b53","rgba(19, 139, 83, 0.16)"),I(c,v,"#ff6a00","rgba(255, 106, 0, 0.12)")];if(C&&y!=="bar"){const M={type:"line",borderWidth:2,fill:!1,tension:0,pointRadius:0,pointHoverRadius:0,spanGaps:!0,yAxisID:"y"},T=L=>m.map((D,R)=>R===w||S.has(R)?L[R]:null);k.push({...M,label:"",data:T(g),borderColor:"rgba(19, 139, 83, 0.55)",borderDash:[5,4]}),k.push({...M,label:"",data:T(v),borderColor:"rgba(255, 106, 0, 0.55)",borderDash:[5,4]})}const A=h?"Multiplier (\xD7)":"Dkr",P=M=>h?metaReportChartAxisTick(M,"x"):metaReportChartAxisTick(M,"kr");return new Chart(e,{type:y==="bar"?"bar":"line",data:{labels:m,datasets:k},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!0,position:"top",align:"end",labels:{boxWidth:10,boxHeight:10,font:{size:11,weight:"600"},color:"#6b5348",filter(M){return!!M.text}}},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,filter(M){return!!M.dataset.label},callbacks:{label(M){return`${M.dataset.label||""}: ${metaReportChartTooltipLabel(M.parsed.y,a)}`}}}},scales:{x:{grid:{color:"rgba(26, 18, 8, 0.06)"},ticks:{color:"#6b5348",font:{size:11},maxRotation:45,minRotation:0}},y:{type:"linear",position:"left",title:{display:!0,text:A,color:"#6b5348",font:{size:11,weight:"600"}},grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:"#6b5348",font:{size:11},callback:P}}}}})}function updateMetaReportChart(e,t,a){const n=document.getElementById(`meta-report-chart-${e}`),o=document.getElementById(`meta-report-chart-${e}-empty`);if(!n||!o)return;const r=e==="roas"?"roasKr":"poasKr",s=e==="roas"?"roasX":"poasX",i=t,l=i.filter(c=>metaReportChartValue(c,a,r,s)!=null);if(metaReportsState.chartInstances[e]&&(metaReportsState.chartInstances[e].destroy(),metaReportsState.chartInstances[e]=null),l.length<META_REPORT_CHART_MIN_POINTS||typeof Chart>"u"){n.hidden=!0,o.hidden=!1;return}n.hidden=!1,o.hidden=!0,metaReportsState.chartInstances[e]=buildMetaReportLineChart(n,i,a,r,s)}function updateMetaReportSpendReturnChart(e,t,a,{projection:n=null,showProjection:o=!1,projectionLabel:r="Projected",chartType:s=metaReportsState.spendChartType,target:i="spend"}={}){const l=i==="scenario"?`meta-report-scenario-chart-${e}`:`meta-report-chart-scatter-${e}`,c=i==="scenario"?`meta-report-scenario-chart-${e}-empty`:`meta-report-chart-scatter-${e}-empty`,d=document.getElementById(l),u=document.getElementById(c);if(!d||!u)return;const p=e==="roas"?"roasKr":"poasKr",f=e==="roas"?"roasX":"poasX",h=e==="poas"?t.filter(m=>m.poasKr!=null&&m.poasX!=null):t.filter(m=>metaReportParseAmount(m.spend)>0),b=i==="scenario"?"scenarioChartInstances":"chartScatterInstances";if(metaReportsState[b][e]&&(metaReportsState[b][e].destroy(),metaReportsState[b][e]=null),h.length<META_REPORT_CHART_MIN_POINTS||typeof Chart>"u"){d.hidden=!0,u.hidden=!1;return}if(o&&n?.insufficientData){d.hidden=!0,u.hidden=!1;return}d.hidden=!1,u.hidden=!0;const y=a==="x"?resolveMetaReportSpendChartBaseline(h,n):null;metaReportsState[b][e]=buildMetaReportDualMetricChart(d,{series:h,mode:a,krKey:p,xKey:f,returnLabel:e==="roas"?"ROAS":"POAS",chartType:s,projection:n,projectionLabel:r,showProjection:o,baselineSpend:y})}function updateMetaReportScatterChart(e,t,a){updateMetaReportSpendReturnChart(e,t,a,{showProjection:!1,chartType:metaReportsState.spendChartType,target:"spend"})}function updateMetaReportScenarioChart(e,t,a,n,o=null){const r=document.getElementById(`meta-report-scenario-chart-${e}`),s=document.getElementById(`meta-report-scenario-chart-${e}-empty`);if(!r||!s)return;const i=o||metaReportsState.clientPayload||metaReportsState.publicPayload,l=resolveMetaReportScenarioDisplayTimeline(i,t),c=resolveMetaReportScenarioAdActiveSeries(l,e),d=resolveMetaReportScenarioChartSeries(c);if(metaReportsState.scenarioChartInstances[e]&&(metaReportsState.scenarioChartInstances[e].destroy(),metaReportsState.scenarioChartInstances[e]=null),d.length<META_REPORT_CHART_MIN_POINTS||typeof Chart>"u"){r.hidden=!0,s.hidden=!1;return}r.hidden=!1,s.hidden=!0;const u=a?.insufficientData?null:a;metaReportsState.scenarioChartInstances[e]=buildMetaReportScenarioExtrapolationChart(r,{series:l,mode:n,kind:e,projection:u,chartType:metaReportsState.spendChartType,hasBottomline:e==="poas"})}function mountMetaReportScenarioCharts(e){const t=resolveMetaReportScenarioPayload(e),a=e||metaReportsState.clientPayload||metaReportsState.publicPayload,n=resolveMetaReportScenarioDisplayTimeline(a),o=payloadHasMetaReportBottomline(t),r=document.getElementById("meta-report-scenario-poas-wrap");r&&(r.hidden=!o);const s=metaReportsState.chartProjection;updateMetaReportScenarioChart("roas",n,s,metaReportsState.chartScenarioRoasMode,a),o?updateMetaReportScenarioChart("poas",n,s,metaReportsState.chartScenarioPoasMode,a):metaReportsState.scenarioChartInstances.poas&&(metaReportsState.scenarioChartInstances.poas.destroy(),metaReportsState.scenarioChartInstances.poas=null)}function syncMetaReportSpendChartTypeToolbar(e=metaReportsState.chartTab||"trend"){const t=document.getElementById("meta-report-spend-chart-type-wrap");t&&(t.hidden=e!=="spend")}function setMetaReportChartTab(e){metaReportsState.chartTab=e,document.querySelectorAll("[data-meta-chart-tab]").forEach(t=>{const a=t.getAttribute("data-meta-chart-tab")===e;t.classList.toggle("is-active",a),t.setAttribute("aria-selected",a?"true":"false")}),document.querySelectorAll("[data-meta-chart-panel]").forEach(t=>{const a=t.getAttribute("data-meta-chart-panel")===e;t.classList.toggle("is-active",a),t.hidden=!a}),syncMetaReportSpendChartTypeToolbar(e),mountActiveMetaReportCharts()}function mountActiveMetaReportCharts(){const e=metaReportsState.chartSeries||[];metaReportsState.chartTab==="spend"?(updateMetaReportScatterChart("roas",e,metaReportsState.chartScatterRoasMode),updateMetaReportScatterChart("poas",e,metaReportsState.chartScatterPoasMode)):(updateMetaReportChart("roas",e,metaReportsState.chartRoasMode),updateMetaReportChart("poas",e,metaReportsState.chartPoasMode))}function refreshMetaReportSpendAndScenarioCharts(e){mountActiveMetaReportCharts(),document.getElementById("meta-report-scenario-card")&&e?syncMetaReportScenario(e):mountMetaReportScenarioCharts(e)}function setMetaReportSpendChartType(e,{persist:t=!1,clientId:a=null,payload:n=null}={}){const o=normalizeMetaReportSpendChartType(e);metaReportsState.spendChartType=o,document.querySelectorAll("[data-spend-chart-type]").forEach(s=>{s.classList.toggle("is-active",s.getAttribute("data-spend-chart-type")===o)});const r=n||metaReportsState.clientPayload||metaReportsState.publicPayload;return refreshMetaReportSpendAndScenarioCharts(r),t&&a?patchMetaReportSettings(a,{metaReportSpendChartType:o}):Promise.resolve(null)}function bindMetaReportChartTabs(){document.querySelectorAll("[data-meta-chart-tab]").forEach(e=>{e.onclick=()=>{setMetaReportChartTab(e.getAttribute("data-meta-chart-tab"))}})}function bindMetaReportChartToggles(){const e=document.getElementById("meta-chart-roas-mode");e&&e.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const i=s.getAttribute("data-mode");metaReportsState.chartRoasMode=i,e.querySelectorAll("[data-mode]").forEach(l=>{l.classList.toggle("is-active",l.getAttribute("data-mode")===i)}),updateMetaReportChart("roas",metaReportsState.chartSeries||[],i)}});const t=document.getElementById("meta-chart-poas-mode");t&&t.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const i=s.getAttribute("data-mode");metaReportsState.chartPoasMode=i,t.querySelectorAll("[data-mode]").forEach(l=>{l.classList.toggle("is-active",l.getAttribute("data-mode")===i)}),updateMetaReportChart("poas",metaReportsState.chartSeries||[],i)}});const a=document.getElementById("meta-chart-scatter-roas-mode");a&&a.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const i=s.getAttribute("data-mode");metaReportsState.chartScatterRoasMode=i,a.querySelectorAll("[data-mode]").forEach(l=>{l.classList.toggle("is-active",l.getAttribute("data-mode")===i)}),updateMetaReportScatterChart("roas",metaReportsState.chartSeries||[],i)}});const n=document.getElementById("meta-chart-scatter-poas-mode");n&&n.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const i=s.getAttribute("data-mode");metaReportsState.chartScatterPoasMode=i,n.querySelectorAll("[data-mode]").forEach(l=>{l.classList.toggle("is-active",l.getAttribute("data-mode")===i)}),updateMetaReportScatterChart("poas",metaReportsState.chartSeries||[],i)}});const o=document.getElementById("meta-scenario-roas-mode");o&&o.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const i=s.getAttribute("data-mode");metaReportsState.chartScenarioRoasMode=i,o.querySelectorAll("[data-mode]").forEach(l=>{l.classList.toggle("is-active",l.getAttribute("data-mode")===i)}),updateMetaReportScenarioChart("roas",resolveMetaReportScenarioDisplayTimeline(metaReportsState.clientPayload||metaReportsState.publicPayload,metaReportsState.chartSeries||[]),metaReportsState.chartProjection,i)}});const r=document.getElementById("meta-scenario-poas-mode");r&&r.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const i=s.getAttribute("data-mode");metaReportsState.chartScenarioPoasMode=i,r.querySelectorAll("[data-mode]").forEach(l=>{l.classList.toggle("is-active",l.getAttribute("data-mode")===i)}),updateMetaReportScenarioChart("poas",resolveMetaReportScenarioDisplayTimeline(metaReportsState.clientPayload||metaReportsState.publicPayload,metaReportsState.chartSeries||[]),metaReportsState.chartProjection,i)}})}function bindMetaReportSpendChartTypePicker(e,t){document.querySelectorAll("#meta-report-spend-chart-type-wrap [data-spend-chart-type]").forEach(a=>{a.onclick=async()=>{const n=a.getAttribute("data-spend-chart-type");if(!(!n||n===metaReportsState.spendChartType)&&(setMetaReportSpendChartType(n,{payload:t}),!!e))try{const o={metaReportSpendChartType:normalizeMetaReportSpendChartType(n)},r=t?.reportKind==="google-ads"?await patchGoogleAdsReportSettings(e,o):await patchMetaReportSettings(e,o);if(r?.settings&&t){const s=t.reportKind==="google-ads"?googleAdsSettingsToMetaUx(r.settings):r.settings;t.settings={...t.settings,...s},metaReportsState.clientPayload?.clientId===t.clientId&&(metaReportsState.clientPayload.settings=t.settings)}}catch(o){showToast(o.message||"Could not save chart type default","error")}}})}function syncMetaReportChartToggleUi(){[["roas",metaReportsState.chartRoasMode,"meta-chart-roas-mode"],["poas",metaReportsState.chartPoasMode,"meta-chart-poas-mode"],["scatter-roas",metaReportsState.chartScatterRoasMode,"meta-chart-scatter-roas-mode"],["scatter-poas",metaReportsState.chartScatterPoasMode,"meta-chart-scatter-poas-mode"],["scenario-roas",metaReportsState.chartScenarioRoasMode,"meta-scenario-roas-mode"],["scenario-poas",metaReportsState.chartScenarioPoasMode,"meta-scenario-poas-mode"]].forEach(([,e,t])=>{const a=document.getElementById(t);a&&a.querySelectorAll("[data-mode]").forEach(n=>{n.classList.toggle("is-active",n.getAttribute("data-mode")===e)})})}function scheduleMetaReportScenarioSettingsPersist(e,t="meta"){e&&(clearTimeout(metaReportsState._scenarioSettingsTimer),metaReportsState._scenarioSettingsTimer=setTimeout(()=>{const a={metaReportBudgetMultiplier:metaReportsState.budgetMultiplier,metaReportBudgetBaseline:metaReportsState.budgetBaseline,metaReportScenarioMonthWindow:metaReportsState.scenarioMonthWindow,metaReportScenarioSmoothUneven:metaReportsState.scenarioSmoothUneven,metaReportScenarioBlendHistory:metaReportsState.scenarioBlendHistory,metaReportScenarioIncludeTrend:metaReportsState.scenarioIncludeTrend};(t==="google-ads"?patchGoogleAdsReportSettings(e,a,{fast:!0}):patchMetaReportSettings(e,a,{fast:!0})).catch(()=>{})},350))}function syncMetaReportScenarioControlValues(){const e=document.getElementById("meta-report-budget-multiplier"),t=document.getElementById("meta-report-budget-multiplier-value");e&&(e.value=String(metaReportsState.budgetMultiplier)),t&&(t.textContent=`${metaReportsState.budgetMultiplier.toFixed(1)}\xD7`);const a=document.getElementById("meta-report-budget-baseline");a&&(a.value=normalizeMetaReportBudgetBaseline(metaReportsState.budgetBaseline));const n=document.getElementById("meta-report-scenario-month-window");n&&(n.value=normalizeMetaReportScenarioMonthWindow(metaReportsState.scenarioMonthWindow))}function bindMetaReportScenarioControls(e,{editable:t=!1}={}){if(!t)return;const a=e?.clientId||null;syncMetaReportScenarioControlValues();const n=document.getElementById("meta-report-budget-multiplier"),o=document.getElementById("meta-report-budget-multiplier-value"),r=document.getElementById("meta-report-budget-baseline"),s=document.getElementById("meta-report-scenario-month-window"),i=()=>scheduleMetaReportScenarioSettingsPersist(a,e?.reportKind||"meta"),l=()=>syncMetaReportScenario(e);n&&(n.oninput=()=>{metaReportsState.budgetMultiplier=normalizeMetaReportBudgetMultiplier(n.value),o&&(o.textContent=`${metaReportsState.budgetMultiplier.toFixed(1)}\xD7`),l(),i()}),r&&(r.onchange=()=>{metaReportsState.budgetBaseline=normalizeMetaReportBudgetBaseline(r.value),l(),i()}),s&&(s.onchange=()=>{metaReportsState.scenarioMonthWindow=normalizeMetaReportScenarioMonthWindow(s.value),l(),i()});const c=()=>{document.querySelectorAll("[data-scenario-pill]").forEach(d=>{d.onclick=()=>{const u=d.getAttribute("data-scenario-pill");if(!u||d.disabled)return;metaReportsState[u]=!metaReportsState[u],applyMetaReportScenarioPillsToState(getMetaReportScenarioPillsFromState());const p=document.getElementById("meta-report-scenario-pills-wrap");p&&(p.outerHTML=renderMetaReportScenarioModelPills(),c()),l(),i()}})};c()}function syncMetaReportScenario(e){const t=resolveMetaReportScenarioPayload(e),a=resolveMetaReportScenarioSeries(e),n=payloadHasMetaReportBottomline(t),o=filterMetaReportScenarioSeries(a,{hasBottomline:n}),r=buildMetaReportScenarioProjection(a,e);if(metaReportsState.chartProjection=r,syncMetaReportBaselineUi(metaReportsState.chartSeries||a,r,t),!document.getElementById("meta-report-scenario-card"))return;const i=document.getElementById("meta-report-scenario-context-wrap");i&&(i.innerHTML=renderMetaReportScenarioContextStrip(r));const l=document.getElementById("meta-report-scenario-grid");l&&(l.innerHTML=renderMetaReportScenarioMetrics(r)),mountMetaReportScenarioCharts(e)}function mountMetaReportTrendCharts(e,{editable:t=!1,clientId:a=null}={}){const n=document.getElementById("meta-report-charts-panel");if(!e||!n)return;hydrateMetaReportSpendChartType(e),hydrateMetaReportScenarioSettings(e);const{series:o,demo:r}=resolveMetaReportChartSeries(e,{allowDemo:!t});metaReportsState.chartSeries=o,metaReportsState.chartDemo=r,updateMetaReportScenarioSource(e);const s=document.getElementById("meta-report-chart-demo-badge");s&&(s.hidden=!(r&&t)),bindMetaReportChartTabs(),bindMetaReportChartToggles(),t&&(bindMetaReportScenarioControls(e,{editable:!0}),bindMetaReportSpendChartTypePicker(a,e)),syncMetaReportChartToggleUi(),syncMetaReportSpendChartTypeToolbar(metaReportsState.chartTab||"trend"),document.querySelectorAll("[data-spend-chart-type]").forEach(i=>{i.classList.toggle("is-active",i.getAttribute("data-spend-chart-type")===metaReportsState.spendChartType)}),setMetaReportChartTab(metaReportsState.chartTab||"trend"),syncMetaReportScenario(e)}function mountMetaReportCharts(e,{editable:t=!1,clientId:a=null}={}){if(destroyMetaReportCharts(),destroyMetaReportComparisonChart(),!e)return;t||(metaReportsState.reportViewMode="monthly");const n=metaReportsState.reportViewMode||"monthly";if(t&&bindMetaReportViewModeTabs(e,{editable:t}),n==="monthly"||!t){mountMetaReportTrendCharts(e,{editable:t,clientId:a});return}if(mountMetaReportComparison(e,{editable:t}),t){const{series:o}=resolveMetaReportChartSeries(e,{allowDemo:!1});o.length&&(metaReportsState.chartSeries=o),bindMetaReportScenarioControls(e,{editable:!0}),syncMetaReportScenario(e)}}function syncMetaReportMonthPanelDom(e,t={},a=null){const n=a||metaReportsState.clientPayload||metaReportsState.publicPayload,o=metaReportsState.activeMonthKey,r=resolveMetaReportActiveMonthPayload(n)||e,s=document.getElementById("meta-report-month-panel");s&&(n&&(hydrateMetaReportSpendChartType(n),hydrateMetaReportScenarioSettings(n)),s.innerHTML=renderMetaReportMonthBody(r,{...t,yearPayload:t.yearPayload||n,activeMonthKey:o||r?.monthKey||null}),requestAnimationFrame(()=>{mountMetaReportCharts(n,{editable:!!t.editable,clientId:n?.clientId||null})}))}function renderMetaReportEmptyMonthCard({editable:e=!1,synced:t=!1}={}){return t?`
  ...
  `:""}function renderMetaReportMonthBody(e,{editable:t=!1,yearPayload:a=null,activeMonthKey:n=null,settings:o=null}={}){const r=n||e?.monthKey||null,s=r?metaReportMonthBounds(r):null,i=o||a?.settings||{},l=isMetaReportGhlListClient(i),c=resolveClientToplineMode(i),d=resolveMetaToplineSource(e,i),u=l&&c==="cenhub"&&d==="ghl";let p="";if(t&&e&&!e.meta?.emptyMonth&&s){const E=u?" readonly":"",I=renderMetaReportMonthManualRow(e,i);p=`
    ...
    `}const f=n||e?.monthKey||null,h=t?f?`Report preview \xB7 ${metaMonthLabel(f)}`:"Report preview":f?`Report \xB7 ${metaMonthLabel(f)}`:"Report",b=metaReportsState.reportViewMode||"monthly",y=shouldShowMetaReportYearVisuals(e,a,{editable:t}),m=t&&y,g=e&&!e.meta?.emptyMonth?`
    <div class="meta-report-preview-card">
      <div class="meta-report-preview-card-label">${h}</div>
      ${renderMetaReportHighlightStrip(e)}
    </div>
  `:"",v=renderMetaReportMonthTables(e,{editable:t}),w=y?renderMetaReportChartsPanel({editable:t}):"",$=t&&y?renderMetaReportScenarioCard():"",S=m?renderMetaReportViewModeTabs():"";let C;return y?C=`
      ...
      ${$}
    `:C=`<div class="meta-report-content-main">${v}</div>`,`${p}${g}${S}${C}`}function renderMetaReportsHubPage(e){const t=e.clients||[],a=e.meta||{};return`
  ...
  `}function setMetaReportYearLoadingBanner(e,t,a){const n=document.querySelector(e);if(!n)return;let o=n.querySelector(".meta-report-year-loading-banner");a?(o||(o=document.createElement("span"),o.className="meta-report-year-loading-banner",o.setAttribute("aria-live","polite"),n.appendChild(o)),o.innerHTML=`<span class="meta-report-save-indicator-spinner"></span> Loading ${esc(t)}\u2026`,o.hidden=!1):o&&(o.hidden=!0)}function setMetaReportClientYearLoading(e,t){const a=document.querySelector(".meta-report-client-page"),n=document.getElementById("meta-report-year");if(t){n&&(n.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!0);const o=document.querySelector(".meta-report-tabs");o&&(o.innerHTML=renderMetaReportTabsSkeleton(),o.setAttribute("aria-busy","true"));const r=document.getElementById("meta-report-month-panel");r&&(r.innerHTML=renderMetaReportMonthPanelSkeleton(),r.classList.add("is-loading")),destroyMetaReportCharts()}else{n&&(n.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!1);const o=document.querySelector(".meta-report-tabs");o&&o.removeAttribute("aria-busy");const r=document.getElementById("meta-report-month-panel");r&&r.classList.remove("is-loading")}}function setMetaCvYearLoading(e,t){const a=document.querySelector(".sync-history-page.meta-reports-page"),n=document.getElementById("meta-cv-year"),o=document.getElementById("meta-cv-search");if(t){n&&(n.disabled=!0),o&&(o.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!0);const r=document.querySelector(".meta-cv-summary");r&&(r.classList.add("is-skeleton"),r.innerHTML=renderMetaCvSummarySkeleton());const s=document.querySelector(".meta-cv-legend");s&&s.setAttribute("aria-hidden","true");const i=document.getElementById("meta-cv-client-list");i&&(i.innerHTML=renderMetaCvListSkeleton(),i.setAttribute("aria-busy","true"));const l=document.getElementById("meta-cv-editor");l&&(l.innerHTML=renderMetaCvEditorYearSkeleton(),l.setAttribute("aria-busy","true"))}else{n&&(n.disabled=!1),o&&(o.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!1);const r=document.querySelector(".meta-cv-summary");r&&r.classList.remove("is-skeleton");const s=document.querySelector(".meta-cv-legend");s&&s.removeAttribute("aria-hidden");const i=document.getElementById("meta-cv-client-list");i&&i.removeAttribute("aria-busy");const l=document.getElementById("meta-cv-editor");l&&l.removeAttribute("aria-busy")}}function setMetaReportPublicYearLoading(e,t){const a=document.querySelector(".meta-reports-page--public"),n=document.getElementById("meta-report-year");if(t){n&&(n.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!0);const o=document.querySelector(".meta-reports-page--public .meta-report-tabs");o&&(o.innerHTML=renderMetaReportTabsSkeleton(),o.setAttribute("aria-busy","true"));const r=document.getElementById("meta-report-month-panel");r&&(r.innerHTML=renderMetaReportMonthPanelSkeleton(),r.classList.add("is-loading")),destroyMetaReportCharts()}else{n&&(n.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!1);const o=document.querySelector(".meta-reports-page--public .meta-report-tabs");o&&o.removeAttribute("aria-busy");const r=document.getElementById("meta-report-month-panel");r&&r.classList.remove("is-loading")}}function bindMetaReportsClientChromeEvents(e){const t=e.clientId,a=document.getElementById("meta-report-year");a&&(a.onchange=async()=>{if(a.selectedOptions?.[0]?.disabled){a.value=String(metaReportsState.selectedYear);return}const o=metaReportsState.selectedYear,r=Number(a.value);if(r!==o){metaReportsState.selectedYear=r,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportClientYearLoading(r,!0);try{if(linkedReportsState.origin==="google-ads"&&linkedReportsState.metaPayload){const s=linkedReportsState.metaPayload.clientId,i=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(s)}?year=${encodeURIComponent(r)}`);linkedReportsState.metaPayload=i,syncMetaReportSelectedYear(i,{disableUnavailable:!0}),Number(metaReportsState.selectedYear)!==Number(i.year)&&(metaReportsState.selectedYear=i.year),applyLinkedAdminPlatformState("meta");const l=document.querySelector(".meta-report-client-page");l&&(l.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents(),requestAnimationFrame(()=>{mountMetaReportCharts(i,{editable:!0,clientId:s})})}else await loadMetaReportsClientPage({silent:!0})}catch(s){if(metaReportsState.selectedYear=o,a&&(a.value=String(o)),linkedReportsState.origin==="google-ads"&&linkedReportsState.metaPayload){applyLinkedAdminPlatformState("meta");const i=document.querySelector(".meta-report-client-page");i&&(i.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents()}else await loadMetaReportsClientPage({silent:!0});showToast(s.message||"Load failed","error")}finally{setMetaReportClientYearLoading(r,!1)}}}),bindMetaReportCopyButtons(),bindMetaReportBackfillButton(t),bindMetaReportBottomlineSummaryEvents(e),bindMetaReportExcelSheetSummaryEvents(e),bindMetaReportShareEvents(e)}function bindMetaReportsClientEvents(e){bindMetaReportsClientChromeEvents(e),bindMetaReportsClientTabEvents(e),rebindMetaReportMonthPanelEvents(e.clientId,e),isMetaReportGhlListClient(e.settings||{})&&bindMetaReportToplineSourceControl(e.clientId,e),bindLinkedReportChrome()}function bindMetaReportsClientEditEvents(e,t){const a=document.getElementById("meta-report-refresh-meta");a&&(a.onclick=async()=>{a.disabled=!0;try{const o=metaReportsState.activeMonthKey,r=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(o)}/refresh`,{method:"POST"});refreshMetaReportMonthPanel(r.monthPayload),showToast("Meta data refreshed","success")}catch(o){showToast(o.message||"Meta refresh failed","error")}finally{a.disabled=!1}});const n=document.getElementById("meta-report-save-month");n&&(n.onclick=async()=>{n.disabled=!0;try{const o=metaReportsState.activeMonthKey,r=t?.months?.[o],s=t?.settings||{},i=resolveClientToplineMode(s),l=resolveMetaToplineSource(r,s),c=isMetaReportGhlListClient(s)&&i==="cenhub"&&l==="manual",d={periodStart:document.getElementById("meta-report-period-start")?.value,periodEnd:document.getElementById("meta-report-period-end")?.value,wonLeads:document.getElementById("meta-report-won-leads")?.value===""?null:Number(document.getElementById("meta-report-won-leads")?.value),avgLeadValue:document.getElementById("meta-report-avg-lead-value")?.value===""?null:Number(document.getElementById("meta-report-avg-lead-value")?.value),avgProfitPerWon:document.getElementById("meta-report-avg-profit")?.value===""?null:Number(document.getElementById("meta-report-avg-profit")?.value)};c&&(d.toplineSource="manual",d.manualOverride=!0,d.manualLeads=document.getElementById("meta-report-leads")?.value===""?null:Number(document.getElementById("meta-report-leads")?.value));const u=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(o)}`,{method:"PUT",body:JSON.stringify(d)});refreshMetaReportMonthPanel(u.monthPayload),showToast("Month saved","success")}catch(o){showToast(o.message||"Save failed","error")}finally{n.disabled=!1}})}function bindPublicMetaReportTabEvents(e){document.querySelectorAll("[data-meta-month-tab]").forEach(t=>{t.onclick=()=>{switchMetaReportMonthTab(t.getAttribute("data-meta-month-tab"),{editable:!1})}})}function bindPublicMetaReportEvents(e){bindPublicMetaReportTabEvents(e),bindLinkedReportChrome({publicView:!0});const t=document.getElementById("meta-report-year");t&&(t.onchange=async()=>{if(t.selectedOptions?.[0]?.disabled){t.value=String(metaReportsState.selectedYear);return}const n=metaReportsState.selectedYear,o=Number(t.value);if(o!==n){metaReportsState.selectedYear=o,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportPublicYearLoading(o,!0);try{await loadPublicMetaReportPage({silent:!0})}catch(r){metaReportsState.selectedYear=n,t&&(t.value=String(n)),await loadPublicMetaReportPage({silent:!0}),showToast(r.message||"Load failed","error")}finally{setMetaReportPublicYearLoading(o,!1)}}})}async function loadMetaReportsHubPage(){const e=document.getElementById("dashboard");if(!e)return;const t=await fetchStaffMe();if(!t){e.innerHTML=`
    ...
    <div class="meta-report-control-panel${n?" is-editing-share":""}${o?" is-editing-report":""}${a.metaReportEnabled?"":" is-share-disabled"}" id="meta-report-control-panel">
      <div class="meta-report-control-bar">
        ...
        <div class="meta-report-control-bar-actions meta-report-toolbar-actions">
          <span class="meta-report-save-indicator" id="meta-report-save-indicator"><span class="meta-report-save-indicator-spinner"></span> Saving\u2026</span>
          ${s?`<button type="button" class="admin-btn admin-btn--secondary" id="meta-report-toolbar-copy-link" data-copy-report-url="${esc(t.reportUrl)}"${a.metaReportEnabled?"":" disabled"}>Copy link</button>`:""}
  ...
  `}function refreshGoogleAdsReportClientShareUi(e){const t=googleAdsPayloadToMetaUiShape(e);refreshMetaReportClientShareUi(t)}function bindGoogleAdsReportShareEvents(e){const t=googleAdsPayloadToMetaUiShape(e),a=e.clientId;bindMetaReportCopyButtons();const n=document.getElementById("meta-report-rotate-token");n&&(n.onclick=async()=>{if(window.confirm("Rotate the share link? The old link will stop working.")){n.disabled=!0;try{const c=(await patchGoogleAdsReportSettings(a,{rotateAccessToken:!0})).settings||{},d=googleAdsReportsState.clientPayload||e;d.reportUrl=c.reportUrl||d.reportUrl,c&&(d.settings={...d.settings,...c}),googleAdsReportsState.clientPayload=d,refreshGoogleAdsReportClientShareUi(d),showToast("Share link rotated","success")}catch(l){showToast(l.message||"Rotate failed","error")}finally{const l=document.getElementById("meta-report-rotate-token");l&&(l.disabled=!1)}}});const o=document.getElementById("meta-report-share-edit");o&&(o.onclick=()=>openGoogleAdsReportShareModal(e));const r=document.getElementById("meta-report-share-save");r&&(r.onclick=async()=>{const l=document.getElementById("meta-report-share-slug"),c=normalizeMetaReportSlugInput(l?.value);if(!c||c.length<2){showToast("Enter a valid slug (at least 2 characters).","error");return}r.disabled=!0;try{const u=(await patchGoogleAdsReportSettings(a,{metaReportSlug:c})).settings||{},p=googleAdsReportsState.clientPayload||e;p.settings={...p.settings,...u},p.reportUrl=u.reportUrl||null,googleAdsReportsState.clientPayload=p,refreshGoogleAdsReportClientShareUi(p),closeMetaReportModal(),showToast("Share link slug saved","success")}catch(d){showToast(d.message||"Save failed","error")}finally{const d=document.getElementById("meta-report-share-save");d&&(d.disabled=!1)}});const s=document.getElementById("meta-report-share-slug");s&&(s.oninput=()=>{s.value=normalizeMetaReportSlugInput(s.value)});const i=document.querySelector("[data-meta-client-preview]");if(i){let l=0;i.onchange=async()=>{const c=++l,d=i.checked,u=!d,p=googleAdsReportsState.clientPayload||e;applyMetaReportEnabledUi(googleAdsPayloadToMetaUiShape(p),d);const f=i.closest(".meta-hub-switch");f?.classList.add("is-saving");try{const h=await patchGoogleAdsReportSettings(a,{metaReportEnabled:d},{fast:!0});if(c!==l)return;const b=h.settings||{};p.settings={...p.settings,...b},p.reportUrl=b.reportUrl??p.reportUrl,googleAdsReportsState.clientPayload=p,applyMetaReportEnabledUi(googleAdsPayloadToMetaUiShape(p),!!b.googleAdsReportEnabled),showToast(d?"Client preview enabled":"Client preview disabled","success")}catch(h){if(c!==l)return;applyMetaReportEnabledUi(googleAdsPayloadToMetaUiShape(p),u),i.checked=u,showToast(h.message||"Update failed","error")}finally{c===l&&f?.classList.remove("is-saving")}}}bindGoogleAdsReportBottomlineSummaryEvents(e)}function openGoogleAdsReportShareModal(e){metaReportsState.clientShareExpanded=!0,openMetaReportModal(renderMetaReportShareModalContent(googleAdsPayloadToMetaUiShape(e))),bindGoogleAdsReportShareEvents(e)}function openGoogleAdsReportBottomlineModal(e){metaReportsState.clientReportSettingsExpanded=!0,syncMetaReportControlPanelUi();const t=googleAdsPayloadToMetaUiShape(e);openMetaReportModal(renderMetaReportBottomlineModalContent(t)),bindMetaReportBottomlineFeeEvents(e.clientId,"meta-report",async(a,n)=>{try{const r=(await patchGoogleAdsReportSettings(e.clientId,a)).settings||{},s=googleAdsReportsState.clientPayload||e;s.settings={...s.settings,...r},googleAdsReportsState.clientPayload=s;const i=googleAdsSettingsToMetaUx(s.settings);metaReportsState.clientPayload=googleAdsPayloadToMetaUiShape(s),syncMetaReportBottomlineFeeDom(i,"meta-report"),updateMetaReportBottomlineFeeSummary(i,"meta-report"),bindGoogleAdsReportBottomlineSummaryEvents(s),showToast(Object.prototype.hasOwnProperty.call(a,"metaReportShowBottomline")?a.metaReportShowBottomline?"Bottomline enabled":"Bottomline disabled":"Bottomline settings saved","success")}catch(o){typeof n=="function"&&n(),showToast(o.message||"Save failed","error")}})}function bindGoogleAdsReportBottomlineSummaryEvents(e){const t=document.getElementById("meta-report-fee-edit");!t||!e||(t.onclick=()=>openGoogleAdsReportBottomlineModal(e))}function openGoogleAdsReportExcelSheetModal(e){metaReportsState.clientExcelSheetExpanded=!0,syncMetaReportControlPanelUi(),openMetaReportModal(renderMetaReportExcelSheetModalContent(googleAdsPayloadToMetaUiShape(e)),{wide:!0}),bindGoogleAdsReportExcelSheetModalEvents(e)}function bindGoogleAdsReportExcelSheetSummaryEvents(e){const t=document.getElementById("meta-report-excel-sheet-edit");!t||!e||(t.onclick=()=>openGoogleAdsReportExcelSheetModal(e))}function bindGoogleAdsReportExcelSheetModalEvents(e){const t=document.getElementById("meta-report-excel-sheet-url"),a=document.getElementById("meta-report-excel-sheet-save");if(!t||!a)return;const n=async()=>{const o=resolveMetaReportExcelSheetUrl(googleAdsSettingsToMetaUx(googleAdsReportsState.clientPayload?.settings||{})),r=t.value.trim();a.disabled=!0;try{const i=(await patchGoogleAdsReportSettings(e.clientId,{metaReportExcelSheetUrl:r||null})).settings||{},l=googleAdsReportsState.clientPayload||e;l.settings={...l.settings,...i},googleAdsReportsState.clientPayload=l,metaReportsState.clientPayload=googleAdsPayloadToMetaUiShape(l),updateMetaReportExcelSheetSummary(metaReportsState.clientPayload.settings),syncMetaReportExcelSheetUi(metaReportsState.clientPayload.settings),bindGoogleAdsReportExcelSheetSummaryEvents(l),closeMetaReportModal(),showToast(r?"Excel sheet link saved":"Excel sheet link removed","success")}catch(s){t.value=o||"",showToast(s.message||"Could not save Excel sheet link","error")}finally{a.disabled=!1}};a.onclick=n,t.onkeydown=o=>{o.key==="Enter"&&(o.preventDefault(),n())}}function bindGoogleAdsReportBackfillButton(e){const t=document.getElementById("meta-report-backfill");t&&(t.onclick=async()=>{const a=googleAdsReportsState.clientPayload,n=googleAdsMonthsNeedingBackfill(a),o=n.length?n:a?.monthKeys||[];if(!o.length)return;t.disabled=!0;const r=document.getElementById("meta-report-backfill-progress");let s=0,i=0;for(const l of o){s+=1,r&&(r.textContent=`Fetching ${metaMonthLabel(l)} ${l.slice(0,4)}\u2026 (${s}/${o.length})`);try{await adminFetch(`/api/google-ads-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(l)}/refresh`,{method:"POST"})}catch{i+=1}}r&&(r.textContent=""),i?showToast(`Synced ${s-i}/${o.length} months. ${i} failed (check Google Ads access).`,"error"):showToast(`Synced ${o.length} month${o.length===1?"":"s"} from Google Ads`,"success"),await reloadCurrentLinkedEditor()})}function renderGoogleAdsReportMonthBody(e,{editable:t=!1,yearPayload:a=null,activeMonthKey:n=null}={}){const o=n||e?.monthKey||null,r=o?metaReportMonthBounds(o):null;let s="";t&&e&&!e.meta?.emptyMonth&&r&&(s=`
      <div class="meta-report-edit-panel" id="meta-report-edit-panel">
        ...
        <div class="meta-report-edit-grid">
          ...
          <label class="meta-cv-value-field is-locked">Number of leads<input type="number" step="any" id="meta-report-leads" value="${esc(e.topline?.leads??"")}" readonly disabled tabindex="-1" aria-readonly="true" /></label>
    ...
    `);const i=n||e?.monthKey||null,l=t?i?`Report preview \xB7 ${metaMonthLabel(i)}`:"Report preview":i?`Report \xB7 ${metaMonthLabel(i)}`:"Report",c=metaReportsState.reportViewMode||"monthly",d=shouldShowMetaReportYearVisuals(e,a,{editable:t}),u=t&&d,p=e&&!e.meta?.emptyMonth?`
    <div class="meta-report-preview-card">
      <div class="meta-report-preview-card-label">${l}</div>
      ${renderMetaReportHighlightStrip(e)}
    </div>
  `:"",f=renderMetaReportMonthTables(e,{editable:t,adGroupTitle:"Google ads"}),h=d?renderMetaReportChartsPanel({editable:t}):"",b=t&&d?renderMetaReportScenarioCard():"",y=u?renderMetaReportViewModeTabs():"";let m;return d?m=`
    ...
    `).join(""),document.querySelectorAll("[data-google-ads-month-tab]").forEach(o=>{o.onclick=()=>switchGoogleAdsReportMonthTab(o.getAttribute("data-google-ads-month-tab"))})),syncGoogleAdsReportMonthPanelDom(e.months?.[googleAdsReportsState.activeMonthKey],{editable:!0,yearPayload:googleAdsPayloadToMetaUiShape(e)},e),bindGoogleAdsReportMonthEditEvents(e.clientId,e),bindGoogleAdsReportBackfillButton(e.clientId),bindGoogleAdsReportShareEvents(e),bindGoogleAdsReportBottomlineSummaryEvents(e),bindGoogleAdsReportExcelSheetSummaryEvents(e),ensureMetaReportScenarioSource(metaReportsState.clientPayload,{editable:!0})}function bindGoogleAdsReportsClientChromeEvents(e){const t=e.clientId,a=document.getElementById("meta-report-year");a&&(a.onchange=async()=>{if(a.selectedOptions?.[0]?.disabled){a.value=String(googleAdsReportsState.selectedYear);return}const o=googleAdsReportsState.selectedYear,r=Number(a.value);if(r!==o){googleAdsReportsState.selectedYear=r,linkedReportsState.origin!=="meta"&&(metaReportsState.selectedYear=r),googleAdsReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportClientYearLoading(r,!0);try{if(linkedReportsState.origin==="meta"&&linkedReportsState.googlePayload){const s=linkedReportsState.googlePayload.clientId,i=await adminFetch(`/api/google-ads-reports/clients/${encodeURIComponent(s)}?year=${encodeURIComponent(r)}`);linkedReportsState.googlePayload=i,googleAdsReportsState.clientPayload=i,googleAdsReportsState.selectedYear=Number(i.year)||r,applyLinkedAdminPlatformState("google-ads");const l=document.querySelector(".meta-report-client-page");l&&(l.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents();const c=googleAdsPayloadToMetaUiShape(i);requestAnimationFrame(()=>{mountMetaReportCharts(c,{editable:!0,clientId:s})})}else await loadGoogleAdsClientPage({silent:!0})}catch(s){if(googleAdsReportsState.selectedYear=o,linkedReportsState.origin!=="meta"&&(metaReportsState.selectedYear=o),a&&(a.value=String(o)),linkedReportsState.origin==="meta"&&linkedReportsState.googlePayload){applyLinkedAdminPlatformState("google-ads");const i=document.querySelector(".meta-report-client-page");i&&(i.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents()}else await loadGoogleAdsClientPage({silent:!0});showToast(s.message||"Load failed","error")}finally{setMetaReportClientYearLoading(r,!1)}}}),bindMetaReportCopyButtons(),bindGoogleAdsReportBackfillButton(t),bindGoogleAdsReportBottomlineSummaryEvents(e),bindGoogleAdsReportExcelSheetSummaryEvents(e),bindGoogleAdsReportShareEvents(e)}function bindGoogleAdsReportsClientEvents(e){bindGoogleAdsReportsClientChromeEvents(e),document.querySelectorAll("[data-google-ads-month-tab]").forEach(t=>{t.onclick=()=>switchGoogleAdsReportMonthTab(t.getAttribute("data-google-ads-month-tab"))}),bindGoogleAdsReportMonthEditEvents(e.clientId,e),bindLinkedReportChrome()}const GOOGLE_ADS_HUB_FILTERS=[{value:"enabled",label:"Live"},{value:"not-enabled",label:"Not enabled"},{value:"all",label:"All"}];function filterGoogleAdsClients(e,t,a=""){let n=e||[];t==="enabled"&&(n=n.filter(r=>r.googleAdsReportEnabled)),(t==="not-enabled"||t==="needs-setup")&&(n=n.filter(r=>!r.googleAdsReportEnabled));const o=String(a||"").trim().toLowerCase();return o&&(n=n.filter(r=>[r.accountName,r.googleCustomerId,r.googleCustomerLabel,r.clientId].filter(Boolean).join(" ").toLowerCase().includes(o))),n}function getGoogleAdsHubView(e,t,a=googleAdsReportsState.searchQuery){const n=e?.clients||[];return{clients:filterGoogleAdsClients(n,t,a),allClients:n,summary:e?.summary||{},google:e?.google||{},filter:t,searchQuery:a}}function renderGoogleAdsHubFiltersHtml(e){return GOOGLE_ADS_HUB_FILTERS.map(t=>`
    <button
      type="button"
      class="meta-hub-filter${e===t.value?" is-active":""}"
...
Saved values and settings are kept. You can enable it again later.`)){e.disabled=!0;try{await patchGoogleAdsReportSettings(a,{metaReportEnabled:!1},{fast:!0}),showToast("Report disabled","success");const r=googleAdsReportsState.filter==="enabled"?"not-enabled":googleAdsReportsState.filter;await revealGoogleAdsHubAccount(a,{filter:r})}catch(r){showToast(r.message||"Update failed","error"),e.disabled=!1}}}})}function bindGoogleAdsHubEvents(){const e=document.getElementById("google-ads-search");e&&(e.oninput=()=>{googleAdsReportsState.searchQuery=e.value,updateGoogleAdsHubDom(getGoogleAdsHubView(googleAdsReportsState.dashboardData,googleAdsReportsState.filter,googleAdsReportsState.searchQuery))}),document.querySelectorAll("[data-google-ads-filter]").forEach(a=>{a.onclick=()=>{googleAdsReportsState.filter=a.getAttribute("data-google-ads-filter")||"enabled",document.querySelectorAll("[data-google-ads-filter]").forEach(n=>{n.classList.toggle("is-active",n===a)}),updateGoogleAdsHubDom(getGoogleAdsHubView(googleAdsReportsState.dashboardData,googleAdsReportsState.filter,googleAdsReportsState.searchQuery))}});const t=document.getElementById("google-ads-refresh");t&&(t.onclick=()=>loadGoogleAdsHubPage()),bindGoogleAdsHubRowEvents()}async function loadGoogleAdsHubPage(){const e=document.getElementById("dashboard");if(!e)return;const t=await fetchStaffMe();if(!t){e.innerHTML=`
  ...
  `}async function loadGoogleAdsClientPage({silent:e=!1}={}){const t=document.getElementById("dashboard");if(!t)return;const a=await fetchStaffMe();if(!a){window.location.href=`/login?next=${encodeURIComponent(window.location.pathname)}`;return}currentStaffUser=a;const n=CLIENT_SLUG;if(!googleAdsReportsState.clientPageMounted)t.innerHTML=`
    ...
    `;else if(!e){const o=document.getElementById("meta-report-month-panel");o&&o.classList.add("is-loading")}try{const o=await adminFetch(`/api/google-ads-reports/clients/${encodeURIComponent(n)}?year=${encodeURIComponent(googleAdsReportsState.selectedYear)}`);if(o?.settings?.googleAdsReportEnabled===!1){t.innerHTML=`
        ...
        `)}
      `;return}googleAdsReportsState.selectedYear=Number(o.year)||googleAdsReportsState.selectedYear,metaReportsState.selectedYear=googleAdsReportsState.selectedYear,(!googleAdsReportsState.activeMonthKey||!(o.monthKeys||[]).includes(googleAdsReportsState.activeMonthKey))&&(googleAdsReportsState.activeMonthKey=o.monthKeys?.[o.monthKeys.length-1]||null),metaReportsState.activeMonthKey=googleAdsReportsState.activeMonthKey;const r=googleAdsPayloadToMetaUiShape(o);await ensureMetaReportScenarioSource(r,{editable:!0});const s=await fetchLinkedPartnerPayload(o,"google-ads");hydrateAdminLinkedReports({origin:"google-ads",metaPayload:s,googlePayload:o}),s&&(!metaReportsState.activeMonthKey||!(s.monthKeys||[]).includes(metaReportsState.activeMonthKey))&&(metaReportsState.activeMonthKey=s.monthKeys?.[s.monthKeys.length-1]||null);const i=linkedReportsState.activePlatform==="meta"&&s,l=i?s:r;if(i&&(metaReportsState.clientPayload=s,metaReportsState.selectedYear=Number(s.year)||metaReportsState.selectedYear,hydrateMetaReportSpendChartType(s),hydrateMetaReportScenarioSettings(s)),!googleAdsReportsState.clientPageMounted)googleAdsReportsState.clientPayload=o,i||(metaReportsState.clientPayload=r,metaReportsState.clientShareExpanded=!1,metaReportsState.clientReportSettingsExpanded=!1,metaReportsState.clientExcelSheetExpanded=!1,metaReportsState.reportViewMode="monthly",metaReportsState.comparisonYearCache={}),t.innerHTML=renderGoogleAdsClientPage(o),googleAdsReportsState.clientPageMounted=!0,bindLinkedAdminEditorEvents(),requestAnimationFrame(()=>{mountMetaReportCharts(l,{editable:!0,clientId:i?s.clientId:n})});else if(i){const c=document.querySelector(".meta-report-client-page");c&&(c.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents()}else updateGoogleAdsReportsClientContent(o),bindLinkedReportChrome()}catch(o){googleAdsReportsState.clientPageMounted?e||showToast(o.message||"Load failed","error"):t.innerHTML=`
        ${renderBrandTopbar(renderStaffAdminChrome("google-ads"))}
        ${wrapDashboardShell(`<div class="error-state" style="padding:24px">${esc(o.message)}</div>`)}
      `}finally{const o=document.getElementById("meta-report-month-panel");o&&o.classList.remove("is-loading")}}function getGoogleAdsCvFilteredClients(e=googleAdsReportsState.customValues.overview){const t=(e?.clients||[]).filter(n=>n.googleAdsReportEnabled!==!1),a=String(googleAdsReportsState.customValues.searchQuery||"").trim().toLowerCase();return a?t.filter(n=>[n.accountName,n.clientId,n.googleCustomerId,n.googleCustomerLabel].filter(Boolean).join(" ").toLowerCase().includes(a)):t}function renderGoogleAdsCvMonthPills(e,t=[]){const a=googleAdsReportsState.customValues.selectedClientId,n=googleAdsReportsState.customValues.selectedMonthKey;return t.map(o=>{const s=(e.months?.[o]||{}).status||"empty",i=a===e.clientId&&n===o;return`
      <button
        type="button"
    ...
    `).join(""):'<div class="meta-report-empty" style="padding:32px 12px">No matching clients.</div>'}function renderGoogleAdsCvEditor(e){const t=googleAdsReportsState.customValues,a=(e.clients||[]).find(u=>u.clientId===t.selectedClientId),n=t.selectedMonthKey;if(!a||!n)return`
      <div class="meta-cv-editor-empty">
        Select a client month pill to edit won leads, average lead value, and average profit.
      </div>
    `;const o=a.months?.[n]||{},r=a.googleAdsReportShowBottomline,s=t.draftInputs,i=o.googleConversions!=null?o.googleConversions:"",l=s?.wonLeads??(o.wonLeads!=null?o.wonLeads:""),c=s?.avgLeadValue??(o.avgLeadValue!=null?o.avgLeadValue:""),d=s?.avgProfitPerWon??(o.avgProfitPerWon!=null?o.avgProfitPerWon:"");return`
    <div class="meta-report-edit-panel-head">
      <div>
    ...
    <div class="meta-cv-editor-grid">
      <label>Client
        <select id="gads-cv-client-select" class="admin-select">
          ${(e.clients||[]).map(u=>`
            <option value="${esc(u.clientId)}"${u.clientId===a.clientId?" selected":""}>${esc(u.accountName)}</option>
          `).join("")}
        </select>
      </label>
      <label>Month
        <select id="gads-cv-month-select" class="admin-select">
          ${(e.monthKeys||[]).map(u=>`
            <option value="${esc(u)}"${u===n?" selected":""}>${esc(metaMonthLabel(u))}</option>
          `).join("")}
        </select>
      </label>
      <label class="meta-cv-value-field is-locked">Number of leads
        <input type="number" step="any" id="gads-cv-leads" value="${esc(i)}" readonly disabled tabindex="-1" aria-readonly="true" />
      </label>
      ...
      <label class="meta-cv-value-field">Avg profit per won${r?"":" (optional)"}
  ...
  `}function refreshGoogleAdsCvListAndEditor(){const e=googleAdsReportsState.customValues.overview;if(!e)return;const t=document.getElementById("gads-cv-client-list");t&&(t.innerHTML=renderGoogleAdsCvClientRows(e));const a=document.getElementById("gads-cv-editor");a&&(a.innerHTML=renderGoogleAdsCvEditor(e)),googleAdsReportsState.customValues.draftInputs=null,bindGoogleAdsCvEditorEvents(),bindGoogleAdsCvListEvents()}function setGoogleAdsCvSavePending(e){googleAdsReportsState.customValues.saving=e;const t=document.getElementById("gads-cv-save"),a=document.getElementById("gads-cv-save-indicator");a&&a.classList.toggle("is-visible",e),t&&(t.disabled=e,t.textContent=e?"Saving\u2026":"Save values")}function setGoogleAdsCvYearLoading(e,t){const a=document.querySelector(".sync-history-page.meta-reports-page"),n=document.getElementById("gads-cv-year"),o=document.getElementById("gads-cv-search");t?(n&&(n.disabled=!0),o&&(o.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!0)):(n&&(n.disabled=!1),o&&(o.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!1))}function classifyGoogleAdsCvMonthStatus(e,t=!1){if(!e)return"empty";const a=e.wonLeads!=null,n=e.avgLeadValue!=null,o=e.avgProfitPerWon!=null;return a&&n&&(!t||o)?"complete":a||n||o?"partial":"empty"}function applyGoogleAdsCvSaveResult(e,t,a){const o=googleAdsReportsState.customValues.overview?.clients?.find(s=>s.clientId===e),r=o?.months?.[t];r&&(r.wonLeads=a.wonLeads,r.avgLeadValue=a.avgLeadValue,r.avgProfitPerWon=a.avgProfitPerWon,r.status=classifyGoogleAdsCvMonthStatus(r,!!o.googleAdsReportShowBottomline),r.updatedAt=r.status==="empty"?null:new Date().toISOString())}async function refreshGoogleAdsCvOverviewSilently(){const e=await adminFetch(`/api/google-ads-reports/custom-values?year=${encodeURIComponent(googleAdsReportsState.selectedYear)}`);googleAdsReportsState.selectedYear=Number(e.year)||googleAdsReportsState.selectedYear,googleAdsReportsState.customValues.overview=e;const t=document.getElementById("gads-cv-client-list");t&&(t.innerHTML=renderGoogleAdsCvClientRows(e),bindGoogleAdsCvListEvents());const a=document.querySelector(".meta-cv-summary");if(a&&e.summary){const n=e.summary;a.innerHTML=`
    ...
    `}}function collectGoogleAdsCvSaveBody(){return{wonLeads:document.getElementById("gads-cv-won-leads")?.value===""?null:Number(document.getElementById("gads-cv-won-leads")?.value),avgLeadValue:document.getElementById("gads-cv-avg-lead-value")?.value===""?null:Number(document.getElementById("gads-cv-avg-lead-value")?.value),avgProfitPerWon:document.getElementById("gads-cv-avg-profit")?.value===""?null:Number(document.getElementById("gads-cv-avg-profit")?.value)}}function selectGoogleAdsCvMonth(e,t){googleAdsReportsState.customValues.selectedClientId=e,googleAdsReportsState.customValues.selectedMonthKey=t,refreshGoogleAdsCvListAndEditor()}function bindGoogleAdsCvListEvents(){document.querySelectorAll("[data-gads-cv-month]").forEach(e=>{e.onclick=()=>{selectGoogleAdsCvMonth(e.getAttribute("data-gads-cv-client"),e.getAttribute("data-gads-cv-month"))}})}function bindGoogleAdsCvEditorEvents(){const e=document.getElementById("gads-cv-client-select"),t=document.getElementById("gads-cv-month-select");e&&(e.onchange=()=>{const n=googleAdsReportsState.customValues.selectedMonthKey||googleAdsReportsState.customValues.overview?.monthKeys?.slice(-1)[0];n&&selectGoogleAdsCvMonth(e.value,n)}),t&&(t.onchange=()=>{const n=googleAdsReportsState.customValues.selectedClientId;n&&selectGoogleAdsCvMonth(n,t.value)});const a=document.getElementById("gads-cv-save");a&&(a.onclick=async()=>{const n=googleAdsReportsState.customValues.selectedClientId,o=googleAdsReportsState.customValues.selectedMonthKey;if(!n||!o||googleAdsReportsState.customValues.saving)return;const r=collectGoogleAdsCvSaveBody();setGoogleAdsCvSavePending(!0);try{await adminFetchWithRetry(`/api/google-ads-reports/clients/${encodeURIComponent(n)}/months/${encodeURIComponent(o)}`,{method:"PUT",body:JSON.stringify(r)},{retries:2,timeoutMs:3e4}),applyGoogleAdsCvSaveResult(n,o,r),googleAdsReportsState.customValues.draftInputs=r,setGoogleAdsCvSavePending(!1),refreshGoogleAdsCvListAndEditor(),showToast("Custom values saved","success");try{await refreshGoogleAdsCvOverviewSilently()}catch(s){console.warn("Google Ads custom values overview refresh failed after save",s)}}catch(s){const i=s?.name==="AbortError"?"Save timed out \u2014 try again":s.message||"Save failed";showToast(i,"error"),setGoogleAdsCvSavePending(!1)}})}function bindGoogleAdsCustomValuesEvents(e){const t=document.getElementById("gads-cv-year");t&&(t.onchange=async()=>{const n=googleAdsReportsState.selectedYear,o=Number(t.value);if(o!==n){googleAdsReportsState.selectedYear=o,googleAdsReportsState.customValues.selectedClientId=null,googleAdsReportsState.customValues.selectedMonthKey=null,setGoogleAdsCvYearLoading(o,!0);try{await loadGoogleAdsCustomValuesPage({silent:!0})}catch(r){googleAdsReportsState.selectedYear=n,t&&(t.value=String(n)),await loadGoogleAdsCustomValuesPage({silent:!0,keepSelection:!0}),showToast(r.message||"Load failed","error")}finally{setGoogleAdsCvYearLoading(o,!1)}}});const a=document.getElementById("gads-cv-search");a&&(a.oninput=()=>{googleAdsReportsState.customValues.searchQuery=a.value;const n=document.getElementById("gads-cv-client-list");n&&(n.innerHTML=renderGoogleAdsCvClientRows(e)),bindGoogleAdsCvListEvents()}),bindGoogleAdsCvListEvents(),bindGoogleAdsCvEditorEvents()}async function loadGoogleAdsCustomValuesPage({silent:e=!1,keepSelection:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){window.location.href=`/login?next=${encodeURIComponent(window.location.pathname)}`;return}currentStaffUser=n,!googleAdsReportsState.customValues.mounted&&!e&&(a.innerHTML=`
      ${renderBrandTopbar(renderStaffAdminChrome("google-ads-custom"))}
      ${wrapDashboardShell('<div class="loading-state"><div class="spinner"></div><p>Loading custom values...</p></div>')}
    `);try{const o=await adminFetch(`/api/google-ads-reports/custom-values?year=${encodeURIComponent(googleAdsReportsState.selectedYear)}`);googleAdsReportsState.selectedYear=Number(o.year)||googleAdsReportsState.selectedYear,googleAdsReportsState.customValues.overview=o,t||(o.clients||[]).some(s=>s.clientId===googleAdsReportsState.customValues.selectedClientId)||(googleAdsReportsState.customValues.selectedClientId=null,googleAdsReportsState.customValues.selectedMonthKey=null),a.innerHTML=renderGoogleAdsCustomValuesPage(o),googleAdsReportsState.customValues.mounted=!0,googleAdsReportsState.customValues.saving=!1,bindGoogleAdsCustomValuesEvents(o)}catch(o){if(!googleAdsReportsState.customValues.mounted)a.innerHTML=`
        ${renderBrandTopbar(renderStaffAdminChrome("google-ads-custom"))}
        ${wrapDashboardShell(`<div class="error-state" style="padding:24px">${esc(o.message)}</div>`)}
...
Type "skip" to skip manual months, or "overwrite" to replace all:`,"skip");if(!r)return!1;r.trim().toLowerCase()==="overwrite"&&(n={...n,skipManual:!1,overwriteManual:!0})}}return await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/switch-topline-source`,{method:"POST",body:JSON.stringify(n)}),showToast(a==="cenhub"?"Switched all months to Cenhub":"Switched all months to Meta","success"),typeof t.reload=="function"?await t.reload():await loadMetaReportsClientPage({silent:!0}),!0}function bindMetaReportToplineChangeModal(e){const t=e.clientId;if(document.querySelectorAll('input[name="meta-topline-draft-mode"]').forEach(n=>{n.addEventListener("change",updateMetaReportToplineApplyState)}),document.getElementById("meta-report-topline-ack")?.addEventListener("change",updateMetaReportToplineApplyState),document.getElementById("meta-report-topline-confirm")?.addEventListener("input",updateMetaReportToplineApplyState),resolveClientToplineMode(e.settings||{})==="cenhub"){const n=typeof e.reload=="function";bindMetaToplineCenhubActionEvents({clientId:t,prefix:"meta-report-topline-modal",getMonthKey:()=>metaReportsState.activeMonthKey,getYear:()=>metaReportsState.selectedYear,setSaving:o=>{const r=document.getElementById("meta-report-topline-modal-loading");r&&(r.hidden=!o);const s=document.getElementById("meta-report-topline-modal-sync-ghl-year");s&&(s.disabled=o||e.settings?.hasGhl===!1)},onReload:async()=>{n?await e.reload():await loadMetaReportsClientPage({silent:!0}),closeMetaReportModal()}})}const a=document.getElementById("meta-report-topline-apply");a&&(a.onclick=async()=>{const n=getMetaReportToplineDraftMode(),o=resolveClientToplineMode(e.settings||{});if(n===o)return;a.disabled=!0,document.getElementById("meta-report-topline-modal-loading")?.removeAttribute("hidden");const r=typeof e.reload=="function";r?setMetaCvSavePending(!0):(metaReportsState.clientToplineSaving=!0,syncMetaReportToplineSourceBar(metaReportsState.clientPayload||e));try{await applyMetaReportToplineSwitch(t,e,n)&&closeMetaReportModal()}catch(s){showToast(s.message||"Could not switch data source","error")}finally{r?setMetaCvSavePending(!1):(metaReportsState.clientToplineSaving=!1,syncMetaReportToplineSourceBar(metaReportsState.clientPayload)),document.getElementById("meta-report-topline-modal-loading")?.setAttribute("hidden","")}})}function renderMetaReportMonthManualRow(e,t={},{prefix:a="meta-report"}={}){if(!metaMonthAllowsManualControls(e,t))return"";const o=resolveMetaToplineSource(e,t)==="manual",r=monthHasCenhubSnapshot(e,t)?"Switch back to Cenhub":"Switch back to Meta";return o?`
    <div class="meta-report-month-manual-row">
      ...
      <div class="meta-report-month-manual-row-actions">
        ...
        <button type="button" class="admin-btn admin-btn--primary admin-btn--small" id="${a}-restore-month-source">${esc(r)}</button>
      </div>
    </div>
  `:`
      <div class="meta-report-month-manual-row">
    ...
    `}function renderMetaCvToplineSourceControl(e,t){if(!e?.metaReportGhlDataEnabled)return"";const a=e.metaReportToplineMode==="cenhub"?"cenhub":"meta",n=metaReportsState.customValues.saving,o=n?" disabled":"",r=e.hasGhl!==!1;return`
...
Type "skip" to skip manual months, or "overwrite" to replace all:`,"skip");if(!h)return;h.trim().toLowerCase()==="overwrite"&&(u=!1,p=!0)}const f=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/sync-ghl-year?year=${encodeURIComponent(c)}`,{method:"POST",body:JSON.stringify({skipManual:u,overwriteManual:p})});r?await r():s&&await s(f,null,{yearSync:!0}),showToast(`Synced ${f.synced?.length||0} month(s)${f.skipped?.length?`, skipped ${f.skipped.length}`:""}`,"success")}catch(c){showToast(c.message||"Year sync failed","error")}finally{o&&o(!1)}});const l=document.getElementById(`${t}-refresh-snapshot`);l&&(l.onclick=async()=>{const c=a?.();if(c){o&&o(!0);try{const d=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(c)}/refresh-snapshot`,{method:"POST",body:"{}"});s&&await s(d,c),showToast("Cenhub data refreshed and synced","success")}catch(d){showToast(d.message||"Refresh failed","error")}finally{o&&o(!1)}}})}function monthHasCenhubSnapshot(e,t={}){return e?resolveMetaToplineSource(e,t)==="ghl"?!0:!!e.ghlSyncedAt:!1}function renderMetaCvClientRows(e){const t=getMetaCvFilteredClients(e),a=e.monthKeys||[];return t.length?t.map(n=>`
    ...
    `).join(""):'<div class="meta-report-empty" style="padding:32px 12px">No matching clients.</div>'}function monthStatusIsEmpty(e,t={}){return e?(e.status??classifyMetaCvMonthStatus({wonLeads:e.inputs?.wonLeads??e.topline?.wonLeads??e.wonLeads,avgLeadValue:e.inputs?.avgLeadValue??e.topline?.avgLeadValue??e.avgLeadValue,avgProfitPerWon:e.inputs?.avgProfitPerWon??e.avgProfitPerWon},!!t.metaReportShowBottomline))==="empty":!0}function metaReportEffectiveFeeEnabled(e,t=null){if(!t)return!!e?.metaReportFeeEnabled;const a=!!e?.metaReportShowBottomline;return(t.status??classifyMetaCvMonthStatus({wonLeads:t.inputs?.wonLeads??t.topline?.wonLeads??t.wonLeads,avgLeadValue:t.inputs?.avgLeadValue??t.topline?.avgLeadValue??t.avgLeadValue,avgProfitPerWon:t.inputs?.avgProfitPerWon??t.avgProfitPerWon},a))==="empty"?!1:!!e?.metaReportFeeEnabled}function resolveMetaReportFeeMode(e={}){return e.metaReportFeeEnabled?resolveMetaReportStoredFeeMode(e):""}const META_REPORT_FEE_MODE_META=[{value:"",icon:"\u2013",title:"None",desc:"No Censio fee"},{value:"performance",icon:"%",title:"Performance fee",desc:"% of profit (POAS)"},{value:"marketing",icon:"Dkr",title:"Marketing fee",desc:"Fixed Dkr amount"}];function metaReportFeeValueBlockHtml(e,t,a,n,{inline:o=!1}={}){return o&&t==="performance"?`
      ...
      </label>`:'<p class="meta-report-fee-value-empty">No amount needed \u2014 just save your selection.</p>'}function metaReportUsesInlineFeeValue(e){return e==="meta-cv"}function describeMetaReportFeeModeLabel(e,t,a,{feeEnabled:n=!0}={}){if(!n||e===""||e==null)return"No Censio fee";if(e==="performance"){const o=Number(t);return`Performance fee \xB7 ${Number.isFinite(o)?o:20}%`}if(e==="marketing"){const o=Number(a);return`Marketing fee \xB7 Dkr ${Number.isFinite(o)?o:0}`}return"No Censio fee"}function readMetaReportFeeDraftState(e){const t=document.getElementById(`${e}-fee-nested`);if(!t)return null;const a=t.querySelector(`input[name="${e}-fee-mode"]:checked`),n=a?a.value||"":t.dataset.feeMode||"";let o=Number(t.dataset.feePercent),r=Number(t.dataset.marketingFee);if(n==="performance"){const u=document.getElementById(`${e}-setting-fee-percent`),p=Number(u?.value);Number.isFinite(p)&&(o=p)}else if(n==="marketing"){const u=document.getElementById(`${e}-setting-marketing-fee`),p=Number(u?.value);Number.isFinite(p)&&(r=p)}const s=t.dataset.feeEnabled==="true"?resolveMetaReportStoredFeeMode({metaReportFeeEnabled:!0,metaReportFeeMode:t.dataset.feeMode||null,metaReportMarketingFeeAmount:t.dataset.marketingFee}):"",i=Number(t.dataset.feePercent),l=Number(t.dataset.marketingFee);return{appliedMode:s,appliedPercent:i,appliedMarketing:l,selectedMode:n,selectedPercent:o,selectedMarketing:r,isDirty:n!==s||(n==="performance"?o!==i:n==="marketing"?r!==l:!1),appliedLabel:describeMetaReportFeeModeLabel(s,i,l),selectedLabel:describeMetaReportFeeModeLabel(n,o,r)}}function metaReportFeeStatusHtml(e){return e.isDirty?`
  ...
  `}function openMetaReportBottomlineModal(e){metaReportsState.clientReportSettingsExpanded=!0,syncMetaReportControlPanelUi(),openMetaReportModal(renderMetaReportBottomlineModalContent(e)),bindMetaReportBottomlineFeeEvents(e.clientId,"meta-report")}function bindMetaReportBottomlineSummaryEvents(e){const t=document.getElementById("meta-report-fee-edit");!t||!e||(t.onclick=()=>openMetaReportBottomlineModal(e))}function updateMetaReportBottomlineFeeSummary(e={},t="meta-report"){const a=document.getElementById(`${t}-fee-summary`);if(!a)return;const n=document.createElement("div");n.innerHTML=renderMetaReportBottomlineFeeSummary(e,t);const o=n.firstElementChild;o&&a.replaceWith(o),bindMetaReportBottomlineSummaryEvents(metaReportsState.clientPayload)}function renderMetaReportBottomlineFeeSettings(e={},t="meta-report",{compact:a=!1,variant:n="default",collapsible:o=!1,externalSummary:r=!1}={}){const s=!!e.metaReportShowBottomline,i=!!e.metaReportFeeEnabled,l=e.metaReportFeeMode||"",c=resolveMetaReportFeeMode(e),d=e.metaReportFeePercent??20,u=e.metaReportMarketingFeeAmount??0,p=metaReportUsesInlineFeeValue(t),f=`data-fee-mode="${esc(l)}" data-fee-enabled="${i?"true":"false"}" data-fee-percent="${esc(d)}" data-marketing-fee="${esc(u)}"`;if(n==="cv"){const h=describeMetaReportFeeModeLabel(c,d,u),b=META_REPORT_FEE_MODE_META.map(({value:y,title:m})=>`
    ...
    <div class="meta-report-bottomline-fee-settings meta-report-bottomline-fee-settings--cv">
      <div class="meta-cv-bottomline-panel">
        ...
        <div class="meta-report-fee-nested meta-cv-bottomline-body${s?"":" is-hidden"}" id="${t}-fee-nested" ${f}>
          <div class="meta-report-fee-status" id="${t}-fee-status" aria-live="polite">
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,a=(e.clients||[]).find(L=>L.clientId===t.selectedClientId),n=t.selectedMonthKey;if(!a||!n)return`
    ...
    `;const o=a.months?.[n]||{};if(t.loadingEditor)return renderMetaCvEditorSkeleton(a,n,o);const r=t.editorPayload?.months?.[n]||null,s=a.metaReportShowBottomline,i=!!a.metaReportGhlDataEnabled,l={metaReportGhlDataEnabled:a.metaReportGhlDataEnabled,metaReportToplineMode:a.metaReportToplineMode},c=resolveClientToplineMode(l),d=resolveMetaCvMonthToplineSource(r,o,l),u=i&&c==="cenhub"&&d==="ghl",p=o.wonLeads!=null?o.wonLeads:r?.inputs?.wonLeads??r?.topline?.wonLeads??"",f=o.avgLeadValue!=null?o.avgLeadValue:r?.inputs?.avgLeadValue??r?.topline?.avgLeadValue??"",h=o.avgProfitPerWon!=null?o.avgProfitPerWon:r?.inputs?.avgProfitPerWon??"",b=o.ghlLeads??r?.ghlTotals?.leads??r?.topline?.leads??"",y=o.ghlTotalRevenue??r?.ghlTotals?.totalRevenue??"",m=o.ghlTotalProfit??r?.ghlTotals?.totalProfit??"",g=metaReportsState.customValues.draftInputs,v=i&&c==="cenhub"&&d==="manual",w=u?b:g?.manualLeads??(v?o.manualLeads??r?.topline?.leads??"":r?.topline?.leads??o.manualLeads??""),$=g?.wonLeads??p,S=g?.avgLeadValue??f,C=g?.avgProfitPerWon??h,E=u?' readonly disabled tabindex="-1" aria-readonly="true"':"",I=u?" disabled":"",k=u?" is-locked":"",A=t.settingsSaving&&t.settingsSavingScope==="report",P=i?renderMetaCvToplineSourceControl(a,e):"",M=renderMetaCvMonthManualRow(r||{dataSource:d},a),T=i?renderMetaMonthSourcePill(r||{dataSource:d},l):"";return`
    <div class="meta-report-edit-panel-head">
      <div>
        <h3>${esc(a.accountName)}</h3>
        <p class="meta-cv-editor-sub">
    ...
    <div class="meta-cv-editor-grid">
      ...
      <label class="meta-cv-value-field${k}">Avg profit per won${s?"":" (optional)"}
  ...
  `}function bindMetaReportsGhlClientsEvents(){document.querySelectorAll("[data-ghl-list-toggle]").forEach(e=>{e.onchange=async()=>{const t=e.getAttribute("data-ghl-list-toggle"),a=e.checked,n=!a;metaReportsState.ghlClients.savingClientId=t;try{await adminFetch(`/api/meta-reports/ghl-clients/${encodeURIComponent(t)}`,{method:"PATCH",body:JSON.stringify({enabled:a})});const o=metaReportsState.ghlClients.data?.clients?.find(r=>r.clientId===t);o&&(o.onGhlList=a),showToast(a?"Added to Cenhub list":"Removed from Cenhub list","success")}catch(o){e.checked=n,showToast(o.message||"Update failed","error")}finally{metaReportsState.ghlClients.savingClientId=null}}})}async function loadMetaReportsGhlClientsPage(){const e=document.getElementById("dashboard");if(!e)return;const t=await fetchStaffMe();if(!t){window.location.href=`/login?next=${encodeURIComponent(window.location.pathname)}`;return}currentStaffUser=t,metaReportsState.ghlClients.mounted||(e.innerHTML=`
    ...
    `);try{const o=await adminFetch(`/api/meta-reports/custom-values?year=${encodeURIComponent(metaReportsState.selectedYear)}`);metaReportsState.selectedYear=Number(o.year)||metaReportsState.selectedYear,metaReportsState.customValues.overview=o,t||(o.clients||[]).some(s=>s.clientId===metaReportsState.customValues.selectedClientId)||(metaReportsState.customValues.selectedClientId=null,metaReportsState.customValues.selectedMonthKey=null,metaReportsState.customValues.editorPayload=null),a.innerHTML=renderMetaReportsCustomValuesPage(o),metaReportsState.customValues.mounted=!0,metaReportsState.customValues.saving=!1,bindMetaReportsCustomValuesEvents(o)}catch(o){if(!metaReportsState.customValues.mounted)a.innerHTML=`
        ${renderBrandTopbar(renderStaffAdminChrome("meta-reports-custom"))}
        ${wrapDashboardShell(`<div class="error-state" style="padding:24px">${esc(o.message)}</div>`)}
      `;else{if(e)throw o;showToast(o.message||"Load failed","error")}}}const CLIENT_HUB_FILTER_OPTIONS=[{value:"all",label:"All"},{value:"live",label:"Live"},{value:"needs-setup",label:"Needs setup"}],clientsHubState={filter:"all",searchQuery:"",clients:[]};function filterCenhubHubClients(e,t,a=""){let n=e||[];t==="live"&&(n=n.filter(r=>r.status==="ready")),t==="needs-setup"&&(n=n.filter(r=>r.status&&r.status!=="ready"));const o=String(a||"").trim().toLowerCase();return o&&(n=n.filter(r=>`${r.accountName||""} ${r.clientId||""}`.toLowerCase().includes(o))),n}function renderClientHubFiltersHtml(e){return CLIENT_HUB_FILTER_OPTIONS.map(t=>`
    <button
      type="button"
      class="meta-hub-filter${e===t.value?" is-active":""}"
  ...
  `:s;return`
    ...
    <div class="admin-hub">
      ...
      <div class="client-grid" id="client-grid">
        ${o?n.map(l=>renderClientCard(l)).join(""):`<div class="hub-empty">${esc(r)}</div>`}
      </div>
...
This removes the account, GHL token, and all synced snapshot data. This cannot be undone.`))return;if(window.prompt(`Type "${e}" to confirm deletion:`)!==e){showToast("Deletion cancelled \u2014 slug did not match.","error");return}try{await adminFetch(`/api/clients/${encodeURIComponent(e)}`,{method:"DELETE"}),showToast(`Deleted ${e}`,"success"),IS_ADMIN_HUB?await loadAdminHub():window.location.href="/admin"}catch(o){showToast(o.message,"error")}}async function syncClient(e,t){t&&(t.disabled=!0,t.textContent="Syncing...");try{await adminFetch(`/api/clients/${encodeURIComponent(e)}/sync`,{method:"POST",body:"{}"}),showToast("Sync completed","success"),IS_ADMIN_HUB?await loadAdminHub():IS_ADMIN_CLIENT?(await loadSetupAccount(),accountCanPreviewDashboard(setupAccount)&&loadDashboard(!0,{background:!0})):loadDashboard(!0,{background:!0})}catch(a){showToast(a.message,"error")}finally{if(t){t.disabled=!1;const a=t.dataset.syncLabel||"Sync";t.innerHTML=t.dataset.syncLabel?`${ICON_SYNC} ${a}`:a}}}function getMetricsModelLabels(e,t=setupPipelines){const a=new Map((t||[]).map(n=>[n.id,n.name]));return e.dedupeEnabled?{typeLabel:"Funnel + deduplication",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId||"\u2014"}`}:e.winPipelineId?{typeLabel:"Simple (single win pipeline)",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId}`}:{typeLabel:"Simple (no deduplication)",winLabel:"All won opportunities"}}const ICON_LAYER='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z"/><path d="M3 13l9 5 9-5"/></svg>',ICON_MERGE='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="2.4"/><circle cx="6" cy="18" r="2.4"/><circle cx="18" cy="15" r="2.4"/><path d="M6 8.4V15.6"/><path d="M8.2 6.4C14 6.4 14 12.6 15.8 13.4"/></svg>',ICON_TARGET='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>',ICON_LOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 018 0v3.5"/></svg>',ICON_UNLOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 017.8-1.2"/></svg>',ICON_TAG='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.6 12.7L12.7 20.6a2 2 0 01-2.8 0l-7-7a2 2 0 010-2.8L10.8 3H19a2 2 0 012 2v7.7z"/><circle cx="15" cy="8" r="1.2"/></svg>',ICON_HASH='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9h14M5 15h14M10 3L8 21M16 3l-2 18"/></svg>',ICON_EDIT='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 013 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>',ICON_WARNING='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.3 3.9L2.6 18a1.5 1.5 0 001.3 2.2h16.2a1.5 1.5 0 001.3-2.2L13.7 3.9a1.5 1.5 0 00-3.4 0z"/><path d="M12 9v4"/><path d="M12 16.5h.01"/></svg>';function renderMetricsModelPanel(e){const t=getMetricsModelLabels(e),a=!e.metricsModelSetAt||metricsModelChangeMode,n=a?" is-wizard":" is-locked",o=e.dedupeEnabled?"dedupe":e.winPipelineId?"pipeline":"simple",r=e.metricsModelLockedAt?`Locked since ${new Date(e.metricsModelLockedAt).toLocaleDateString("en-GB")}`:"Editable until first successful sync",s=e.metricsModelLockedAt?"metrics-model-badge is-locked":"metrics-model-badge";return a?`
  ...
  `:`
    ...
    <div class="field-group">
      ...
      <select id="${e}">
        ...
        ${n.map(r=>`
          <option value="${esc(r.id)}" ${r.id===a?"selected":""}>${esc(r.name)}</option>
        `).join("")}
      </select>
  ...
  `}function getSetupProgressSteps(e){return[{id:"metrics",label:"Metrics",done:!!e.metricsModelSetAt},{id:"ghl",label:"GHL",done:!!(e.hasGhlToken&&e.locationId)},{id:"pipelines",label:"Pipelines",done:!!(e.newLeadsPipelineId&&e.salesPipelineId)},{id:"meta",label:"Meta",done:e.metaSyncStatus==="ok",partial:!!(e.metaAdAccountId&&e.metaSyncStatus!=="ok")}]}function renderSetupProgressStrip(e){const t=getSetupProgressSteps(e),a='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 6L9 17l-5-5"/></svg>';return`
    <nav class="setup-progress" aria-label="Setup progress">
      ${t.map((n,o)=>{const r=n.done?" is-done":n.partial?" is-partial":"",s=n.done?`<span class="setup-progress-mark">${a}</span>`:`<span class="setup-progress-mark">${o+1}</span>`;return`
          <button type="button" class="setup-progress-step${r}" onclick="scrollToSetupSection('${n.id}')">
            ${s}
      ...
      <div class="checkbox-list">
        ${o.map(([r,s])=>`
          <label class="checkbox-item">
            <input type="checkbox"
              ${isVisible(t,r,n)?"checked":""}
              onchange="toggleDisplay('${t}', '${r}'${n?`, '${n}'`:""})" />
            <span>${s}</span>
          </label>
        `).join("")}
      </div>
  ...
  `:`
    ...
    `}function renderTable(e,t,a,n,o){const r=a.filter(s=>isVisible("columns",s.key,e));return r.length?`
  ...
  `}function renderDashboardContent(e){const{kpis:t,statusBreakdown:a,sourceReport:n,assigneeReport:o,pipelines:r,filters:s}=e,i=isVisible("sections","statusBreakdown");return`
