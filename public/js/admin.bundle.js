    ...
    <div class="sync-history-page meta-reports-page meta-report-client-page">
      ...
      <div class="meta-report-settings">
        <div class="meta-report-settings-group">
          ...
          <label class="meta-report-fee-field${s.metaReportFeeEnabled?"":" is-disabled"}" id="meta-report-fee-field">Fee %
            <input type="number" step="any" min="0" max="100" id="meta-report-setting-fee-percent" value="${esc(s.metaReportFeePercent??20)}" ${s.metaReportFeeEnabled?"":"disabled"} />
          </label>
        </div>
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,n=(e.clients||[]).find(c=>c.clientId===t.selectedClientId),a=t.selectedMonthKey;if(!n||!a)return`
    ...
    <div class="meta-report-settings meta-cv-client-settings${t.settingsSaving?" is-saving":""}">
      ...
      <div class="meta-report-settings-group">
        ...
        ${renderMetaReportSwitch("meta-cv-setting-fee",n.metaReportFeeEnabled,"Censio performance fee")}
        <label class="meta-report-fee-field${n.metaReportFeeEnabled?"":" is-disabled"}" id="meta-cv-fee-field">Fee %
          <input type="number" step="any" min="0" max="100" id="meta-cv-setting-fee-percent" value="${esc(n.metaReportFeePercent??20)}" ${n.metaReportFeeEnabled?"":"disabled"} />
        </label>
      </div>
    </div>
