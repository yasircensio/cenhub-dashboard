    ...
    <section class="meta-report-comparison-view" id="meta-report-comparison-view">
      <div class="meta-report-comparison-controls">
        <div class="meta-report-comparison-presets" id="meta-report-comparison-presets">
          ${META_REPORT_COMPARISON_PRESETS.map(({id:o,label:r})=>{const i=metaReportComparisonPresetDisabled(o,e),l=i&&o==="mom"?"No previous month available":"";return`
              <button type="button" class="preset-btn${metaReportsState.comparisonMode===o?" active":""}${i?" is-disabled":""}" data-comparison-preset="${esc(o)}" aria-pressed="${metaReportsState.comparisonMode===o}"${i?" disabled":""}${l?` title="${esc(l)}"`:""}>${esc(r)}</button>
            `}).join("")}
        </div>
