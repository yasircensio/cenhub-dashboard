  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,n=(e.clients||[]).find(c=>c.clientId===t.selectedClientId),a=t.selectedMonthKey;if(!n||!a)return`
    ...
    <div class="meta-report-settings meta-cv-client-settings${t.settingsSaving?" is-saving":""}">
      ...
      <div class="meta-report-settings-group">
        ...
        ${renderMetaReportSwitch("meta-cv-setting-fee",m,"Censio performance fee",h)}
    ...
    <div class="meta-report-line-items-editor${t.settingsSaving?" is-settings-saving":""}">
      <div class="meta-report-line-items-head meta-cv-line-items-head">
        <div class="meta-cv-line-items-head-row">
          <h4>Other items</h4>
          <button type="button" class="admin-btn admin-btn--secondary admin-btn--small" id="meta-cv-add-line"${t.settingsSaving?" disabled":""}>Add row</button>
        </div>
      ...
      <div id="meta-cv-line-items-list">
        ${$.length?$.map((c,f)=>`
          <div class="meta-report-line-item-row" data-index="${f}">
