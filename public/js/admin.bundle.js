  ...
  `).join("");return`
    ...
    <div class="sync-history-page meta-reports-page">
      ...
      <table class="meta-ghl-clients-table">
        ...
        <tbody>${a||'<tr><td colspan="5">No Meta report clients found.</td></tr>'}</tbody>
      </table>
    </div>
    `)}
