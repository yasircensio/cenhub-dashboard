...
Resume the interrupted ${b}?`)&&(l=h.id,d=Number(h.batchOffset)||0)}}if(n?setFbLeadProgress({processed:d,total:0,label:d>0?"Resuming preview\u2026":"Fetching Meta leads\u2026"}):updateGlobalApplyProgress({waiting:!0,elapsed:0}),n&&d===0){const h=await adminFetchWithRetry("/api/fb-lead-sync/prepare",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:n,runId:l})}),p=h.summary||h;l=p.runId,d=0,setFbLeadProgress({processed:0,total:p.inWindow||0,label:`Matching ${p.inWindow||0} Meta leads to GHL\u2026`})}else!n&&d===0&&updateGlobalApplyProgress({waiting:!1,processed:0,total:w||g?.updated||0});do{u=await adminFetchWithRetry("/api/fb-lead-sync/run",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:n,runId:l,previewRunId:n?null:S,batchOffset:d,batchLimit:o})});const h=u.summary||u;l=h.runId,d=h.nextBatchOffset??h.batchOffset+(h.batchProcessed||0),v=v.concat(h.rows||[]),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.runId=l);const p=h.inWindow||d||w;n?(setFbLeadProgress({processed:d,total:p,complete:!h.hasMore}),i&&(i.innerHTML=renderFbLeadRunResults({...h,rows:v}))):updateGlobalApplyProgress({processed:d,total:p,written:h.updated||0,complete:!h.hasMore})}while((u.summary||u).hasMore);y=!0;const $=u.summary||u,c=$.inWindow||d||w,m=$.nextBatchOffset??d;if(n)setFbLeadProgress({processed:m,total:c,complete:!0}),markFbLeadPreviewReady(e,t,$.updated),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.previewOk=($.updated||0)>0),showToast(($.updated||0)>0?"Preview complete \u2014 use Apply in Run history below.":"Preview complete \u2014 all contacts already have Fb Lead id. Nothing to apply.","success"),await refreshFbLeadHistoryUi(),document.getElementById("fb-lead-history-mount")?.scrollIntoView({behavior:"smooth",block:"nearest"});else{updateGlobalApplyProgress({processed:m,total:c,written:$.updated||0,complete:!0}),delete fbLeadSyncState.previewOkByClient[e];try{const h=JSON.parse(sessionStorage.getItem("fbLeadSyncPreviewOk")||"{}");delete h[e],sessionStorage.setItem("fbLeadSyncPreviewOk",JSON.stringify(h))}catch{}showToast("FB lead sync complete \u2014 Fb Lead id written to GHL","success"),stopGlobalApplyProgress({success:!0})}await refreshFbLeadHistoryUi();const f=await adminFetch("/api/fb-lead-sync");fbLeadSyncState.clients=f.clients||[],hydrateFbLeadPreviewState(fbLeadSyncState.clients),await refreshFbLeadClientRowsUi()}catch($){n?hideFbLeadProgress(!0):(updateGlobalApplyProgress({error:`Failed \u2014 ${$.message||"Apply failed"}`}),stopGlobalApplyProgress({success:!1,keepVisibleMs:12e3})),showToast(($.message||(n?"FB lead preview failed.":"FB lead apply failed."))+(n?" Partial progress is saved \u2014 use Resume in Run history or try Preview again.":" Partial progress is saved \u2014 use Resume in Run history."),"error"),await refreshFbLeadHistoryUi()}finally{s&&(s.disabled=!1),fbLeadSyncState.applyingRunId=null,!y&&n&&hideFbLeadProgress(!0),!n&&!y&&(fbLeadSyncState.isApplying=!1,await refreshFbLeadHistoryUi())}}async function expandFbLeadRun(e){const t=document.getElementById(`fb-lead-run-audit-${e}`);if(t){if(!t.hidden){t.hidden=!0;return}try{const n=await adminFetch(`/api/fb-lead-sync/history/${e}`),a=fbLeadSyncState.clients.find(i=>i.clientId===n.run.clientId);t.innerHTML=`<td colspan="7"><div class="fb-lead-audit-scroll" id="fb-lead-audit-scroll-${e}">${renderFbLeadAuditTable(n.run.rows||[],n.run.locationId||a?.locationId)}</div></td>`,t.hidden=!1;const s=document.getElementById(`fb-lead-audit-scroll-${e}`);s&&s.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(n){showToast(n.message||"Failed to load run audit.","error")}}}function viewFbLeadClientHistory(e){const t=getFbLeadHistoryRunsForDisplay(fbLeadSyncState.historyRuns.filter(s=>s.clientId===e)),n=document.getElementById("fb-lead-history-mount");if(!n)return;const a=Object.fromEntries(fbLeadSyncState.clients.map(s=>[s.clientId,s.locationId]));n.innerHTML=t.length?renderFbLeadHistoryRows(t,a):`<div class="sync-history-empty">No runs for ${esc(e)} yet.</div>`,n.scrollIntoView({behavior:"smooth",block:"start"})}async function loadFbLeadSyncPage({silent:e=!1,fullPreflight:t=!1}={}){const n=document.getElementById("dashboard");if(!n)return;const a=await fetchStaffMe();if(!a){e||(n.innerHTML=`
  ...
  `}function getMetaReportMonthBodyOptions(e={},{editable:t=!1}={}){return{editable:t,showOtherToClient:e.metaReportShowOther!==!1}}function renderMetaReportMonthBody(e,{editable:t=!1,showOtherToClient:n=!0}={}){if(!e)return'<div class="meta-report-empty">No data for this month yet.</div>';if(e.meta?.emptyMonth)return`<div class="meta-report-empty">No ad spend recorded for this month yet.${t?' Click "Refresh from Meta" below, or use "Backfill from Meta" above to pull historical months.':""}</div>`;let a="";t&&(a=`
    ...
    `);const s=[["Total spend",metaFmtKr(e.meta?.spend),""],["Cost Pr Mile (CPM)",metaFmtKr(e.meta?.cpm),""],["Impressions",metaFmtNum(e.meta?.impressions),""],["Reach",metaFmtNum(e.meta?.reach),""],["Click",metaFmtNum(e.meta?.clicks),""],["CTR",metaFmtNum(e.meta?.conversionRatePercent,2),"%"]],i=[["Leads",metaFmtNum(e.topline?.leads),""],["Cost Per Lead (CPL)",metaFmtKr(e.topline?.cpl),""],["Won leads",metaFmtNum(e.topline?.wonLeads),""],["Total Lead Value",metaFmtKr(e.topline?.totalLeadValue),""],["Average Lead Value",metaFmtKr(e.topline?.avgLeadValue),""],["Client acquisition cost (CAC)",metaFmtKr(e.topline?.cac),""],["Return on Ads Spend (ROAS)",metaFmtKr(e.topline?.roasKr),""],["Return on Ads Spend % (ROAS)",metaFmtX(e.topline?.roasX),""]];let o="";if(o+=renderMetaReportMetricTable("Meta ads",s,"meta"),o+=renderMetaReportMetricTable("Topline KPI'er",i,"topline",{highlightLastN:2}),e.bottomline){const v=[["Leads",metaFmtNum(e.bottomline.leads),""],["Won leads",metaFmtNum(e.bottomline.wonLeads),""],["Total Lead Value",metaFmtKr(e.bottomline.totalLeadValue),""],["Average Lead Value",metaFmtKr(e.bottomline.avgLeadValue),""],["Client acquisition cost (CAC)",metaFmtKr(e.bottomline.cac),""],["Avg Total Profit",metaFmtKr(e.bottomline.totalProfit),""],["Avg Single Profit Order",metaFmtKr(e.bottomline.avgProfitPerWon),""],["Profit on Ads Spend (POAS)",metaFmtKr(e.bottomline.poasKr),""],["Profit on Ads Spend % (POAS)",metaFmtX(e.bottomline.poasX),""]];e.bottomline.censioFee>0&&(v.push([`Censio performance fee (${metaFmtNum(e.bottomline.feePercent,0)}%)`,metaFmtKr(e.bottomline.censioFee),""]),v.push(["Profit on Investment (POI)",metaFmtKr(e.bottomline.poiKr),""]),v.push(["Profit on Investment % (POI)",metaFmtX(e.bottomline.poiX),""])),o+=renderMetaReportMetricTable("Bottomline KPI'er",v,"bottomline",{highlightLastN:2})}if(!!e.customLineItems?.length&&(t||n)){const v=e.customLineItems.map(y=>[y.label,metaFmtKr(y.amount),""]);v.push(["Total",metaFmtKr(e.customLineItemsTotal),""]),o+=renderMetaReportMetricTable("Other",v,"other",{badge:t&&!n?"Hidden from client":"",highlightLastN:1})}const d=`
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,n=(e.clients||[]).find(c=>c.clientId===t.selectedClientId),a=t.selectedMonthKey;if(!n||!a)return`
    ...
    `;const s=n.months?.[a]||{},i=t.editorPayload?.months?.[a]||null,o=n.metaReportShowBottomline,r=s.wonLeads!=null?s.wonLeads:i?.inputs?.wonLeads??i?.topline?.wonLeads??"",l=s.avgLeadValue!=null?s.avgLeadValue:i?.inputs?.avgLeadValue??i?.topline?.avgLeadValue??"",d=s.avgProfitPerWon!=null?s.avgProfitPerWon:i?.inputs?.avgProfitPerWon??"",u=i?.customLineItems||[],v=n.metaReportShowOther!==!1,y=metaReportsState.customValues.draftInputs,S=y?.wonLeads??r,g=y?.avgLeadValue??l,w=y?.avgProfitPerWon??d,$=y?.lineItems??u;return`
    ...
    <div class="meta-report-line-items-editor">
      <div class="meta-report-line-items-head meta-cv-line-items-head">
        <div class="meta-cv-line-items-head-row">
          <h4>Other items</h4>
          <button type="button" class="admin-btn admin-btn--secondary admin-btn--small" id="meta-cv-add-line">Add row</button>
        </div>
    ...
    <div class="meta-cv-editor-actions">
      ...
      <button type="button" class="admin-btn admin-btn--primary" id="meta-cv-save"${t.saving||t.loadingEditor?" disabled":""}>
  ...
  `}function refreshMetaCvListAndEditor(){const e=metaReportsState.customValues.overview;if(!e)return;const t=document.getElementById("meta-cv-client-list");t&&(t.innerHTML=renderMetaCvClientRows(e));const n=document.getElementById("meta-cv-editor");n&&(n.innerHTML=renderMetaCvEditor(e)),metaReportsState.customValues.draftInputs=null,bindMetaCvEditorEvents(),bindMetaCvListEvents()}function setMetaCvSavePending(e){metaReportsState.customValues.saving=e;const t=document.getElementById("meta-cv-save");t&&(t.disabled=e||metaReportsState.customValues.loadingEditor,t.textContent=e?"Saving\u2026":"Save values")}function classifyMetaCvMonthStatus(e,t=!1){if(!e)return"empty";const n=e.wonLeads!=null,a=e.avgLeadValue!=null,s=e.avgProfitPerWon!=null,i=Number(e.lineItemCount)||0;return n&&a&&(!t||s)?"complete":n||a||s||i>0?"partial":"empty"}function applyMetaCvSaveResult(e,t,n,a){const i=metaReportsState.customValues.overview?.clients?.find(l=>l.clientId===e),o=i?.months?.[t],r=a?.month||{};o&&(o.wonLeads=r.wonLeads??n.wonLeads,o.avgLeadValue=r.avgLeadValue??n.avgLeadValue,o.avgProfitPerWon=r.avgProfitPerWon??n.avgProfitPerWon,o.lineItemCount=r.lineItems?.length??n.lineItems?.length??0,o.updatedAt=r.updatedAt||new Date().toISOString(),o.status=classifyMetaCvMonthStatus(o,!!i.metaReportShowBottomline)),a?.monthPayload&&(metaReportsState.customValues.editorPayload={...metaReportsState.customValues.editorPayload||{},months:{...metaReportsState.customValues.editorPayload?.months||{},[t]:a.monthPayload}})}async function refreshMetaCvOverviewSilently(){const e=await adminFetch(`/api/meta-reports/custom-values?year=${encodeURIComponent(metaReportsState.selectedYear)}`);metaReportsState.selectedYear=Number(e.year)||metaReportsState.selectedYear,metaReportsState.customValues.overview=e;const t=document.getElementById("meta-cv-client-list");t&&(t.innerHTML=renderMetaCvClientRows(e),bindMetaCvListEvents());const n=document.querySelector(".meta-cv-summary");if(n&&e.summary){const a=e.summary;n.innerHTML=`
    ...
    `}}function collectMetaCvLineItems(){return Array.from(document.querySelectorAll("#meta-cv-line-items-list .meta-report-line-item-row")).map((e,t)=>({label:String(e.querySelector(".meta-cv-line-label")?.value||"").trim(),amount:Number(e.querySelector(".meta-cv-line-amount")?.value)||0,sortOrder:t})).filter(e=>e.label)}function collectMetaCvSaveBody(){return{wonLeads:document.getElementById("meta-cv-won-leads")?.value===""?null:Number(document.getElementById("meta-cv-won-leads")?.value),avgLeadValue:document.getElementById("meta-cv-avg-lead-value")?.value===""?null:Number(document.getElementById("meta-cv-avg-lead-value")?.value),avgProfitPerWon:document.getElementById("meta-cv-avg-profit")?.value===""?null:Number(document.getElementById("meta-cv-avg-profit")?.value),lineItems:collectMetaCvLineItems()}}async function saveMetaCvClientSettings(e,t,n){try{const a=metaReportsState.customValues.selectedMonthKey,s=await patchMetaReportSettings(e,{...t,monthKey:a||void 0}),o=metaReportsState.customValues.overview?.clients?.find(r=>r.clientId===e);o&&s.settings&&(o.metaReportShowBottomline=!!s.settings.metaReportShowBottomline,o.metaReportFeeEnabled=!!s.settings.metaReportFeeEnabled,o.metaReportFeePercent=s.settings.metaReportFeePercent??20,o.metaReportShowOther=s.settings.metaReportShowOther!==!1),s.monthPayload&&a&&(metaReportsState.customValues.editorPayload={...metaReportsState.customValues.editorPayload||{},months:{...metaReportsState.customValues.editorPayload?.months||{},[a]:s.monthPayload}}),metaReportsState.customValues.draftInputs=collectMetaCvSaveBody(),refreshMetaCvListAndEditor(),showToast(describeMetaReportSettingsChange(t,s.settings||{}),"success")}catch(a){showToast(a.message||"Update failed","error"),n&&n()}}function bindMetaCvSettingsEvents(e){const t=document.getElementById("meta-cv-setting-bottomline"),n=document.getElementById("meta-cv-setting-fee"),a=document.getElementById("meta-cv-setting-fee-percent"),s=document.getElementById("meta-cv-setting-other");if(syncMetaReportFeeFieldState(!!n?.checked,"meta-cv"),t&&(t.onchange=()=>{const i=t.checked;saveMetaCvClientSettings(e,{metaReportShowBottomline:i},()=>{t.checked=!i})}),n&&(n.onchange=()=>{const i=n.checked;syncMetaReportFeeFieldState(i,"meta-cv");const o={metaReportFeeEnabled:i};i&&t&&!t.checked&&(t.checked=!0,o.metaReportShowBottomline=!0),saveMetaCvClientSettings(e,o,()=>{n.checked=!i,Object.prototype.hasOwnProperty.call(o,"metaReportShowBottomline")&&t&&(t.checked=!1),syncMetaReportFeeFieldState(n.checked,"meta-cv")})}),a){a.dataset.prevValue=a.value;const i=()=>{if(a.disabled)return;const o=a.dataset.prevValue;let r=Number(a.value);Number.isFinite(r)||(r=20),r=Math.min(100,Math.max(0,r)),a.value=String(r),String(r)!==String(o)&&(a.dataset.prevValue=String(r),saveMetaCvClientSettings(e,{metaReportFeePercent:r},()=>{a.value=o,a.dataset.prevValue=o}))};a.onchange=i,a.onkeydown=o=>{o.key==="Enter"&&(o.preventDefault(),a.blur())}}s&&(s.onchange=()=>{const i=s.checked;saveMetaCvClientSettings(e,{metaReportShowOther:i},()=>{s.checked=!i})})}async function selectMetaCvMonth(e,t,{reloadEditor:n=!0}={}){if(metaReportsState.customValues.selectedClientId=e,metaReportsState.customValues.selectedMonthKey=t,refreshMetaCvListAndEditor(),!!n){metaReportsState.customValues.loadingEditor=!0,refreshMetaCvListAndEditor();try{const a=String(t).slice(0,4),s=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}?year=${encodeURIComponent(a)}`);metaReportsState.customValues.selectedClientId===e&&metaReportsState.customValues.selectedMonthKey===t&&(metaReportsState.customValues.editorPayload=s)}catch(a){showToast(a.message||"Failed to load month","error")}finally{metaReportsState.customValues.loadingEditor=!1,refreshMetaCvListAndEditor()}}}function bindMetaCvListEvents(){document.querySelectorAll("[data-meta-cv-month]").forEach(e=>{e.onclick=()=>{selectMetaCvMonth(e.getAttribute("data-meta-cv-client"),e.getAttribute("data-meta-cv-month"))}})}function bindMetaCvEditorEvents(){const e=metaReportsState.customValues.selectedClientId;e&&bindMetaCvSettingsEvents(e);const t=document.getElementById("meta-cv-client-select"),n=document.getElementById("meta-cv-month-select");t&&(t.onchange=()=>{const i=metaReportsState.customValues.selectedMonthKey||metaReportsState.customValues.overview?.monthKeys?.slice(-1)[0];i&&selectMetaCvMonth(t.value,i)}),n&&(n.onchange=()=>{const i=metaReportsState.customValues.selectedClientId;i&&selectMetaCvMonth(i,n.value)});const a=document.getElementById("meta-cv-add-line");a&&(a.onclick=()=>{const i=document.getElementById("meta-cv-line-items-list");if(!i)return;i.querySelector(".note")&&(i.innerHTML="");const o=document.createElement("div");o.className="meta-report-line-item-row",o.innerHTML=`
        ...
        <button type="button" class="admin-btn admin-btn--ghost admin-btn--small meta-cv-line-remove">Remove</button>
      `,i.appendChild(o),o.querySelector(".meta-cv-line-remove")?.addEventListener("click",()=>o.remove())}),document.querySelectorAll(".meta-cv-line-remove").forEach(i=>{i.onclick=()=>i.closest(".meta-report-line-item-row")?.remove()});const s=document.getElementById("meta-cv-save");s&&(s.onclick=async()=>{const i=metaReportsState.customValues.selectedClientId,o=metaReportsState.customValues.selectedMonthKey;if(!i||!o)return;const r=collectMetaCvSaveBody();fetch("http://127.0.0.1:7412/ingest/8036624f-bbd1-4142-b516-bb72c323b06c",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"b952dc"},body:JSON.stringify({sessionId:"b952dc",runId:"post-fix-flash",hypothesisId:"F",location:"index.html:meta-cv-save",message:"save body captured",data:{clientId:i,monthKey:o,body:r},timestamp:Date.now()})}).catch(()=>{}),setMetaCvSavePending(!0);try{const l=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(i)}/months/${encodeURIComponent(o)}`,{method:"PUT",body:JSON.stringify(r)});applyMetaCvSaveResult(i,o,r,l),metaReportsState.customValues.draftInputs=r,setMetaCvSavePending(!1),refreshMetaCvListAndEditor(),fetch("http://127.0.0.1:7412/ingest/8036624f-bbd1-4142-b516-bb72c323b06c",{method:"POST",headers:{"Content-Type":"application/json","X-Debug-Session-Id":"b952dc"},body:JSON.stringify({sessionId:"b952dc",runId:"post-fix-flash",hypothesisId:"F",location:"index.html:meta-cv-save",message:"save applied without full editor wipe",data:{wonLeads:r.wonLeads,domWon:document.getElementById("meta-cv-won-leads")?.value},timestamp:Date.now()})}).catch(()=>{}),showToast("Custom values saved","success"),await refreshMetaCvOverviewSilently()}catch(l){showToast(l.message||"Save failed","error"),setMetaCvSavePending(!1)}})}function bindMetaReportsCustomValuesEvents(e){const t=document.getElementById("meta-cv-year");t&&(t.onchange=async()=>{metaReportsState.selectedYear=Number(t.value),metaReportsState.customValues.selectedClientId=null,metaReportsState.customValues.selectedMonthKey=null,metaReportsState.customValues.editorPayload=null,await loadMetaReportsCustomValuesPage({silent:!0})});const n=document.getElementById("meta-cv-search");n&&(n.oninput=()=>{metaReportsState.customValues.searchQuery=n.value;const a=document.getElementById("meta-cv-client-list");a&&(a.innerHTML=renderMetaCvClientRows(e)),bindMetaCvListEvents()}),bindMetaCvListEvents(),bindMetaCvEditorEvents()}async function loadMetaReportsCustomValuesPage({silent:e=!1,keepSelection:t=!1}={}){const n=document.getElementById("dashboard");if(!n)return;const a=await fetchStaffMe();if(!a){window.location.href=`/login?next=${encodeURIComponent(window.location.pathname)}`;return}currentStaffUser=a,!metaReportsState.customValues.mounted&&!e&&(n.innerHTML=`
      ${renderBrandTopbar(renderStaffAdminChrome("meta-reports-custom"))}
