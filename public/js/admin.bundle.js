  ...
  `).join("")}function renderAdminHubSkeletonPage(e){const t=e==="clients",n=e==="google-ads",a=t?"clients":n?"google-ads":"meta-reports",o=t?"Client administration":n?"Google Ads reports":"Meta client reports",s=t?`<div class="page-hero admin-hub-hero">
        ...
        <div class="meta-premium-page-hero-inner">
          <div class="admin-breadcrumb">
            ...
            <span>${n?"Google Ads":"Meta reports"}</span>
          </div>
          <h1>${o}</h1>
        </div>
      </div>`,i=t?"client-grid":"meta-hub-cards";return`
    ${renderBrandTopbar(renderStaffAdminChrome(a))}
    ${wrapDashboardShell(`
    ${s}
...
Resume the interrupted ${S}?`)&&(l=$.id,c=Number($.batchOffset)||0)}}if(n?setFbLeadProgress({processed:c,total:0,label:c>0?"Resuming preview\u2026":"Fetching Meta leads\u2026"}):updateGlobalApplyProgress({waiting:!0,elapsed:0}),n&&c===0){const $=await adminFetchWithRetry("/api/fb-lead-sync/prepare",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:n,runId:l})}),w=$.summary||$;l=w.runId,c=0,setFbLeadProgress({processed:0,total:w.inWindow||0,label:`Matching ${w.inWindow||0} Meta leads to GHL\u2026`})}else!n&&c===0&&updateGlobalApplyProgress({waiting:!1,processed:0,total:b||h?.updated||0});do{d=await adminFetchWithRetry("/api/fb-lead-sync/run",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:n,runId:l,previewRunId:n?null:f,batchOffset:c,batchLimit:s})});const $=d.summary||d;l=$.runId,c=$.nextBatchOffset??$.batchOffset+($.batchProcessed||0),u=u.concat($.rows||[]),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.runId=l);const w=$.inWindow||c||b;n?(setFbLeadProgress({processed:c,total:w,complete:!$.hasMore}),r&&(r.innerHTML=renderFbLeadRunResults({...$,rows:u}))):updateGlobalApplyProgress({processed:c,total:w,written:$.updated||0,complete:!$.hasMore})}while((d.summary||d).hasMore);p=!0;const y=d.summary||d,m=y.inWindow||c||b,g=y.nextBatchOffset??c;if(n)setFbLeadProgress({processed:g,total:m,complete:!0}),markFbLeadPreviewReady(e,t,y.updated),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.previewOk=(y.updated||0)>0),showToast((y.updated||0)>0?"Preview complete \u2014 use Apply in Run history below.":"Preview complete \u2014 all contacts already have Fb Lead id. Nothing to apply.","success"),await refreshFbLeadHistoryUi(),document.getElementById("fb-lead-history-mount")?.scrollIntoView({behavior:"smooth",block:"nearest"});else{updateGlobalApplyProgress({processed:g,total:m,written:y.updated||0,complete:!0}),delete fbLeadSyncState.previewOkByClient[e];try{const $=JSON.parse(sessionStorage.getItem("fbLeadSyncPreviewOk")||"{}");delete $[e],sessionStorage.setItem("fbLeadSyncPreviewOk",JSON.stringify($))}catch{}showToast("FB lead sync complete \u2014 Fb Lead id written to GHL","success"),stopGlobalApplyProgress({success:!0})}await refreshFbLeadHistoryUi();const v=await adminFetch("/api/fb-lead-sync");fbLeadSyncState.clients=v.clients||[],hydrateFbLeadPreviewState(fbLeadSyncState.clients),await refreshFbLeadClientRowsUi()}catch(y){n?hideFbLeadProgress(!0):(updateGlobalApplyProgress({error:`Failed \u2014 ${y.message||"Apply failed"}`}),stopGlobalApplyProgress({success:!1,keepVisibleMs:12e3})),showToast((y.message||(n?"FB lead preview failed.":"FB lead apply failed."))+(n?" Partial progress is saved \u2014 use Resume in Run history or try Preview again.":" Partial progress is saved \u2014 use Resume in Run history."),"error"),await refreshFbLeadHistoryUi()}finally{o&&(o.disabled=!1),fbLeadSyncState.applyingRunId=null,!p&&n&&hideFbLeadProgress(!0),!n&&!p&&(fbLeadSyncState.isApplying=!1,await refreshFbLeadHistoryUi())}}async function expandFbLeadRun(e){const t=document.getElementById(`fb-lead-run-audit-${e}`);if(t){if(!t.hidden){t.hidden=!0;return}try{const n=await adminFetch(`/api/fb-lead-sync/history/${e}`),a=fbLeadSyncState.clients.find(r=>r.clientId===n.run.clientId);t.innerHTML=`<td colspan="7"><div class="fb-lead-audit-scroll" id="fb-lead-audit-scroll-${e}">${renderFbLeadAuditTable(n.run.rows||[],n.run.locationId||a?.locationId)}</div></td>`,t.hidden=!1;const o=document.getElementById(`fb-lead-audit-scroll-${e}`);o&&o.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(n){showToast(n.message||"Failed to load run audit.","error")}}}function viewFbLeadClientHistory(e){const t=getFbLeadHistoryRunsForDisplay(fbLeadSyncState.historyRuns.filter(o=>o.clientId===e)),n=document.getElementById("fb-lead-history-mount");if(!n)return;const a=Object.fromEntries(fbLeadSyncState.clients.map(o=>[o.clientId,o.locationId]));n.innerHTML=t.length?renderFbLeadHistoryRows(t,a):`<div class="sync-history-empty">No runs for ${esc(e)} yet.</div>`,n.scrollIntoView({behavior:"smooth",block:"start"})}async function loadFbLeadSyncPage({silent:e=!1,fullPreflight:t=!1}={}){const n=document.getElementById("dashboard");if(!n)return;const a=await fetchStaffMe();if(!a){e||(n.innerHTML=`
  ...
  `}function renderLinkedReportLinkControl(){const e=linkedReportsState.pair,t=linkedReportsState.origin||(IS_ADMIN_GOOGLE_ADS_CLIENT?"google-ads":"meta");if(e){const a=t==="meta"?e.googleAccountName:e.metaAccountName;return`<button type="button" class="admin-btn admin-btn--secondary linked-report-link-btn" id="linked-report-link-btn">Linked \xB7 ${esc(a||"partner")}</button>`}return`<button type="button" class="admin-btn admin-btn--secondary linked-report-link-btn" id="linked-report-link-btn">${esc(t==="meta"?"Link Google Ads":"Link Meta report")}</button>`}function linkedAdminOrigin(){return linkedReportsState.origin||(IS_ADMIN_GOOGLE_ADS_CLIENT?"google-ads":"meta")}function renderLinkedAdminPlatformTabsHtml(){const e=[];return linkedReportsState.metaPayload&&e.push("meta"),linkedReportsState.googlePayload&&e.push("google-ads"),renderLinkedReportPlatformTabs({platforms:e,activePlatform:linkedReportsState.activePlatform||linkedAdminOrigin()})}function renderLinkedPublicPlatformTabsHtml(){const e=linkedReportsState.publicDual;return e?.platforms?renderLinkedReportPlatformTabs({platforms:e.platforms,activePlatform:linkedReportsState.activePlatform||e.origin||"meta"}):""}function renderLinkedAdminEditorInner(){if(isGoogleAdsEditorActive()&&linkedReportsState.googlePayload){const s=linkedReportsState.googlePayload,i=googleAdsPayloadToMetaUiShape(s),l=s.monthKeys||[],c=googleAdsReportsState.activeMonthKey||l[l.length-1]||"",d=googleAdsMonthToMetaUiShape(s.months?.[c]||null),u=l.map(p=>`
    ...
    `}const e=linkedReportsState.metaPayload||metaReportsState.clientPayload,t=e?.monthKeys||[],n=metaReportsState.activeMonthKey||t[t.length-1]||"",a=e?.months?.[n]||null,o=e?.settings||{},r=t.map(s=>`
  ...
  `}function applyLinkedAdminPlatformState(e){if(linkedReportsState.activePlatform=e,metaReportsState.clientShareExpanded=!1,metaReportsState.clientReportSettingsExpanded=!1,metaReportsState.clientExcelSheetExpanded=!1,metaReportsState.reportViewMode="monthly",metaReportsState.chartProjection=null,e==="google-ads"&&linkedReportsState.googlePayload){const n=linkedReportsState.googlePayload,a=googleAdsPayloadToMetaUiShape(n);return googleAdsReportsState.clientPayload=n,metaReportsState.clientPayload=a,googleAdsReportsState.selectedYear=Number(n.year)||googleAdsReportsState.selectedYear,metaReportsState.selectedYear=googleAdsReportsState.selectedYear,(!googleAdsReportsState.activeMonthKey||!(n.monthKeys||[]).includes(googleAdsReportsState.activeMonthKey))&&(googleAdsReportsState.activeMonthKey=n.monthKeys?.[n.monthKeys.length-1]||null),metaReportsState.activeMonthKey=googleAdsReportsState.activeMonthKey,hydrateMetaReportSpendChartType(a),hydrateMetaReportScenarioSettings(a),a}const t=linkedReportsState.metaPayload;return metaReportsState.clientPayload=t,t?.year&&(metaReportsState.selectedYear=Number(t.year)),(!metaReportsState.activeMonthKey||!(t?.monthKeys||[]).includes(metaReportsState.activeMonthKey))&&(metaReportsState.activeMonthKey=t?.monthKeys?.[t.monthKeys.length-1]||null),hydrateMetaReportSpendChartType(t),hydrateMetaReportScenarioSettings(t),t}function bindLinkedReportChrome({publicView:e=!1}={}){document.querySelectorAll("[data-linked-platform]").forEach(n=>{n.onclick=()=>{const a=n.getAttribute("data-linked-platform");!a||a===linkedReportsState.activePlatform||(e?switchLinkedPublicPlatform(a):switchLinkedAdminPlatform(a))}});const t=document.getElementById("linked-report-link-btn");t&&(t.onclick=()=>openLinkedReportPickerModal())}function bindLinkedAdminEditorEvents(){if(bindLinkedReportChrome(),isGoogleAdsEditorActive()&&linkedReportsState.googlePayload){bindGoogleAdsReportsClientEvents(linkedReportsState.googlePayload);return}const e=linkedReportsState.metaPayload||metaReportsState.clientPayload;e&&bindMetaReportsClientEvents(e)}function switchLinkedAdminPlatform(e){const t=applyLinkedAdminPlatformState(e),n=document.querySelector(".meta-report-client-page");if(!n||!t)return;n.innerHTML=renderLinkedAdminEditorInner(),bindLinkedAdminEditorEvents();const a=isGoogleAdsEditorActive()&&linkedReportsState.googlePayload?.clientId||t.clientId;ensureMetaReportScenarioSource(t,{editable:!0}).then(()=>{mountMetaReportCharts(t,{editable:!0,clientId:a})})}function publicLinkedActiveRawPayload(){return linkedReportsState.activePlatform==="google-ads"?linkedReportsState.googlePayload||linkedReportsState.publicDual?.google||null:linkedReportsState.publicDual?linkedReportsState.metaPayload||linkedReportsState.publicDual?.meta||null:metaReportsState.publicPayload}function switchLinkedPublicPlatform(e){linkedReportsState.activePlatform=e;const t=publicLinkedActiveRawPayload();if(!t)return;metaReportsState.activeMonthKey=null,metaReportsState.selectedYear=Number(t.year)||metaReportsState.selectedYear,metaReportsState.comparisonYearCache={};const n=t.reportKind==="google-ads"?googleAdsPayloadToMetaUiShape(t):t;hydrateMetaReportSpendChartType(n),hydrateMetaReportScenarioSettings(n),ensureMetaReportScenarioSource(n,{editable:!1}).then(()=>{updatePublicMetaReportContent(t),bindLinkedReportChrome({publicView:!0});const a=document.getElementById("meta-report-year");a&&!a.onchange&&bindPublicMetaReportEvents(t)})}function renderLinkedReportPickerSkeleton(e=5){return Array.from({length:e}).map(()=>`
  ...
  `).join("")}function renderLinkedReportPickerItems(e,t=""){const n=String(t||"").trim().toLowerCase(),a=linkedReportsState.pair,r=linkedAdminOrigin()==="meta"?a?.googleClientId:a?.metaClientId,s=e.filter(i=>n?[i.name,i.id,i.sub].filter(Boolean).join(" ").toLowerCase().includes(n):!0);return s.length?(s.sort((i,l)=>{const c=i.id===r?0:1,d=l.id===r?0:1;return c!==d?c-d:String(i.name||"").localeCompare(String(l.name||""))}),s.map(i=>{const l=i.id===r,c=String(i.name||i.id||"?").trim().charAt(0).toUpperCase();return`
    ...
    `}).join("")):'<p class="linked-report-picker-empty">No matching accounts.</p>'}async function saveLinkedReportPair(e,t){const n=`/api/google-ads-reports/clients/${encodeURIComponent(e)}/settings`;return adminFetch(n,{method:"PATCH",body:JSON.stringify({linkedMetaClientId:t})})}async function reloadLinkedAdminPairAndRender(){if(linkedAdminOrigin()==="google-ads"){googleAdsReportsState.clientPageMounted=!1,await loadGoogleAdsClientPage({silent:!0});return}metaReportsState.clientPageMounted=!1,await loadMetaReportsClientPage({silent:!0})}async function reloadCurrentLinkedEditor(){if(isGoogleAdsEditorActive()&&linkedReportsState.googlePayload){if(linkedReportsState.origin==="meta"){const e=linkedReportsState.googlePayload.clientId,t=await adminFetch(`/api/google-ads-reports/clients/${encodeURIComponent(e)}?year=${encodeURIComponent(googleAdsReportsState.selectedYear)}`);linkedReportsState.googlePayload=t,googleAdsReportsState.clientPayload=t,googleAdsReportsState.selectedYear=Number(t.year)||googleAdsReportsState.selectedYear,applyLinkedAdminPlatformState("google-ads");const n=document.querySelector(".meta-report-client-page");n&&(n.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents();const a=googleAdsPayloadToMetaUiShape(t);requestAnimationFrame(()=>{mountMetaReportCharts(a,{editable:!0,clientId:e})});return}await loadGoogleAdsClientPage({silent:!0});return}if(linkedReportsState.origin==="google-ads"&&linkedReportsState.metaPayload){const e=linkedReportsState.metaPayload.clientId,t=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}?year=${encodeURIComponent(metaReportsState.selectedYear)}`);linkedReportsState.metaPayload=t,applyLinkedAdminPlatformState("meta");const n=document.querySelector(".meta-report-client-page");n&&(n.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents(),requestAnimationFrame(()=>{mountMetaReportCharts(t,{editable:!0,clientId:e})});return}await loadMetaReportsClientPage({silent:!0})}async function openLinkedReportPickerModal(){const e=linkedAdminOrigin(),t=linkedReportsState.pair,n=e==="meta"?"Link Google Ads account":"Link Meta report",a=e==="meta"?t?.googleAccountName:t?.metaAccountName;openMetaReportModal(`
    <div class="meta-report-modal-head">
      <h2 class="meta-report-modal-title">${esc(n)}</h2>
      ...
      ${t?`
        <div class="linked-report-picker-current">
          <div class="linked-report-picker-current-copy">
            ...
            <span class="linked-report-picker-current-name">${esc(a||"partner")}</span>
          </div>
  ...
  `:""}function renderMetaReportMonthBody(e,{editable:t=!1,yearPayload:n=null,activeMonthKey:a=null,settings:o=null}={}){const r=a||e?.monthKey||null,s=r?metaReportMonthBounds(r):null,i=o||n?.settings||{},l=isMetaReportGhlListClient(i),c=resolveClientToplineMode(i),d=resolveMetaToplineSource(e,i),u=l&&c==="cenhub"&&d==="ghl";let p="";if(t&&e&&!e.meta?.emptyMonth&&s){const E=u?" readonly":"",I=renderMetaReportMonthManualRow(e,i);p=`
    ...
    `}const f=a||e?.monthKey||null,h=t?f?`Report preview \xB7 ${metaMonthLabel(f)}`:"Report preview":f?`Report \xB7 ${metaMonthLabel(f)}`:"Report",b=metaReportsState.reportViewMode||"monthly",y=shouldShowMetaReportYearVisuals(e,n,{editable:t}),m=t&&y,g=e&&!e.meta?.emptyMonth?`
  ...
  `:"",v=renderMetaReportMonthTables(e,{editable:t}),$=y?renderMetaReportChartsPanel({editable:t}):"",w=t&&y?renderMetaReportScenarioCard():"",S=m?renderMetaReportViewModeTabs():"";let R;return y?R=`
      ...
      ${w}
    `:R=`<div class="meta-report-content-main">${v}</div>`,`${p}${g}${S}${R}`}function renderMetaReportsHubPage(e){const t=e.clients||[],n=e.meta||{};return`
  ...
  `}function renderMetaReportsClientPage(e){return`
    ...
    `)}
  `}function metaReportClientDisplayName(e){return String(e?.accountName||e?.clientId||"").trim()||"Meta report"}function syncMetaReportPublicBranding(e){const t=metaReportClientDisplayName(e);document.title=`${t} \xB7 Censio Analytics`;const n=document.querySelector(".meta-report-public-hero h1");n&&(n.textContent=t)}function renderPublicMetaReportPage(e){const t=e.reportKind==="google-ads"||linkedReportsState.activePlatform==="google-ads",n=t?googleAdsPayloadToMetaUiShape(e):e,a=metaReportClientDisplayName(n),o=n.monthKeys||[],r=metaReportsState.activeMonthKey||o[o.length-1]||"",s=n.months?.[r]||null,i=t?renderGoogleAdsReportMonthBody(s,{editable:!1,yearPayload:n,activeMonthKey:r}):renderMetaReportMonthBody(s,getMetaReportMonthBodyOptions(n.settings,{editable:!1,yearPayload:n})),l=o.map(d=>`
    ...
    <div class="meta-reports-page meta-reports-page--public">
      ...
      <div class="meta-report-toolbar">
        <div class="meta-report-toolbar-left">
          <label class="meta-report-year-field">Year
            <select id="meta-report-year" class="admin-select">
              ${renderMetaReportYearSelectOptions(n,{disableUnavailable:!0})}
            </select>
          </label>
        ...
        <div class="meta-report-toolbar-actions" id="meta-report-public-excel-sheet-btn">
          ${renderMetaReportExcelSheetButton(n.settings||{},{variant:"secondary"})}
        </div>
      </div>
  ...
  `}function setMetaReportYearLoadingBanner(e,t,n){const a=document.querySelector(e);if(!a)return;let o=a.querySelector(".meta-report-year-loading-banner");n?(o||(o=document.createElement("span"),o.className="meta-report-year-loading-banner",o.setAttribute("aria-live","polite"),a.appendChild(o)),o.innerHTML=`<span class="meta-report-save-indicator-spinner"></span> Loading ${esc(t)}\u2026`,o.hidden=!1):o&&(o.hidden=!0)}function setMetaReportClientYearLoading(e,t){const n=document.querySelector(".meta-report-client-page"),a=document.getElementById("meta-report-year");if(t){a&&(a.disabled=!0),n&&n.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!0);const o=document.querySelector(".meta-report-tabs");o&&(o.innerHTML=renderMetaReportTabsSkeleton(),o.setAttribute("aria-busy","true"));const r=document.getElementById("meta-report-month-panel");r&&(r.innerHTML=renderMetaReportMonthPanelSkeleton(),r.classList.add("is-loading")),destroyMetaReportCharts()}else{a&&(a.disabled=!1),n&&n.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!1);const o=document.querySelector(".meta-report-tabs");o&&o.removeAttribute("aria-busy");const r=document.getElementById("meta-report-month-panel");r&&r.classList.remove("is-loading")}}function setMetaCvYearLoading(e,t){const n=document.querySelector(".sync-history-page.meta-reports-page"),a=document.getElementById("meta-cv-year"),o=document.getElementById("meta-cv-search");if(t){a&&(a.disabled=!0),o&&(o.disabled=!0),n&&n.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!0);const r=document.querySelector(".meta-cv-summary");r&&(r.classList.add("is-skeleton"),r.innerHTML=renderMetaCvSummarySkeleton());const s=document.querySelector(".meta-cv-legend");s&&s.setAttribute("aria-hidden","true");const i=document.getElementById("meta-cv-client-list");i&&(i.innerHTML=renderMetaCvListSkeleton(),i.setAttribute("aria-busy","true"));const l=document.getElementById("meta-cv-editor");l&&(l.innerHTML=renderMetaCvEditorYearSkeleton(),l.setAttribute("aria-busy","true"))}else{a&&(a.disabled=!1),o&&(o.disabled=!1),n&&n.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!1);const r=document.querySelector(".meta-cv-summary");r&&r.classList.remove("is-skeleton");const s=document.querySelector(".meta-cv-legend");s&&s.removeAttribute("aria-hidden");const i=document.getElementById("meta-cv-client-list");i&&i.removeAttribute("aria-busy");const l=document.getElementById("meta-cv-editor");l&&l.removeAttribute("aria-busy")}}function setMetaReportPublicYearLoading(e,t){const n=document.querySelector(".meta-reports-page--public"),a=document.getElementById("meta-report-year");if(t){a&&(a.disabled=!0),n&&n.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!0);const o=document.querySelector(".meta-reports-page--public .meta-report-tabs");o&&(o.innerHTML=renderMetaReportTabsSkeleton(),o.setAttribute("aria-busy","true"));const r=document.getElementById("meta-report-month-panel");r&&(r.innerHTML=renderMetaReportMonthPanelSkeleton(),r.classList.add("is-loading")),destroyMetaReportCharts()}else{a&&(a.disabled=!1),n&&n.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!1);const o=document.querySelector(".meta-reports-page--public .meta-report-tabs");o&&o.removeAttribute("aria-busy");const r=document.getElementById("meta-report-month-panel");r&&r.classList.remove("is-loading")}}function bindMetaReportsClientChromeEvents(e){const t=e.clientId,n=document.getElementById("meta-report-year");n&&(n.onchange=async()=>{if(n.selectedOptions?.[0]?.disabled){n.value=String(metaReportsState.selectedYear);return}const o=metaReportsState.selectedYear,r=Number(n.value);if(r!==o){metaReportsState.selectedYear=r,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportClientYearLoading(r,!0);try{if(linkedReportsState.origin==="google-ads"&&linkedReportsState.metaPayload){const s=linkedReportsState.metaPayload.clientId,i=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(s)}?year=${encodeURIComponent(r)}`);linkedReportsState.metaPayload=i,syncMetaReportSelectedYear(i,{disableUnavailable:!0}),Number(metaReportsState.selectedYear)!==Number(i.year)&&(metaReportsState.selectedYear=i.year),applyLinkedAdminPlatformState("meta");const l=document.querySelector(".meta-report-client-page");l&&(l.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents(),requestAnimationFrame(()=>{mountMetaReportCharts(i,{editable:!0,clientId:s})})}else await loadMetaReportsClientPage({silent:!0})}catch(s){if(metaReportsState.selectedYear=o,n&&(n.value=String(o)),linkedReportsState.origin==="google-ads"&&linkedReportsState.metaPayload){applyLinkedAdminPlatformState("meta");const i=document.querySelector(".meta-report-client-page");i&&(i.innerHTML=renderLinkedAdminEditorInner()),bindLinkedAdminEditorEvents()}else await loadMetaReportsClientPage({silent:!0});showToast(s.message||"Load failed","error")}finally{setMetaReportClientYearLoading(r,!1)}}}),bindMetaReportCopyButtons(),bindMetaReportBackfillButton(t),bindMetaReportBottomlineSummaryEvents(e),bindMetaReportExcelSheetSummaryEvents(e),bindMetaReportShareEvents(e)}function bindMetaReportsClientEvents(e){bindMetaReportsClientChromeEvents(e),bindMetaReportsClientTabEvents(e),rebindMetaReportMonthPanelEvents(e.clientId,e),isMetaReportGhlListClient(e.settings||{})&&bindMetaReportToplineSourceControl(e.clientId,e),bindLinkedReportChrome()}function bindMetaReportsClientEditEvents(e,t){const n=document.getElementById("meta-report-refresh-meta");n&&(n.onclick=async()=>{n.disabled=!0;try{const o=metaReportsState.activeMonthKey,r=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(o)}/refresh`,{method:"POST"});refreshMetaReportMonthPanel(r.monthPayload),showToast("Meta data refreshed","success")}catch(o){showToast(o.message||"Meta refresh failed","error")}finally{n.disabled=!1}});const a=document.getElementById("meta-report-save-month");a&&(a.onclick=async()=>{a.disabled=!0;try{const o=metaReportsState.activeMonthKey,r=t?.months?.[o],s=t?.settings||{},i=resolveClientToplineMode(s),l=resolveMetaToplineSource(r,s),c=isMetaReportGhlListClient(s)&&i==="cenhub"&&l==="manual",d={periodStart:document.getElementById("meta-report-period-start")?.value,periodEnd:document.getElementById("meta-report-period-end")?.value,wonLeads:document.getElementById("meta-report-won-leads")?.value===""?null:Number(document.getElementById("meta-report-won-leads")?.value),avgLeadValue:document.getElementById("meta-report-avg-lead-value")?.value===""?null:Number(document.getElementById("meta-report-avg-lead-value")?.value),avgProfitPerWon:document.getElementById("meta-report-avg-profit")?.value===""?null:Number(document.getElementById("meta-report-avg-profit")?.value)};c&&(d.toplineSource="manual",d.manualOverride=!0,d.manualLeads=document.getElementById("meta-report-leads")?.value===""?null:Number(document.getElementById("meta-report-leads")?.value));const u=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(o)}`,{method:"PUT",body:JSON.stringify(d)});refreshMetaReportMonthPanel(u.monthPayload),showToast("Month saved","success")}catch(o){showToast(o.message||"Save failed","error")}finally{a.disabled=!1}})}function bindPublicMetaReportTabEvents(e){document.querySelectorAll("[data-meta-month-tab]").forEach(t=>{t.onclick=()=>{switchMetaReportMonthTab(t.getAttribute("data-meta-month-tab"),{editable:!1})}})}function bindPublicMetaReportEvents(e){bindPublicMetaReportTabEvents(e),bindLinkedReportChrome({publicView:!0});const t=document.getElementById("meta-report-year");t&&(t.onchange=async()=>{if(t.selectedOptions?.[0]?.disabled){t.value=String(metaReportsState.selectedYear);return}const a=metaReportsState.selectedYear,o=Number(t.value);if(o!==a){metaReportsState.selectedYear=o,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportPublicYearLoading(o,!0);try{await loadPublicMetaReportPage({silent:!0})}catch(r){metaReportsState.selectedYear=a,t&&(t.value=String(a)),await loadPublicMetaReportPage({silent:!0}),showToast(r.message||"Load failed","error")}finally{setMetaReportPublicYearLoading(o,!1)}}})}async function loadMetaReportsHubPage(){const e=document.getElementById("dashboard");if(!e)return;const t=await fetchStaffMe();if(!t){e.innerHTML=`
    ...
    `;return}currentStaffUser=t,metaReportsState.hubMounted||(e.innerHTML=renderAdminHubSkeletonPage("meta-reports"));try{const n=await adminFetch("/api/meta-reports?filter=all");metaReportsState.dashboardData=n;const a=getMetaReportsHubView(n,metaReportsState.filter,metaReportsState.searchQuery);metaReportsState.hubMounted?updateMetaReportsHubDom(a):(e.innerHTML=renderMetaReportsHubPage(a),metaReportsState.hubMounted=!0,bindMetaReportsHubEvents())}catch(n){metaReportsState.hubMounted?showToast(n.message||"Load failed","error"):e.innerHTML=`
        ${renderBrandTopbar(renderStaffAdminChrome("meta-reports"))}
        ${wrapDashboardShell(`<div class="error-state" style="padding:24px">${esc(n.message)}</div>`)}
    ...
    <div class="meta-report-control-panel${a?" is-editing-share":""}${o?" is-editing-report":""}${n.metaReportEnabled?"":" is-share-disabled"}" id="meta-report-control-panel">
      <div class="meta-report-control-bar">
        ...
        <div class="meta-report-control-bar-actions meta-report-toolbar-actions">
          <span class="meta-report-save-indicator" id="meta-report-save-indicator"><span class="meta-report-save-indicator-spinner"></span> Saving\u2026</span>
          ${s?`<button type="button" class="admin-btn admin-btn--secondary" id="meta-report-toolbar-copy-link" data-copy-report-url="${esc(t.reportUrl)}"${n.metaReportEnabled?"":" disabled"}>Copy link</button>`:""}
          ${resolveMetaReportExcelSheetUrl(n)?`<a class="admin-btn admin-btn--secondary" id="meta-report-excel-sheet-toolbar-btn" href="${esc(resolveMetaReportExcelSheetUrl(n))}" target="_blank" rel="noopener noreferrer">See Excel sheet</a>`:'<a class="admin-btn admin-btn--secondary" id="meta-report-excel-sheet-toolbar-btn" href="#" target="_blank" rel="noopener noreferrer" hidden>See Excel sheet</a>'}
          ${renderLinkedReportLinkControl()}
        </div>
      </div>
      ${s?`
        <div class="meta-report-control-status-rows"${i?" hidden":""} id="meta-report-control-status">
          ...
          <div class="meta-report-control-status-grid">
            ${renderMetaReportExcelSheetSummary(n)}
          </div>
        </div>
      `:`
  ...
  `}function refreshGoogleAdsReportClientShareUi(e){const t=googleAdsPayloadToMetaUiShape(e);refreshMetaReportClientShareUi(t)}function bindGoogleAdsReportShareEvents(e){const t=googleAdsPayloadToMetaUiShape(e),n=e.clientId;bindMetaReportCopyButtons();const a=document.getElementById("meta-report-rotate-token");a&&(a.onclick=async()=>{if(window.confirm("Rotate the share link? The old link will stop working.")){a.disabled=!0;try{const c=(await patchGoogleAdsReportSettings(n,{rotateAccessToken:!0})).settings||{},d=googleAdsReportsState.clientPayload||e;d.reportUrl=c.reportUrl||d.reportUrl,c&&(d.settings={...d.settings,...c}),googleAdsReportsState.clientPayload=d,refreshGoogleAdsReportClientShareUi(d),showToast("Share link rotated","success")}catch(l){showToast(l.message||"Rotate failed","error")}finally{const l=document.getElementById("meta-report-rotate-token");l&&(l.disabled=!1)}}});const o=document.getElementById("meta-report-share-edit");o&&(o.onclick=()=>openGoogleAdsReportShareModal(e));const r=document.getElementById("meta-report-share-save");r&&(r.onclick=async()=>{const l=document.getElementById("meta-report-share-slug"),c=normalizeMetaReportSlugInput(l?.value);if(!c||c.length<2){showToast("Enter a valid slug (at least 2 characters).","error");return}r.disabled=!0;try{const u=(await patchGoogleAdsReportSettings(n,{metaReportSlug:c})).settings||{},p=googleAdsReportsState.clientPayload||e;p.settings={...p.settings,...u},p.reportUrl=u.reportUrl||null,googleAdsReportsState.clientPayload=p,refreshGoogleAdsReportClientShareUi(p),closeMetaReportModal(),showToast("Share link slug saved","success")}catch(d){showToast(d.message||"Save failed","error")}finally{const d=document.getElementById("meta-report-share-save");d&&(d.disabled=!1)}});const s=document.getElementById("meta-report-share-slug");s&&(s.oninput=()=>{s.value=normalizeMetaReportSlugInput(s.value)});const i=document.querySelector("[data-meta-client-preview]");if(i){let l=0;i.onchange=async()=>{const c=++l,d=i.checked,u=!d,p=googleAdsReportsState.clientPayload||e;applyMetaReportEnabledUi(googleAdsPayloadToMetaUiShape(p),d);const f=i.closest(".meta-hub-switch");f?.classList.add("is-saving");try{const h=await patchGoogleAdsReportSettings(n,{metaReportEnabled:d},{fast:!0});if(c!==l)return;const b=h.settings||{};p.settings={...p.settings,...b},p.reportUrl=b.reportUrl??p.reportUrl,googleAdsReportsState.clientPayload=p,applyMetaReportEnabledUi(googleAdsPayloadToMetaUiShape(p),!!b.googleAdsReportEnabled),showToast(d?"Client preview enabled":"Client preview disabled","success")}catch(h){if(c!==l)return;applyMetaReportEnabledUi(googleAdsPayloadToMetaUiShape(p),u),i.checked=u,showToast(h.message||"Update failed","error")}finally{c===l&&f?.classList.remove("is-saving")}}}bindGoogleAdsReportBottomlineSummaryEvents(e)}function openGoogleAdsReportShareModal(e){metaReportsState.clientShareExpanded=!0,openMetaReportModal(renderMetaReportShareModalContent(googleAdsPayloadToMetaUiShape(e))),bindGoogleAdsReportShareEvents(e)}function openGoogleAdsReportBottomlineModal(e){metaReportsState.clientReportSettingsExpanded=!0,syncMetaReportControlPanelUi();const t=googleAdsPayloadToMetaUiShape(e);openMetaReportModal(renderMetaReportBottomlineModalContent(t)),bindMetaReportBottomlineFeeEvents(e.clientId,"meta-report",async(n,a)=>{try{const r=(await patchGoogleAdsReportSettings(e.clientId,n)).settings||{},s=googleAdsReportsState.clientPayload||e;s.settings={...s.settings,...r},googleAdsReportsState.clientPayload=s;const i=googleAdsSettingsToMetaUx(s.settings);metaReportsState.clientPayload=googleAdsPayloadToMetaUiShape(s),syncMetaReportBottomlineFeeDom(i,"meta-report"),updateMetaReportBottomlineFeeSummary(i,"meta-report"),bindGoogleAdsReportBottomlineSummaryEvents(s),showToast(Object.prototype.hasOwnProperty.call(n,"metaReportShowBottomline")?n.metaReportShowBottomline?"Bottomline enabled":"Bottomline disabled":"Bottomline settings saved","success")}catch(o){typeof a=="function"&&a(),showToast(o.message||"Save failed","error")}})}function bindGoogleAdsReportBottomlineSummaryEvents(e){const t=document.getElementById("meta-report-fee-edit");!t||!e||(t.onclick=()=>openGoogleAdsReportBottomlineModal(e))}function openGoogleAdsReportExcelSheetModal(e){metaReportsState.clientExcelSheetExpanded=!0,syncMetaReportControlPanelUi(),openMetaReportModal(renderMetaReportExcelSheetModalContent(googleAdsPayloadToMetaUiShape(e)),{wide:!0}),bindGoogleAdsReportExcelSheetModalEvents(e)}function bindGoogleAdsReportExcelSheetSummaryEvents(e){const t=document.getElementById("meta-report-excel-sheet-edit");!t||!e||(t.onclick=()=>openGoogleAdsReportExcelSheetModal(e))}function bindGoogleAdsReportExcelSheetModalEvents(e){const t=document.getElementById("meta-report-excel-sheet-url"),n=document.getElementById("meta-report-excel-sheet-save");if(!t||!n)return;const a=async()=>{const o=resolveMetaReportExcelSheetUrl(googleAdsSettingsToMetaUx(googleAdsReportsState.clientPayload?.settings||{})),r=t.value.trim();n.disabled=!0;try{const i=(await patchGoogleAdsReportSettings(e.clientId,{metaReportExcelSheetUrl:r||null})).settings||{},l=googleAdsReportsState.clientPayload||e;l.settings={...l.settings,...i},googleAdsReportsState.clientPayload=l,metaReportsState.clientPayload=googleAdsPayloadToMetaUiShape(l),updateMetaReportExcelSheetSummary(metaReportsState.clientPayload.settings),syncMetaReportExcelSheetUi(metaReportsState.clientPayload.settings),bindGoogleAdsReportExcelSheetSummaryEvents(l),closeMetaReportModal(),showToast(r?"Excel sheet link saved":"Excel sheet link removed","success")}catch(s){t.value=o||"",showToast(s.message||"Could not save Excel sheet link","error")}finally{n.disabled=!1}};n.onclick=a,t.onkeydown=o=>{o.key==="Enter"&&(o.preventDefault(),a())}}function bindGoogleAdsReportBackfillButton(e){const t=document.getElementById("meta-report-backfill");t&&(t.onclick=async()=>{const n=googleAdsReportsState.clientPayload,a=googleAdsMonthsNeedingBackfill(n),o=a.length?a:n?.monthKeys||[];if(!o.length)return;t.disabled=!0;const r=document.getElementById("meta-report-backfill-progress");let s=0,i=0;for(const l of o){s+=1,r&&(r.textContent=`Fetching ${metaMonthLabel(l)} ${l.slice(0,4)}\u2026 (${s}/${o.length})`);try{await adminFetch(`/api/google-ads-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(l)}/refresh`,{method:"POST"})}catch{i+=1}}r&&(r.textContent=""),i?showToast(`Synced ${s-i}/${o.length} months. ${i} failed (check Google Ads access).`,"error"):showToast(`Synced ${o.length} month${o.length===1?"":"s"} from Google Ads`,"success"),await reloadCurrentLinkedEditor()})}function renderGoogleAdsReportMonthBody(e,{editable:t=!1,yearPayload:n=null,activeMonthKey:a=null}={}){const o=a||e?.monthKey||null,r=o?metaReportMonthBounds(o):null;let s="";t&&e&&!e.meta?.emptyMonth&&r&&(s=`
    ...
    `);const i=a||e?.monthKey||null,l=t?i?`Report preview \xB7 ${metaMonthLabel(i)}`:"Report preview":i?`Report \xB7 ${metaMonthLabel(i)}`:"Report",c=metaReportsState.reportViewMode||"monthly",d=shouldShowMetaReportYearVisuals(e,n,{editable:t}),u=t&&d,p=e&&!e.meta?.emptyMonth?`
    <div class="meta-report-preview-card">
  ...
  `).join("")}function renderGoogleAdsCardMenu(e,t){const n=`google-${e}`;return`
    <div class="card-menu" id="card-menu-${esc(n)}">
      <button
        ...
        title="More actions"
        aria-haspopup="menu"
        onclick="toggleCardMenu('${n}', event)"
      >
  ...
  `}function renderGoogleAdsHubCard(e){const t=!!e.clientId,n=!!(t&&e.googleAdsReportEnabled),a=e.clientId||e.googleCustomerId||"",o=e.needsSetup?'<span class="meta-report-badge meta-report-badge--setup">Needs setup</span>':n?'<span class="meta-report-badge meta-report-badge--on">Report live</span>':'<span class="meta-report-badge meta-report-badge--off">Report off</span>',r=t?`<a href="/admin/google-ads/${encodeURIComponent(e.clientId)}" class="meta-hub-card-name">${esc(e.accountName)}</a>`:`<span class="meta-hub-card-name">${esc(e.accountName)}</span>`,s=n?renderGoogleAdsCardMenu(e.clientId,e.accountName):renderMetaHubSwitch({label:"Enable",attr:e.needsSetup?"data-google-ads-enable":"data-google-ads-report-enabled",value:e.needsSetup?e.googleCustomerId:e.clientId,checked:!1,inline:!0}),i=[];t&&(i.push(`<a class="admin-btn" href="/admin/google-ads/${encodeURIComponent(e.clientId)}">Edit report</a>`),e.reportUrl&&n&&i.push(`<button type="button" class="admin-btn admin-btn--secondary" data-copy-report-url="${esc(e.reportUrl)}">Copy link</button>`));const l=`meta-hub-card-actions${i.length===1?" meta-hub-card-actions--single":""}`;return`
    <article class="meta-hub-card ${e.needsSetup?"is-setup":""}" data-google-ads-row="${esc(a)}" data-google-ads-name="${esc(e.accountName)}">
      <div class="meta-hub-card-head">
        <span class="meta-hub-avatar" aria-hidden="true">${metaHubClientInitial(e.accountName)}</span>
        <div class="meta-hub-card-title">
          <div class="meta-hub-card-name-row">
  ...
  `}async function loadGoogleAdsClientPage({silent:e=!1}={}){const t=document.getElementById("dashboard");if(!t)return;const n=await fetchStaffMe();if(!n){window.location.href=`/login?next=${encodeURIComponent(window.location.pathname)}`;return}currentStaffUser=n;const a=CLIENT_SLUG;if(!googleAdsReportsState.clientPageMounted)t.innerHTML=`
    ...
    `;else if(!e){const n=document.getElementById("meta-report-month-panel");n&&n.classList.add("is-loading")}try{const n=await fetch(`/api/meta-reports/public/${encodeURIComponent(REPORT_TOKEN)}?year=${encodeURIComponent(metaReportsState.selectedYear)}`).then(async r=>{const s=await r.json();if(!r.ok)throw new Error(s.error||"Report not found");return s}),a=captureDualPublicPayload(n);if(syncMetaReportSelectedYear(a,{disableUnavailable:!0}),Number(metaReportsState.selectedYear)!==Number(a.year))return loadPublicMetaReportPage({silent:!0});(!metaReportsState.activeMonthKey||!(a.monthKeys||[]).includes(metaReportsState.activeMonthKey))&&(metaReportsState.activeMonthKey=a.monthKeys?.[a.monthKeys.length-1]||null);const o=a.reportKind==="google-ads"?googleAdsPayloadToMetaUiShape(a):a;await ensureMetaReportScenarioSource(o,{editable:!1}),metaReportsState.publicPageMounted?(updatePublicMetaReportContent(a),bindLinkedReportChrome({publicView:!0})):(metaReportsState.publicPayload=a,hydrateMetaReportSpendChartType(o),hydrateMetaReportScenarioSettings(o),t.innerHTML=renderPublicMetaReportPage(a),metaReportsState.publicPageMounted=!0,syncMetaReportPublicBranding(o),bindPublicMetaReportEvents(a),mountMetaReportCharts(o,{editable:!1}))}catch(n){if(!metaReportsState.publicPageMounted)t.innerHTML=`
        ${renderAppTopbar()}
        ${wrapDashboardShell(`<div class="error-state" style="padding:24px">${esc(n.message||"Report not found")}</div>`)}
      `;else{if(e)throw n;showToast(n.message||"Load failed","error")}}finally{const n=document.getElementById("meta-report-month-panel");n&&n.classList.remove("is-loading")}}}function metaCvShortMonth(e){const t=Number(String(e||"").slice(5,7));return["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][t-1]||e}function metaCvFormatUpdatedAt(e){if(!e)return"Not updated yet";const t=new Date(e);return Number.isNaN(t.getTime())?"Not updated yet":t.toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}function getMetaCvFilteredClients(e=metaReportsState.customValues.overview){const t=e?.clients||[],n=String(metaReportsState.customValues.searchQuery||"").trim().toLowerCase();return n?t.filter(a=>[a.accountName,a.clientId,a.metaAdAccountId].filter(Boolean).join(" ").toLowerCase().includes(n)):t}function renderMetaCvMonthPills(e,t=[]){const n=metaReportsState.customValues.selectedClientId,a=metaReportsState.customValues.selectedMonthKey;return t.map(o=>{const s=(e.months?.[o]||{}).status||"empty",i=n===e.clientId&&a===o;return`
      <button
        type="button"
...
Type "skip" to skip manual months, or "overwrite" to replace all:`,"skip");if(!h)return;h.trim().toLowerCase()==="overwrite"&&(u=!1,p=!0)}const f=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/sync-ghl-year?year=${encodeURIComponent(c)}`,{method:"POST",body:JSON.stringify({skipManual:u,overwriteManual:p})});r?await r():s&&await s(f,null,{yearSync:!0}),showToast(`Synced ${f.synced?.length||0} month(s)${f.skipped?.length?`, skipped ${f.skipped.length}`:""}`,"success")}catch(c){showToast(c.message||"Year sync failed","error")}finally{o&&o(!1)}});const l=document.getElementById(`${t}-refresh-snapshot`);l&&(l.onclick=async()=>{const c=n?.();if(c){o&&o(!0);try{const d=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(c)}/refresh-snapshot`,{method:"POST",body:"{}"});s&&await s(d,c),showToast("Cenhub data refreshed and synced","success")}catch(d){showToast(d.message||"Refresh failed","error")}finally{o&&o(!1)}}})}function monthHasCenhubSnapshot(e,t={}){return e?resolveMetaToplineSource(e,t)==="ghl"?!0:!!e.ghlSyncedAt:!1}function renderMetaCvClientRows(e){const t=getMetaCvFilteredClients(e),n=e.monthKeys||[];return t.length?t.map(a=>`
  ...
  `}function renderMetaReportBottomlineFeeEditor(e={},t="meta-report",{compact:n=!1,modal:a=!1}={}){const o=!!e.metaReportShowBottomline,r=!!e.metaReportFeeEnabled,s=e.metaReportFeeMode||"",i=resolveMetaReportFeeMode(e),l=e.metaReportFeePercent??20,c=e.metaReportMarketingFeeAmount??0,d=metaReportUsesInlineFeeValue(t),u=`data-fee-mode="${esc(s)}" data-fee-enabled="${r?"true":"false"}" data-fee-percent="${esc(l)}" data-marketing-fee="${esc(c)}"`,p=describeMetaReportFeeModeLabel(i,l,c),f=META_REPORT_FEE_MODE_META.map(({value:b,icon:y,title:m,desc:g})=>`
    ...
    <div class="meta-report-bottomline-editor" id="${t}-fee-editor">
      ...
      <div class="meta-report-fee-nested${o?"":" is-hidden"}" id="${t}-fee-nested" ${u}>
        ...
        <div class="meta-report-fee-mode-grid${n?" meta-report-fee-mode-grid--rows":""}">${f}
        </div>
        <div class="meta-report-fee-value" id="${t}-fee-value">${metaReportFeeValueBlockHtml(t,i,l,c,{inline:d})}</div>
        ${h}
      </div>
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,n=(e.clients||[]).find(L=>L.clientId===t.selectedClientId),a=t.selectedMonthKey;if(!n||!a)return`
    ...
    `;const o=n.months?.[a]||{};if(t.loadingEditor)return renderMetaCvEditorSkeleton(n,a,o);const r=t.editorPayload?.months?.[a]||null,s=n.metaReportShowBottomline,i=!!n.metaReportGhlDataEnabled,l={metaReportGhlDataEnabled:n.metaReportGhlDataEnabled,metaReportToplineMode:n.metaReportToplineMode},c=resolveClientToplineMode(l),d=resolveMetaCvMonthToplineSource(r,o,l),u=i&&c==="cenhub"&&d==="ghl",p=o.wonLeads!=null?o.wonLeads:r?.inputs?.wonLeads??r?.topline?.wonLeads??"",f=o.avgLeadValue!=null?o.avgLeadValue:r?.inputs?.avgLeadValue??r?.topline?.avgLeadValue??"",h=o.avgProfitPerWon!=null?o.avgProfitPerWon:r?.inputs?.avgProfitPerWon??"",b=o.ghlLeads??r?.ghlTotals?.leads??r?.topline?.leads??"",y=o.ghlTotalRevenue??r?.ghlTotals?.totalRevenue??"",m=o.ghlTotalProfit??r?.ghlTotals?.totalProfit??"",g=metaReportsState.customValues.draftInputs,v=i&&c==="cenhub"&&d==="manual",$=u?b:g?.manualLeads??(v?o.manualLeads??r?.topline?.leads??"":r?.topline?.leads??o.manualLeads??""),w=g?.wonLeads??p,S=g?.avgLeadValue??f,R=g?.avgProfitPerWon??h,E=u?' readonly disabled tabindex="-1" aria-readonly="true"':"",I=u?" disabled":"",k=u?" is-locked":"",A=t.settingsSaving&&t.settingsSavingScope==="report",P=i?renderMetaCvToplineSourceControl(n,e):"",M=renderMetaCvMonthManualRow(r||{dataSource:d},n),T=i?renderMetaMonthSourcePill(r||{dataSource:d},l):"";return`
    <div class="meta-report-edit-panel-head">
      <div>
  ...
  `}async function loadAdminHub(){const e=document.getElementById("dashboard");if(await requireStaffAuth()){e.innerHTML=renderAdminHubSkeletonPage("clients");try{const n=await adminFetch("/api/clients");e.innerHTML=renderAdminHubPage(n.clients||[])}catch(n){e.innerHTML=`
      ${renderBrandTopbar(renderStaffAdminChrome("clients"))}
      ${wrapDashboardShell(`<div class="error-state" style="padding:24px">${esc(n.message)}</div>`)}
