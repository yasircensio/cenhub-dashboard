      ...
      <div class="meta-report-comparison-range-grid">
        <div class="meta-report-comparison-range-block is-a">
          ...
          <div class="meta-report-comparison-range-dates">
            <input type="date" class="admin-select" data-comparison-date="a-start" value="${esc(r)}" aria-label="Period A start date"${c}${d} />
            <input type="date" class="admin-select" data-comparison-date="a-end" value="${esc(o)}" aria-label="Period A end date"${c}${d} />
          </div>
        </div>
        ...
        <div class="meta-report-comparison-range-block is-b">
          ...
          <div class="meta-report-comparison-range-dates">
            <input type="date" class="admin-select" data-comparison-date="b-start" value="${esc(i)}" aria-label="Period B start date"${c}${d} />
            <input type="date" class="admin-select" data-comparison-date="b-end" value="${esc(l)}" aria-label="Period B end date"${c}${d} />
          </div>
        </div>
      </div>
    </div>
