...
Resume the interrupted ${w}?`)&&(l=g.id,d=Number(g.batchOffset)||0)}}if(a?setFbLeadProgress({processed:d,total:0,label:d>0?"Resuming preview\u2026":"Fetching Meta leads\u2026"}):updateGlobalApplyProgress({waiting:!0,elapsed:0}),a&&d===0){const g=await adminFetchWithRetry("/api/fb-lead-sync/prepare",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l})}),p=g.summary||g;l=p.runId,d=0,setFbLeadProgress({processed:0,total:p.inWindow||0,label:`Matching ${p.inWindow||0} Meta leads to GHL\u2026`})}else!a&&d===0&&updateGlobalApplyProgress({waiting:!1,processed:0,total:$||v?.updated||0});do{c=await adminFetchWithRetry("/api/fb-lead-sync/run",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l,previewRunId:a?null:y,batchOffset:d,batchLimit:r})});const g=c.summary||c;l=g.runId,d=g.nextBatchOffset??g.batchOffset+(g.batchProcessed||0),m=m.concat(g.rows||[]),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.runId=l);const p=g.inWindow||d||$;a?(setFbLeadProgress({processed:d,total:p,complete:!g.hasMore}),o&&(o.innerHTML=renderFbLeadRunResults({...g,rows:m}))):updateGlobalApplyProgress({processed:d,total:p,written:g.updated||0,complete:!g.hasMore})}while((c.summary||c).hasMore);b=!0;const S=c.summary||c,u=S.inWindow||d||$,f=S.nextBatchOffset??d;if(a)setFbLeadProgress({processed:f,total:u,complete:!0}),markFbLeadPreviewReady(e,t,S.updated),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.previewOk=(S.updated||0)>0),showToast((S.updated||0)>0?"Preview complete \u2014 use Apply in Run history below.":"Preview complete \u2014 all contacts already have Fb Lead id. Nothing to apply.","success"),await refreshFbLeadHistoryUi(),document.getElementById("fb-lead-history-mount")?.scrollIntoView({behavior:"smooth",block:"nearest"});else{updateGlobalApplyProgress({processed:f,total:u,written:S.updated||0,complete:!0}),delete fbLeadSyncState.previewOkByClient[e];try{const g=JSON.parse(sessionStorage.getItem("fbLeadSyncPreviewOk")||"{}");delete g[e],sessionStorage.setItem("fbLeadSyncPreviewOk",JSON.stringify(g))}catch{}showToast("FB lead sync complete \u2014 Fb Lead id written to GHL","success"),stopGlobalApplyProgress({success:!0})}await refreshFbLeadHistoryUi();const h=await adminFetch("/api/fb-lead-sync");fbLeadSyncState.clients=h.clients||[],hydrateFbLeadPreviewState(fbLeadSyncState.clients),await refreshFbLeadClientRowsUi()}catch(S){a?hideFbLeadProgress(!0):(updateGlobalApplyProgress({error:`Failed \u2014 ${S.message||"Apply failed"}`}),stopGlobalApplyProgress({success:!1,keepVisibleMs:12e3})),showToast((S.message||(a?"FB lead preview failed.":"FB lead apply failed."))+(a?" Partial progress is saved \u2014 use Resume in Run history or try Preview again.":" Partial progress is saved \u2014 use Resume in Run history."),"error"),await refreshFbLeadHistoryUi()}finally{s&&(s.disabled=!1),fbLeadSyncState.applyingRunId=null,!b&&a&&hideFbLeadProgress(!0),!a&&!b&&(fbLeadSyncState.isApplying=!1,await refreshFbLeadHistoryUi())}}async function expandFbLeadRun(e){const t=document.getElementById(`fb-lead-run-audit-${e}`);if(t){if(!t.hidden){t.hidden=!0;return}try{const a=await adminFetch(`/api/fb-lead-sync/history/${e}`),n=fbLeadSyncState.clients.find(o=>o.clientId===a.run.clientId);t.innerHTML=`<td colspan="7"><div class="fb-lead-audit-scroll" id="fb-lead-audit-scroll-${e}">${renderFbLeadAuditTable(a.run.rows||[],a.run.locationId||n?.locationId)}</div></td>`,t.hidden=!1;const s=document.getElementById(`fb-lead-audit-scroll-${e}`);s&&s.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(a){showToast(a.message||"Failed to load run audit.","error")}}}function viewFbLeadClientHistory(e){const t=getFbLeadHistoryRunsForDisplay(fbLeadSyncState.historyRuns.filter(s=>s.clientId===e)),a=document.getElementById("fb-lead-history-mount");if(!a)return;const n=Object.fromEntries(fbLeadSyncState.clients.map(s=>[s.clientId,s.locationId]));a.innerHTML=t.length?renderFbLeadHistoryRows(t,n):`<div class="sync-history-empty">No runs for ${esc(e)} yet.</div>`,a.scrollIntoView({behavior:"smooth",block:"start"})}async function loadFbLeadSyncPage({silent:e=!1,fullPreflight:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){e||(a.innerHTML=`
  ...
  `}function getMetaReportMonthBodyOptions(e={},{editable:t=!1}={}){return{editable:t}}const META_REPORT_CHART_MIN_POINTS=2;function isMetaReportCensioClient(e){const t=String(e?.clientId||"").toLowerCase(),a=String(e?.accountName||"");return t==="censio"||/censio/i.test(a)}function monthHasChartData(e){if(!e||e.meta?.emptyMonth)return!1;const t=Number(e.meta?.spend)||0,a=Number(e.topline?.leads)||0;return t>0||a>0}function buildMetaReportChartSeries(e){const t=e?.monthKeys||[],a=e?.months||{},n=[];for(const s of t){const o=a[s];if(!o||o.meta?.emptyMonth||!monthHasChartData(o))continue;const r=Number(o.topline?.roasKr)||0,i=Number(o.topline?.roasX)||0,l=!!o.bottomline,d=l?Number(o.bottomline.poasKr)||0:null,c=l?Number(o.bottomline.poasX)||0:null;n.push({monthKey:s,label:metaMonthLabel(s),roasKr:r,roasX:i,poasKr:d,poasX:c,spend:Number(o.meta?.spend)||0,leads:Number(o.topline?.leads)||0,wonLeads:Number(o.topline?.wonLeads)||0,avgLeadValue:Number(o.topline?.avgLeadValue)||0,avgProfitPerWon:Number(o.inputs?.avgProfitPerWon)||0,hasData:!0})}return n}function getMetaReportDemoSeries(e,t,a,n){if(!isMetaReportCensioClient({clientId:e,accountName:t}))return null;const o=new Date,r=o.getFullYear(),i=o.getMonth()+1,l=Number(a)||r;let d=(n||[]).filter(c=>{const m=Number(String(c).slice(0,4)),b=Number(String(c).slice(5,7));return!(m!==l||l===r&&b>i)});if(!d.length){const c=l===r?Math.min(8,i):8;d=Array.from({length:c},(m,b)=>`${l}-${String(b+1).padStart(2,"0")}`)}return d.map((c,m)=>{const b=d.length>1?m/(d.length-1):0,y=Math.round(8e3+b*1e4),v=Math.round(2e3+b*15e3),$=Number((.5+b*2.5).toFixed(2)),S=Math.round(1500+b*12e3),u=Number((.4+b*2.2).toFixed(2)),f=Math.round(20+b*80),h=Math.max(1,Math.round(f*(.08+b*.04)));return{monthKey:c,label:metaMonthLabel(c),roasKr:v,roasX:$,poasKr:S,poasX:u,spend:y,leads:f,wonLeads:h,avgLeadValue:85e3,avgProfitPerWon:42e3,hasData:!0,demo:!0}})}function resolveMetaReportChartSeries(e){const t=buildMetaReportChartSeries(e);if(t.length>=META_REPORT_CHART_MIN_POINTS)return{series:t,demo:!1};if(isMetaReportCensioClient(e)){const a=getMetaReportDemoSeries(e.clientId,e.accountName,e.year||metaReportsState.selectedYear,e.monthKeys);if(a&&a.length>=META_REPORT_CHART_MIN_POINTS)return{series:a,demo:!0}}return{series:t,demo:!1}}function metaReportParseAmount(e){const t=Number.parseFloat(e);return Number.isFinite(t)?t:0}function metaReportRoundMoney(e){return Math.round(metaReportParseAmount(e)*100)/100}function metaReportRoundRatio(e){return Math.round(metaReportParseAmount(e)*1e8)/1e8}function metaReportAggregateSeriesEfficiency(e=[]){let t=0,a=0,n=0,s=0,o=0;for(const i of e){const l=metaReportParseAmount(i.spend),d=metaReportParseAmount(i.leads),c=metaReportParseAmount(i.wonLeads);l<=0&&d<=0||(t+=l,a+=d,n+=c,s+=c*metaReportParseAmount(i.avgLeadValue),o+=c*metaReportParseAmount(i.avgProfitPerWon))}const r=e.filter(i=>metaReportParseAmount(i.spend)>0).length;return{avgCpl:a>0?metaReportRoundMoney(t/a):0,winRate:a>0?metaReportRoundRatio(n/a):0,avgLeadValue:n>0?metaReportRoundMoney(s/n):0,avgProfitPerWon:n>0?metaReportRoundMoney(o/n):0,avgMonthlySpend:r>0?metaReportRoundMoney(t/r):0}}function metaReportProjectBudgetAtSpend(e,t,a=!1){const n=metaReportParseAmount(e);if(n<=0||t.avgCpl<=0)return{spend:0,leads:0,wonLeads:0,totalLeadValue:0,roasKr:0,roasX:0,poasKr:null,poasX:null};const s=metaReportRoundMoney(n/t.avgCpl),o=metaReportRoundMoney(s*t.winRate),r=metaReportRoundMoney(o*t.avgLeadValue),i=metaReportRoundMoney(r-n),l=n>0?metaReportRoundRatio(i/n):0;let d=null,c=null;if(a&&t.avgProfitPerWon>0){const m=metaReportRoundMoney(o*t.avgProfitPerWon);d=metaReportRoundMoney(m-n),c=n>0?metaReportRoundRatio(d/n):0}return{spend:n,leads:s,wonLeads:o,totalLeadValue:r,roasKr:i,roasX:l,poasKr:d,poasX:c}}function metaReportProjectBudgetScenario({series:e=[],baselineSpend:t,multiplier:a=1,hasBottomline:n=!1}={}){const s=metaReportAggregateSeriesEfficiency(e),o=metaReportParseAmount(t),r=metaReportParseAmount(a)||1,i=metaReportProjectBudgetAtSpend(o,s,n),l=metaReportProjectBudgetAtSpend(metaReportRoundMoney(o*r),s,n);return{efficiency:s,baseline:i,projected:l,multiplier:r,baselineSpend:o,hasBottomline:n,insufficientData:s.avgCpl<=0||o<=0}}function metaReportLinearRegression(e=[]){const t=e.length;if(t<2)return{slope:0,intercept:0,r:0};let a=0,n=0,s=0,o=0,r=0;for(const b of e){const y=metaReportParseAmount(b.x),v=metaReportParseAmount(b.y);a+=y,n+=v,s+=y*v,o+=y*y,r+=v*v}const i=t*o-a*a;if(i===0)return{slope:0,intercept:n/t,r:0};const l=(t*s-a*n)/i,d=(n-l*a)/t,c=Math.sqrt((t*o-a*a)*(t*r-n*n)),m=c>0?(t*s-a*n)/c:0;return{slope:l,intercept:d,r:m}}function metaReportEfficiencyInsight(e=[],t="roasX"){const a=e.filter(o=>metaReportParseAmount(o.spend)>0).map(o=>({x:metaReportParseAmount(o.spend),y:metaReportParseAmount(o[t])}));if(a.length<2)return{tone:"neutral",message:"Not enough months to assess spend efficiency yet."};const{slope:n,r:s}=metaReportLinearRegression(a);return Math.abs(s)<.25?{tone:"neutral",message:"Return is stable across spend levels."}:n>0?{tone:"positive",message:"Higher spend months tend to maintain or improve return \u2014 scaling looks promising."}:{tone:"negative",message:"Higher spend months show lower efficiency \u2014 improve targeting/creative before scaling."}}function metaReportSpendAxisTick(e){const t=Number(e)||0;return Math.abs(t)>=1e6?`${(t/1e6).toFixed(1)}M`:Math.abs(t)>=1e3?`${Math.round(t/1e3)}K`:t}function metaReportDeltaPct(e,t){const a=metaReportParseAmount(t),n=metaReportParseAmount(e);return a?metaReportRoundRatio((n-a)/Math.abs(a)*100):null}function metaReportFormatDeltaPct(e){return e==null||!Number.isFinite(e)?"":`${e>0?"+":""}${e.toFixed(0)}%`}function metaReportResolveBaselineSpend(e,t){if(metaReportsState.budgetBaseline==="month"&&metaReportsState.activeMonthKey){const n=t.find(s=>s.monthKey===metaReportsState.activeMonthKey);if(n&&metaReportParseAmount(n.spend)>0)return metaReportParseAmount(n.spend)}return metaReportAggregateSeriesEfficiency(t).avgMonthlySpend}function payloadHasMetaReportBottomline(e){return e?.settings?.metaReportShowBottomline===!1?!1:seriesHasBottomline(metaReportsState.chartSeries||buildMetaReportChartSeries(e))}function seriesHasBottomline(e=[]){return e.some(t=>t.poasKr!=null&&t.poasX!=null)}function renderMetaReportChartsPanel(){const e=metaReportsState.chartTab||"trend";return`
    <aside class="meta-report-charts-panel" id="meta-report-charts-panel">
      ...
      <div class="meta-report-chart-tabs" role="tablist" aria-label="Chart views">
        <button type="button" class="meta-report-chart-tab${e==="trend"?" is-active":""}" data-meta-chart-tab="trend" role="tab" aria-selected="${e==="trend"}">Monthly trend</button>
        <button type="button" class="meta-report-chart-tab${e==="spend"?" is-active":""}" data-meta-chart-tab="spend" role="tab" aria-selected="${e==="spend"}">Spend vs return</button>
      </div>
      <div class="meta-report-chart-tab-panel${e==="trend"?" is-active":""}" data-meta-chart-panel="trend" role="tabpanel"${e==="trend"?"":" hidden"}>
      ...
      <div class="meta-report-chart-tab-panel${e==="spend"?" is-active":""}" data-meta-chart-panel="spend" role="tabpanel"${e==="spend"?"":" hidden"}>
        <p class="meta-report-scenario-insight" id="meta-report-spend-insight"></p>
        <div class="meta-report-chart-card" data-meta-chart="scatter-roas">
          <div class="meta-report-chart-head">
            <h3 class="meta-report-chart-title">ROAS vs ad spend</h3>
            <div class="meta-report-chart-toggle" id="meta-chart-scatter-roas-mode" role="group" aria-label="ROAS scatter display mode">
              <button type="button" class="meta-report-chart-toggle-btn is-active" data-mode="kr">Dkr</button>
              <button type="button" class="meta-report-chart-toggle-btn" data-mode="x">Multiplier</button>
            </div>
          </div>
          <div class="meta-report-chart-canvas-wrap">
            <canvas id="meta-report-chart-scatter-roas" aria-label="ROAS vs ad spend chart"></canvas>
        ...
        <div class="meta-report-chart-card" data-meta-chart="scatter-poas">
          <div class="meta-report-chart-head">
            <h3 class="meta-report-chart-title">POAS vs ad spend</h3>
            <div class="meta-report-chart-toggle" id="meta-chart-scatter-poas-mode" role="group" aria-label="POAS scatter display mode">
              <button type="button" class="meta-report-chart-toggle-btn is-active" data-mode="kr">Dkr</button>
              <button type="button" class="meta-report-chart-toggle-btn" data-mode="x">Multiplier</button>
            </div>
          </div>
          <div class="meta-report-chart-canvas-wrap">
            <canvas id="meta-report-chart-scatter-poas" aria-label="POAS vs ad spend chart"></canvas>
  ...
  `}function renderMetaReportScenarioMetrics(e){if(!e||e.insufficientData)return'<p class="meta-report-scenario-empty">Add months with ad spend and leads to model a budget scenario.</p>';const t=[["Ad spend",metaFmtKr(e.baseline.spend),metaFmtKr(e.projected.spend),metaReportFormatDeltaPct(metaReportDeltaPct(e.projected.spend,e.baseline.spend))],["Leads",metaFmtNum(e.baseline.leads),metaFmtNum(e.projected.leads),metaReportFormatDeltaPct(metaReportDeltaPct(e.projected.leads,e.baseline.leads))],["Won leads",metaFmtNum(e.baseline.wonLeads,1),metaFmtNum(e.projected.wonLeads,1),metaReportFormatDeltaPct(metaReportDeltaPct(e.projected.wonLeads,e.baseline.wonLeads))],["Total lead value",metaFmtKr(e.baseline.totalLeadValue),metaFmtKr(e.projected.totalLeadValue),metaReportFormatDeltaPct(metaReportDeltaPct(e.projected.totalLeadValue,e.baseline.totalLeadValue))],["ROAS",`${metaFmtKr(e.baseline.roasKr)} \xB7 ${metaFmtX(e.baseline.roasX)}`,`${metaFmtKr(e.projected.roasKr)} \xB7 ${metaFmtX(e.projected.roasX)}`,metaReportFormatDeltaPct(metaReportDeltaPct(e.projected.roasKr,e.baseline.roasKr))]];return e.hasBottomline&&t.push(["POAS",`${metaFmtKr(e.baseline.poasKr)} \xB7 ${metaFmtX(e.baseline.poasX)}`,`${metaFmtKr(e.projected.poasKr)} \xB7 ${metaFmtX(e.projected.poasX)}`,metaReportFormatDeltaPct(metaReportDeltaPct(e.projected.poasKr,e.baseline.poasKr))]),`
    ...
    `).join("")}
  `}function destroyMetaReportCharts(){["roas","poas"].forEach(e=>{metaReportsState.chartInstances[e]&&(metaReportsState.chartInstances[e].destroy(),metaReportsState.chartInstances[e]=null),metaReportsState.chartScatterInstances[e]&&(metaReportsState.chartScatterInstances[e].destroy(),metaReportsState.chartScatterInstances[e]=null)})}function metaReportChartValue(e,t,a,n){const s=t==="x"?e[n]:e[a];return Number(s)||0}function metaReportChartTooltipLabel(e,t){return t==="x"?metaFmtX(e):metaFmtKr(e)}function metaReportChartAxisTick(e,t){if(t==="x")return`${Number(e).toFixed(1)}x`;const a=Number(e)||0;return Math.abs(a)>=1e6?`${(a/1e6).toFixed(1)}M`:Math.abs(a)>=1e3?`${Math.round(a/1e3)}K`:a}function buildMetaReportLineChart(e,t,a,n,s){const o=t.map(i=>i.label),r=t.map(i=>metaReportChartValue(i,a,n,s));return new Chart(e,{type:"line",data:{labels:o,datasets:[{label:a==="x"?"Multiplier":"Dkr",data:r,borderColor:"#ff6a00",backgroundColor:"rgba(255, 106, 0, 0.12)",borderWidth:2.5,pointBackgroundColor:"#ff6a00",pointBorderColor:"#ffffff",pointBorderWidth:2,pointRadius:4,pointHoverRadius:5,fill:!0,tension:.3}]},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,callbacks:{label(i){return metaReportChartTooltipLabel(i.parsed.y,a)}}}},scales:{x:{grid:{color:"rgba(26, 18, 8, 0.06)"},ticks:{color:"#6b5348",font:{size:11}}},y:{grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:"#6b5348",font:{size:11},callback:i=>metaReportChartAxisTick(i,a)}}}}})}function buildMetaReportScatterChart(e,t,a,n,s,o=null){const r=t.filter(u=>metaReportParseAmount(u.spend)>0),i=r.map(u=>({x:metaReportParseAmount(u.spend),y:metaReportChartValue(u,a,n,s),label:u.label,spend:u.spend,rawPoint:u})),l=i.map(u=>({x:u.x,y:u.y})),d=metaReportLinearRegression(l),c=i.map(u=>u.x),m=c.length?Math.min(...c):0,b=c.length?Math.max(...c):0,y=o?metaReportParseAmount(o.projected?.spend):0,v=Math.max(b,y),$=v>m?[{x:m,y:d.slope*m+d.intercept},{x:v,y:d.slope*v+d.intercept}]:[],S=[{type:"scatter",label:"Months",data:i,borderColor:"#ff6a00",backgroundColor:"#ff6a00",pointBackgroundColor:"#ff6a00",pointBorderColor:"#ffffff",pointBorderWidth:2,pointRadius:5,pointHoverRadius:6}];if($.length===2&&r.length>=META_REPORT_CHART_MIN_POINTS&&S.push({type:"line",label:"Trend",data:$,borderColor:"rgba(255, 106, 0, 0.35)",backgroundColor:"transparent",borderDash:[6,4],borderWidth:2,pointRadius:0,pointHoverRadius:0,fill:!1}),o&&!o.insufficientData){const u=metaReportParseAmount(o.projected[a==="x"?s:n]);y>0&&S.push({type:"scatter",label:"Projected",data:[{x:y,y:u,label:"Projected"}],borderColor:"#138b53",backgroundColor:"#138b53",pointStyle:"rectRot",pointRadius:7,pointHoverRadius:8})}return new Chart(e,{data:{datasets:S},options:{responsive:!0,maintainAspectRatio:!1,parsing:!1,interaction:{mode:"nearest",intersect:!0},plugins:{legend:{display:!1},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,callbacks:{title(u){return u[0]?.raw?.label||"Point"},label(u){const f=u.raw||{};if(f.label==="Projected")return metaReportChartTooltipLabel(f.y,a);const h=metaFmtKr(f.spend??f.x),g=metaReportChartTooltipLabel(f.y,a);return`${h} \xB7 ${g}`}}}},scales:{x:{type:"linear",title:{display:!0,text:"Ad spend",color:"#6b5348",font:{size:11,weight:"600"}},grid:{color:"rgba(26, 18, 8, 0.06)"},ticks:{color:"#6b5348",font:{size:11},callback:u=>metaReportSpendAxisTick(u)}},y:{title:{display:!0,text:a==="x"?"Multiplier":"Return (Dkr)",color:"#6b5348",font:{size:11,weight:"600"}},grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:"#6b5348",font:{size:11},callback:u=>metaReportChartAxisTick(u,a)}}}}})}function updateMetaReportChart(e,t,a){const n=document.getElementById(`meta-report-chart-${e}`),s=document.getElementById(`meta-report-chart-${e}-empty`);if(!n||!s)return;const o=e==="roas"?"roasKr":"poasKr",r=e==="roas"?"roasX":"poasX",i=e==="poas"?t.filter(l=>l.poasKr!=null&&l.poasX!=null):t;if(metaReportsState.chartInstances[e]&&(metaReportsState.chartInstances[e].destroy(),metaReportsState.chartInstances[e]=null),i.length<META_REPORT_CHART_MIN_POINTS||typeof Chart>"u"){n.hidden=!0,s.hidden=!1;return}n.hidden=!1,s.hidden=!0,metaReportsState.chartInstances[e]=buildMetaReportLineChart(n,i,a,o,r)}function updateMetaReportScatterChart(e,t,a,n=null){const s=document.getElementById(`meta-report-chart-scatter-${e}`),o=document.getElementById(`meta-report-chart-scatter-${e}-empty`);if(!s||!o)return;const r=e==="roas"?"roasKr":"poasKr",i=e==="roas"?"roasX":"poasX",l=e==="poas"?t.filter(d=>d.poasKr!=null&&d.poasX!=null):t.filter(d=>metaReportParseAmount(d.spend)>0);if(metaReportsState.chartScatterInstances[e]&&(metaReportsState.chartScatterInstances[e].destroy(),metaReportsState.chartScatterInstances[e]=null),l.length<META_REPORT_CHART_MIN_POINTS||typeof Chart>"u"){s.hidden=!0,o.hidden=!1;return}s.hidden=!1,o.hidden=!0,metaReportsState.chartScatterInstances[e]=buildMetaReportScatterChart(s,l,a,r,i,n)}function setMetaReportChartTab(e){metaReportsState.chartTab=e,document.querySelectorAll("[data-meta-chart-tab]").forEach(t=>{const a=t.getAttribute("data-meta-chart-tab")===e;t.classList.toggle("is-active",a),t.setAttribute("aria-selected",a?"true":"false")}),document.querySelectorAll("[data-meta-chart-panel]").forEach(t=>{const a=t.getAttribute("data-meta-chart-panel")===e;t.classList.toggle("is-active",a),t.hidden=!a}),mountActiveMetaReportCharts()}function mountActiveMetaReportCharts(){const e=metaReportsState.chartSeries||[],t=metaReportsState.chartProjection;metaReportsState.chartTab==="spend"?(updateMetaReportScatterChart("roas",e,metaReportsState.chartScatterRoasMode,t),updateMetaReportScatterChart("poas",e,metaReportsState.chartScatterPoasMode,t)):(updateMetaReportChart("roas",e,metaReportsState.chartRoasMode),updateMetaReportChart("poas",e,metaReportsState.chartPoasMode))}function bindMetaReportChartTabs(){document.querySelectorAll("[data-meta-chart-tab]").forEach(e=>{e.onclick=()=>{setMetaReportChartTab(e.getAttribute("data-meta-chart-tab"))}})}function bindMetaReportChartToggles(){const e=document.getElementById("meta-chart-roas-mode");e&&e.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const o=s.getAttribute("data-mode");metaReportsState.chartRoasMode=o,e.querySelectorAll("[data-mode]").forEach(r=>{r.classList.toggle("is-active",r.getAttribute("data-mode")===o)}),updateMetaReportChart("roas",metaReportsState.chartSeries||[],o)}});const t=document.getElementById("meta-chart-poas-mode");t&&t.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const o=s.getAttribute("data-mode");metaReportsState.chartPoasMode=o,t.querySelectorAll("[data-mode]").forEach(r=>{r.classList.toggle("is-active",r.getAttribute("data-mode")===o)}),updateMetaReportChart("poas",metaReportsState.chartSeries||[],o)}});const a=document.getElementById("meta-chart-scatter-roas-mode");a&&a.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const o=s.getAttribute("data-mode");metaReportsState.chartScatterRoasMode=o,a.querySelectorAll("[data-mode]").forEach(r=>{r.classList.toggle("is-active",r.getAttribute("data-mode")===o)}),updateMetaReportScatterChart("roas",metaReportsState.chartSeries||[],o,metaReportsState.chartProjection)}});const n=document.getElementById("meta-chart-scatter-poas-mode");n&&n.querySelectorAll("[data-mode]").forEach(s=>{s.onclick=()=>{const o=s.getAttribute("data-mode");metaReportsState.chartScatterPoasMode=o,n.querySelectorAll("[data-mode]").forEach(r=>{r.classList.toggle("is-active",r.getAttribute("data-mode")===o)}),updateMetaReportScatterChart("poas",metaReportsState.chartSeries||[],o,metaReportsState.chartProjection)}})}function syncMetaReportChartToggleUi(){[["roas",metaReportsState.chartRoasMode,"meta-chart-roas-mode"],["poas",metaReportsState.chartPoasMode,"meta-chart-poas-mode"],["scatter-roas",metaReportsState.chartScatterRoasMode,"meta-chart-scatter-roas-mode"],["scatter-poas",metaReportsState.chartScatterPoasMode,"meta-chart-scatter-poas-mode"]].forEach(([,e,t])=>{const a=document.getElementById(t);a&&a.querySelectorAll("[data-mode]").forEach(n=>{n.classList.toggle("is-active",n.getAttribute("data-mode")===e)})})}function syncMetaReportSpendInsight(e){const t=document.getElementById("meta-report-spend-insight");if(!t)return;const a=metaReportEfficiencyInsight(e,metaReportsState.chartScatterRoasMode==="x"?"roasX":"roasKr");t.textContent=a.message,t.className=`meta-report-scenario-insight${a.tone!=="neutral"?` is-${a.tone}`:""}`}function bindMetaReportScenarioControls(e){const t=document.getElementById("meta-report-budget-multiplier"),a=document.getElementById("meta-report-budget-multiplier-value"),n=document.getElementById("meta-report-budget-baseline");t&&(t.oninput=()=>{metaReportsState.budgetMultiplier=Number(t.value)||1,a&&(a.textContent=`${metaReportsState.budgetMultiplier.toFixed(1)}\xD7`),syncMetaReportScenario(e)}),n&&(n.onchange=()=>{metaReportsState.budgetBaseline=n.value==="month"?"month":"year",syncMetaReportScenario(e)})}function syncMetaReportScenario(e){const t=metaReportsState.chartSeries||[],a=payloadHasMetaReportBottomline(e),n=metaReportResolveBaselineSpend(e,t),s=metaReportProjectBudgetScenario({series:t,baselineSpend:n,multiplier:metaReportsState.budgetMultiplier,hasBottomline:a});metaReportsState.chartProjection=s;const o=document.getElementById("meta-report-scenario-grid");o&&(o.innerHTML=renderMetaReportScenarioMetrics(s)),syncMetaReportSpendInsight(t),metaReportsState.chartTab==="spend"&&(updateMetaReportScatterChart("roas",t,metaReportsState.chartScatterRoasMode,s),updateMetaReportScatterChart("poas",t,metaReportsState.chartScatterPoasMode,s))}function mountMetaReportCharts(e,{editable:t=!1}={}){if(destroyMetaReportCharts(),!e)return;const{series:a,demo:n}=resolveMetaReportChartSeries(e);metaReportsState.chartSeries=a,metaReportsState.chartDemo=n;const s=document.getElementById("meta-report-chart-demo-badge");s&&(s.hidden=!(n&&t)),bindMetaReportChartTabs(),bindMetaReportChartToggles(),bindMetaReportScenarioControls(e),syncMetaReportChartToggleUi(),setMetaReportChartTab(metaReportsState.chartTab||"trend"),syncMetaReportScenario(e)}function syncMetaReportMonthPanelDom(e,t={},a=null){const n=document.getElementById("meta-report-month-panel");if(!n)return;const s=a||metaReportsState.clientPayload||metaReportsState.publicPayload;n.innerHTML=renderMetaReportMonthBody(e,t),requestAnimationFrame(()=>{mountMetaReportCharts(s,{editable:!!t.editable})})}function renderMetaReportMonthTables(e,{editable:t=!1}={}){if(!e)return'<div class="meta-report-empty">No data for this month yet.</div>';if(e.meta?.emptyMonth)return`<div class="meta-report-empty">No ad spend recorded for this month yet.${t?' Click "Refresh from Meta" below, or use "Backfill from Meta" above to pull historical months.':""}</div>`;const a=[["Total spend",metaFmtKr(e.meta?.spend),""],["Cost Pr Mile (CPM)",metaFmtKr(e.meta?.cpm),""],["Impressions",metaFmtNum(e.meta?.impressions),""],["Reach",metaFmtNum(e.meta?.reach),""],["Click",metaFmtNum(e.meta?.clicks),""],["CTR",metaFmtNum(e.meta?.conversionRatePercent,2),"%"]],n=[["Leads",metaFmtNum(e.topline?.leads),""],["Cost Per Lead (CPL)",metaFmtKr(e.topline?.cpl),""],["Won leads",metaFmtNum(e.topline?.wonLeads),""],["Total Lead Value",metaFmtKr(e.topline?.totalLeadValue),""],["Average Lead Value",metaFmtKr(e.topline?.avgLeadValue),""],["Client acquisition cost (CAC)",metaFmtKr(e.topline?.cac),""],["Return on Ads Spend (ROAS)",metaFmtKr(e.topline?.roasKr),""],["Return on Ads Spend % (ROAS)",metaFmtX(e.topline?.roasX),""]];let s="";if(s+=renderMetaReportMetricTable("Meta ads",a,"meta"),s+=renderMetaReportMetricTable("Topline KPI'er",n,"topline",{highlightLastN:2}),e.bottomline){const o=[["Leads",metaFmtNum(e.bottomline.leads),""],["Won leads",metaFmtNum(e.bottomline.wonLeads),""],["Total Lead Value",metaFmtKr(e.bottomline.totalLeadValue),""],["Average Lead Value",metaFmtKr(e.bottomline.avgLeadValue),""],["Client acquisition cost (CAC)",metaFmtKr(e.bottomline.cac),""],["Avg Total Profit",metaFmtKr(e.bottomline.totalProfit),""],["Avg Single Profit Order",metaFmtKr(e.bottomline.avgProfitPerWon),""],["Profit on Ads Spend (POAS)",metaFmtKr(e.bottomline.poasKr),""],["Profit on Ads Spend % (POAS)",metaFmtX(e.bottomline.poasX),""]];if(e.bottomline.feeMode){const r=e.bottomline.feeLabel||(e.bottomline.feeMode==="marketing"?"Censio marketing fee":`Censio performance fee (${metaFmtNum(e.bottomline.feePercent,0)}%)`);o.push([r,metaFmtKr(e.bottomline.censioFee),""]),o.push(["Profit on Investment (POI)",metaFmtKr(e.bottomline.poiKr),""]),o.push(["Profit on Investment % (POI)",metaFmtX(e.bottomline.poiX),""])}s+=renderMetaReportMetricTable("Bottomline KPI'er",o,"bottomline",{highlightLastN:2})}return s?`
  ...
  `:"",o=renderMetaReportMonthTables(e,{editable:t}),r=renderMetaReportChartsPanel();return`${a}${s}
  ...
  `}function setMetaReportClientSettingsExpanded(e,t){if(e!=="meta-report")return;metaReportsState.clientReportSettingsExpanded=!!t,t&&(metaReportsState.clientShareExpanded=!1);const a=document.querySelector(".meta-report-bottomline-fee-settings--client"),n=document.getElementById(`${e}-fee-editor`);a?.classList.toggle("is-editing",t),a?.classList.toggle("is-collapsed",!t),n&&n.classList.toggle("is-hidden",!t);const s=document.getElementById("meta-report-share-summary"),o=document.getElementById("meta-report-share-editor");s&&(s.hidden=metaReportsState.clientShareExpanded),o&&(o.hidden=!metaReportsState.clientShareExpanded),syncMetaReportControlPanelUi()}function updateMetaReportBottomlineFeeSummary(e={},t="meta-report"){const a=document.getElementById(`${t}-fee-summary`);if(!a)return;const n=document.createElement("div");n.innerHTML=renderMetaReportBottomlineFeeSummary(e,t);const s=n.firstElementChild;s&&a.replaceWith(s);const o=document.getElementById(`${t}-fee-edit`);o&&(o.onclick=()=>setMetaReportClientSettingsExpanded(t,!0))}function renderMetaReportBottomlineFeeSettings(e={},t="meta-report",{compact:a=!1,variant:n="default",collapsible:s=!1,externalSummary:o=!1}={}){const r=!!e.metaReportShowBottomline,i=!!e.metaReportFeeEnabled,l=e.metaReportFeeMode||"",d=resolveMetaReportFeeMode(e),c=e.metaReportFeePercent??20,m=e.metaReportMarketingFeeAmount??0,b=metaReportUsesInlineFeeValue(t),y=`data-fee-mode="${esc(l)}" data-fee-enabled="${i?"true":"false"}" data-fee-percent="${esc(c)}" data-marketing-fee="${esc(m)}"`;if(n==="cv"){const h=describeMetaReportFeeModeLabel(d,c,m),g=META_REPORT_FEE_MODE_META.map(({value:p,title:w})=>`
    ...
    <div class="meta-report-bottomline-fee-settings meta-report-bottomline-fee-settings--cv">
      <div class="meta-cv-bottomline-panel">
        ...
        <div class="meta-report-fee-nested meta-cv-bottomline-body${r?"":" is-hidden"}" id="${t}-fee-nested" ${y}>
          ...
          <div class="meta-cv-fee-footer">
            <div class="meta-cv-fee-value-inline" id="${t}-fee-value">${metaReportFeeValueBlockHtml(t,d,c,m,{inline:!0})}</div>
            <button type="button" class="admin-btn admin-btn--primary admin-btn--small" id="${t}-fee-save" disabled>Saved</button>
          </div>
        </div>
      </div>
    </div>
  `}const v=describeMetaReportFeeModeLabel(d,c,m),$=META_REPORT_FEE_MODE_META.map(({value:h,icon:g,title:p,desc:w})=>`
        ...
        </label>`).join(""),S=s?metaReportsState.clientReportSettingsExpanded:!0,u=s?`
    ...
    <div class="meta-report-bottomline-fee-settings${s?" meta-report-bottomline-fee-settings--client":""}${s?S?" is-editing":" is-collapsed":""}">
      ...
      <div class="meta-report-bottomline-editor${s&&!S?" is-hidden":""}" id="${t}-fee-editor">
        ...
        <div class="meta-report-fee-nested${r?"":" is-hidden"}" id="${t}-fee-nested" ${y}>
          <div class="meta-report-fee-status" id="${t}-fee-status" aria-live="polite">
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,a=(e.clients||[]).find($=>$.clientId===t.selectedClientId),n=t.selectedMonthKey;if(!a||!n)return`
    ...
    `;const s=a.months?.[n]||{};if(t.loadingEditor)return renderMetaCvEditorSkeleton(a,n,s);const o=t.editorPayload?.months?.[n]||null,r=a.metaReportShowBottomline,i=s.wonLeads!=null?s.wonLeads:o?.inputs?.wonLeads??o?.topline?.wonLeads??"",l=s.avgLeadValue!=null?s.avgLeadValue:o?.inputs?.avgLeadValue??o?.topline?.avgLeadValue??"",d=s.avgProfitPerWon!=null?s.avgProfitPerWon:o?.inputs?.avgProfitPerWon??"",c=metaReportsState.customValues.draftInputs,m=c?.wonLeads??i,b=c?.avgLeadValue??l,y=c?.avgProfitPerWon??d,v=t.settingsSaving&&t.settingsSavingScope==="report";return`
    ...
    <div class="meta-cv-editor-grid">
      ...
      <label>Won leads
        <input type="number" step="any" id="meta-cv-won-leads" value="${esc(m)}" />
      </label>
      <label>Avg lead value
        <input type="number" step="any" id="meta-cv-avg-lead-value" value="${esc(b)}" />
      </label>
      <label>Avg profit per won${r?"":" (optional)"}
        <input type="number" step="any" id="meta-cv-avg-profit" value="${esc(y)}" />
      </label>
    </div>
    <div class="meta-report-settings-group meta-report-settings-group--stacked meta-cv-client-settings${v?" is-saving":""}">
      ${renderMetaReportSaveIndicator("meta-cv-settings-status",v)}
...
This removes the account, GHL token, and all synced snapshot data. This cannot be undone.`))return;if(window.prompt(`Type "${e}" to confirm deletion:`)!==e){showToast("Deletion cancelled \u2014 slug did not match.","error");return}try{await adminFetch(`/api/clients/${encodeURIComponent(e)}`,{method:"DELETE"}),showToast(`Deleted ${e}`,"success"),IS_ADMIN_HUB?await loadAdminHub():window.location.href="/admin"}catch(s){showToast(s.message,"error")}}async function syncClient(e,t){t&&(t.disabled=!0,t.textContent="Syncing...");try{await adminFetch(`/api/clients/${encodeURIComponent(e)}/sync`,{method:"POST",body:"{}"}),showToast("Sync completed","success"),IS_ADMIN_HUB?await loadAdminHub():IS_ADMIN_CLIENT?(await loadSetupAccount(),accountCanPreviewDashboard(setupAccount)&&loadDashboard(!0,{background:!0})):loadDashboard(!0,{background:!0})}catch(a){showToast(a.message,"error")}finally{if(t){t.disabled=!1;const a=t.dataset.syncLabel||"Sync";t.innerHTML=t.dataset.syncLabel?`${ICON_SYNC} ${a}`:a}}}function getMetricsModelLabels(e,t=setupPipelines){const a=new Map((t||[]).map(n=>[n.id,n.name]));return e.dedupeEnabled?{typeLabel:"Funnel + deduplication",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId||"\u2014"}`}:e.winPipelineId?{typeLabel:"Simple (single win pipeline)",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId}`}:{typeLabel:"Simple (no deduplication)",winLabel:"All won opportunities"}}const ICON_LAYER='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z"/><path d="M3 13l9 5 9-5"/></svg>',ICON_MERGE='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="2.4"/><circle cx="6" cy="18" r="2.4"/><circle cx="18" cy="15" r="2.4"/><path d="M6 8.4V15.6"/><path d="M8.2 6.4C14 6.4 14 12.6 15.8 13.4"/></svg>',ICON_TARGET='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>',ICON_LOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 018 0v3.5"/></svg>',ICON_UNLOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 017.8-1.2"/></svg>',ICON_TAG='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.6 12.7L12.7 20.6a2 2 0 01-2.8 0l-7-7a2 2 0 010-2.8L10.8 3H19a2 2 0 012 2v7.7z"/><circle cx="15" cy="8" r="1.2"/></svg>',ICON_HASH='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9h14M5 15h14M10 3L8 21M16 3l-2 18"/></svg>',ICON_EDIT='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 013 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>',ICON_WARNING='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.3 3.9L2.6 18a1.5 1.5 0 001.3 2.2h16.2a1.5 1.5 0 001.3-2.2L13.7 3.9a1.5 1.5 0 00-3.4 0z"/><path d="M12 9v4"/><path d="M12 16.5h.01"/></svg>';function renderMetricsModelPanel(e){const t=getMetricsModelLabels(e),a=!e.metricsModelSetAt||metricsModelChangeMode,n=a?" is-wizard":" is-locked",s=e.dedupeEnabled?"dedupe":e.winPipelineId?"pipeline":"simple",o=e.metricsModelLockedAt?`Locked since ${new Date(e.metricsModelLockedAt).toLocaleDateString("en-GB")}`:"Editable until first successful sync",r=e.metricsModelLockedAt?"metrics-model-badge is-locked":"metrics-model-badge";return a?`
  ...
  `:'<div class="pipeline-warning">Select at least one pipeline, then click Apply data filters.</div>'}function defaultDisplayPrefs(){const e={kpis:{},sections:{},charts:getDefaultChartPrefs(),statusItems:{},columns:{}};return Object.keys(DISPLAY_OPTIONS.kpis).forEach(t=>{e.kpis[t]=!0}),Object.keys(DISPLAY_OPTIONS.sections).forEach(t=>{e.sections[t]=!0}),Object.keys(DISPLAY_OPTIONS.charts).forEach(t=>{e.charts[t]=!0}),Object.keys(DISPLAY_OPTIONS.statusItems).forEach(t=>{e.statusItems[t]=!0}),Object.entries(DISPLAY_OPTIONS.columns).forEach(([t,a])=>{e.columns[t]={},Object.keys(a).forEach(n=>{e.columns[t][n]=!0})}),e}function loadDisplayPrefs(){if(IS_CLIENT_VIEW&&!IS_PREVIEW)return defaultDisplayPrefs();try{const e=JSON.parse(localStorage.getItem(STORAGE_KEY)||localStorage.getItem(LEGACY_STORAGE_KEY)||"null");if(!e)return defaultDisplayPrefs();const t=defaultDisplayPrefs();return{kpis:{...t.kpis,...e.kpis},sections:{...t.sections,...e.sections},charts:{...t.charts,...e.charts},statusItems:{...t.statusItems,...e.statusItems},columns:{sourceReport:{...t.columns.sourceReport,...e.columns?.sourceReport||{}},assigneeReport:{...t.columns.assigneeReport,...e.columns?.assigneeReport||{}},pipelineBreakdown:{...t.columns.pipelineBreakdown,...e.columns?.pipelineBreakdown||{}}}}}catch{return defaultDisplayPrefs()}}function ensureChartsVisible(){const e=Object.keys(DISPLAY_OPTIONS.charts);e.some(a=>display.charts[a]!==!1)||(e.forEach(a=>{display.charts[a]=!0}),saveDisplayPrefs())}function saveDisplayPrefs(){localStorage.setItem(STORAGE_KEY,JSON.stringify(display))}function isVisible(e,t,a){return e==="columns"?display.columns[a]?.[t]!==!1:display[e]?.[t]!==!1}function toggleDisplay(e,t,a){e==="columns"?display.columns[a][t]=!display.columns[a][t]:display[e][t]=!display[e][t],saveDisplayPrefs(),cachedData&&updateDashboardContent(cachedData)}function setAllDisplay(e,t,a){e==="columns"?Object.keys(DISPLAY_OPTIONS.columns[a]).forEach(n=>{display.columns[a][n]=t}):Object.keys(DISPLAY_OPTIONS[e]).forEach(n=>{display[e][n]=t}),saveDisplayPrefs(),cachedData&&updateDashboardContent(cachedData)}const fmt=e=>new Intl.NumberFormat("da-DK",{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(Number(e)||0)),fmtCompact=e=>{const t=Number(e)||0;return t>=1e6?`${(t/1e6).toFixed(2)}M`:t>=1e3?`${(t/1e3).toFixed(2)}K`:fmt(t)},fmtPct=e=>`${(Number(e)||0).toFixed(2)}%`,fmtRoas=e=>{const t=Number(e)||0;return t>0?`${t.toFixed(2)}x`:"\u2014"};function formatActiveDateFilter(e){if(!e.dateFrom&&!e.dateTo)return"Till date";const t=getDashboardTimeZone();if(window.MarketingMetrics?.formatShortDateLabel){const a=window.MarketingMetrics.formatShortDateLabel(e.dateFrom,t),n=window.MarketingMetrics.formatShortDateLabel(e.dateTo,t);if(a&&n)return`${a} \u2013 ${n}`}return`${e.dateFrom||"start"} to ${e.dateTo||"now"}`}function showDateRangeError(e){document.querySelectorAll("#date-range-error").forEach(t=>{t.textContent=e,t.hidden=!e})}function clearDateRangeError(){showDateRangeError("")}function needsFreshData(){return!lastFetchedAt||Date.now()-lastFetchedAt>DATA_FRESH_MS}function buildQuery(e,t={}){const a=new URLSearchParams,n=getAllPipelineIds(e||[]),s=state.pipelineIds.filter(o=>n.includes(o));if(!s.length)throw new Error("Select at least one pipeline.");return a.set("pipelineIds",s.join(",")),state.dateField&&a.set("dateField",state.dateField),state.dateFrom&&a.set("dateFrom",state.dateFrom),state.dateTo&&a.set("dateTo",state.dateTo),["status","source","assignedTo","adSpend"].forEach(o=>{state[o]&&state[o]!=="all"&&a.set(o,state[o])}),appendTenantParams(a),t.forceFresh&&a.set("fresh","1"),a.toString()}function formatDateInput(e){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${n}`}function getDashboardTimeZone(){return cachedData?.account?.timezone||"Europe/Copenhagen"}function getCalendarPartsInTimeZone(e,t=new Date){const a=new Intl.DateTimeFormat("en-CA",{timeZone:e,year:"numeric",month:"2-digit",day:"2-digit"}).formatToParts(t);return{year:Number(a.find(n=>n.type==="year")?.value),month:Number(a.find(n=>n.type==="month")?.value),day:Number(a.find(n=>n.type==="day")?.value)}}function formatMonthDateRange(e,t){const a=`${e}-${String(t).padStart(2,"0")}-01`,n=new Date(e,t,0).getDate(),s=`${e}-${String(t).padStart(2,"0")}-${String(n).padStart(2,"0")}`;return{start:a,end:s}}const datePickerState={inputId:null,anchorEl:null,viewYear:null,viewMonth:null};let datePickerListenersBound=!1;function isoFromParts(e,t,a){const n=Number(a);return!e||!t||!Number.isFinite(n)?"":`${e}-${String(t).padStart(2,"0")}-${String(n).padStart(2,"0")}`}function formatPickerDisplayLabel(e,t){if(!e||!/^\d{4}-\d{2}-\d{2}$/.test(e))return t;const a=getDashboardTimeZone();return window.MarketingMetrics?.formatShortDateLabel&&window.MarketingMetrics.formatShortDateLabel(e,a)||e}function ensureDatePickerPopover(){if(document.getElementById("date-picker-popover"))return;const e=document.createElement("div");e.id="date-picker-backdrop",e.className="date-picker-backdrop",e.hidden=!0,e.addEventListener("click",closeDatePicker),document.body.appendChild(e);const t=document.createElement("div");t.id="date-picker-popover",t.className="date-picker-popover",t.hidden=!0,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),document.body.appendChild(t)}function syncDatePickerDisplays(){[{id:"dateFrom",key:"dateFrom",placeholder:"Pick start date"},{id:"dateTo",key:"dateTo",placeholder:"Pick end date"}].forEach(({id:e,key:t,placeholder:a})=>{const n=document.getElementById(e),s=document.getElementById(`${e}-display`),o=document.getElementById(`${e}-trigger`),r=state[t]??"";n&&(n.value=r),s&&(s.textContent=formatPickerDisplayLabel(r,a)),o?.classList.toggle("is-empty",!r),o?.classList.toggle("has-value",!!r)})}function getStateDateValue(e){return state[e]??""}function getDatePickerViewMonth(e){const t=getStateDateValue(e);if(/^\d{4}-\d{2}-\d{2}$/.test(t)){const[a,n]=t.split("-").map(Number);return{year:a,month:n}}return getCalendarPartsInTimeZone(getDashboardTimeZone())}function getTodayIso(){const e=getCalendarPartsInTimeZone(getDashboardTimeZone());return isoFromParts(e.year,e.month,e.day)}function isStartDateDisabled(e){return e>=getTodayIso()}function isFutureDateDisabled(e){return e>getTodayIso()}function isFutureMonthView(e,t){const a=getCalendarPartsInTimeZone(getDashboardTimeZone());return e>a.year||e===a.year&&t>a.month}function isDatePickerDayDisabled(e,t){return t==="dateFrom"&&isStartDateDisabled(e)?!0:isFutureDateDisabled(e)}function renderDatePickerDayCell(e,t,a,n,s,o,r,i){const l=["date-picker-day"];if(a&&l.push("is-outside"),e===n&&l.push("is-today"),e===s&&l.push("is-selected"),o&&r){const d=o<=r?o:r,c=o<=r?r:o;e>=d&&e<=c&&l.push("is-in-range")}return e===o&&l.push("is-range-start"),e===r&&l.push("is-range-end"),isDatePickerDayDisabled(e,i)?(l.push("is-disabled"),`<button type="button" class="${l.join(" ")}" disabled aria-disabled="true">${t}</button>`):`<button type="button" class="${l.join(" ")}" onclick="selectDatePickerDay('${e}')">${t}</button>`}function renderDatePickerPopover(){const e=document.getElementById("date-picker-popover");if(!e||!datePickerState.inputId)return;const{viewYear:t,viewMonth:a,inputId:n}=datePickerState,s=new Intl.DateTimeFormat("en-GB",{month:"long",year:"numeric"}).format(new Date(t,a-1,1)),o=["Mo","Tu","We","Th","Fr","Sa","Su"],i=(new Date(t,a-1,1).getDay()+6)%7,l=new Date(t,a,0).getDate(),d=new Date(t,a-1,0).getDate(),c=getCalendarPartsInTimeZone(getDashboardTimeZone()),m=isoFromParts(c.year,c.month,c.day),b=getStateDateValue(n),y=getStateDateValue("dateFrom"),v=getStateDateValue("dateTo");let $="";for(let w=i-1;w>=0;w-=1){const k=d-w,I=a===1?12:a-1,L=a===1?t-1:t,R=isoFromParts(L,I,k);$+=renderDatePickerDayCell(R,k,!0,m,b,y,v,n)}for(let w=1;w<=l;w+=1){const k=isoFromParts(t,a,w);$+=renderDatePickerDayCell(k,w,!1,m,b,y,v,n)}const S=(7-(i+l)%7)%7;for(let w=1;w<=S;w+=1){const k=a===12?1:a+1,I=a===12?t+1:t,L=isoFromParts(I,k,w);$+=renderDatePickerDayCell(L,w,!0,m,b,y,v,n)}const u=n==="dateFrom"?'<span class="date-picker-hint">Start date must be before today</span>':"",f=n==="dateTo"?'<button type="button" class="date-picker-footer-btn primary" onclick="setDatePickerToday()">Today</button>':"",h=a===12?1:a+1,g=a===12?t+1:t,p=!isFutureMonthView(g,h);e.innerHTML=`
    <div class="date-picker-panel">
      ...
      <div class="date-picker-weekdays">
        ${o.map(w=>`<div class="date-picker-weekday">${w}</div>`).join("")}
      </div>
  ...
  `,IS_ADMIN_CLIENT&&loadSetupAccount(),initDatePickers()}let isFetching=!1,pendingRefetch=!1,fetchGeneration=0,activeFetchController=null,fetchStartedAt=0;const FETCH_TIMEOUT_MS=9e4;function restoreDashboardContentAfterFailedFetch(e){!e||!cachedData||(cachedData=applyMarketingData(cachedData,cachedFacebookMetrics),updateDashboardContent(cachedData),updateFilterUi())}function setPresetButtonsDisabled(e){document.querySelectorAll("[data-preset]").forEach(t=>{t.disabled=e})}function resetFetchUiState(){isFetching=!1,setPresetButtonsDisabled(!1);const e=document.getElementById("apply-filters-btn");e&&(e.disabled=!1,e.textContent="Apply data filters")}function cancelActiveFetch(){activeFetchController&&(activeFetchController.abort(),activeFetchController=null)}function canReuseBootstrapDashboard(e){return!!(e?.kpis&&usesClientPipelineDefaults()&&!state.dateFrom&&!state.dateTo&&state.status==="all"&&state.source==="all"&&state.assignedTo==="all")}async function loadDashboard(e=!0,t={}){const{background:a=!1,forceFresh:n=!1}=t,s=!!n,o=document.getElementById("dashboard");if(isFetching&&(e||!cachedData))cancelActiveFetch(),fetchGeneration+=1,pendingRefetch=!1,resetFetchUiState();else if(isFetching){e&&(pendingRefetch=!0);return}const r=!!document.getElementById("dashboard-content"),i=document.getElementById("apply-filters-btn");if(e||!cachedData){const l=++fetchGeneration;activeFetchController=new AbortController;const d=activeFetchController.signal;if(isFetching=!0,fetchStartedAt=Date.now(),!r)o.innerHTML=`
        ...
        `)}`;else if(!a){const c=document.getElementById("dashboard-content");c&&(c.innerHTML=renderKpiSkeleton()),i&&(i.disabled=!0,i.textContent="Loading..."),setPresetButtonsDisabled(!0)}try{let c=null;if(!availablePipelines.length){if(c=await bootstrapDashboardData(d),l!==fetchGeneration)return;availablePipelines=c.filterOptions.pipelines||[],ensurePipelineDefaults(availablePipelines,c.account?.defaultPipelineIds)}if(!ensurePipelineSelectionBeforeFetch())throw new Error("Select at least one pipeline.");const b=canReuseBootstrapDashboard(c)&&!s;let y,v;if(b?[v,y]=await Promise.all([fetchFacebookMetrics(d),Promise.resolve(c)]):[y,v]=await Promise.all([fetchDashboardData(availablePipelines,d,{forceFresh:s}),fetchFacebookMetrics(d)]),l!==fetchGeneration)return;cachedFacebookMetrics=v,cachedData=applyMarketingData(y,v),cachedData.account?.facebookClientId?facebookClientId=cachedData.account.facebookClientId:cachedData.account?.clientId&&(facebookClientId=cachedData.account.clientId),availablePipelines=cachedData.filterOptions.pipelines||availablePipelines,ensurePipelineDefaults(availablePipelines,cachedData?.account?.defaultPipelineIds),lastFetchedAt=cachedData.cachedAt?new Date(cachedData.cachedAt).getTime():Date.now()}catch(c){if(l!==fetchGeneration)return;if(c.name==="AbortError"){r?restoreDashboardContentAfterFailedFetch(r):o.innerHTML=`
            ${renderBrandTopbar(IS_ADMIN?'<a class="admin-topbar-link" href="/admin">Admin hub</a>':"")}
            ${wrapDashboardShell(`
            ...
            `)}`;return}if(IS_ADMIN_CLIENT&&r){const m=document.getElementById("dashboard-content");m&&(m.innerHTML=`
            <div class="note admin-setup-placeholder">
              ${esc(c.message)}
