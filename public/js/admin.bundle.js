(function(){const t=window.location.pathname.replace(/^\/+|\/+$/g,"").split("/").filter(Boolean);if(t[0]==="login"){document.body.dataset.dashboardMode="login",delete document.body.dataset.clientSlug;return}if(t[0]==="team"){document.body.dataset.dashboardMode="team",delete document.body.dataset.clientSlug;return}if(t[0]==="admin"){if(t[1]==="sync-history"&&(t[2]==="ghl"||t[2]==="meta")){document.body.dataset.dashboardMode=`sync-history-${t[2]}`,delete document.body.dataset.clientSlug;return}if(t[1]==="fb-lead-sync"){document.body.dataset.dashboardMode="fb-lead-sync",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]==="custom-values"){document.body.dataset.dashboardMode="meta-reports-custom",delete document.body.dataset.clientSlug;return}if(t[1]==="meta-reports"&&t[2]){document.body.dataset.dashboardMode="meta-reports-client",document.body.dataset.clientSlug=t[2];return}if(t[1]==="meta-reports"){document.body.dataset.dashboardMode="meta-reports",delete document.body.dataset.clientSlug;return}document.body.dataset.dashboardMode=t.length>=2?"admin":"hub",t.length>=2?document.body.dataset.clientSlug=t[1]:delete document.body.dataset.clientSlug;return}if(t[0]==="report"&&t[1]){document.body.dataset.dashboardMode="report",document.body.dataset.reportToken=t[1],delete document.body.dataset.clientSlug;return}t[0]&&t[0]!=="index.html"&&(document.body.dataset.dashboardMode="client",document.body.dataset.clientSlug=t[0])})();const DASHBOARD_MODE=document.body.dataset.dashboardMode||"client",IS_LOGIN_PAGE=DASHBOARD_MODE==="login",IS_TEAM_PAGE=DASHBOARD_MODE==="team",IS_ADMIN_HUB=DASHBOARD_MODE==="hub",IS_ADMIN_CLIENT=DASHBOARD_MODE==="admin",IS_ADMIN_SYNC_HISTORY_GHL=DASHBOARD_MODE==="sync-history-ghl",IS_ADMIN_SYNC_HISTORY_META=DASHBOARD_MODE==="sync-history-meta",IS_ADMIN_FB_LEAD_SYNC=DASHBOARD_MODE==="fb-lead-sync",IS_ADMIN_META_REPORTS=DASHBOARD_MODE==="meta-reports",IS_ADMIN_META_REPORTS_CLIENT=DASHBOARD_MODE==="meta-reports-client",IS_ADMIN_META_REPORTS_CUSTOM=DASHBOARD_MODE==="meta-reports-custom",IS_REPORT_VIEW=DASHBOARD_MODE==="report",REPORT_TOKEN=document.body.dataset.reportToken||"",IS_ADMIN_SYNC_HISTORY=IS_ADMIN_SYNC_HISTORY_GHL||IS_ADMIN_SYNC_HISTORY_META,IS_CLIENT_VIEW=DASHBOARD_MODE==="client",IS_PREVIEW=IS_CLIENT_VIEW&&!!new URLSearchParams(window.location.search).get("client"),IS_ADMIN=IS_ADMIN_HUB||IS_ADMIN_CLIENT||IS_TEAM_PAGE||IS_ADMIN_SYNC_HISTORY||IS_ADMIN_FB_LEAD_SYNC||IS_ADMIN_META_REPORTS||IS_ADMIN_META_REPORTS_CLIENT||IS_ADMIN_META_REPORTS_CUSTOM||new URLSearchParams(window.location.search).get("view")==="admin",ADMIN_UI=IS_ADMIN_HUB||IS_ADMIN_CLIENT||IS_TEAM_PAGE||IS_ADMIN_SYNC_HISTORY||IS_ADMIN_FB_LEAD_SYNC||IS_ADMIN_META_REPORTS||IS_ADMIN_META_REPORTS_CLIENT||IS_ADMIN_META_REPORTS_CUSTOM||IS_ADMIN,LOADING_MSG=ADMIN_UI?"Loading dashboard data...":"Henter dashboard data...",RETRY_MSG=ADMIN_UI?"Try again":"Pr\xF8v igen";(function(){const t=document.getElementById("initial-loading-msg");t&&(t.textContent=LOADING_MSG)})();function resolveClientSlug(){if(document.body.dataset.clientSlug)return document.body.dataset.clientSlug;const e=window.location.pathname.replace(/^\/+|\/+$/g,"").split("/").filter(Boolean);return e[0]==="admin"&&e[1]==="meta-reports"&&e[2]&&e[2]!=="custom-values"?e[2]:e[0]==="admin"&&e[1]&&e[1]!=="meta-reports"?e[1]:e[0]&&e[0]!=="admin"&&e[0]!=="index.html"&&e[0]!=="report"?e[0]:new URLSearchParams(window.location.search).get("client")||"suntech-nordic"}const CLIENT_SLUG=resolveClientSlug();let tenantParams={},facebookClientId=CLIENT_SLUG,setupAccount=null,setupPipelines=[],metricsModelChangeMode=!1;function esc(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function renderBrandTopbar(e=""){const t=!!(e&&e.includes("staff-admin-chrome")),a=t||e&&e.includes("admin-topbar-link")?"/admin":"",n=a?`<a href="${a}" class="brand-logo-link" aria-label="Cenhub home"><img class="brand-logo" src="/cenhub-logo-white.png" alt="Cenhub" width="167" height="41" /></a>`:'<img class="brand-logo" src="/cenhub-logo-white.png" alt="Cenhub" width="167" height="41" />',s=t?`<button type="button" class="staff-nav-toggle" id="staff-nav-toggle" aria-expanded="false" aria-controls="staff-topbar-panel" aria-label="Open menu">
  ...
  `}function renderSyncHistoryRows(e,t){if(!e.length)return'<div class="sync-history-empty">No sync runs logged yet.</div>';const a=t==="meta"?"Spend / details":"Details",n=e.map(s=>{let o="\u2014";if(t==="meta"){const r=[];if(s.thisMonthSpend!=null&&r.push(`${fmtDkk(s.thisMonthSpend)} DKK this month`),s.spendDateStop){const i=formatSyncHistoryDate(s.spendDateStop);i&&r.push(`through ${i}`)}s.errorMessage&&r.push(s.errorMessage),o=r.join(" \xB7 ")||"\u2014"}else s.opportunityCount!=null?(o=`${s.opportunityCount} opportunities`,s.errorMessage&&(o+=` \xB7 ${s.errorMessage}`)):s.errorMessage&&(o=s.errorMessage);return`
      <tr>
...
${a}`))try{const s=await adminFetch(`/api/sync-history?type=${encodeURIComponent(e)}`,{method:"DELETE"});showToast(`Cleared ${s.deleted||0} log entr${s.deleted===1?"y":"ies"}.`,"success"),await loadSyncHistoryPage(e)}catch(s){showToast(s.message||`Failed to clear ${t} sync log.`,"error")}}function renderSyncHistoryLoginPrompt(e){const t=e==="meta"?"Meta sync log":"GHL sync log";return`
  ...
  `}async function loadSyncHistoryPage(e,{silent:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){t||(a.innerHTML=renderSyncHistoryLoginPrompt(e));return}currentStaffUser=n,t||(a.innerHTML=`
    ...
    `);try{const s=await adminFetch(`/api/sync-history?type=${encodeURIComponent(e)}&limit=150`);a.innerHTML=renderSyncHistoryPage(e,s);const o=document.getElementById("sync-history-refresh");o&&(o.onclick=()=>loadSyncHistoryPage(e));const r=document.getElementById("sync-history-clear-log");r&&(r.onclick=()=>clearSyncHistoryLog(e)),syncHistoryRefreshTimer&&(clearInterval(syncHistoryRefreshTimer),syncHistoryRefreshTimer=null),syncHistoryRefreshTimer=window.setInterval(()=>{loadSyncHistoryPage(e,{silent:!0}).catch(()=>{})},6e4)}catch(s){a.innerHTML=`
      ${renderBrandTopbar(renderStaffAdminChrome(e==="meta"?"meta-sync":"ghl-sync"))}
...
${r} contact(s) will get Fb Lead id written in GHL. This writes live data.`)&&(fbLeadSyncState.activeRun={clientId:e,mode:t,runId:null,previewOk:!0,previewRunId:a},await runFbLeadSyncBatch({clientId:e,mode:t,dryRun:!1}))}async function refreshFbLeadClientRowsUi(){const e=document.getElementById("fb-lead-clients-mount"),t=document.getElementById("fb-lead-field-warnings-mount");e&&(e.innerHTML=renderFbLeadClientRows(fbLeadSyncState.clients)),t&&(t.innerHTML=renderFbLeadFieldWarnings(fbLeadSyncState.clients)),bindFbLeadSyncToggles()}function renderFbLeadClientActions(e){const t=esc(e.clientId),a=e.metaPageId?"":`<a class="admin-btn admin-btn--ghost admin-btn--small" href="/admin/${encodeURIComponent(e.clientId)}">Setup</a>`;return`
  ...
  `}function lastRunIsSuccessfulApply(e){if(!e||e.dryRun)return!1;const t=String(e.status||"").toLowerCase();return t==="success"||t==="ok"}function lastRunIsSuccessfulPreview(e){if(!e||!e.dryRun)return!1;const t=String(e.status||"").toLowerCase();return t==="success"||t==="ok"}function resolveFbLeadClientStats(e,t={}){const a=e?.displayStats||{},n=t.metaLeadCount90d??a.metaLeadCount90d??null,s=t.estimatedMissing??a.outstanding??null,o=t.estimatedMissing!=null?"Estimated contacts still missing Fb Lead id (from a Meta sample)":a.outstandingHint||"Estimated contacts still missing Fb Lead id (from a Meta sample)";return{metaLeads:n!=null?String(n):"\u2014",missing:s!=null?String(s):"\u2014",missingTitle:o}}function formatFbLeadLastRunLabel(e){if(!e)return"\u2014";const t=[e.dryRun?"preview":e.status,`${e.updated||0} ${e.dryRun?"would update":"updated"}`];return(e.skippedNoMatch??0)>0&&t.push(`${e.skippedNoMatch} no match`),t.join(" \xB7 ")}function renderFbLeadClientRows(e){return e.length?`
    <div class="sync-history-table-wrap">
      <table class="sync-history-table fb-lead-clients-table">
        ...
        <tbody>${e.map(a=>{const n=fbLeadSyncState.preflightByClient[a.clientId]||{},s=resolveFbLeadClientStats(a,n),o=formatFbLeadLastRunLabel(a.lastRun);return`
      <tr>
        <td>
  ...
  `:'<div class="sync-history-empty">No clients configured yet.</div>'}function renderFbLeadClientRowsWrapper(e){return`<div id="fb-lead-clients-mount">${renderFbLeadClientRows(e)}</div>`}function renderFbLeadHistoryRows(e,t={}){const a=getFbLeadHistoryRunsForDisplay(e);if(!a.length){const s=fbLeadSyncState.showRoutineCronRuns?0:(e||[]).filter(o=>isRoutineSuccessfulCronRun(o)).length;return s>0?`<div class="sync-history-empty">${s} routine auto-sync run(s) hidden \u2014 enable <strong>Show routine auto-sync runs</strong> above to view them.</div>`:'<div class="sync-history-empty">No FB lead sync runs logged yet.</div>'}return e=a,`
    <div class="sync-history-table-wrap">
      <table class="sync-history-table">
        ...
        <tbody>${e.map(s=>{const o=[s.mode,s.dryRun?"dry-run":"apply",s.dryRun?`${s.updated||0} would update`:`${s.updated||0} updated`,`${s.skippedNoMatch||0} no match`,s.errors?`${s.errors} errors`:null].filter(Boolean).join(" \xB7 "),r=dryRunIsReadyForApply(s,e)&&!fbLeadSyncState.isApplying,i=isPartialSyncRun(s)&&!fbLeadSyncState.isApplying,l=fbLeadSyncState.isApplying&&fbLeadSyncState.applyingRunId===s.id,c=renderSyncStatusBadge(l?"applying":s.status);return`
  ...
  `}function renderFbLeadAuditTable(e,t){if(!e.length)return'<div class="sync-history-empty" style="padding:12px">No contact-level rows stored for this run.</div>';const a=e.map(s=>{const o=ghlContactUrl(t,s.contactId),r=o?`<a href="${esc(o)}" target="_blank" rel="noopener noreferrer">Open in GHL</a>`:"\u2014";return`
      <tr>
  ...
  `}function renderGlobalApplyProgress(e,t,a=0){const n=fbLeadSyncState.clients.find(r=>r.clientId===e),s=t==="backfill"?"90-day backfill":"recent sync",o=a>0?`${a} contact(s)`:"contacts";return`
...
Resume the interrupted ${S}?`)&&(l=w.id,c=Number(w.batchOffset)||0)}}if(a?setFbLeadProgress({processed:c,total:0,label:c>0?"Resuming preview\u2026":"Fetching Meta leads\u2026"}):updateGlobalApplyProgress({waiting:!0,elapsed:0}),a&&c===0){const w=await adminFetchWithRetry("/api/fb-lead-sync/prepare",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l})}),g=w.summary||w;l=g.runId,c=0,setFbLeadProgress({processed:0,total:g.inWindow||0,label:`Matching ${g.inWindow||0} Meta leads to GHL\u2026`})}else!a&&c===0&&updateGlobalApplyProgress({waiting:!1,processed:0,total:$||m?.updated||0});do{d=await adminFetchWithRetry("/api/fb-lead-sync/run",{method:"POST",body:JSON.stringify({clientId:e,mode:t,dryRun:a,runId:l,previewRunId:a?null:h,batchOffset:c,batchLimit:r})});const w=d.summary||d;l=w.runId,c=w.nextBatchOffset??w.batchOffset+(w.batchProcessed||0),u=u.concat(w.rows||[]),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.runId=l);const g=w.inWindow||c||$;a?(setFbLeadProgress({processed:c,total:g,complete:!w.hasMore}),o&&(o.innerHTML=renderFbLeadRunResults({...w,rows:u}))):updateGlobalApplyProgress({processed:c,total:g,written:w.updated||0,complete:!w.hasMore})}while((d.summary||d).hasMore);p=!0;const v=d.summary||d,f=v.inWindow||c||$,y=v.nextBatchOffset??c;if(a)setFbLeadProgress({processed:y,total:f,complete:!0}),markFbLeadPreviewReady(e,t,v.updated),fbLeadSyncState.activeRun&&(fbLeadSyncState.activeRun.previewOk=(v.updated||0)>0),showToast((v.updated||0)>0?"Preview complete \u2014 use Apply in Run history below.":"Preview complete \u2014 all contacts already have Fb Lead id. Nothing to apply.","success"),await refreshFbLeadHistoryUi(),document.getElementById("fb-lead-history-mount")?.scrollIntoView({behavior:"smooth",block:"nearest"});else{updateGlobalApplyProgress({processed:y,total:f,written:v.updated||0,complete:!0}),delete fbLeadSyncState.previewOkByClient[e];try{const w=JSON.parse(sessionStorage.getItem("fbLeadSyncPreviewOk")||"{}");delete w[e],sessionStorage.setItem("fbLeadSyncPreviewOk",JSON.stringify(w))}catch{}showToast("FB lead sync complete \u2014 Fb Lead id written to GHL","success"),stopGlobalApplyProgress({success:!0})}await refreshFbLeadHistoryUi();const b=await adminFetch("/api/fb-lead-sync");fbLeadSyncState.clients=b.clients||[],hydrateFbLeadPreviewState(fbLeadSyncState.clients),await refreshFbLeadClientRowsUi()}catch(v){a?hideFbLeadProgress(!0):(updateGlobalApplyProgress({error:`Failed \u2014 ${v.message||"Apply failed"}`}),stopGlobalApplyProgress({success:!1,keepVisibleMs:12e3})),showToast((v.message||(a?"FB lead preview failed.":"FB lead apply failed."))+(a?" Partial progress is saved \u2014 use Resume in Run history or try Preview again.":" Partial progress is saved \u2014 use Resume in Run history."),"error"),await refreshFbLeadHistoryUi()}finally{s&&(s.disabled=!1),fbLeadSyncState.applyingRunId=null,!p&&a&&hideFbLeadProgress(!0),!a&&!p&&(fbLeadSyncState.isApplying=!1,await refreshFbLeadHistoryUi())}}async function expandFbLeadRun(e){const t=document.getElementById(`fb-lead-run-audit-${e}`);if(t){if(!t.hidden){t.hidden=!0;return}try{const a=await adminFetch(`/api/fb-lead-sync/history/${e}`),n=fbLeadSyncState.clients.find(o=>o.clientId===a.run.clientId);t.innerHTML=`<td colspan="7"><div class="fb-lead-audit-scroll" id="fb-lead-audit-scroll-${e}">${renderFbLeadAuditTable(a.run.rows||[],a.run.locationId||n?.locationId)}</div></td>`,t.hidden=!1;const s=document.getElementById(`fb-lead-audit-scroll-${e}`);s&&s.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(a){showToast(a.message||"Failed to load run audit.","error")}}}function viewFbLeadClientHistory(e){const t=getFbLeadHistoryRunsForDisplay(fbLeadSyncState.historyRuns.filter(s=>s.clientId===e)),a=document.getElementById("fb-lead-history-mount");if(!a)return;const n=Object.fromEntries(fbLeadSyncState.clients.map(s=>[s.clientId,s.locationId]));a.innerHTML=t.length?renderFbLeadHistoryRows(t,n):`<div class="sync-history-empty">No runs for ${esc(e)} yet.</div>`,a.scrollIntoView({behavior:"smooth",block:"start"})}async function loadFbLeadSyncPage({silent:e=!1,fullPreflight:t=!1}={}){const a=document.getElementById("dashboard");if(!a)return;const n=await fetchStaffMe();if(!n){e||(a.innerHTML=`
  ...
  `:`<div class="meta-hub-switch is-disabled"><span class="meta-hub-switch-label">${esc(e)}</span><span class="meta-report-muted">\u2014</span></div>`}function metaReportFullUrl(e){return e?`${window.location.origin}${e}`:""}function normalizeMetaReportSlugInput(e){return String(e||"").trim().toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"")}function resolveMetaReportShareSlug(e){const t=e.settings||{};if(t.metaReportSlug)return t.metaReportSlug;const n=String(e.reportUrl||"").replace(/^\/report\//,"").match(/^(.+)-(\d{4})$/);return n?n[1]:""}function resolveMetaReportShareCode(e){const a=String(e.reportUrl||"").replace(/^\/report\//,"").match(/-(\d{4})$/);return a?a[1]:""}function renderMetaReportShareSummary(e,{hidden:t=!1}={}){const n=!!(e.settings||{}).metaReportEnabled,s=resolveMetaReportShareSlug(e),o=resolveMetaReportShareCode(e),r=s?`${s}-${o||"\xB7\xB7\xB7\xB7"}`:"Not set";return`
  ...
  `}function renderMetaReportMetricTable(e,t,a="meta",{badge:n="",highlightLastN:s=0}={}){const o=t.map(([r,i,l],c)=>`
  ...
  `}const META_REPORT_COMPARISON_PRESETS=[{id:"mom",label:"This month vs last month"},{id:"custom",label:"Custom dates"},{id:"ytd",label:"This year vs last year"}],META_REPORT_COMPARISON_TABLE_GROUPS=[{title:"Meta ads",accent:"meta",rows:[{label:"Total spend",metricId:"spend",format:"kr",higherIsBetter:null},{label:"Cost Pr Mile (CPM)",metricId:"cpm",format:"kr",higherIsBetter:!1},{label:"Impressions",metricId:"impressions",format:"num",higherIsBetter:!0},{label:"Reach",metricId:"reach",format:"num",higherIsBetter:!0},{label:"Click",metricId:"clicks",format:"num",higherIsBetter:!0},{label:"CTR",metricId:"conversionRatePercent",format:"pct",higherIsBetter:!0}]},{title:"Topline KPI'er",accent:"topline",highlightLastN:2,rows:[{label:"Leads",metricId:"leads",format:"num",higherIsBetter:!0},{label:"Cost Per Lead (CPL)",metricId:"cpl",format:"kr",higherIsBetter:!1},{label:"Won leads",metricId:"wonLeads",format:"num",higherIsBetter:!0},{label:"Total Lead Value",metricId:"totalLeadValue",format:"kr",higherIsBetter:!0},{label:"Average Lead Value",metricId:"avgLeadValue",format:"kr",higherIsBetter:!0},{label:"Client acquisition cost (CAC)",metricId:"cac",format:"kr",higherIsBetter:!1},{label:"Return on Ads Spend (ROAS)",metricId:"roasKr",format:"kr",higherIsBetter:!0},{label:"Return on Ads Spend % (ROAS)",metricId:"roasX",format:"x",higherIsBetter:!0}]},{title:"Bottomline KPI'er",accent:"bottomline",highlightLastN:2,bottomlineOnly:!0,rows:[{label:"Leads",metricId:"leads",format:"num",higherIsBetter:!0},{label:"Won leads",metricId:"wonLeads",format:"num",higherIsBetter:!0},{label:"Total Lead Value",metricId:"totalLeadValue",format:"kr",higherIsBetter:!0},{label:"Average Lead Value",metricId:"avgLeadValue",format:"kr",higherIsBetter:!0},{label:"Client acquisition cost (CAC)",metricId:"cac",format:"kr",higherIsBetter:!1},{label:"Avg Total Profit",metricId:"totalProfit",format:"kr",higherIsBetter:!0},{label:"Avg Single Profit Order",metricId:"avgProfitPerWon",format:"kr",higherIsBetter:!0},{label:"Profit on Ads Spend (POAS)",metricId:"poasKr",format:"kr",higherIsBetter:!0},{label:"Profit on Ads Spend % (POAS)",metricId:"poasX",format:"x",higherIsBetter:!0},{label:"Censio fee",metricId:"censioFee",format:"kr",higherIsBetter:!1},{label:"Profit on Investment (POI)",metricId:"poiKr",format:"kr",higherIsBetter:!0},{label:"Profit on Investment % (POI)",metricId:"poiX",format:"x",higherIsBetter:!0}]}];function metaReportComparisonAddMonths(e,t=0){const a=String(e||"").trim();if(!/^\d{4}-\d{2}$/.test(a))return null;const[n,s]=a.split("-").map(Number),o=new Date(n,s-1+t,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`}function metaReportComparisonMonthKeysInRange(e,t){if(!e||!t)return[];const[a,n]=e<=t?[e,t]:[t,e],s=[];let o=a;for(;o&&o<=n&&(s.push(o),o!==n);)o=metaReportComparisonAddMonths(o,1);return s}function metaReportComparisonParseDate(e){const t=String(e||"").trim().slice(0,10);if(!/^\d{4}-\d{2}-\d{2}$/.test(t))return null;const[a,n,s]=t.split("-").map(Number),o=new Date(a,n-1,s);return o.getFullYear()!==a||o.getMonth()!==n-1||o.getDate()!==s?null:t}function metaReportComparisonDaysInclusive(e,t){const a=metaReportComparisonParseDate(e),n=metaReportComparisonParseDate(t);if(!a||!n||a>n)return 0;const[s,o,r]=a.split("-").map(Number),[i,l,c]=n.split("-").map(Number),d=Date.UTC(s,o-1,r),u=Date.UTC(i,l-1,c);return Math.floor((u-d)/864e5)+1}function metaReportComparisonOverlapDays(e,t,a,n){const s=e>a?e:a,o=t<n?t:n;return!s||!o||s>o?0:metaReportComparisonDaysInclusive(s,o)}function metaReportComparisonMonthKeyFromDate(e){const t=metaReportComparisonParseDate(e);return t?t.slice(0,7):null}function metaReportComparisonMonthKeysOverlappingDates(e,t){const a=metaReportComparisonParseDate(e),n=metaReportComparisonParseDate(t);if(!a||!n)return[];const[s,o]=a<=n?[a,n]:[n,a],r=[];let i=metaReportComparisonMonthKeyFromDate(s);const l=metaReportComparisonMonthKeyFromDate(o);for(;i&&i<=l&&(r.push(i),i!==l);)i=metaReportComparisonAddMonths(i,1);return r}function metaReportComparisonMonthEffectivePeriod(e,t){const a=metaReportMonthBounds(t||e?.monthKey),n=metaReportComparisonParseDate(e?.periodStart)||a.start,s=metaReportComparisonParseDate(e?.periodEnd)||a.end;return n&&s&&n<=s?{start:n,end:s}:a}function metaReportComparisonFormatDateLabel(e){const t=metaReportComparisonParseDate(e);if(!t)return"\u2014";const[a,n,s]=t.split("-").map(Number);return`${s} ${META_MONTH_LABELS[n-1]||n} ${a}`}function metaReportComparisonFormatDateRangeLabel(e,t){const a=metaReportComparisonParseDate(e),n=metaReportComparisonParseDate(t);if(!a||!n)return"\u2014";if(a===n)return metaReportComparisonFormatDateLabel(a);const s=a.slice(0,4),o=n.slice(0,4),r=a.slice(5,7),i=n.slice(5,7);if(s===o&&r===i){const[,l,c]=a.split("-").map(Number),[,,d]=n.split("-").map(Number);return`${c}\u2013${d} ${META_MONTH_LABELS[l-1]||l} ${s}`}return s===o?`${metaReportComparisonFormatDateLabel(a).replace(` ${s}`,"")}\u2013${metaReportComparisonFormatDateLabel(n)}`:`${metaReportComparisonFormatDateLabel(a)} \u2013 ${metaReportComparisonFormatDateLabel(n)}`}function metaReportComparisonMonthPayloadDates(e,t){const a=metaReportComparisonMonthEffectivePeriod(e,t);return{startDate:a.start,endDate:a.end,startMonthKey:t,endMonthKey:t}}function metaReportComparisonFullMonthDates(e){const t=metaReportMonthBounds(e);return{startDate:t.start,endDate:t.end,startMonthKey:e,endMonthKey:e}}function metaReportComparisonFormatDisplayLabel(e,t){const a=metaReportComparisonNormalizePeriod(t);return a?e==="mom"?metaReportComparisonPeriodLabel(a.startMonthKey,a.endMonthKey):e==="ytd"?a.startDate.slice(0,4):metaReportComparisonFormatDateRangeLabel(a.startDate,a.endDate):"\u2014"}function metaReportComparisonAggregateForMode(e,t,a){const n=metaReportComparisonNormalizePeriod(a);if(!n)return{label:"\u2014",monthKeys:[],monthCount:0,expectedMonthCount:0,partialData:!1,hasData:!1,hasBottomline:!1,metrics:metaReportComparisonAggregateDateRange({},null,null).metrics};let s;return e==="mom"?s=metaReportAggregateComparisonRange(t,n.startMonthKey,n.endMonthKey):s=metaReportComparisonAggregateDateRange(t,n.startDate,n.endDate),s.label=metaReportComparisonFormatDisplayLabel(e,n),s}function metaReportComparisonNormalizePeriod(e=null){if(!e)return null;const t=metaReportComparisonParseDate(e.startDate)||(e.startMonthKey?metaReportMonthBounds(e.startMonthKey).start:null),a=metaReportComparisonParseDate(e.endDate)||(e.endMonthKey?metaReportMonthBounds(e.endMonthKey).end:null);if(!t||!a)return null;const[n,s]=t<=a?[t,a]:[a,t];return{startDate:n,endDate:s,startMonthKey:metaReportComparisonMonthKeyFromDate(n),endMonthKey:metaReportComparisonMonthKeyFromDate(s)}}function metaReportComparisonPeriodLabel(e,t){if(!e||!t)return"\u2014";if(e===t)return`${metaMonthLabel(e)} ${String(e).slice(0,4)}`;const a=String(e).slice(0,4),n=String(t).slice(0,4);return a===n?`${metaMonthLabel(e)}\u2013${metaMonthLabel(t)} ${a}`:`${metaMonthLabel(e)} ${a}\u2013${metaMonthLabel(t)} ${n}`}function metaReportMonthHasComparisonData(e){return!e||e.meta?.emptyMonth?!1:metaReportParseAmount(e.meta?.spend)>0||metaReportParseAmount(e.topline?.leads)>0}function metaReportAggregateComparisonRange(e={},t,a){const n=metaReportComparisonMonthKeysInRange(t,a),s=[];let o=!1,r=0,i=0,l=0,c=0,d=0,u=0,p=0,h=0,m=0,$=0,v=0,f=0,y=0;for(const R of n){const A=e[R];if(!metaReportMonthHasComparisonData(A))continue;s.push(R),A.bottomline&&(o=!0);const k=metaReportParseAmount(A.meta?.spend),F=metaReportParseAmount(A.meta?.impressions),O=metaReportParseAmount(A.topline?.leads),x=metaReportParseAmount(A.topline?.wonLeads);r+=k,i+=F,l+=metaReportParseAmount(A.meta?.reach),c+=metaReportParseAmount(A.meta?.clicks),d+=O,u+=x,p+=metaReportParseAmount(A.topline?.totalLeadValue),x>0&&($+=metaReportParseAmount(A.topline?.avgLeadValue)*x,A.bottomline&&(v+=metaReportParseAmount(A.bottomline.avgProfitPerWon)*x)),F>0&&(f+=metaReportParseAmount(A.meta?.cpm)*F,y+=F),A.bottomline&&(h+=metaReportParseAmount(A.bottomline.totalProfit),m+=metaReportParseAmount(A.bottomline.censioFee))}const b=d>0?Math.round(r/d*100)/100:0,w=u>0?Math.round(r/u*100)/100:0,g=u>0?Math.round($/u*100)/100:0,S=u>0?Math.round(v/u*100)/100:0,L=y>0?Math.round(f/y*100)/100:0,B=i>0?Math.round(c/i*100*1e8)/1e8:0,P=Math.round((p-r)*100)/100,C=r>0?Math.round(P/r*1e8)/1e8:0,M=Math.round((h-r)*100)/100,E=r>0?Math.round(M/r*1e8)/1e8:0,I=o?Math.round((M-m)*100)/100:0,T=r>0&&o?Math.round(I/r*1e8)/1e8:0;return{startKey:t,endKey:a,label:metaReportComparisonPeriodLabel(t,a),monthKeys:s,monthCount:s.length,expectedMonthCount:n.length,partialData:s.length>0&&s.length<n.length,hasData:s.length>0,hasBottomline:o,metrics:{spend:r,cpm:L,impressions:i,reach:l,clicks:c,conversionRatePercent:B,leads:d,cpl:b,wonLeads:u,totalLeadValue:p,avgLeadValue:g,cac:w,roasKr:P,roasX:C,totalProfit:h,avgProfitPerWon:S,poasKr:M,poasX:E,censioFee:m,poiKr:I,poiX:T}}}function metaReportComparisonAggregateDateRange(e={},t,a){const n=metaReportComparisonParseDate(t),s=metaReportComparisonParseDate(a);if(!n||!s)return{startDate:t||null,endDate:a||null,label:"\u2014",monthKeys:[],monthCount:0,expectedMonthCount:0,partialData:!1,hasData:!1,hasBottomline:!1,metrics:metaReportAggregateComparisonRange({},"0000-00","0000-00").metrics};const[o,r]=n<=s?[n,s]:[s,n],i=metaReportComparisonMonthKeysOverlappingDates(o,r),l=[];let c=!1,d=0,u=0,p=0,h=0,m=0,$=0,v=0,f=0,y=0,b=0,w=0,g=0,S=0,L=0,B=0;for(const K of i){const D=e[K],H=metaReportComparisonMonthEffectivePeriod(D,K),V=metaReportComparisonOverlapDays(o,r,H.start,H.end);if(V<=0||(d+=V,!metaReportMonthHasComparisonData(D)))continue;l.push(K),u+=V,D.bottomline&&(c=!0);const W=metaReportComparisonDaysInclusive(H.start,H.end),N=W>0?V/W:0,j=metaReportParseAmount(D.meta?.spend)*N,_=metaReportParseAmount(D.meta?.impressions)*N,q=metaReportParseAmount(D.topline?.leads)*N,U=metaReportParseAmount(D.topline?.wonLeads)*N;p+=j,h+=_,m+=metaReportParseAmount(D.meta?.reach)*N,$+=metaReportParseAmount(D.meta?.clicks)*N,v+=q,f+=U,y+=metaReportParseAmount(D.topline?.totalLeadValue)*N,U>0&&(g+=metaReportParseAmount(D.topline?.avgLeadValue)*U,D.bottomline&&(S+=metaReportParseAmount(D.bottomline.avgProfitPerWon)*U)),_>0&&(L+=metaReportParseAmount(D.meta?.cpm)*_,B+=_),D.bottomline&&(b+=metaReportParseAmount(D.bottomline.totalProfit)*N,w+=metaReportParseAmount(D.bottomline.censioFee)*N)}const P=v>0?Math.round(p/v*100)/100:0,C=f>0?Math.round(p/f*100)/100:0,M=f>0?Math.round(g/f*100)/100:0,E=f>0?Math.round(S/f*100)/100:0,I=B>0?Math.round(L/B*100)/100:0,T=h>0?Math.round($/h*100*1e8)/1e8:0,R=Math.round((y-p)*100)/100,A=p>0?Math.round(R/p*1e8)/1e8:0,k=Math.round((b-p)*100)/100,F=p>0?Math.round(k/p*1e8)/1e8:0,O=c?Math.round((k-w)*100)/100:0,x=p>0&&c?Math.round(O/p*1e8)/1e8:0;return{startDate:o,endDate:r,label:metaReportComparisonFormatDateRangeLabel(o,r),monthKeys:l,monthCount:l.length,expectedMonthCount:i.length,partialData:d>0&&u<d,hasData:l.length>0,hasBottomline:c,metrics:{spend:p,cpm:I,impressions:h,reach:m,clicks:$,conversionRatePercent:T,leads:v,cpl:P,wonLeads:f,totalLeadValue:y,avgLeadValue:M,cac:C,roasKr:R,roasX:A,totalProfit:b,avgProfitPerWon:E,poasKr:k,poasX:F,censioFee:w,poiKr:O,poiX:x}}}function metaReportComparisonMergedMonthsMap(e,t,a){const n=metaReportComparisonYearsNeeded(t,a),s={...e?.months||{}};return n.forEach(o=>{Number(e?.year)!==Number(o)&&Object.assign(s,metaReportComparisonMonthsForYear(e,o))}),s}function metaReportResolveComparisonPresetDates(e,t="mom"){const a=metaReportsState.activeMonthKey||null,n=metaReportComparisonMergedMonthsMap(e,null,null);if(t==="custom")return{mode:t,periodA:metaReportComparisonNormalizePeriod(metaReportsState.comparisonPeriodA),periodB:metaReportComparisonNormalizePeriod(metaReportsState.comparisonPeriodB)};if(!a)return{mode:t,periodA:null,periodB:null};if(t==="mom"){const s=metaReportComparisonAddMonths(a,-1);return{mode:t,periodA:metaReportComparisonFullMonthDates(a),periodB:s?metaReportComparisonFullMonthDates(s):null}}if(t==="ytd"){const s=String(a).slice(0,4),o=String(a).slice(5,7),r=String(Number(s)-1),i=metaReportMonthBounds(a),l=`${r}-${o}`,c=metaReportMonthBounds(l);return{mode:t,periodA:{startDate:`${s}-01-01`,endDate:i.end,startMonthKey:`${s}-01`,endMonthKey:a},periodB:{startDate:`${r}-01-01`,endDate:c.end,startMonthKey:`${r}-01`,endMonthKey:l}}}return{mode:t,periodA:null,periodB:null}}function metaReportApplyComparisonPresetDefaults(e,t=metaReportsState.comparisonMode){const a=metaReportResolveComparisonPresetDates(e,t);return a.periodA&&(metaReportsState.comparisonPeriodA={...a.periodA}),a.periodB&&(metaReportsState.comparisonPeriodB={...a.periodB}),a}function metaReportResolveComparisonPresets({activeMonthKey:e=null,mode:t="mom"}={}){const a=metaReportsState.clientPayload||metaReportsState.publicPayload;return metaReportResolveComparisonPresetDates(a,t)}function metaReportComparisonMetricDefs(e=!1){const t=[{id:"spend",label:"Ad spend",group:"meta",format:"kr",higherIsBetter:null},{id:"cpm",label:"CPM",group:"meta",format:"kr",higherIsBetter:!1},{id:"impressions",label:"Impressions",group:"meta",format:"num",higherIsBetter:!0},{id:"reach",label:"Reach",group:"meta",format:"num",higherIsBetter:!0},{id:"clicks",label:"Clicks",group:"meta",format:"num",higherIsBetter:!0},{id:"conversionRatePercent",label:"CTR",group:"meta",format:"pct",higherIsBetter:!0},{id:"leads",label:"Leads",group:"topline",format:"num",higherIsBetter:!0},{id:"cpl",label:"CPL",group:"topline",format:"kr",higherIsBetter:!1},{id:"wonLeads",label:"Won leads",group:"topline",format:"num",higherIsBetter:!0},{id:"totalLeadValue",label:"Total lead value",group:"topline",format:"kr",higherIsBetter:!0},{id:"avgLeadValue",label:"Average lead value",group:"topline",format:"kr",higherIsBetter:!0},{id:"cac",label:"CAC",group:"topline",format:"kr",higherIsBetter:!1},{id:"roasKr",label:"ROAS",group:"topline",format:"kr",higherIsBetter:!0},{id:"roasX",label:"ROAS %",group:"topline",format:"x",higherIsBetter:!0}];return e&&t.push({id:"totalProfit",label:"Total profit",group:"bottomline",format:"kr",higherIsBetter:!0},{id:"avgProfitPerWon",label:"Avg profit per won",group:"bottomline",format:"kr",higherIsBetter:!0},{id:"poasKr",label:"POAS",group:"bottomline",format:"kr",higherIsBetter:!0},{id:"poasX",label:"POAS %",group:"bottomline",format:"x",higherIsBetter:!0},{id:"poiKr",label:"POI",group:"bottomline",format:"kr",higherIsBetter:!0},{id:"poiX",label:"POI %",group:"bottomline",format:"x",higherIsBetter:!0}),t}function metaReportComparisonHeroIds(e=!1){return e?["spend","leads","wonLeads","roasKr","totalLeadValue","poasKr"]:["spend","leads","wonLeads","roasKr","totalLeadValue"]}function metaReportComparisonChartIds(e=!1,t="kr"){const a=["spend","leads","totalLeadValue"];return t==="x"?[...a,"roasX",...e?["poasX"]:[]]:[...a,"roasKr",...e?["poasKr"]:[]]}function metaReportBuildYtdByMonthComparison(e,t,a,n){if(!a||!n)return[];const s=metaReportComparisonMonthKeysInRange(a.startMonthKey,a.endMonthKey),o=String(n.startMonthKey||"").slice(0,4);return s.map(r=>{const i=String(r).slice(5,7),l=`${o}-${i}`,c=metaReportAggregateComparisonRange(e,r,r),d=metaReportAggregateComparisonRange(t,l,l);return{monthKey:r,label:metaMonthLabel(r),periodA:c.hasData?c.metrics:null,periodB:d.hasData?d.metrics:null,hasDataA:c.hasData,hasDataB:d.hasData}})}function metaReportBuildComparison({monthsMap:e={},monthsMapA:t=null,monthsMapB:a=null,periodA:n=null,periodB:s=null,mode:o="mom"}={}){const r=t||a||e,i=metaReportComparisonNormalizePeriod(n),l=metaReportComparisonNormalizePeriod(s);if(!i?.startDate||!i?.endDate||!l?.startDate||!l?.endDate)return{mode:o,insufficientData:!0,samePeriod:!1,periodA:null,periodB:null,deltas:{},heroMetrics:[],detailRows:[],ytdByMonth:[],hasBottomline:!1};const c=i.startDate===l.startDate&&i.endDate===l.endDate,d=metaReportComparisonAggregateForMode(o,r,n),u=metaReportComparisonAggregateForMode(o,r,s),p=d.hasBottomline||u.hasBottomline,h=!d.hasData&&!u.hasData,m=metaReportComparisonMetricDefs(p),$={},v=m.map(b=>{const w=d.metrics[b.id],g=u.metrics[b.id],S=metaReportDeltaPct(w,g);return $[b.id]={pct:S,abs:Math.round((metaReportParseAmount(w)-metaReportParseAmount(g))*100)/100},{...b,valueA:w,valueB:g,deltaPct:S}}),f=metaReportComparisonHeroIds(p).map(b=>{const w=m.find(g=>g.id===b);return{id:b,label:w?.label||b,valueA:d.metrics[b],valueB:u.metrics[b],deltaPct:$[b]?.pct??null,format:w?.format||"num",higherIsBetter:w?.higherIsBetter??null}}),y=o==="ytd"?metaReportBuildYtdByMonthComparison(r,r,i,l):[];return{mode:o,insufficientData:h,samePeriod:c,hasBottomline:p,periodA:d,periodB:u,deltas:$,heroMetrics:f,detailRows:v,ytdByMonth:y}}function metaReportComparisonYearsNeeded(e,t){const a=new Set;for(const n of[e,t]){const s=metaReportComparisonNormalizePeriod(n);s&&(s.startDate&&a.add(s.startDate.slice(0,4)),s.endDate&&a.add(s.endDate.slice(0,4)))}return[...a].filter(Boolean)}function metaReportComparisonMonthsForYear(e,t){return!e||Number(e.year)===Number(t)?e?.months||{}:metaReportsState.comparisonYearCache?.[t]?.months||{}}function metaReportComparisonAvailableMonthKeys(e){const t=new Set,a=n=>{n&&Object.entries(n.months||{}).forEach(([s,o])=>{metaReportMonthHasComparisonData(o)&&t.add(s)})};return a(e),Object.values(metaReportsState.comparisonYearCache||{}).forEach(a),[...t].sort()}function metaReportComparisonPresetDisabled(e,t){const a=metaReportsState.activeMonthKey;return a?e==="mom"?!metaReportComparisonAddMonths(a,-1):!1:!0}function metaReportComparisonFmtValue(e,t="num",a=!0){return a?t==="kr"?metaFmtKr(e):t==="x"?metaFmtX(e):t==="pct"?`${metaFmtNum(e,2)}%`:metaFmtNum(e):"\u2014"}function metaReportComparisonDeltaTone(e,t=null){return e==null||!Number.isFinite(e)||e===0?"neutral":t===!1?e<0?"positive":"negative":e>0?"positive":"negative"}function metaReportComparisonPeriodsFromState(e){let t=metaReportComparisonNormalizePeriod(metaReportsState.comparisonPeriodA),a=metaReportComparisonNormalizePeriod(metaReportsState.comparisonPeriodB);if(!t||!a){const n=metaReportApplyComparisonPresetDefaults(e,metaReportsState.comparisonMode);t=n.periodA,a=n.periodB}return{periodA:t,periodB:a,mode:metaReportsState.comparisonMode}}function metaReportComparisonMaps(e,t,a){const n=metaReportComparisonMergedMonthsMap(e,t,a);return{monthsMapA:n,monthsMapB:n}}async function ensureMetaReportComparisonYears(e,{editable:t=!1}={}){const{periodA:a,periodB:n}=metaReportComparisonPeriodsFromState(e),s=metaReportComparisonYearsNeeded(a,n),o=String(e?.year||metaReportsState.selectedYear),r=s.filter(i=>i!==o&&!metaReportsState.comparisonYearCache[i]);if(r.length)for(const i of r)try{let l;t&&e?.clientId?l=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e.clientId)}?year=${encodeURIComponent(i)}`):REPORT_TOKEN&&(l=await fetch(`/api/meta-reports/public/${encodeURIComponent(REPORT_TOKEN)}?year=${encodeURIComponent(i)}`).then(async c=>{const d=await c.json();if(!c.ok)throw new Error(d.error||"Report not found");return d})),l&&(metaReportsState.comparisonYearCache[i]=l)}catch{}}function computeMetaReportComparison(e){const{periodA:t,periodB:a,mode:n}=metaReportComparisonPeriodsFromState(e),s=metaReportComparisonMergedMonthsMap(e,t,a);return metaReportBuildComparison({monthsMap:s,periodA:t,periodB:a,mode:n})}function metaReportComparisonDateInputBounds(e){const t=metaReportComparisonAvailableMonthKeys(e);if(!t.length)return{min:"",max:""};const a=metaReportComparisonMergedMonthsMap(e,null,null);let n="",s="";return t.forEach(o=>{const r=metaReportComparisonMonthEffectivePeriod(a[o],o);(!n||r.start<n)&&(n=r.start),(!s||r.end>s)&&(s=r.end)}),{min:n,max:s}}function renderMetaReportComparisonDateField(e,t,a,n,s){const o=n.min?` data-min="${esc(n.min)}"`:"",r=n.max?` data-max="${esc(n.max)}"`:"";return`
    <label class="meta-report-comparison-date-field">
      ...
      <span class="meta-report-comparison-date-input-wrap">
        <input type="text" class="meta-report-comparison-date-input" data-comparison-date="${esc(e)}-${esc(t)}" value="${esc(a)}" placeholder="Select date" autocomplete="off" inputmode="none"${o}${r} />
  ...
  `}function destroyMetaReportComparisonDatePickers(){document.querySelectorAll("[data-comparison-date]").forEach(e=>{e._metaComparisonDatePicker&&(e._metaComparisonDatePicker.destroy(),e._metaComparisonDatePicker=null)})}function renderMetaReportComparisonPeriodTiles(e,t,a){const n=metaReportsState.comparisonMode||"mom";if(n==="custom"){const r=metaReportComparisonDateInputBounds(a),i=e?.startDate||r.min||"",l=e?.endDate||i,c=t?.startDate||r.min||"",d=t?.endDate||c;return`
      <div class="meta-report-comparison-tiles" id="meta-report-comparison-range-panel">
        <div class="meta-report-comparison-tile is-a is-custom">
          ...
          <div class="meta-report-comparison-tile-dates">
            ${renderMetaReportComparisonDateField("a","start",i,r,"From")}
            ${renderMetaReportComparisonDateField("a","end",l,r,"To")}
          </div>
        </div>
        ...
        <div class="meta-report-comparison-tile is-b is-custom">
          ...
          <div class="meta-report-comparison-tile-dates">
            ${renderMetaReportComparisonDateField("b","start",c,r,"From")}
            ${renderMetaReportComparisonDateField("b","end",d,r,"To")}
          </div>
        </div>
      </div>
    `}const s=metaReportComparisonFormatDisplayLabel(n,e),o=metaReportComparisonFormatDisplayLabel(n,t);return`
    <div class="meta-report-comparison-tiles" id="meta-report-comparison-range-panel">
      ...
      <div class="meta-report-comparison-tile is-b">
        <span class="meta-report-comparison-tile-caption">Period B</span>
        <div class="meta-report-comparison-tile-label">${esc(o)}</div>
      </div>
    </div>
  `}function renderMetaReportComparisonChangeCell(e,t,a=!0,n=!0){const s=metaReportComparisonDeltaTone(e,t);if(!a&&!n||!a||!n||e==null||!Number.isFinite(e))return'<span class="meta-report-comparison-change is-neutral">\u2014</span>';const o=e>0?"\u2191":e<0?"\u2193":"\u2014",r=metaReportFormatDeltaPct(e);return`<span class="meta-report-comparison-change is-${s}">${esc(o)} ${esc(r)}</span>`}function renderMetaReportComparisonGroupTable(e,t,a,n,{highlightLastN:s=0}={}){if(!n||n.insufficientData||n.samePeriod)return"";const o=n.periodA.label,r=n.periodB.label,i=n.periodA.hasData!==!1,l=n.periodB.hasData!==!1,c=t.map((d,u)=>{const p=n.periodA.metrics[d.metricId],h=n.periodB.metrics[d.metricId],m=i&&l?metaReportDeltaPct(p,h):null;return`
  ...
  `}function renderMetaReportComparisonView(){const e=metaReportsState.clientPayload||metaReportsState.publicPayload,t=metaReportsState.comparisonResult||computeMetaReportComparison(e),{periodA:a,periodB:n}=metaReportComparisonPeriodsFromState(e),s=metaReportsState.comparisonTab||"table",o=metaReportsState.comparisonLoading;return`
    <section class="meta-report-comparison-view" id="meta-report-comparison-view">
      ...
      <div class="meta-report-comparison-view-card${o?" is-loading":""}">
  ...
  `}function destroyMetaReportComparisonChart(){metaReportsState.comparisonChartInstance&&(metaReportsState.comparisonChartInstance.destroy(),metaReportsState.comparisonChartInstance=null)}function metaReportComparisonChartLabel(e,t){return t.find(a=>a.id===e)?.label||e}function buildMetaReportComparisonGroupedBarChart(e,t,a="kr"){const n=metaReportComparisonMetricDefs(t.hasBottomline),s=metaReportComparisonChartIds(t.hasBottomline,a),o=s.map(c=>metaReportComparisonChartLabel(c,n)),r=s.map(c=>metaReportParseAmount(t.periodA.metrics[c])),i=t.periodB.hasData!==!1,l=s.map(c=>i?metaReportParseAmount(t.periodB.metrics[c]):null);return new Chart(e,{type:"bar",data:{labels:o,datasets:[{label:t.periodA.label,data:r,backgroundColor:"rgba(255, 106, 0, 0.82)",borderColor:"#ff6a00",borderWidth:1,borderRadius:6,maxBarThickness:42},{label:t.periodB.label,data:l,backgroundColor:"rgba(148, 163, 184, 0.82)",borderColor:"#94a3b8",borderWidth:1,borderRadius:6,maxBarThickness:42}]},options:{responsive:!0,maintainAspectRatio:!1,layout:{padding:{left:8,right:12,top:0,bottom:0}},interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!0,position:"top",labels:{boxWidth:12,font:{size:11}}},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,callbacks:{label(c){const d=c.parsed.y,u=s[c.dataIndex],p=n.find(h=>h.id===u);return`${c.dataset.label}: ${metaReportComparisonFmtValue(d,p?.format||"num")}`}}}},scales:{x:{grid:{display:!1},ticks:{color:"#6b5348",font:{size:11},maxRotation:45,minRotation:0}},y:{grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:"#6b5348",font:{size:11},callback:c=>{const d=Number(c)||0;return Math.abs(d)>=1e6?`${(d/1e6).toFixed(1)}M`:Math.abs(d)>=1e3?`${Math.round(d/1e3)}K`:d}}}}}})}function metaReportComparisonYtdLineMetricId(e,t){return t==="x"?e?"poasX":"roasX":e?"poasKr":"totalLeadValue"}function buildMetaReportComparisonYtdLineChart(e,t,a="kr"){const n=t.ytdByMonth||[];if(!n.length)return null;const s=metaReportComparisonYtdLineMetricId(t.hasBottomline,a),r=metaReportComparisonMetricDefs(t.hasBottomline).find(u=>u.id===s),i=n.map(u=>u.label),l=n.map(u=>u.hasDataA&&u.periodA?metaReportParseAmount(u.periodA[s]):null),c=n.map(u=>u.hasDataB&&u.periodB?metaReportParseAmount(u.periodB[s]):null);return l.some(u=>u!=null)||c.some(u=>u!=null)?new Chart(e,{type:"line",data:{labels:i,datasets:[{label:t.periodA.label,data:l,borderColor:"#ff6a00",backgroundColor:"rgba(255, 106, 0, 0.08)",borderWidth:2,pointBackgroundColor:"#ff6a00",pointRadius:3,tension:.3,spanGaps:!1},{label:t.periodB.label,data:c,borderColor:"#94a3b8",backgroundColor:"rgba(148, 163, 184, 0.08)",borderWidth:2,pointBackgroundColor:"#94a3b8",pointRadius:3,tension:.3,spanGaps:!1}]},options:{responsive:!0,maintainAspectRatio:!1,layout:{padding:{left:8,right:12,top:0,bottom:0}},interaction:{mode:"index",intersect:!1},plugins:{legend:{display:!0,position:"top",labels:{boxWidth:12,font:{size:11}}},tooltip:{backgroundColor:"#ffffff",borderColor:"#e8e0d8",borderWidth:1,titleColor:"#1a1208",bodyColor:"#1a1208",padding:10,callbacks:{label(u){const p=u.parsed.y;return p==null?`${u.dataset.label}: \u2014`:`${u.dataset.label}: ${metaReportComparisonFmtValue(p,r?.format||"num")}`}}},title:{display:!0,text:r?.label||s,color:"#6b5348",font:{size:12,weight:"600"},padding:{bottom:8}}},scales:{x:{grid:{display:!1},ticks:{color:"#6b5348",font:{size:11}}},y:{grid:{color:"rgba(26, 18, 8, 0.08)"},ticks:{color:"#6b5348",font:{size:11},callback:u=>{const p=Number(u)||0;return a==="x"?`${p.toFixed(2)}x`:Math.abs(p)>=1e6?`${(p/1e6).toFixed(1)}M`:Math.abs(p)>=1e3?`${Math.round(p/1e3)}K`:p}}}}}}):null}function buildMetaReportComparisonChart(e,t,a="kr"){const n=document.getElementById("meta-report-comparison-chart-empty");if(!t||t.insufficientData||t.samePeriod)return n&&(n.hidden=!1),null;let s=null;return t.mode==="ytd"?s=buildMetaReportComparisonYtdLineChart(e,t,a):s=buildMetaReportComparisonGroupedBarChart(e,t,a),n&&(n.hidden=!!s),s}function mountMetaReportComparisonChart(e){if(destroyMetaReportComparisonChart(),(metaReportsState.comparisonTab||"table")!=="chart")return;const t=document.getElementById("meta-report-comparison-chart");t&&(metaReportsState.comparisonChartInstance=buildMetaReportComparisonChart(t,e,metaReportsState.comparisonChartMode))}function setMetaReportComparisonTab(e){if(metaReportsState.comparisonTab=e==="chart"?"chart":"table",document.querySelectorAll("[data-comparison-tab]").forEach(t=>{const a=t.getAttribute("data-comparison-tab")===metaReportsState.comparisonTab;t.classList.toggle("is-active",a),t.setAttribute("aria-selected",a)}),document.querySelectorAll("[data-comparison-panel]").forEach(t=>{const a=t.getAttribute("data-comparison-panel")===metaReportsState.comparisonTab;t.classList.toggle("is-active",a),t.hidden=!a}),metaReportsState.comparisonTab==="chart"){const t=metaReportsState.clientPayload||metaReportsState.publicPayload;mountMetaReportComparisonChart(metaReportsState.comparisonResult||computeMetaReportComparison(t))}else destroyMetaReportComparisonChart()}function setMetaReportViewMode(e,t,{editable:a=!1}={}){metaReportsState.reportViewMode=e==="comparison"?"comparison":"monthly",document.querySelectorAll("[data-report-view-mode]").forEach(s=>{const o=s.getAttribute("data-report-view-mode")===metaReportsState.reportViewMode;s.classList.toggle("is-active",o),s.setAttribute("aria-selected",o)}),document.querySelectorAll("[data-report-view-panel]").forEach(s=>{const o=s.getAttribute("data-report-view-panel")===metaReportsState.reportViewMode;s.classList.toggle("is-active",o),s.hidden=!o});const n=document.querySelector("#meta-report-month-panel .meta-report-preview-card");if(n&&(n.hidden=metaReportsState.reportViewMode==="comparison"),metaReportsState.reportViewMode==="monthly")destroyMetaReportComparisonChart(),mountMetaReportTrendCharts(t,{editable:a,clientId:t?.clientId||null}),a&&syncMetaReportScenario(t);else if(destroyMetaReportTrendCharts(),t){const{series:s}=resolveMetaReportChartSeries(t);s.length&&(metaReportsState.chartSeries=s),bindMetaReportComparisonControls(t,{editable:a}),refreshMetaReportComparison(t,{editable:a}),a&&(bindMetaReportScenarioControls(t,{editable:!0}),syncMetaReportScenario(t))}}function bindMetaReportViewModeTabs(e,{editable:t=!1}={}){document.querySelectorAll("[data-report-view-mode]").forEach(a=>{a.onclick=()=>{const n=a.getAttribute("data-report-view-mode");!n||n===metaReportsState.reportViewMode||setMetaReportViewMode(n,e,{editable:t})}})}function syncMetaReportComparisonUi(e,{editable:t=!1}={}){const a=document.getElementById("meta-report-comparison-view");if(!a)return;const n=computeMetaReportComparison(e);metaReportsState.comparisonResult=n;const s=document.getElementById("meta-report-comparison-headline-wrap");s&&s.remove();const o=a.querySelector(".meta-report-comparison-view-card");o&&o.classList.toggle("is-loading",!!metaReportsState.comparisonLoading);const r=document.getElementById("meta-report-comparison-table-wrap");r&&(r.innerHTML=renderMetaReportComparisonTables(n));const i=document.getElementById("meta-report-comparison-chart-empty");i&&(i.hidden=!(n.insufficientData||n.samePeriod)),(metaReportsState.comparisonTab||"table")==="chart"&&mountMetaReportComparisonChart(n)}async function refreshMetaReportComparison(e,{editable:t=!1}={}){if(!(!e||!document.getElementById("meta-report-comparison-view"))){metaReportsState.comparisonLoading=!0,syncMetaReportComparisonUi(e,{editable:t});try{await ensureMetaReportComparisonYears(e,{editable:t})}finally{metaReportsState.comparisonLoading=!1,syncMetaReportComparisonUi(e,{editable:t})}}}async function applyMetaReportComparisonDateChange(e,t,{editable:a=!1}={}){const n=t.getAttribute("data-comparison-date");if(!n||!t.value)return;const[s,o]=n.split("-"),r=`comparisonPeriod${s.toUpperCase()}`;metaReportsState[r]||(metaReportsState[r]={startDate:null,endDate:null});const i=metaReportsState[r];if(i[`${o}Date`]=t.value,i.startDate&&i.endDate&&i.startDate>i.endDate){const c=i.startDate;i.startDate=i.endDate,i.endDate=c}metaReportsState.comparisonMode="custom",await refreshMetaReportComparison(e,{editable:a});const l=document.getElementById("meta-report-comparison-range-wrap");if(l){const{periodA:c,periodB:d}=metaReportComparisonPeriodsFromState(e);l.innerHTML=renderMetaReportComparisonPeriodTiles(c,d,e),bindComparisonDateInputs()}document.querySelectorAll("[data-comparison-preset]").forEach(c=>{c.classList.toggle("active",c.getAttribute("data-comparison-preset")==="custom"),c.setAttribute("aria-pressed",c.getAttribute("data-comparison-preset")==="custom")})}function bindMetaReportComparisonControls(e,{editable:t=!1}={}){const a=()=>{document.querySelectorAll("[data-comparison-preset]").forEach(s=>{s.onclick=async()=>{if(s.disabled)return;const o=s.getAttribute("data-comparison-preset");if(!o)return;metaReportsState.comparisonMode=o,metaReportApplyComparisonPresetDefaults(e,o),metaReportsState.comparisonLoading=!0;const r=document.getElementById("meta-report-comparison-view");r&&(r.outerHTML=renderMetaReportComparisonView(),bindMetaReportComparisonControls(e,{editable:t})),await refreshMetaReportComparison(e,{editable:t})}})},n=()=>{if(destroyMetaReportComparisonDatePickers(),document.querySelectorAll("[data-comparison-date]").forEach(s=>{s.onchange=null}),typeof flatpickr<"u"){document.querySelectorAll("[data-comparison-date]").forEach(s=>{const o=metaReportComparisonDateInputBounds(e);s._metaComparisonDatePicker&&s._metaComparisonDatePicker.destroy(),s._metaComparisonDatePicker=flatpickr(s,{dateFormat:"Y-m-d",minDate:o.min||s.getAttribute("data-min")||void 0,maxDate:o.max||s.getAttribute("data-max")||void 0,disableMobile:!0,allowInput:!1,clickOpens:!0,animate:!0,onChange:(i,l,c)=>{!l||c._metaComparisonApplying||applyMetaReportComparisonDateChange(e,c.input,{editable:t})}});const r=s.closest(".meta-report-comparison-date-input-wrap");r&&(r.onclick=i=>{i.target!==s&&s._metaComparisonDatePicker?.open()})});return}document.querySelectorAll("[data-comparison-date]").forEach(s=>{s.onchange=()=>{applyMetaReportComparisonDateChange(e,s,{editable:t})}})};document.querySelectorAll("[data-comparison-tab]").forEach(s=>{s.onclick=()=>{const o=s.getAttribute("data-comparison-tab");o&&setMetaReportComparisonTab(o)}}),document.querySelectorAll("#meta-report-comparison-chart-mode .meta-report-chart-toggle-btn").forEach(s=>{s.onclick=()=>{metaReportsState.comparisonChartMode=s.getAttribute("data-mode")||"kr",document.querySelectorAll("#meta-report-comparison-chart-mode .meta-report-chart-toggle-btn").forEach(o=>{o.classList.toggle("is-active",o===s)}),mountMetaReportComparisonChart(metaReportsState.comparisonResult||computeMetaReportComparison(e))}}),a(),n(),setMetaReportComparisonTab(metaReportsState.comparisonTab||"table")}function mountMetaReportComparison(e,{editable:t=!1}={}){document.getElementById("meta-report-comparison-view")&&(bindMetaReportComparisonControls(e,{editable:t}),refreshMetaReportComparison(e,{editable:t}))}function renderMetaReportScenarioCard(){return`
  ...
  `}function metaReportFormatDeltaPct(e){return e==null||!Number.isFinite(e)?"":`${e>0?"+":""}${e.toFixed(0)}%`}function metaReportScenarioDeltaTone(e=""){return String(e).startsWith("+")?"positive":String(e).startsWith("-")?"negative":"neutral"}function renderMetaReportScenarioOutcomeCard({label:e,projectedValue:t,projectedSub:a="",baselineValue:n="",delta:s=""}={}){const o=metaReportScenarioDeltaTone(s);return`
    <div class="meta-report-scenario-outcome-card ${o==="negative"?"is-negative":"is-positive"}">
      ...
      ${s?`<div class="meta-report-scenario-outcome-delta is-${o}">${esc(s)}</div>`:""}
  ...
  `:""}function renderMetaReportMonthBody(e,{editable:t=!1,yearPayload:a=null,activeMonthKey:n=null}={}){const s=n||e?.monthKey||null,o=s?metaReportMonthBounds(s):null;let r="";t&&e&&!e.meta?.emptyMonth&&o&&(r=`
  ...
  `:"",p=renderMetaReportMonthTables(e,{editable:t}),h=d?renderMetaReportChartsPanel({editable:t}):"",m=t&&d?renderMetaReportScenarioCard():"",$=d?renderMetaReportViewModeTabs():"";let v;return d?v=`
    ...
    `)}
  `}function renderMetaReportsClientPage(e){const t=e.monthKeys||[],a=metaReportsState.activeMonthKey||t[t.length-1]||"",n=e.months?.[a]||null,s=e.settings||{},o=t.map(r=>`
  ...
  `}function setMetaReportYearLoadingBanner(e,t,a){const n=document.querySelector(e);if(!n)return;let s=n.querySelector(".meta-report-year-loading-banner");a?(s||(s=document.createElement("span"),s.className="meta-report-year-loading-banner",s.setAttribute("aria-live","polite"),n.appendChild(s)),s.innerHTML=`<span class="meta-report-save-indicator-spinner"></span> Loading ${esc(t)}\u2026`,s.hidden=!1):s&&(s.hidden=!0)}function setMetaReportClientYearLoading(e,t){const a=document.querySelector(".meta-report-client-page"),n=document.getElementById("meta-report-year");if(t){n&&(n.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!0);const s=document.querySelector(".meta-report-tabs");s&&(s.innerHTML=renderMetaReportTabsSkeleton(),s.setAttribute("aria-busy","true"));const o=document.getElementById("meta-report-month-panel");o&&(o.innerHTML=renderMetaReportMonthPanelSkeleton(),o.classList.add("is-loading")),destroyMetaReportCharts()}else{n&&(n.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-report-client-page .meta-report-toolbar-left",e,!1);const s=document.querySelector(".meta-report-tabs");s&&s.removeAttribute("aria-busy");const o=document.getElementById("meta-report-month-panel");o&&o.classList.remove("is-loading")}}function setMetaCvYearLoading(e,t){const a=document.querySelector(".sync-history-page.meta-reports-page"),n=document.getElementById("meta-cv-year"),s=document.getElementById("meta-cv-search");if(t){n&&(n.disabled=!0),s&&(s.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!0);const o=document.querySelector(".meta-cv-summary");o&&(o.classList.add("is-skeleton"),o.innerHTML=renderMetaCvSummarySkeleton());const r=document.querySelector(".meta-cv-legend");r&&r.setAttribute("aria-hidden","true");const i=document.getElementById("meta-cv-client-list");i&&(i.innerHTML=renderMetaCvListSkeleton(),i.setAttribute("aria-busy","true"));const l=document.getElementById("meta-cv-editor");l&&(l.innerHTML=renderMetaCvEditorYearSkeleton(),l.setAttribute("aria-busy","true"))}else{n&&(n.disabled=!1),s&&(s.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-cv-toolbar-left",e,!1);const o=document.querySelector(".meta-cv-summary");o&&o.classList.remove("is-skeleton");const r=document.querySelector(".meta-cv-legend");r&&r.removeAttribute("aria-hidden");const i=document.getElementById("meta-cv-client-list");i&&i.removeAttribute("aria-busy");const l=document.getElementById("meta-cv-editor");l&&l.removeAttribute("aria-busy")}}function setMetaReportPublicYearLoading(e,t){const a=document.querySelector(".meta-reports-page--public"),n=document.getElementById("meta-report-year");if(t){n&&(n.disabled=!0),a&&a.classList.add("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!0);const s=document.querySelector(".meta-reports-page--public .meta-report-tabs");s&&(s.innerHTML=renderMetaReportTabsSkeleton(),s.setAttribute("aria-busy","true"));const o=document.getElementById("meta-report-month-panel");o&&(o.innerHTML=renderMetaReportMonthPanelSkeleton(),o.classList.add("is-loading")),destroyMetaReportCharts()}else{n&&(n.disabled=!1),a&&a.classList.remove("is-year-loading"),setMetaReportYearLoadingBanner(".meta-reports-page--public .meta-report-toolbar-left",e,!1);const s=document.querySelector(".meta-reports-page--public .meta-report-tabs");s&&s.removeAttribute("aria-busy");const o=document.getElementById("meta-report-month-panel");o&&o.classList.remove("is-loading")}}function bindMetaReportsClientChromeEvents(e){const t=e.clientId,a=document.getElementById("meta-report-year");a&&(a.onchange=async()=>{if(a.selectedOptions?.[0]?.disabled){a.value=String(metaReportsState.selectedYear);return}const s=metaReportsState.selectedYear,o=Number(a.value);if(o!==s){metaReportsState.selectedYear=o,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportClientYearLoading(o,!0);try{await loadMetaReportsClientPage({silent:!0})}catch(r){metaReportsState.selectedYear=s,a&&(a.value=String(s)),await loadMetaReportsClientPage({silent:!0}),showToast(r.message||"Load failed","error")}finally{setMetaReportClientYearLoading(o,!1)}}}),bindMetaReportCopyButtons(),bindMetaReportBackfillButton(t),bindMetaReportBottomlineFeeEvents(t,"meta-report"),bindMetaReportShareEvents(e)}function bindMetaReportsClientEvents(e){bindMetaReportsClientChromeEvents(e),bindMetaReportsClientTabEvents(e),bindMetaReportsClientEditEvents(e.clientId,e)}function bindMetaReportsClientEditEvents(e,t){const a=document.getElementById("meta-report-refresh-meta");a&&(a.onclick=async()=>{a.disabled=!0;try{const s=metaReportsState.activeMonthKey,o=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(s)}/refresh`,{method:"POST"});refreshMetaReportMonthPanel(o.monthPayload),showToast("Meta data refreshed","success")}catch(s){showToast(s.message||"Meta refresh failed","error")}finally{a.disabled=!1}});const n=document.getElementById("meta-report-save-month");n&&(n.onclick=async()=>{n.disabled=!0;try{const s=metaReportsState.activeMonthKey,o={periodStart:document.getElementById("meta-report-period-start")?.value,periodEnd:document.getElementById("meta-report-period-end")?.value,wonLeads:Number(document.getElementById("meta-report-won-leads")?.value),avgLeadValue:Number(document.getElementById("meta-report-avg-lead-value")?.value),avgProfitPerWon:Number(document.getElementById("meta-report-avg-profit")?.value)},r=await adminFetch(`/api/meta-reports/clients/${encodeURIComponent(e)}/months/${encodeURIComponent(s)}`,{method:"PUT",body:JSON.stringify(o)});refreshMetaReportMonthPanel(r.monthPayload),showToast("Month saved","success")}catch(s){showToast(s.message||"Save failed","error")}finally{n.disabled=!1}})}function bindPublicMetaReportTabEvents(e){document.querySelectorAll("[data-meta-month-tab]").forEach(t=>{t.onclick=()=>{switchMetaReportMonthTab(t.getAttribute("data-meta-month-tab"),{editable:!1})}})}function bindPublicMetaReportEvents(e){bindPublicMetaReportTabEvents(e);const t=document.getElementById("meta-report-year");t&&(t.onchange=async()=>{if(t.selectedOptions?.[0]?.disabled){t.value=String(metaReportsState.selectedYear);return}const n=metaReportsState.selectedYear,s=Number(t.value);if(s!==n){metaReportsState.selectedYear=s,metaReportsState.activeMonthKey=null,metaReportsState.comparisonYearCache={},setMetaReportPublicYearLoading(s,!0);try{await loadPublicMetaReportPage({silent:!0})}catch(o){metaReportsState.selectedYear=n,t&&(t.value=String(n)),await loadPublicMetaReportPage({silent:!0}),showToast(o.message||"Load failed","error")}finally{setMetaReportPublicYearLoading(s,!1)}}})}async function loadMetaReportsHubPage(){const e=document.getElementById("dashboard");if(!e)return;const t=await fetchStaffMe();if(!t){e.innerHTML=`
    ...
    `).join(""):'<div class="meta-report-empty" style="padding:32px 12px">No matching clients.</div>'}function monthStatusIsEmpty(e,t={}){return e?(e.status??classifyMetaCvMonthStatus({wonLeads:e.inputs?.wonLeads??e.topline?.wonLeads??e.wonLeads,avgLeadValue:e.inputs?.avgLeadValue??e.topline?.avgLeadValue??e.avgLeadValue,avgProfitPerWon:e.inputs?.avgProfitPerWon??e.avgProfitPerWon},!!t.metaReportShowBottomline))==="empty":!0}function metaReportEffectiveFeeEnabled(e,t=null){if(!t)return!!e?.metaReportFeeEnabled;const a=!!e?.metaReportShowBottomline;return(t.status??classifyMetaCvMonthStatus({wonLeads:t.inputs?.wonLeads??t.topline?.wonLeads??t.wonLeads,avgLeadValue:t.inputs?.avgLeadValue??t.topline?.avgLeadValue??t.avgLeadValue,avgProfitPerWon:t.inputs?.avgProfitPerWon??t.avgProfitPerWon},a))==="empty"?!1:!!e?.metaReportFeeEnabled}function resolveMetaReportFeeMode(e={}){return e.metaReportFeeEnabled?resolveMetaReportStoredFeeMode(e):""}const META_REPORT_FEE_MODE_META=[{value:"",icon:"\u2013",title:"None",desc:"No Censio fee"},{value:"performance",icon:"%",title:"Performance fee",desc:"% of profit (POAS)"},{value:"marketing",icon:"Dkr",title:"Marketing fee",desc:"Fixed Dkr amount"}];function metaReportFeeValueBlockHtml(e,t,a,n,{inline:s=!1}={}){return s&&t==="performance"?`
      ...
      </label>`:'<p class="meta-report-fee-value-empty">No amount needed \u2014 just save your selection.</p>'}function metaReportUsesInlineFeeValue(e){return e==="meta-cv"}function describeMetaReportFeeModeLabel(e,t,a,{feeEnabled:n=!0}={}){if(!n||e===""||e==null)return"No Censio fee";if(e==="performance"){const s=Number(t);return`Performance fee \xB7 ${Number.isFinite(s)?s:20}%`}if(e==="marketing"){const s=Number(a);return`Marketing fee \xB7 Dkr ${Number.isFinite(s)?s:0}`}return"No Censio fee"}function readMetaReportFeeDraftState(e){const t=document.getElementById(`${e}-fee-nested`);if(!t)return null;const a=t.querySelector(`input[name="${e}-fee-mode"]:checked`),n=a?a.value||"":t.dataset.feeMode||"";let s=Number(t.dataset.feePercent),o=Number(t.dataset.marketingFee);if(n==="performance"){const u=document.getElementById(`${e}-setting-fee-percent`),p=Number(u?.value);Number.isFinite(p)&&(s=p)}else if(n==="marketing"){const u=document.getElementById(`${e}-setting-marketing-fee`),p=Number(u?.value);Number.isFinite(p)&&(o=p)}const r=t.dataset.feeEnabled==="true"?resolveMetaReportStoredFeeMode({metaReportFeeEnabled:!0,metaReportFeeMode:t.dataset.feeMode||null,metaReportMarketingFeeAmount:t.dataset.marketingFee}):"",i=Number(t.dataset.feePercent),l=Number(t.dataset.marketingFee);return{appliedMode:r,appliedPercent:i,appliedMarketing:l,selectedMode:n,selectedPercent:s,selectedMarketing:o,isDirty:n!==r||(n==="performance"?s!==i:n==="marketing"?o!==l:!1),appliedLabel:describeMetaReportFeeModeLabel(r,i,l),selectedLabel:describeMetaReportFeeModeLabel(n,s,o)}}function metaReportFeeStatusHtml(e){return e.isDirty?`
  ...
  `}const m=describeMetaReportFeeModeLabel(c,d,u),$=META_REPORT_FEE_MODE_META.map(({value:b,icon:w,title:g,desc:S})=>`
        ...
        <div class="meta-report-fee-save-row">
          <button type="button" class="admin-btn admin-btn--primary admin-btn--small" id="${t}-fee-save">Save fee settings</button>
        </div>`,y=s&&!o?renderMetaReportBottomlineFeeSummary(e,t):"";return`
  ...
  `}function renderMetaCvEditor(e){const t=metaReportsState.customValues,a=(e.clients||[]).find($=>$.clientId===t.selectedClientId),n=t.selectedMonthKey;if(!a||!n)return`
    ...
    `;const s=a.months?.[n]||{};if(t.loadingEditor)return renderMetaCvEditorSkeleton(a,n,s);const o=t.editorPayload?.months?.[n]||null,r=a.metaReportShowBottomline,i=s.wonLeads!=null?s.wonLeads:o?.inputs?.wonLeads??o?.topline?.wonLeads??"",l=s.avgLeadValue!=null?s.avgLeadValue:o?.inputs?.avgLeadValue??o?.topline?.avgLeadValue??"",c=s.avgProfitPerWon!=null?s.avgProfitPerWon:o?.inputs?.avgProfitPerWon??"",d=metaReportsState.customValues.draftInputs,u=d?.wonLeads??i,p=d?.avgLeadValue??l,h=d?.avgProfitPerWon??c,m=t.settingsSaving&&t.settingsSavingScope==="report";return`
...
This removes the account, GHL token, and all synced snapshot data. This cannot be undone.`))return;if(window.prompt(`Type "${e}" to confirm deletion:`)!==e){showToast("Deletion cancelled \u2014 slug did not match.","error");return}try{await adminFetch(`/api/clients/${encodeURIComponent(e)}`,{method:"DELETE"}),showToast(`Deleted ${e}`,"success"),IS_ADMIN_HUB?await loadAdminHub():window.location.href="/admin"}catch(s){showToast(s.message,"error")}}async function syncClient(e,t){t&&(t.disabled=!0,t.textContent="Syncing...");try{await adminFetch(`/api/clients/${encodeURIComponent(e)}/sync`,{method:"POST",body:"{}"}),showToast("Sync completed","success"),IS_ADMIN_HUB?await loadAdminHub():IS_ADMIN_CLIENT?(await loadSetupAccount(),accountCanPreviewDashboard(setupAccount)&&loadDashboard(!0,{background:!0})):loadDashboard(!0,{background:!0})}catch(a){showToast(a.message,"error")}finally{if(t){t.disabled=!1;const a=t.dataset.syncLabel||"Sync";t.innerHTML=t.dataset.syncLabel?`${ICON_SYNC} ${a}`:a}}}function getMetricsModelLabels(e,t=setupPipelines){const a=new Map((t||[]).map(n=>[n.id,n.name]));return e.dedupeEnabled?{typeLabel:"Funnel + deduplication",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId||"\u2014"}`}:e.winPipelineId?{typeLabel:"Simple (single win pipeline)",winLabel:`Win pipeline: ${a.get(e.winPipelineId)||e.winPipelineId}`}:{typeLabel:"Simple (no deduplication)",winLabel:"All won opportunities"}}const ICON_LAYER='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z"/><path d="M3 13l9 5 9-5"/></svg>',ICON_MERGE='<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="2.4"/><circle cx="6" cy="18" r="2.4"/><circle cx="18" cy="15" r="2.4"/><path d="M6 8.4V15.6"/><path d="M8.2 6.4C14 6.4 14 12.6 15.8 13.4"/></svg>',ICON_TARGET='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="3"/></svg>',ICON_LOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 018 0v3.5"/></svg>',ICON_UNLOCK='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="10.5" width="15" height="9" rx="2"/><path d="M8 10.5V7a4 4 0 017.8-1.2"/></svg>',ICON_TAG='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.6 12.7L12.7 20.6a2 2 0 01-2.8 0l-7-7a2 2 0 010-2.8L10.8 3H19a2 2 0 012 2v7.7z"/><circle cx="15" cy="8" r="1.2"/></svg>',ICON_HASH='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9h14M5 15h14M10 3L8 21M16 3l-2 18"/></svg>',ICON_EDIT='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 013 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>',ICON_WARNING='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.3 3.9L2.6 18a1.5 1.5 0 001.3 2.2h16.2a1.5 1.5 0 001.3-2.2L13.7 3.9a1.5 1.5 0 00-3.4 0z"/><path d="M12 9v4"/><path d="M12 16.5h.01"/></svg>';function renderMetricsModelPanel(e){const t=getMetricsModelLabels(e),a=!e.metricsModelSetAt||metricsModelChangeMode,n=a?" is-wizard":" is-locked",s=e.dedupeEnabled?"dedupe":e.winPipelineId?"pipeline":"simple",o=e.metricsModelLockedAt?`Locked since ${new Date(e.metricsModelLockedAt).toLocaleDateString("en-GB")}`:"Editable until first successful sync",r=e.metricsModelLockedAt?"metrics-model-badge is-locked":"metrics-model-badge";return a?`
  ...
  `}function getSetupProgressSteps(e){return[{id:"metrics",label:"Metrics",done:!!e.metricsModelSetAt},{id:"ghl",label:"GHL",done:!!(e.hasGhlToken&&e.locationId)},{id:"pipelines",label:"Pipelines",done:!!(e.newLeadsPipelineId&&e.salesPipelineId)},{id:"meta",label:"Meta",done:e.metaSyncStatus==="ok",partial:!!(e.metaAdAccountId&&e.metaSyncStatus!=="ok")}]}function renderSetupProgressStrip(e){const t=getSetupProgressSteps(e),a='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 6L9 17l-5-5"/></svg>';return`
    <nav class="setup-progress" aria-label="Setup progress">
      ${t.map((n,s)=>{const o=n.done?" is-done":n.partial?" is-partial":"",r=n.done?`<span class="setup-progress-mark">${a}</span>`:`<span class="setup-progress-mark">${s+1}</span>`;return`
  ...
  `:`
    ...
    `}function renderTable(e,t,a,n,s){const o=a.filter(r=>isVisible("columns",r.key,e));return o.length?`
    <div class="dashboard-table-wrap">
      <table class="dashboard-table">
        <thead>
          <tr>
            <th>${t}</th>
            ${o.map(r=>`<th class="${r.align||""}">${r.label}</th>`).join("")}
          </tr>
        </thead>
        <tbody>
          ${n.length?n.map(r=>`
            <tr>
              <td>${s(r,"label")}</td>
              ${o.map(i=>`<td class="${i.align||""}">${s(r,i.key)}</td>`).join("")}
            </tr>
  ...
  `}function renderDashboardContent(e){const{kpis:t,statusBreakdown:a,sourceReport:n,assigneeReport:s,pipelines:o,filters:r}=e,i=isVisible("sections","statusBreakdown");return`
  ...
  `,IS_ADMIN_CLIENT&&loadSetupAccount(),initDatePickers()}let isFetching=!1,pendingRefetch=!1,fetchGeneration=0,activeFetchController=null,fetchStartedAt=0;const FETCH_TIMEOUT_MS=9e4;function restoreDashboardContentAfterFailedFetch(e){!e||!cachedData||(cachedData=applyMarketingData(cachedData,cachedFacebookMetrics),updateDashboardContent(cachedData),updateFilterUi())}function setPresetButtonsDisabled(e){document.querySelectorAll("[data-preset]").forEach(t=>{t.disabled=e})}function resetFetchUiState(){isFetching=!1,setPresetButtonsDisabled(!1);const e=document.getElementById("apply-filters-btn");e&&(e.disabled=!1,e.textContent="Apply data filters")}function cancelActiveFetch(){activeFetchController&&(activeFetchController.abort(),activeFetchController=null)}function canReuseBootstrapDashboard(e){return!!(e?.kpis&&usesClientPipelineDefaults()&&!state.dateFrom&&!state.dateTo&&state.status==="all"&&state.source==="all"&&state.assignedTo==="all")}async function loadDashboard(e=!0,t={}){const{background:a=!1,forceFresh:n=!1}=t,s=!!n,o=document.getElementById("dashboard");if(isFetching&&(e||!cachedData))cancelActiveFetch(),fetchGeneration+=1,pendingRefetch=!1,resetFetchUiState();else if(isFetching){e&&(pendingRefetch=!0);return}const r=!!document.getElementById("dashboard-content"),i=document.getElementById("apply-filters-btn");if(e||!cachedData){const l=++fetchGeneration;activeFetchController=new AbortController;const c=activeFetchController.signal;if(isFetching=!0,fetchStartedAt=Date.now(),!r)o.innerHTML=`
        ...
        `)}`;else if(!a){const d=document.getElementById("dashboard-content");d&&(d.innerHTML=renderKpiSkeleton()),i&&(i.disabled=!0,i.textContent="Loading..."),setPresetButtonsDisabled(!0)}try{let d=null;if(!availablePipelines.length){if(d=await bootstrapDashboardData(c),l!==fetchGeneration)return;availablePipelines=d.filterOptions.pipelines||[],ensurePipelineDefaults(availablePipelines,d.account?.defaultPipelineIds)}if(!ensurePipelineSelectionBeforeFetch())throw new Error("Select at least one pipeline.");const p=canReuseBootstrapDashboard(d)&&!s;let h,m;if(p?[m,h]=await Promise.all([fetchFacebookMetrics(c),Promise.resolve(d)]):[h,m]=await Promise.all([fetchDashboardData(availablePipelines,c,{forceFresh:s}),fetchFacebookMetrics(c)]),l!==fetchGeneration)return;cachedFacebookMetrics=m,cachedData=applyMarketingData(h,m),cachedData.account?.facebookClientId?facebookClientId=cachedData.account.facebookClientId:cachedData.account?.clientId&&(facebookClientId=cachedData.account.clientId),availablePipelines=cachedData.filterOptions.pipelines||availablePipelines,ensurePipelineDefaults(availablePipelines,cachedData?.account?.defaultPipelineIds),lastFetchedAt=cachedData.cachedAt?new Date(cachedData.cachedAt).getTime():Date.now()}catch(d){if(l!==fetchGeneration)return;if(d.name==="AbortError"){r?restoreDashboardContentAfterFailedFetch(r):o.innerHTML=`
            ...
            </div>`)}else r?r&&cachedData?(restoreDashboardContentAfterFailedFetch(r),showToast(d.message||"Failed to load filtered data.","error")):i&&(i.textContent="Apply failed - try again"):o.innerHTML=`
          ${renderBrandTopbar(IS_ADMIN?'<a class="admin-topbar-link" href="/admin">Admin hub</a>':"")}
          ${wrapDashboardShell(`
            <div class="error-state">
              <div>Fejl ved hentning af data</div>
