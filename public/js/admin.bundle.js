    ...
    <div class="sync-history-page">
      ...
      <div class="sync-history-summary">
        ...
        <div class="sync-history-stat">
          ...
          <div class="sync-history-stat-value" style="font-size:13px;font-family:monospace">${esc(t.schedule||"Every hour (cron-job.org)")}</div>
        </div>
      </div>
